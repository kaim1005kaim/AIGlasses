...
.method private final g(Lokhttp3/internal/connection/RealConnection;J)I
    ...
    invoke-virtual {p1, v3}, Lokhttp3/internal/connection/RealConnection;->G(Z)V
    ...
    invoke-virtual {p1, p2, p3}, Lokhttp3/internal/connection/RealConnection;->F(J)V
...
.method public final a(Lokhttp3/Address;Lokhttp3/internal/connection/RealCall;Ljava/util/List;Z)Z
    ...
    iget-object p0, p0, Lokhttp3/internal/connection/RealConnectionPool;->e:Ljava/util/concurrent/ConcurrentLinkedQueue;
    ...
    :try_start_0
    invoke-virtual {v0}, Lokhttp3/internal/connection/RealConnection;->z()Z
    ...
    :cond_0
    invoke-virtual {v0, p1, p3}, Lokhttp3/internal/connection/RealConnection;->x(Lokhttp3/Address;Ljava/util/List;)Z
    ...
    :cond_1
    :try_start_1
    invoke-virtual {p2, v0}, Lokhttp3/internal/connection/RealCall;->c(Lokhttp3/internal/connection/RealConnection;)V
    :try_end_1
...
.method public final b(J)J
    ...
    :try_start_0
    invoke-direct {p0, v6, p1, p2}, Lokhttp3/internal/connection/RealConnectionPool;->g(Lokhttp3/internal/connection/RealConnection;J)I
    ...
    invoke-virtual {v6}, Lokhttp3/internal/connection/RealConnection;->t()J
    ...
    :try_start_1
    invoke-virtual {v3}, Lokhttp3/internal/connection/RealConnection;->r()Ljava/util/List;
    ...
    :cond_7
    :try_start_2
    invoke-virtual {v3}, Lokhttp3/internal/connection/RealConnection;->t()J
    ...
    :cond_8
    :try_start_3
    invoke-virtual {v3, v1}, Lokhttp3/internal/connection/RealConnection;->G(Z)V
    ...
    invoke-virtual {v3}, Lokhttp3/internal/connection/RealConnection;->c()Ljava/net/Socket;
...
.method public final c(Lokhttp3/internal/connection/RealConnection;)Z
    ...
    :cond_1
    :goto_0
    invoke-virtual {p1}, Lokhttp3/internal/connection/RealConnection;->u()Z
    ...
    invoke-virtual {p1, v0}, Lokhttp3/internal/connection/RealConnection;->G(Z)V
...
.method public final e()V
    ...
    :try_start_0
    invoke-virtual {v1}, Lokhttp3/internal/connection/RealConnection;->r()Ljava/util/List;
    ...
    invoke-virtual {v1, v2}, Lokhttp3/internal/connection/RealConnection;->G(Z)V

    invoke-virtual {v1}, Lokhttp3/internal/connection/RealConnection;->c()Ljava/net/Socket;
