...
.method private final b(Ljava/net/Proxy;Lokhttp3/HttpUrl;Lokhttp3/Dns;)Ljava/net/InetAddress;
    ...
    :cond_0
    sget-object v0, Lokhttp3/internal/authenticator/JavaNetAuthenticator$WhenMappings;->a:[I
...
.method public a(Lokhttp3/Route;Lokhttp3/Response;)Lokhttp3/Request;
    ...
    invoke-virtual/range {p2 .. p2}, Lokhttp3/Response;->w()Ljava/util/List;

    move-result-object v1

    invoke-virtual/range {p2 .. p2}, Lokhttp3/Response;->j0()Lokhttp3/Request;
    ...
    invoke-virtual/range {p2 .. p2}, Lokhttp3/Response;->x()I
    ...
    invoke-virtual {v8}, Lokhttp3/Challenge;->h()Ljava/lang/String;

    move-result-object v9

    const-string v10, "Basic"

    invoke-static {v10, v9, v6}, Lkotlin/text/StringsKt;->K1(Ljava/lang/String;Ljava/lang/String;Z)Z
    ...
    :cond_6
    invoke-virtual {v9}, Lokhttp3/Address;->n()Lokhttp3/Dns;
    ...
    iget-object v9, v0, Lokhttp3/internal/authenticator/JavaNetAuthenticator;->d:Lokhttp3/Dns;
    ...
    invoke-virtual {v8}, Lokhttp3/Challenge;->g()Ljava/lang/String;
    ...
    invoke-virtual {v8}, Lokhttp3/Challenge;->f()Ljava/nio/charset/Charset;

    move-result-object v4

    invoke-static {v1, v2, v4}, Lokhttp3/Credentials;->b(Ljava/lang/String;Ljava/lang/String;Ljava/nio/charset/Charset;)Ljava/lang/String;
    ...
    invoke-virtual {v2, v0, v1}, Lokhttp3/Request$Builder;->n(Ljava/lang/String;Ljava/lang/String;)Lokhttp3/Request$Builder;
