...
# static fields
.field static final l:[Lio/reactivex/internal/operators/flowable/FlowableCache$CacheSubscription;
...
.field final g:Lio/reactivex/internal/operators/flowable/FlowableCache$Node;
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "Lio/reactivex/internal/operators/flowable/FlowableCache$Node<",
            "TT;>;"
...
.field h:Lio/reactivex/internal/operators/flowable/FlowableCache$Node;
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "Lio/reactivex/internal/operators/flowable/FlowableCache$Node<",
            "TT;>;"
...
.method public constructor <init>(Lio/reactivex/Flowable;I)V
    ...
    iput-object p1, p0, Lio/reactivex/internal/operators/flowable/FlowableCache;->g:Lio/reactivex/internal/operators/flowable/FlowableCache$Node;

    iput-object p1, p0, Lio/reactivex/internal/operators/flowable/FlowableCache;->h:Lio/reactivex/internal/operators/flowable/FlowableCache$Node;
...
# virtual methods
.method N8(Lio/reactivex/internal/operators/flowable/FlowableCache$CacheSubscription;)V
    .locals 4
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "(",
...
.method P8()Z
    ...
    iget-object p0, p0, Lio/reactivex/internal/operators/flowable/FlowableCache;->e:Ljava/util/concurrent/atomic/AtomicReference;
...
.method Q8()Z
    ...
    iget-object p0, p0, Lio/reactivex/internal/operators/flowable/FlowableCache;->c:Ljava/util/concurrent/atomic/AtomicBoolean;
...
.method R8(Lio/reactivex/internal/operators/flowable/FlowableCache$CacheSubscription;)V
    .locals 6
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "(",
...
.method S8(Lio/reactivex/internal/operators/flowable/FlowableCache$CacheSubscription;)V
    .locals 17
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "(",
    ...
    :cond_0
    iget-wide v2, v1, Lio/reactivex/internal/operators/flowable/FlowableCache$CacheSubscription;->f:J

    iget v4, v1, Lio/reactivex/internal/operators/flowable/FlowableCache$CacheSubscription;->e:I
    ...
    iput-object v14, v1, Lio/reactivex/internal/operators/flowable/FlowableCache$CacheSubscription;->d:Lio/reactivex/internal/operators/flowable/FlowableCache$Node;

    iget-object v0, v0, Lio/reactivex/internal/operators/flowable/FlowableCache;->j:Ljava/lang/Throwable;
    ...
    :cond_7
    iput-wide v2, v1, Lio/reactivex/internal/operators/flowable/FlowableCache$CacheSubscription;->f:J

    iput v4, v1, Lio/reactivex/internal/operators/flowable/FlowableCache$CacheSubscription;->e:I
...
.method protected l6(Lorg/reactivestreams/Subscriber;)V
    ...
    invoke-virtual {p1, p0}, Lio/reactivex/Flowable;->k6(Lio/reactivex/FlowableSubscriber;)V

    goto :goto_0

    :cond_0
    invoke-virtual {p0, v0}, Lio/reactivex/internal/operators/flowable/FlowableCache;->S8(Lio/reactivex/internal/operators/flowable/FlowableCache$CacheSubscription;)V
...
.method public onComplete()V
    ...
    invoke-virtual {p0, v3}, Lio/reactivex/internal/operators/flowable/FlowableCache;->S8(Lio/reactivex/internal/operators/flowable/FlowableCache$CacheSubscription;)V
...
.method public onError(Ljava/lang/Throwable;)V
    ...
    invoke-virtual {p0, v2}, Lio/reactivex/internal/operators/flowable/FlowableCache;->S8(Lio/reactivex/internal/operators/flowable/FlowableCache$CacheSubscription;)V
...
.method public onNext(Ljava/lang/Object;)V
    ...
    iget-object p1, p0, Lio/reactivex/internal/operators/flowable/FlowableCache;->h:Lio/reactivex/internal/operators/flowable/FlowableCache$Node;
    ...
    iput-object v1, p0, Lio/reactivex/internal/operators/flowable/FlowableCache;->h:Lio/reactivex/internal/operators/flowable/FlowableCache$Node;

    goto :goto_0

    :cond_0
    iget-object v1, p0, Lio/reactivex/internal/operators/flowable/FlowableCache;->h:Lio/reactivex/internal/operators/flowable/FlowableCache$Node;
    ...
    invoke-virtual {p0, v1}, Lio/reactivex/internal/operators/flowable/FlowableCache;->S8(Lio/reactivex/internal/operators/flowable/FlowableCache$CacheSubscription;)V
