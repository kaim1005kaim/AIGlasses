...
.method b(ZZ)Z
    ...
    invoke-virtual {p0, p1}, Lio/reactivex/internal/operators/flowable/FlowablePublishAlt$PublishConnection;->e(Ljava/lang/Throwable;)V

    goto :goto_1

    :cond_0
    iget-object p0, p0, Lio/reactivex/internal/operators/flowable/FlowablePublishAlt$PublishConnection;->d:Ljava/util/concurrent/atomic/AtomicReference;

    sget-object p1, Lio/reactivex/internal/operators/flowable/FlowablePublishAlt$PublishConnection;->m:[Lio/reactivex/internal/operators/flowable/FlowablePublishAlt$InnerSubscription;
    ...
    invoke-virtual {p2}, Lio/reactivex/internal/operators/flowable/FlowablePublishAlt$InnerSubscription;->a()Z

    move-result v1

    if-nez v1, :cond_1

    iget-object p2, p2, Lio/reactivex/internal/operators/flowable/FlowablePublishAlt$InnerSubscription;->a:Lorg/reactivestreams/Subscriber;
...
.method c()V
    ...
    iget-boolean v9, v1, Lio/reactivex/internal/operators/flowable/FlowablePublishAlt$PublishConnection;->h:Z
    ...
    iput-boolean v6, v1, Lio/reactivex/internal/operators/flowable/FlowablePublishAlt$PublishConnection;->h:Z

    invoke-virtual {v1, v3}, Lio/reactivex/internal/operators/flowable/FlowablePublishAlt$PublishConnection;->e(Ljava/lang/Throwable;)V

    return-void

    :cond_d
    :goto_6
    iget-boolean v5, v1, Lio/reactivex/internal/operators/flowable/FlowablePublishAlt$PublishConnection;->h:Z
    ...
    :cond_e
    iput v0, v1, Lio/reactivex/internal/operators/flowable/FlowablePublishAlt$PublishConnection;->j:I
...
.method d(Lio/reactivex/internal/operators/flowable/FlowablePublishAlt$InnerSubscription;)V
    .locals 6
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "(",
...
.method public dispose()V
    ...
    iget-object p0, p0, Lio/reactivex/internal/operators/flowable/FlowablePublishAlt$PublishConnection;->b:Ljava/util/concurrent/atomic/AtomicReference;
...
.method e(Ljava/lang/Throwable;)V
    ...
    sget-object v0, Lio/reactivex/internal/operators/flowable/FlowablePublishAlt$PublishConnection;->m:[Lio/reactivex/internal/operators/flowable/FlowablePublishAlt$InnerSubscription;
    ...
    invoke-virtual {v2}, Lio/reactivex/internal/operators/flowable/FlowablePublishAlt$InnerSubscription;->a()Z

    move-result v3

    if-nez v3, :cond_0

    iget-object v2, v2, Lio/reactivex/internal/operators/flowable/FlowablePublishAlt$InnerSubscription;->a:Lorg/reactivestreams/Subscriber;
...
.method public g(Lorg/reactivestreams/Subscription;)V
    ...
    invoke-virtual {p0}, Lio/reactivex/internal/operators/flowable/FlowablePublishAlt$PublishConnection;->c()V
    ...
    iget p0, p0, Lio/reactivex/internal/operators/flowable/FlowablePublishAlt$PublishConnection;->e:I
