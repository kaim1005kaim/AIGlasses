...
.method constructor <init>([Lorg/reactivestreams/Subscriber;I)V
    ...
    iput p2, p0, Lio/reactivex/internal/operators/parallel/ParallelFromPublisher$ParallelDispatcher;->e:I
...
.method a(I)V
    ...
    iput-boolean p1, p0, Lio/reactivex/internal/operators/parallel/ParallelFromPublisher$ParallelDispatcher;->k:Z

    iget-object p1, p0, Lio/reactivex/internal/operators/parallel/ParallelFromPublisher$ParallelDispatcher;->f:Lorg/reactivestreams/Subscription;
    ...
    iget-object p0, p0, Lio/reactivex/internal/operators/parallel/ParallelFromPublisher$ParallelDispatcher;->g:Lio/reactivex/internal/fuseable/SimpleQueue;
...
.method c()V
    ...
    iget-object v0, v1, Lio/reactivex/internal/operators/parallel/ParallelFromPublisher$ParallelDispatcher;->g:Lio/reactivex/internal/fuseable/SimpleQueue;
    ...
    iget v6, v1, Lio/reactivex/internal/operators/parallel/ParallelFromPublisher$ParallelDispatcher;->j:I

    iget v7, v1, Lio/reactivex/internal/operators/parallel/ParallelFromPublisher$ParallelDispatcher;->m:I
    ...
    :cond_1
    iget-boolean v12, v1, Lio/reactivex/internal/operators/parallel/ParallelFromPublisher$ParallelDispatcher;->k:Z
    ...
    :cond_2
    iget-boolean v12, v1, Lio/reactivex/internal/operators/parallel/ParallelFromPublisher$ParallelDispatcher;->i:Z

    if-eqz v12, :cond_4

    iget-object v13, v1, Lio/reactivex/internal/operators/parallel/ParallelFromPublisher$ParallelDispatcher;->h:Ljava/lang/Throwable;
    ...
    iget v11, v1, Lio/reactivex/internal/operators/parallel/ParallelFromPublisher$ParallelDispatcher;->e:I

    if-ne v7, v11, :cond_9

    iget-object v11, v1, Lio/reactivex/internal/operators/parallel/ParallelFromPublisher$ParallelDispatcher;->f:Lorg/reactivestreams/Subscription;
    ...
    iget-object v0, v1, Lio/reactivex/internal/operators/parallel/ParallelFromPublisher$ParallelDispatcher;->f:Lorg/reactivestreams/Subscription;
    ...
    iput v6, v1, Lio/reactivex/internal/operators/parallel/ParallelFromPublisher$ParallelDispatcher;->j:I

    iput v7, v1, Lio/reactivex/internal/operators/parallel/ParallelFromPublisher$ParallelDispatcher;->m:I
...
.method d()V
    ...
    :cond_1
    iget-boolean v11, v1, Lio/reactivex/internal/operators/parallel/ParallelFromPublisher$ParallelDispatcher;->k:Z
...
.method e()V
    ...
    invoke-interface {v3, v5}, Lorg/reactivestreams/Subscriber;->g(Lorg/reactivestreams/Subscription;)V
...
.method public g(Lorg/reactivestreams/Subscription;)V
    ...
    iget-object v0, p0, Lio/reactivex/internal/operators/parallel/ParallelFromPublisher$ParallelDispatcher;->f:Lorg/reactivestreams/Subscription;
    ...
    iput-object p1, p0, Lio/reactivex/internal/operators/parallel/ParallelFromPublisher$ParallelDispatcher;->f:Lorg/reactivestreams/Subscription;
    ...
    iput-object v0, p0, Lio/reactivex/internal/operators/parallel/ParallelFromPublisher$ParallelDispatcher;->g:Lio/reactivex/internal/fuseable/SimpleQueue;
    ...
    iget p0, p0, Lio/reactivex/internal/operators/parallel/ParallelFromPublisher$ParallelDispatcher;->d:I
...
.method public onError(Ljava/lang/Throwable;)V
    ...
    iput-boolean p1, p0, Lio/reactivex/internal/operators/parallel/ParallelFromPublisher$ParallelDispatcher;->i:Z
...
.method public onNext(Ljava/lang/Object;)V
    ...
    iget-object v0, p0, Lio/reactivex/internal/operators/parallel/ParallelFromPublisher$ParallelDispatcher;->g:Lio/reactivex/internal/fuseable/SimpleQueue;
