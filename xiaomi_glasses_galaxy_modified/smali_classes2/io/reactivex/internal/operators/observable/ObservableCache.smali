...
# static fields
.field static final k:[Lio/reactivex/internal/operators/observable/ObservableCache$CacheDisposable;
...
.field final f:Lio/reactivex/internal/operators/observable/ObservableCache$Node;
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "Lio/reactivex/internal/operators/observable/ObservableCache$Node<",
            "TT;>;"
...
.field g:Lio/reactivex/internal/operators/observable/ObservableCache$Node;
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "Lio/reactivex/internal/operators/observable/ObservableCache$Node<",
            "TT;>;"
...
.method protected I5(Lio/reactivex/Observer;)V
    ...
    invoke-virtual {p0, v0}, Lio/reactivex/internal/operators/observable/ObservableCache;->i8(Lio/reactivex/internal/operators/observable/ObservableCache$CacheDisposable;)V
    ...
    invoke-interface {p1, p0}, Lio/reactivex/ObservableSource;->c(Lio/reactivex/Observer;)V

    goto :goto_0

    :cond_0
    invoke-virtual {p0, v0}, Lio/reactivex/internal/operators/observable/ObservableCache;->n8(Lio/reactivex/internal/operators/observable/ObservableCache$CacheDisposable;)V
...
.method i8(Lio/reactivex/internal/operators/observable/ObservableCache$CacheDisposable;)V
    .locals 4
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "(",
...
.method k8()Z
    ...
    iget-object p0, p0, Lio/reactivex/internal/operators/observable/ObservableCache;->d:Ljava/util/concurrent/atomic/AtomicReference;
...
.method l8()Z
    ...
    iget-object p0, p0, Lio/reactivex/internal/operators/observable/ObservableCache;->b:Ljava/util/concurrent/atomic/AtomicBoolean;
...
.method m8(Lio/reactivex/internal/operators/observable/ObservableCache$CacheDisposable;)V
    .locals 6
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "(",
...
.method n8(Lio/reactivex/internal/operators/observable/ObservableCache$CacheDisposable;)V
    .locals 12
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "(",
    ...
    iget-object p0, p0, Lio/reactivex/internal/operators/observable/ObservableCache;->i:Ljava/lang/Throwable;
...
.method public onComplete()V
    ...
    invoke-virtual {p0, v3}, Lio/reactivex/internal/operators/observable/ObservableCache;->n8(Lio/reactivex/internal/operators/observable/ObservableCache$CacheDisposable;)V
...
.method public onError(Ljava/lang/Throwable;)V
    ...
    invoke-virtual {p0, v2}, Lio/reactivex/internal/operators/observable/ObservableCache;->n8(Lio/reactivex/internal/operators/observable/ObservableCache$CacheDisposable;)V
...
.method public onNext(Ljava/lang/Object;)V
    ...
    invoke-virtual {p0, v1}, Lio/reactivex/internal/operators/observable/ObservableCache;->n8(Lio/reactivex/internal/operators/observable/ObservableCache$CacheDisposable;)V
