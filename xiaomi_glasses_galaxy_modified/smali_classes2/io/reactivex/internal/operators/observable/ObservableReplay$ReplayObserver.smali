...
.field static final f:[Lio/reactivex/internal/operators/observable/ObservableReplay$InnerDisposable;

.field static final g:[Lio/reactivex/internal/operators/observable/ObservableReplay$InnerDisposable;
...
.method static constructor <clinit>()V
    ...
    sput-object v1, Lio/reactivex/internal/operators/observable/ObservableReplay$ReplayObserver;->f:[Lio/reactivex/internal/operators/observable/ObservableReplay$InnerDisposable;

    new-array v0, v0, [Lio/reactivex/internal/operators/observable/ObservableReplay$InnerDisposable;

    sput-object v0, Lio/reactivex/internal/operators/observable/ObservableReplay$ReplayObserver;->g:[Lio/reactivex/internal/operators/observable/ObservableReplay$InnerDisposable;
...
.method constructor <init>(Lio/reactivex/internal/operators/observable/ObservableReplay$ReplayBuffer;)V
    ...
    sget-object v0, Lio/reactivex/internal/operators/observable/ObservableReplay$ReplayObserver;->f:[Lio/reactivex/internal/operators/observable/ObservableReplay$InnerDisposable;
...
.method b(Lio/reactivex/internal/operators/observable/ObservableReplay$InnerDisposable;)Z
    .locals 4
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "(",
    ...
    sget-object v1, Lio/reactivex/internal/operators/observable/ObservableReplay$ReplayObserver;->g:[Lio/reactivex/internal/operators/observable/ObservableReplay$InnerDisposable;
...
.method c(Lio/reactivex/internal/operators/observable/ObservableReplay$InnerDisposable;)V
    .locals 6
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "(",
    ...
    :goto_2
    iget-object v2, p0, Lio/reactivex/internal/operators/observable/ObservableReplay$ReplayObserver;->c:Ljava/util/concurrent/atomic/AtomicReference;
...
.method d()V
    ...
    invoke-interface {v4, v3}, Lio/reactivex/internal/operators/observable/ObservableReplay$ReplayBuffer;->b(Lio/reactivex/internal/operators/observable/ObservableReplay$InnerDisposable;)V
...
.method public isDisposed()Z
    ...
    iget-object p0, p0, Lio/reactivex/internal/operators/observable/ObservableReplay$ReplayObserver;->c:Ljava/util/concurrent/atomic/AtomicReference;

    invoke-virtual {p0}, Ljava/util/concurrent/atomic/AtomicReference;->get()Ljava/lang/Object;

    move-result-object p0

    sget-object v0, Lio/reactivex/internal/operators/observable/ObservableReplay$ReplayObserver;->g:[Lio/reactivex/internal/operators/observable/ObservableReplay$InnerDisposable;
