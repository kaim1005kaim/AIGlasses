...
.method static constructor <clinit>()V
    ...
    sput-object v0, Lio/reactivex/internal/schedulers/SchedulerPoolFactory;->e:Ljava/util/concurrent/atomic/AtomicReference;

    new-instance v0, Ljava/util/concurrent/ConcurrentHashMap;

    invoke-direct {v0}, Ljava/util/concurrent/ConcurrentHashMap;-><init>()V

    sput-object v0, Lio/reactivex/internal/schedulers/SchedulerPoolFactory;->f:Ljava/util/Map;
    ...
    invoke-static {v2, v1, v2, v2, v0}, Lio/reactivex/internal/schedulers/SchedulerPoolFactory;->b(ZLjava/lang/String;ZZLio/reactivex/functions/Function;)Z

    move-result v1

    sput-boolean v1, Lio/reactivex/internal/schedulers/SchedulerPoolFactory;->b:Z

    const-string v3, "rx2.purge-period-seconds"

    invoke-static {v1, v3, v2, v2, v0}, Lio/reactivex/internal/schedulers/SchedulerPoolFactory;->c(ZLjava/lang/String;IILio/reactivex/functions/Function;)I

    move-result v0

    sput v0, Lio/reactivex/internal/schedulers/SchedulerPoolFactory;->d:I
...
.method public static a(Ljava/util/concurrent/ThreadFactory;)Ljava/util/concurrent/ScheduledExecutorService;
    ...
    sget-boolean v0, Lio/reactivex/internal/schedulers/SchedulerPoolFactory;->b:Z

    invoke-static {v0, p0}, Lio/reactivex/internal/schedulers/SchedulerPoolFactory;->f(ZLjava/util/concurrent/ScheduledExecutorService;)V
...
.method public static d()V
    ...
    sget-object v0, Lio/reactivex/internal/schedulers/SchedulerPoolFactory;->e:Ljava/util/concurrent/atomic/AtomicReference;
    ...
    :cond_0
    sget-object v0, Lio/reactivex/internal/schedulers/SchedulerPoolFactory;->f:Ljava/util/Map;
...
.method public static e()V
    ...
    invoke-static {v0}, Lio/reactivex/internal/schedulers/SchedulerPoolFactory;->g(Z)V
...
.method static g(Z)V
    ...
    :goto_0
    sget-object p0, Lio/reactivex/internal/schedulers/SchedulerPoolFactory;->e:Ljava/util/concurrent/atomic/AtomicReference;
    ...
    sget p0, Lio/reactivex/internal/schedulers/SchedulerPoolFactory;->d:I
