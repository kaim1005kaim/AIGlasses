...
.method private n8()Lio/reactivex/observables/ConnectableObservable;
    .locals 1
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "()",
    ...
    invoke-interface {p0}, Lio/reactivex/internal/operators/observable/ObservablePublishClassic;->b()Lio/reactivex/ObservableSource;
...
.method public i8()Lio/reactivex/Observable;
    ...
    invoke-virtual {p0, v0}, Lio/reactivex/observables/ConnectableObservable;->j8(I)Lio/reactivex/Observable;
...
.method public j8(I)Lio/reactivex/Observable;
    .locals 1
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "(I)",
    ...
    invoke-virtual {p0, p1, v0}, Lio/reactivex/observables/ConnectableObservable;->k8(ILio/reactivex/functions/Consumer;)Lio/reactivex/Observable;
...
.method public k8(ILio/reactivex/functions/Consumer;)Lio/reactivex/Observable;
    .locals 1
    ...
    invoke-virtual {p0, p2}, Lio/reactivex/observables/ConnectableObservable;->m8(Lio/reactivex/functions/Consumer;)V

    invoke-static {p0}, Lio/reactivex/plugins/RxJavaPlugins;->U(Lio/reactivex/observables/ConnectableObservable;)Lio/reactivex/observables/ConnectableObservable;
...
.method public final l8()Lio/reactivex/disposables/Disposable;
    .locals 1
...
.method public abstract m8(Lio/reactivex/functions/Consumer;)V
...
.method public o8()Lio/reactivex/Observable;
    ...
    invoke-direct {p0}, Lio/reactivex/observables/ConnectableObservable;->n8()Lio/reactivex/observables/ConnectableObservable;
...
.method public final p8(I)Lio/reactivex/Observable;
    .locals 6
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "(I)",
    ...
    invoke-virtual/range {v0 .. v5}, Lio/reactivex/observables/ConnectableObservable;->r8(IJLjava/util/concurrent/TimeUnit;Lio/reactivex/Scheduler;)Lio/reactivex/Observable;
...
.method public final q8(IJLjava/util/concurrent/TimeUnit;)Lio/reactivex/Observable;
    .locals 6
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "(IJ",
...
.method public final r8(IJLjava/util/concurrent/TimeUnit;Lio/reactivex/Scheduler;)Lio/reactivex/Observable;
    .locals 8
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "(IJ",
...
.method public final s8(JLjava/util/concurrent/TimeUnit;)Lio/reactivex/Observable;
    .locals 6
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "(J",
...
.method public final t8(JLjava/util/concurrent/TimeUnit;Lio/reactivex/Scheduler;)Lio/reactivex/Observable;
    .locals 6
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "(J",
