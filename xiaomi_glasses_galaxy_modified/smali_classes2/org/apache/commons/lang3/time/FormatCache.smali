...
.method static constructor <clinit>()V
    ...
    sput-object v0, Lorg/apache/commons/lang3/time/FormatCache;->c:Ljava/util/concurrent/ConcurrentMap;
...
.method private d(Ljava/lang/Integer;Ljava/lang/Integer;Ljava/util/TimeZone;Ljava/util/Locale;)Ljava/text/Format;
    ...
    invoke-static {p4}, Lorg/apache/commons/lang3/LocaleUtils;->m(Ljava/util/Locale;)Ljava/util/Locale;

    move-result-object p4

    invoke-static {p1, p2, p4}, Lorg/apache/commons/lang3/time/FormatCache;->g(Ljava/lang/Integer;Ljava/lang/Integer;Ljava/util/Locale;)Ljava/lang/String;

    move-result-object p1

    invoke-virtual {p0, p1, p3, p4}, Lorg/apache/commons/lang3/time/FormatCache;->f(Ljava/lang/String;Ljava/util/TimeZone;Ljava/util/Locale;)Ljava/text/Format;
...
.method static g(Ljava/lang/Integer;Ljava/lang/Integer;Ljava/util/Locale;)Ljava/lang/String;
    ...
    sget-object v1, Lorg/apache/commons/lang3/time/FormatCache;->c:Ljava/util/concurrent/ConcurrentMap;
...
.method b(ILjava/util/TimeZone;Ljava/util/Locale;)Ljava/text/Format;
    ...
    invoke-direct {p0, p1, v0, p2, p3}, Lorg/apache/commons/lang3/time/FormatCache;->d(Ljava/lang/Integer;Ljava/lang/Integer;Ljava/util/TimeZone;Ljava/util/Locale;)Ljava/text/Format;
...
.method c(IILjava/util/TimeZone;Ljava/util/Locale;)Ljava/text/Format;
    ...
    invoke-direct {p0, p1, p2, p3, p4}, Lorg/apache/commons/lang3/time/FormatCache;->d(Ljava/lang/Integer;Ljava/lang/Integer;Ljava/util/TimeZone;Ljava/util/Locale;)Ljava/text/Format;
...
.method public e()Ljava/text/Format;
    ...
    invoke-virtual {p0, v2, v2, v0, v1}, Lorg/apache/commons/lang3/time/FormatCache;->c(IILjava/util/TimeZone;Ljava/util/Locale;)Ljava/text/Format;
...
.method public f(Ljava/lang/String;Ljava/util/TimeZone;Ljava/util/Locale;)Ljava/text/Format;
    ...
    invoke-virtual {p0, p1, p2, p3}, Lorg/apache/commons/lang3/time/FormatCache;->a(Ljava/lang/String;Ljava/util/TimeZone;Ljava/util/Locale;)Ljava/text/Format;

    move-result-object v1

    iget-object p0, p0, Lorg/apache/commons/lang3/time/FormatCache;->a:Ljava/util/concurrent/ConcurrentMap;
...
.method h(ILjava/util/TimeZone;Ljava/util/Locale;)Ljava/text/Format;
    ...
    invoke-direct {p0, v0, p1, p2, p3}, Lorg/apache/commons/lang3/time/FormatCache;->d(Ljava/lang/Integer;Ljava/lang/Integer;Ljava/util/TimeZone;Ljava/util/Locale;)Ljava/text/Format;
