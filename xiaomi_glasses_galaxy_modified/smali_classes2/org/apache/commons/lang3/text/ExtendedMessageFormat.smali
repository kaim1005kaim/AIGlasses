...
.method private a(Ljava/lang/String;Ljava/text/ParsePosition;Ljava/lang/StringBuilder;)Ljava/lang/StringBuilder;
    ...
    :cond_0
    invoke-direct {p0, p2}, Lorg/apache/commons/lang3/text/ExtendedMessageFormat;->f(Ljava/text/ParsePosition;)Ljava/text/ParsePosition;
...
.method private c(Ljava/lang/String;)Ljava/text/Format;
    ...
    invoke-interface {v2, p1, v0, p0}, Lorg/apache/commons/lang3/text/FormatFactory;->a(Ljava/lang/String;Ljava/lang/String;Ljava/util/Locale;)Ljava/text/Format;
...
.method private e(Ljava/lang/String;Ljava/util/ArrayList;)Ljava/lang/String;
    ...
    invoke-direct {p0, p2}, Lorg/apache/commons/lang3/text/ExtendedMessageFormat;->b(Ljava/util/Collection;)Z
    ...
    invoke-direct {p0, v1}, Lorg/apache/commons/lang3/text/ExtendedMessageFormat;->f(Ljava/text/ParsePosition;)Ljava/text/ParsePosition;
    ...
    invoke-direct {p0, p1, v4}, Lorg/apache/commons/lang3/text/ExtendedMessageFormat;->h(Ljava/lang/String;Ljava/text/ParsePosition;)I
...
.method private g(Ljava/lang/String;Ljava/text/ParsePosition;)Ljava/lang/String;
    ...
    invoke-direct {p0, p1, p2}, Lorg/apache/commons/lang3/text/ExtendedMessageFormat;->i(Ljava/lang/String;Ljava/text/ParsePosition;)V
...
.method private i(Ljava/lang/String;Ljava/text/ParsePosition;)V
    ...
    invoke-virtual {v0, p0, v1}, Lorg/apache/commons/lang3/text/StrMatcher;->f([CI)I
...
.method public final applyPattern(Ljava/lang/String;)V
    ...
    iput-object p1, p0, Lorg/apache/commons/lang3/text/ExtendedMessageFormat;->a:Ljava/lang/String;
    ...
    invoke-direct {p0, p1, v3}, Lorg/apache/commons/lang3/text/ExtendedMessageFormat;->i(Ljava/lang/String;Ljava/text/ParsePosition;)V

    invoke-virtual {v3}, Ljava/text/ParsePosition;->getIndex()I

    move-result v7

    invoke-direct {p0, v3}, Lorg/apache/commons/lang3/text/ExtendedMessageFormat;->f(Ljava/text/ParsePosition;)Ljava/text/ParsePosition;

    move-result-object v9

    invoke-direct {p0, p1, v9}, Lorg/apache/commons/lang3/text/ExtendedMessageFormat;->h(Ljava/lang/String;Ljava/text/ParsePosition;)I
    ...
    invoke-direct {p0, p1, v8}, Lorg/apache/commons/lang3/text/ExtendedMessageFormat;->g(Ljava/lang/String;Ljava/text/ParsePosition;)Ljava/lang/String;

    move-result-object v8

    invoke-direct {p0, v8}, Lorg/apache/commons/lang3/text/ExtendedMessageFormat;->c(Ljava/lang/String;)Ljava/text/Format;
    ...
    :goto_3
    invoke-static {v8}, Lorg/apache/commons/lang3/Validate;->y(Z)V
    ...
    :goto_4
    invoke-static {v9}, Lorg/apache/commons/lang3/Validate;->y(Z)V
    ...
    invoke-direct {p0, p1, v1}, Lorg/apache/commons/lang3/text/ExtendedMessageFormat;->e(Ljava/lang/String;Ljava/util/ArrayList;)Ljava/lang/String;

    move-result-object p1

    iput-object p1, p0, Lorg/apache/commons/lang3/text/ExtendedMessageFormat;->a:Ljava/lang/String;

    invoke-direct {p0, v0}, Lorg/apache/commons/lang3/text/ExtendedMessageFormat;->b(Ljava/util/Collection;)Z
...
.method public equals(Ljava/lang/Object;)Z
    ...
    invoke-static {v2, v3}, Lorg/apache/commons/lang3/ObjectUtils;->M(Ljava/lang/Object;Ljava/lang/Object;)Z
    ...
    :cond_4
    iget-object p0, p0, Lorg/apache/commons/lang3/text/ExtendedMessageFormat;->b:Ljava/util/Map;

    iget-object p1, p1, Lorg/apache/commons/lang3/text/ExtendedMessageFormat;->b:Ljava/util/Map;

    invoke-static {p0, p1}, Lorg/apache/commons/lang3/ObjectUtils;->M(Ljava/lang/Object;Ljava/lang/Object;)Z
...
.method public hashCode()I
    ...
    iget-object p0, p0, Lorg/apache/commons/lang3/text/ExtendedMessageFormat;->a:Ljava/lang/String;
