...
.method private g(Landroid/content/Context;Landroid/net/Uri;)I
    ...
    invoke-direct {p0, p1, p2}, Lcom/bumptech/glide/load/resource/drawable/ResourceDrawableDecoder;->f(Landroid/content/Context;Landroid/net/Uri;)I
    ...
    invoke-direct {p0, p2}, Lcom/bumptech/glide/load/resource/drawable/ResourceDrawableDecoder;->e(Landroid/net/Uri;)I
...
.method public bridge synthetic a(Ljava/lang/Object;Lcom/bumptech/glide/load/Options;)Z
    ...
    invoke-virtual {p0, p1, p2}, Lcom/bumptech/glide/load/resource/drawable/ResourceDrawableDecoder;->h(Landroid/net/Uri;Lcom/bumptech/glide/load/Options;)Z
...
.method public bridge synthetic b(Ljava/lang/Object;IILcom/bumptech/glide/load/Options;)Lcom/bumptech/glide/load/engine/Resource;
    ...
    invoke-virtual {p0, p1, p2, p3, p4}, Lcom/bumptech/glide/load/resource/drawable/ResourceDrawableDecoder;->c(Landroid/net/Uri;IILcom/bumptech/glide/load/Options;)Lcom/bumptech/glide/load/engine/Resource;
...
.method public c(Landroid/net/Uri;IILcom/bumptech/glide/load/Options;)Lcom/bumptech/glide/load/engine/Resource;
    .locals 1
    ...
    invoke-direct {p0, p1, p2}, Lcom/bumptech/glide/load/resource/drawable/ResourceDrawableDecoder;->d(Landroid/net/Uri;Ljava/lang/String;)Landroid/content/Context;

    move-result-object p3

    invoke-direct {p0, p3, p1}, Lcom/bumptech/glide/load/resource/drawable/ResourceDrawableDecoder;->g(Landroid/content/Context;Landroid/net/Uri;)I
    ...
    invoke-static {p0, p3, p1}, Lcom/bumptech/glide/load/resource/drawable/DrawableDecoderCompat;->b(Landroid/content/Context;Landroid/content/Context;I)Landroid/graphics/drawable/Drawable;
    ...
    :goto_1
    invoke-static {p0}, Lcom/bumptech/glide/load/resource/drawable/NonOwnedDrawableResource;->c(Landroid/graphics/drawable/Drawable;)Lcom/bumptech/glide/load/engine/Resource;
...
.method public h(Landroid/net/Uri;Lcom/bumptech/glide/load/Options;)Z
    .locals 0
    .param p1    # Landroid/net/Uri;
        .annotation build Landroidx/annotation/NonNull;
        .end annotation
