...
.method static constructor <clinit>()V
    ...
    sput-wide v0, Lcom/bumptech/glide/load/engine/prefill/BitmapPreFillRunner;->n:J
...
.method constructor <init>(Lcom/bumptech/glide/load/engine/bitmap_recycle/BitmapPool;Lcom/bumptech/glide/load/engine/cache/MemoryCache;Lcom/bumptech/glide/load/engine/prefill/PreFillQueue;Lcom/bumptech/glide/load/engine/prefill/BitmapPreFillRunner$Clock;Landroid/os/Handler;)V
    ...
    iput-object v0, p0, Lcom/bumptech/glide/load/engine/prefill/BitmapPreFillRunner;->e:Ljava/util/Set;

    const-wide/16 v0, 0x28

    .line 6
    iput-wide v0, p0, Lcom/bumptech/glide/load/engine/prefill/BitmapPreFillRunner;->g:J

    .line 7
    iput-object p1, p0, Lcom/bumptech/glide/load/engine/prefill/BitmapPreFillRunner;->a:Lcom/bumptech/glide/load/engine/bitmap_recycle/BitmapPool;

    .line 8
    iput-object p2, p0, Lcom/bumptech/glide/load/engine/prefill/BitmapPreFillRunner;->b:Lcom/bumptech/glide/load/engine/cache/MemoryCache;

    .line 9
    iput-object p3, p0, Lcom/bumptech/glide/load/engine/prefill/BitmapPreFillRunner;->c:Lcom/bumptech/glide/load/engine/prefill/PreFillQueue;

    .line 10
    iput-object p4, p0, Lcom/bumptech/glide/load/engine/prefill/BitmapPreFillRunner;->d:Lcom/bumptech/glide/load/engine/prefill/BitmapPreFillRunner$Clock;

    .line 11
    iput-object p5, p0, Lcom/bumptech/glide/load/engine/prefill/BitmapPreFillRunner;->f:Landroid/os/Handler;
...
.method private c()J
    ...
    invoke-interface {v0}, Lcom/bumptech/glide/load/engine/cache/MemoryCache;->b()J

    move-result-wide v0

    iget-object p0, p0, Lcom/bumptech/glide/load/engine/prefill/BitmapPreFillRunner;->b:Lcom/bumptech/glide/load/engine/cache/MemoryCache;
...
.method private d()J
    ...
    iget-wide v0, p0, Lcom/bumptech/glide/load/engine/prefill/BitmapPreFillRunner;->g:J

    const-wide/16 v2, 0x4

    mul-long/2addr v2, v0

    sget-wide v4, Lcom/bumptech/glide/load/engine/prefill/BitmapPreFillRunner;->n:J

    invoke-static {v2, v3, v4, v5}, Ljava/lang/Math;->min(JJ)J

    move-result-wide v2

    iput-wide v2, p0, Lcom/bumptech/glide/load/engine/prefill/BitmapPreFillRunner;->g:J
...
.method private e(J)Z
    ...
    iget-object p0, p0, Lcom/bumptech/glide/load/engine/prefill/BitmapPreFillRunner;->d:Lcom/bumptech/glide/load/engine/prefill/BitmapPreFillRunner$Clock;

    invoke-virtual {p0}, Lcom/bumptech/glide/load/engine/prefill/BitmapPreFillRunner$Clock;->a()J
...
.method a()Z
    ...
    invoke-virtual {v2}, Lcom/bumptech/glide/load/engine/prefill/PreFillQueue;->b()Z

    move-result v2

    if-nez v2, :cond_3

    invoke-direct {p0, v0, v1}, Lcom/bumptech/glide/load/engine/prefill/BitmapPreFillRunner;->e(J)Z
    ...
    invoke-virtual {v2}, Lcom/bumptech/glide/load/engine/prefill/PreFillQueue;->c()Lcom/bumptech/glide/load/engine/prefill/PreFillType;

    move-result-object v2

    iget-object v3, p0, Lcom/bumptech/glide/load/engine/prefill/BitmapPreFillRunner;->e:Ljava/util/Set;
    ...
    invoke-interface {v3, v4, v5, v6}, Lcom/bumptech/glide/load/engine/bitmap_recycle/BitmapPool;->g(IILandroid/graphics/Bitmap$Config;)Landroid/graphics/Bitmap;
    ...
    :goto_1
    invoke-static {v3}, Lcom/bumptech/glide/util/Util;->i(Landroid/graphics/Bitmap;)I
    ...
    invoke-static {v3, v7}, Lcom/bumptech/glide/load/resource/bitmap/BitmapResource;->c(Landroid/graphics/Bitmap;Lcom/bumptech/glide/load/engine/bitmap_recycle/BitmapPool;)Lcom/bumptech/glide/load/resource/bitmap/BitmapResource;

    move-result-object v3

    invoke-interface {v6, v5, v3}, Lcom/bumptech/glide/load/engine/cache/MemoryCache;->e(Lcom/bumptech/glide/load/Key;Lcom/bumptech/glide/load/engine/Resource;)Lcom/bumptech/glide/load/engine/Resource;
    ...
    invoke-interface {v5, v3}, Lcom/bumptech/glide/load/engine/bitmap_recycle/BitmapPool;->e(Landroid/graphics/Bitmap;)V
    ...
    :cond_3
    iget-boolean v0, p0, Lcom/bumptech/glide/load/engine/prefill/BitmapPreFillRunner;->h:Z

    if-nez v0, :cond_4

    iget-object p0, p0, Lcom/bumptech/glide/load/engine/prefill/BitmapPreFillRunner;->c:Lcom/bumptech/glide/load/engine/prefill/PreFillQueue;

    invoke-virtual {p0}, Lcom/bumptech/glide/load/engine/prefill/PreFillQueue;->b()Z
...
.method public b()V
    ...
    iput-boolean v0, p0, Lcom/bumptech/glide/load/engine/prefill/BitmapPreFillRunner;->h:Z
...
.method public run()V
    ...
    iget-object v0, p0, Lcom/bumptech/glide/load/engine/prefill/BitmapPreFillRunner;->f:Landroid/os/Handler;
