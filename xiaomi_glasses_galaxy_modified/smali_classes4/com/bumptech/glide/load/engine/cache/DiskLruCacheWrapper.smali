...
.field private static i:Lcom/bumptech/glide/load/engine/cache/DiskLruCacheWrapper;
...
.method public static d(Ljava/io/File;J)Lcom/bumptech/glide/load/engine/cache/DiskCache;
    .locals 1
...
.method public static declared-synchronized e(Ljava/io/File;J)Lcom/bumptech/glide/load/engine/cache/DiskCache;
    .locals 2
    .annotation runtime Ljava/lang/Deprecated;
    .end annotation
    ...
    :try_start_0
    sget-object v1, Lcom/bumptech/glide/load/engine/cache/DiskLruCacheWrapper;->i:Lcom/bumptech/glide/load/engine/cache/DiskLruCacheWrapper;
    ...
    sput-object v1, Lcom/bumptech/glide/load/engine/cache/DiskLruCacheWrapper;->i:Lcom/bumptech/glide/load/engine/cache/DiskLruCacheWrapper;
    ...
    :cond_0
    :goto_0
    sget-object p0, Lcom/bumptech/glide/load/engine/cache/DiskLruCacheWrapper;->i:Lcom/bumptech/glide/load/engine/cache/DiskLruCacheWrapper;
    :try_end_0
...
.method private declared-synchronized f()Lcom/bumptech/glide/disklrucache/DiskLruCache;
    .locals 4
    ...
    invoke-static {v0, v3, v3, v1, v2}, Lcom/bumptech/glide/disklrucache/DiskLruCache;->K(Ljava/io/File;IIJ)Lcom/bumptech/glide/disklrucache/DiskLruCache;
...
.method public a(Lcom/bumptech/glide/load/Key;Lcom/bumptech/glide/load/engine/cache/DiskCache$Writer;)V
    ...
    :goto_0
    :try_start_1
    invoke-direct {p0}, Lcom/bumptech/glide/load/engine/cache/DiskLruCacheWrapper;->f()Lcom/bumptech/glide/disklrucache/DiskLruCache;

    move-result-object p1

    invoke-virtual {p1, v1}, Lcom/bumptech/glide/disklrucache/DiskLruCache;->z(Ljava/lang/String;)Lcom/bumptech/glide/disklrucache/DiskLruCache$Value;
    ...
    iget-object p0, p0, Lcom/bumptech/glide/load/engine/cache/DiskLruCacheWrapper;->d:Lcom/bumptech/glide/load/engine/cache/DiskCacheWriteLocker;

    invoke-virtual {p0, v1}, Lcom/bumptech/glide/load/engine/cache/DiskCacheWriteLocker;->b(Ljava/lang/String;)V

    return-void

    :cond_1
    :try_start_2
    invoke-virtual {p1, v1}, Lcom/bumptech/glide/disklrucache/DiskLruCache;->v(Ljava/lang/String;)Lcom/bumptech/glide/disklrucache/DiskLruCache$Editor;
...
.method public b(Lcom/bumptech/glide/load/Key;)Ljava/io/File;
    ...
    invoke-virtual {p0, v0}, Lcom/bumptech/glide/disklrucache/DiskLruCache;->z(Ljava/lang/String;)Lcom/bumptech/glide/disklrucache/DiskLruCache$Value;
    ...
    invoke-virtual {p0, v0}, Lcom/bumptech/glide/disklrucache/DiskLruCache$Value;->b(I)Ljava/io/File;
...
.method public c(Lcom/bumptech/glide/load/Key;)V
    .locals 1
    ...
    invoke-virtual {p0, p1}, Lcom/bumptech/glide/disklrucache/DiskLruCache;->a0(Ljava/lang/String;)Z
    :try_end_0
    .catch Ljava/io/IOException; {:try_start_0 .. :try_end_0} :catch_0
...
.method public declared-synchronized clear()V
    ...
    :goto_0
    :try_start_1
    invoke-direct {p0}, Lcom/bumptech/glide/load/engine/cache/DiskLruCacheWrapper;->g()V
    :try_end_1
    .catchall {:try_start_1 .. :try_end_1} :catchall_0
