...
.method static constructor <clinit>()V
    ...
    sput-object v0, Lcom/bumptech/glide/load/engine/bitmap_recycle/SizeConfigStrategy;->i:[Landroid/graphics/Bitmap$Config;
...
.method private d(Ljava/lang/Integer;Landroid/graphics/Bitmap;)V
    .locals 3
    ...
    invoke-virtual {p0, p2}, Lcom/bumptech/glide/load/engine/bitmap_recycle/SizeConfigStrategy;->c(Landroid/graphics/Bitmap;)Ljava/lang/String;
...
.method private g(ILandroid/graphics/Bitmap$Config;)Lcom/bumptech/glide/load/engine/bitmap_recycle/SizeConfigStrategy$Key;
    ...
    iget-object p0, p0, Lcom/bumptech/glide/load/engine/bitmap_recycle/SizeConfigStrategy;->a:Lcom/bumptech/glide/load/engine/bitmap_recycle/SizeConfigStrategy$KeyPool;

    invoke-virtual {v5}, Ljava/lang/Integer;->intValue()I

    move-result p1

    invoke-virtual {p0, p1, v4}, Lcom/bumptech/glide/load/engine/bitmap_recycle/SizeConfigStrategy$KeyPool;->e(ILandroid/graphics/Bitmap$Config;)Lcom/bumptech/glide/load/engine/bitmap_recycle/SizeConfigStrategy$Key;
...
.method private static i(Landroid/graphics/Bitmap$Config;)[Landroid/graphics/Bitmap$Config;
    ...
    :cond_1
    sget-object p0, Lcom/bumptech/glide/load/engine/bitmap_recycle/SizeConfigStrategy;->i:[Landroid/graphics/Bitmap$Config;
...
.method public a(IILandroid/graphics/Bitmap$Config;)Ljava/lang/String;
    ...
    invoke-static {p1, p2, p3}, Lcom/bumptech/glide/util/Util;->h(IILandroid/graphics/Bitmap$Config;)I

    move-result p0

    invoke-static {p0, p3}, Lcom/bumptech/glide/load/engine/bitmap_recycle/SizeConfigStrategy;->h(ILandroid/graphics/Bitmap$Config;)Ljava/lang/String;
...
.method public b(Landroid/graphics/Bitmap;)I
    ...
    invoke-static {p1}, Lcom/bumptech/glide/util/Util;->i(Landroid/graphics/Bitmap;)I
...
.method public c(Landroid/graphics/Bitmap;)Ljava/lang/String;
    ...
    invoke-static {p0, p1}, Lcom/bumptech/glide/load/engine/bitmap_recycle/SizeConfigStrategy;->h(ILandroid/graphics/Bitmap$Config;)Ljava/lang/String;
...
.method public e(Landroid/graphics/Bitmap;)V
    ...
    iget p1, v0, Lcom/bumptech/glide/load/engine/bitmap_recycle/SizeConfigStrategy$Key;->b:I
...
.method public f(IILandroid/graphics/Bitmap$Config;)Landroid/graphics/Bitmap;
    ...
    invoke-direct {p0, v0, v1}, Lcom/bumptech/glide/load/engine/bitmap_recycle/SizeConfigStrategy;->d(Ljava/lang/Integer;Landroid/graphics/Bitmap;)V
...
.method public removeLast()Landroid/graphics/Bitmap;
    ...
    invoke-static {v0}, Lcom/bumptech/glide/util/Util;->i(Landroid/graphics/Bitmap;)I
    ...
    invoke-direct {p0, v1, v0}, Lcom/bumptech/glide/load/engine/bitmap_recycle/SizeConfigStrategy;->d(Ljava/lang/Integer;Landroid/graphics/Bitmap;)V
