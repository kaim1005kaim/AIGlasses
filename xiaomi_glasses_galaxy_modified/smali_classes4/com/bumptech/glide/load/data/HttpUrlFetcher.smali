...
.field static final j:Lcom/bumptech/glide/load/data/HttpUrlFetcher$HttpUrlConnectionFactory;
    .annotation build Landroidx/annotation/VisibleForTesting;
    .end annotation
.end field
...
.method private d(Ljava/net/URL;Ljava/util/Map;)Ljava/net/HttpURLConnection;
    .locals 3
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "(",
    ...
    iget p0, p0, Lcom/bumptech/glide/load/data/HttpUrlFetcher;->b:I
...
.method private static e(Ljava/net/HttpURLConnection;)I
    .locals 2
...
.method private f(Ljava/net/HttpURLConnection;)Ljava/io/InputStream;
    .locals 4
    .annotation system Ldalvik/annotation/Throws;
        value = {
            Lcom/bumptech/glide/load/HttpException;
    ...
    invoke-static {p1}, Lcom/bumptech/glide/load/data/HttpUrlFetcher;->e(Ljava/net/HttpURLConnection;)I
...
.method private i(Ljava/net/URL;ILjava/net/URL;Ljava/util/Map;)Ljava/io/InputStream;
    .locals 2
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "(",
    ...
    :cond_1
    :goto_0
    invoke-direct {p0, p1, p4}, Lcom/bumptech/glide/load/data/HttpUrlFetcher;->d(Ljava/net/URL;Ljava/util/Map;)Ljava/net/HttpURLConnection;
    ...
    invoke-static {p3}, Lcom/bumptech/glide/load/data/HttpUrlFetcher;->e(Ljava/net/HttpURLConnection;)I

    move-result p3

    invoke-static {p3}, Lcom/bumptech/glide/load/data/HttpUrlFetcher;->g(I)Z
    ...
    invoke-direct {p0, p1}, Lcom/bumptech/glide/load/data/HttpUrlFetcher;->f(Ljava/net/HttpURLConnection;)Ljava/io/InputStream;
    ...
    invoke-direct {p0, v1, p2, p1, p4}, Lcom/bumptech/glide/load/data/HttpUrlFetcher;->i(Ljava/net/URL;ILjava/net/URL;Ljava/util/Map;)Ljava/io/InputStream;
    ...
    invoke-static {p0}, Lcom/bumptech/glide/load/data/HttpUrlFetcher;->e(Ljava/net/HttpURLConnection;)I
...
.method public c(Lcom/bumptech/glide/Priority;Lcom/bumptech/glide/load/data/DataFetcher$DataCallback;)V
    ...
    invoke-direct {p0, v4, v6, v7, v5}, Lcom/bumptech/glide/load/data/HttpUrlFetcher;->i(Ljava/net/URL;ILjava/net/URL;Ljava/util/Map;)Ljava/io/InputStream;
