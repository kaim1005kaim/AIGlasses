...
.method public final run()V
    ...
    iget v2, v1, Lcom/chad/library/adapter/base/diff/BrvahAsyncDiffer$submitList$1;->$runGeneration:I

    if-ne v0, v2, :cond_0

    iget-object v0, v1, Lcom/chad/library/adapter/base/diff/BrvahAsyncDiffer$submitList$1;->this$0:Lcom/chad/library/adapter/base/diff/BrvahAsyncDiffer;

    iget-object v2, v1, Lcom/chad/library/adapter/base/diff/BrvahAsyncDiffer$submitList$1;->$newList:Ljava/util/List;

    iget-object p0, p0, Lcom/chad/library/adapter/base/diff/BrvahAsyncDiffer$submitList$1$1;->$result:Landroidx/recyclerview/widget/DiffUtil$DiffResult;

    iget-object v1, v1, Lcom/chad/library/adapter/base/diff/BrvahAsyncDiffer$submitList$1;->$commitCallback:Ljava/lang/Runnable;

    invoke-static {v0, v2, p0, v1}, Lcom/chad/library/adapter/base/diff/BrvahAsyncDiffer;->access$latchList(Lcom/chad/library/adapter/base/diff/BrvahAsyncDiffer;Ljava/util/List;Landroidx/recyclerview/widget/DiffUtil$DiffResult;Ljava/lang/Runnable;)V
