...
.method private doLs(Ljava/io/PrintStream;)V
    ...
    iget-object p0, p0, Lcom/facebook/stetho/dumpapp/plugins/FilesDumperPlugin;->mContext:Landroid/content/Context;
    ...
    invoke-static {p0, v0, p1}, Lcom/facebook/stetho/dumpapp/plugins/FilesDumperPlugin;->printDirectoryText(Ljava/io/File;Ljava/lang/String;Ljava/io/PrintStream;)V
...
.method private doTree(Ljava/io/PrintStream;)V
    ...
    invoke-static {p0, v0, p1}, Lcom/facebook/stetho/dumpapp/plugins/FilesDumperPlugin;->printDirectoryVisual(Ljava/io/File;ILjava/io/PrintStream;)V
...
.method private doUsage(Ljava/io/PrintStream;)V
    ...
    const-string p0, "dumpapp files ls: List files similar to the ls command"

    invoke-virtual {p1, p0}, Ljava/io/PrintStream;->println(Ljava/lang/String;)V

    invoke-virtual {p1}, Ljava/io/PrintStream;->println()V

    const-string p0, "dumpapp files tree: List files similar to the tree command"

    invoke-virtual {p1, p0}, Ljava/io/PrintStream;->println(Ljava/lang/String;)V

    invoke-virtual {p1}, Ljava/io/PrintStream;->println()V

    const-string p0, "dumpapp files download: Fetch internal application storage"

    invoke-virtual {p1, p0}, Ljava/io/PrintStream;->println(Ljava/lang/String;)V

    const-string p0, "    <output.zip>: Output location or \'-\' for stdout"

    invoke-virtual {p1, p0}, Ljava/io/PrintStream;->println(Ljava/lang/String;)V

    const-string p0, "    <path>: Fetch only those paths named (directories fetch recursively)"
