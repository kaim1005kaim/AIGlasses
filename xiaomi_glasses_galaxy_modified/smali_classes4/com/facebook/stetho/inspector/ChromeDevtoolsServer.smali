...
.method private handleRemoteMessage(Lcom/facebook/stetho/inspector/jsonrpc/JsonRpcPeer;Ljava/lang/String;)V
    ...
    :cond_1
    new-instance p0, Lcom/facebook/stetho/inspector/MessageHandlingException;
    ...
    invoke-direct {p0, p1}, Lcom/facebook/stetho/inspector/MessageHandlingException;-><init>(Ljava/lang/String;)V
...
.method private handleRemoteRequest(Lcom/facebook/stetho/inspector/jsonrpc/JsonRpcPeer;Lorg/json/JSONObject;)V
    ...
    iget-object p0, p0, Lcom/facebook/stetho/inspector/ChromeDevtoolsServer;->mObjectMapper:Lcom/facebook/stetho/json/ObjectMapper;

    invoke-virtual {p0, v4, v0}, Lcom/facebook/stetho/json/ObjectMapper;->convertValue(Ljava/lang/Object;Ljava/lang/Class;)Ljava/lang/Object;
    ...
    invoke-interface {p1, p0}, Lcom/facebook/stetho/websocket/SimpleSession;->sendText(Ljava/lang/String;)V
...
.method private handleRemoteResponse(Lcom/facebook/stetho/inspector/jsonrpc/JsonRpcPeer;Lorg/json/JSONObject;)V
    ...
    const-class v0, Lcom/facebook/stetho/inspector/jsonrpc/protocol/JsonRpcResponse;
    ...
    check-cast p0, Lcom/facebook/stetho/inspector/jsonrpc/protocol/JsonRpcResponse;

    iget-wide v0, p0, Lcom/facebook/stetho/inspector/jsonrpc/protocol/JsonRpcResponse;->id:J
    ...
    iget-object p2, p2, Lcom/facebook/stetho/inspector/jsonrpc/PendingRequest;->callback:Lcom/facebook/stetho/inspector/jsonrpc/PendingRequestCallback;

    if-eqz p2, :cond_0

    invoke-interface {p2, p1, p0}, Lcom/facebook/stetho/inspector/jsonrpc/PendingRequestCallback;->onResponse(Lcom/facebook/stetho/inspector/jsonrpc/JsonRpcPeer;Lcom/facebook/stetho/inspector/jsonrpc/protocol/JsonRpcResponse;)V
...
.method public onClose(Lcom/facebook/stetho/websocket/SimpleSession;ILjava/lang/String;)V
    ...
    iget-object p0, p0, Lcom/facebook/stetho/inspector/ChromeDevtoolsServer;->mPeers:Ljava/util/Map;

    invoke-interface {p0, p1}, Ljava/util/Map;->remove(Ljava/lang/Object;)Ljava/lang/Object;

    move-result-object p0

    check-cast p0, Lcom/facebook/stetho/inspector/jsonrpc/JsonRpcPeer;

    if-eqz p0, :cond_0

    invoke-virtual {p0}, Lcom/facebook/stetho/inspector/jsonrpc/JsonRpcPeer;->invokeDisconnectReceivers()V
...
.method public onError(Lcom/facebook/stetho/websocket/SimpleSession;Ljava/lang/Throwable;)V
    ...
    invoke-static {p1, p0}, Lcom/facebook/stetho/common/LogRedirector;->e(Ljava/lang/String;Ljava/lang/String;)V
...
.method public onMessage(Lcom/facebook/stetho/websocket/SimpleSession;[BI)V
    ...
    const-string p1, "Ignoring binary message of length "
    ...
    invoke-static {p1, p0}, Lcom/facebook/stetho/common/LogRedirector;->d(Ljava/lang/String;Ljava/lang/String;)V
...
.method public onOpen(Lcom/facebook/stetho/websocket/SimpleSession;)V
    ...
    invoke-direct {v1, p0, p1}, Lcom/facebook/stetho/inspector/jsonrpc/JsonRpcPeer;-><init>(Lcom/facebook/stetho/json/ObjectMapper;Lcom/facebook/stetho/websocket/SimpleSession;)V
