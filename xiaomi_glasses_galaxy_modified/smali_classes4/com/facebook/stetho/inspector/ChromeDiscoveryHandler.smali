...
.method private getAppLabel()Ljava/lang/CharSequence;
    ...
    iget-object p0, p0, Lcom/facebook/stetho/inspector/ChromeDiscoveryHandler;->mContext:Landroid/content/Context;
...
.method private handleActivate(Lcom/facebook/stetho/server/http/LightHttpResponse;)V
    ...
    const-string p0, "Target activation ignored\n"

    const-string/jumbo v0, "text/plain"

    invoke-static {p0, v0}, Lcom/facebook/stetho/server/http/LightHttpBody;->create(Ljava/lang/String;Ljava/lang/String;)Lcom/facebook/stetho/server/http/LightHttpBody;

    move-result-object p0

    invoke-static {p1, p0}, Lcom/facebook/stetho/inspector/ChromeDiscoveryHandler;->setSuccessfulResponse(Lcom/facebook/stetho/server/http/LightHttpResponse;Lcom/facebook/stetho/server/http/LightHttpBody;)V
...
.method private handlePageList(Lcom/facebook/stetho/server/http/LightHttpResponse;)V
    ...
    :cond_0
    iget-object p0, p0, Lcom/facebook/stetho/inspector/ChromeDiscoveryHandler;->mPageListResponse:Lcom/facebook/stetho/server/http/LightHttpBody;
...
.method private handleVersion(Lcom/facebook/stetho/server/http/LightHttpResponse;)V
    ...
    :cond_0
    iget-object p0, p0, Lcom/facebook/stetho/inspector/ChromeDiscoveryHandler;->mVersionResponse:Lcom/facebook/stetho/server/http/LightHttpBody;
...
.method private makeTitle()Ljava/lang/String;
    ...
    const-string p0, " (powered by Stetho)"
...
.method public handleRequest(Lcom/facebook/stetho/server/SocketLike;Lcom/facebook/stetho/server/http/LightHttpRequest;Lcom/facebook/stetho/server/http/LightHttpResponse;)Z
    ...
    iput p0, p3, Lcom/facebook/stetho/server/http/LightHttpResponse;->code:I

    const-string p0, "Not implemented"

    iput-object p0, p3, Lcom/facebook/stetho/server/http/LightHttpResponse;->reasonPhrase:Ljava/lang/String;
    ...
    invoke-static {p0, p1}, Lcom/facebook/stetho/server/http/LightHttpBody;->create(Ljava/lang/String;Ljava/lang/String;)Lcom/facebook/stetho/server/http/LightHttpBody;

    move-result-object p0

    iput-object p0, p3, Lcom/facebook/stetho/server/http/LightHttpResponse;->body:Lcom/facebook/stetho/server/http/LightHttpBody;
    :try_end_0
