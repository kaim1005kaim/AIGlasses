...
.method private filterFiles(Ljava/util/List;Ljava/io/FilenameFilter;)Ljava/util/List;
    ...
    invoke-interface {p2, v4, v3}, Ljava/io/FilenameFilter;->accept(Ljava/io/File;Ljava/lang/String;)Z
...
.method private findEmptyDirs()Ljava/util/List;
    ...
    invoke-virtual {v1, p0}, Ljava/util/ArrayDeque;->toArray([Ljava/lang/Object;)[Ljava/lang/Object;
...
.method private findFiles()Ljava/util/List;
    ...
    iget-object p0, p0, Lch/qos/logback/core/rolling/helper/TimeBasedArchiveRemover;->fileNamePattern:Lch/qos/logback/core/rolling/helper/FileNamePattern;

    invoke-virtual {p0}, Lch/qos/logback/core/rolling/helper/FileNamePattern;->toRegex()Ljava/lang/String;

    move-result-object p0

    invoke-virtual {v0, p0}, Lch/qos/logback/core/rolling/helper/FileFinder;->findFiles(Ljava/lang/String;)Ljava/util/List;
...
.method public toString()Ljava/lang/String;
    ...
    const-string p0, "c.q.l.core.rolling.helper.TimeBasedArchiveRemover"
