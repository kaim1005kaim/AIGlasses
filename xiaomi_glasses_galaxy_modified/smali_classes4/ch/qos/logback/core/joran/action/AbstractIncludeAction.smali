...
.method private checkAttributes(Lorg/xml/sax/Attributes;)Z
    ...
    const-string v1, "One of \"%1$s\", \"%2$s\" or \"%3$s\" attributes must be set."
    ...
    :goto_0
    invoke-virtual {p0, v0, v3}, Lch/qos/logback/core/joran/action/AbstractIncludeAction;->optionalWarning(Ljava/lang/String;Ljava/lang/Exception;)V
    ...
    const-string v1, "Only one of \"%1$s\", \"%2$s\" or \"%3$s\" attributes should be set."
