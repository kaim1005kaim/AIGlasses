...
.field public static final enum UNKNOWN:Lcom/xiaomi/ai/api/SpeechRecognizer$RecognizeScenarioType;
...
.method static constructor <clinit>()V
    ...
    invoke-direct {v0, v2, v3, v1}, Lcom/xiaomi/ai/api/SpeechRecognizer$RecognizeScenarioType;-><init>(Ljava/lang/String;II)V

    sput-object v0, Lcom/xiaomi/ai/api/SpeechRecognizer$RecognizeScenarioType;->UNKNOWN:Lcom/xiaomi/ai/api/SpeechRecognizer$RecognizeScenarioType;

    new-instance v1, Lcom/xiaomi/ai/api/SpeechRecognizer$RecognizeScenarioType;

    const-string v2, "SIMULTANEOUS_TRANSLATION"

    const/4 v4, 0x1

    invoke-direct {v1, v2, v4, v3}, Lcom/xiaomi/ai/api/SpeechRecognizer$RecognizeScenarioType;-><init>(Ljava/lang/String;II)V

    sput-object v1, Lcom/xiaomi/ai/api/SpeechRecognizer$RecognizeScenarioType;->SIMULTANEOUS_TRANSLATION:Lcom/xiaomi/ai/api/SpeechRecognizer$RecognizeScenarioType;

    new-instance v2, Lcom/xiaomi/ai/api/SpeechRecognizer$RecognizeScenarioType;

    const-string v3, "VIDEO_TRANSLATION"

    const/4 v5, 0x2

    invoke-direct {v2, v3, v5, v4}, Lcom/xiaomi/ai/api/SpeechRecognizer$RecognizeScenarioType;-><init>(Ljava/lang/String;II)V

    sput-object v2, Lcom/xiaomi/ai/api/SpeechRecognizer$RecognizeScenarioType;->VIDEO_TRANSLATION:Lcom/xiaomi/ai/api/SpeechRecognizer$RecognizeScenarioType;

    new-instance v3, Lcom/xiaomi/ai/api/SpeechRecognizer$RecognizeScenarioType;

    const-string v4, "ORAL_EXAMINATION"

    const/4 v6, 0x3

    invoke-direct {v3, v4, v6, v5}, Lcom/xiaomi/ai/api/SpeechRecognizer$RecognizeScenarioType;-><init>(Ljava/lang/String;II)V
    ...
    new-instance v4, Lcom/xiaomi/ai/api/SpeechRecognizer$RecognizeScenarioType;

    const-string v5, "AI_MEMORY"

    const/4 v7, 0x4

    invoke-direct {v4, v5, v7, v6}, Lcom/xiaomi/ai/api/SpeechRecognizer$RecognizeScenarioType;-><init>(Ljava/lang/String;II)V

    sput-object v4, Lcom/xiaomi/ai/api/SpeechRecognizer$RecognizeScenarioType;->AI_MEMORY:Lcom/xiaomi/ai/api/SpeechRecognizer$RecognizeScenarioType;

    filled-new-array {v0, v1, v2, v3, v4}, [Lcom/xiaomi/ai/api/SpeechRecognizer$RecognizeScenarioType;

    move-result-object v0

    sput-object v0, Lcom/xiaomi/ai/api/SpeechRecognizer$RecognizeScenarioType;->$VALUES:[Lcom/xiaomi/ai/api/SpeechRecognizer$RecognizeScenarioType;
