...
.method static constructor <clinit>()V
    ...
    invoke-direct {v2, v3, v5, v4}, Lcom/xiaomi/ai/api/AutoController$DRDirective;-><init>(Ljava/lang/String;II)V
    ...
    invoke-direct {v3, v4, v6, v5}, Lcom/xiaomi/ai/api/AutoController$DRDirective;-><init>(Ljava/lang/String;II)V

    sput-object v3, Lcom/xiaomi/ai/api/AutoController$DRDirective;->SWITCH_FRONT_VIDEO_RECORDING:Lcom/xiaomi/ai/api/AutoController$DRDirective;

    new-instance v4, Lcom/xiaomi/ai/api/AutoController$DRDirective;

    const-string v5, "SWITCH_BACK_VIDEO_RECORDING"

    const/4 v7, 0x4

    invoke-direct {v4, v5, v7, v6}, Lcom/xiaomi/ai/api/AutoController$DRDirective;-><init>(Ljava/lang/String;II)V

    sput-object v4, Lcom/xiaomi/ai/api/AutoController$DRDirective;->SWITCH_BACK_VIDEO_RECORDING:Lcom/xiaomi/ai/api/AutoController$DRDirective;
    ...
    invoke-direct {v5, v6, v8, v7}, Lcom/xiaomi/ai/api/AutoController$DRDirective;-><init>(Ljava/lang/String;II)V

    sput-object v5, Lcom/xiaomi/ai/api/AutoController$DRDirective;->OPEN_STOP_MONITOR:Lcom/xiaomi/ai/api/AutoController$DRDirective;

    new-instance v6, Lcom/xiaomi/ai/api/AutoController$DRDirective;

    const-string v7, "CLOSE_STOP_MONITOR"

    const/4 v9, 0x6

    invoke-direct {v6, v7, v9, v8}, Lcom/xiaomi/ai/api/AutoController$DRDirective;-><init>(Ljava/lang/String;II)V

    sput-object v6, Lcom/xiaomi/ai/api/AutoController$DRDirective;->CLOSE_STOP_MONITOR:Lcom/xiaomi/ai/api/AutoController$DRDirective;
    ...
    invoke-direct {v7, v8, v10, v9}, Lcom/xiaomi/ai/api/AutoController$DRDirective;-><init>(Ljava/lang/String;II)V

    sput-object v7, Lcom/xiaomi/ai/api/AutoController$DRDirective;->START_VIDEO_RECORDING:Lcom/xiaomi/ai/api/AutoController$DRDirective;

    new-instance v8, Lcom/xiaomi/ai/api/AutoController$DRDirective;

    const-string v9, "STOP_VIDEO_RECORDING"

    const/16 v11, 0x8

    invoke-direct {v8, v9, v11, v10}, Lcom/xiaomi/ai/api/AutoController$DRDirective;-><init>(Ljava/lang/String;II)V

    sput-object v8, Lcom/xiaomi/ai/api/AutoController$DRDirective;->STOP_VIDEO_RECORDING:Lcom/xiaomi/ai/api/AutoController$DRDirective;
    ...
    invoke-direct {v9, v10, v12, v11}, Lcom/xiaomi/ai/api/AutoController$DRDirective;-><init>(Ljava/lang/String;II)V

    sput-object v9, Lcom/xiaomi/ai/api/AutoController$DRDirective;->START_SOUND_RECORDING:Lcom/xiaomi/ai/api/AutoController$DRDirective;

    new-instance v10, Lcom/xiaomi/ai/api/AutoController$DRDirective;

    const-string v11, "STOP_SOUND_RECORDING"

    const/16 v13, 0xa

    invoke-direct {v10, v11, v13, v12}, Lcom/xiaomi/ai/api/AutoController$DRDirective;-><init>(Ljava/lang/String;II)V

    sput-object v10, Lcom/xiaomi/ai/api/AutoController$DRDirective;->STOP_SOUND_RECORDING:Lcom/xiaomi/ai/api/AutoController$DRDirective;

    filled-new-array/range {v0 .. v10}, [Lcom/xiaomi/ai/api/AutoController$DRDirective;

    move-result-object v0

    sput-object v0, Lcom/xiaomi/ai/api/AutoController$DRDirective;->$VALUES:[Lcom/xiaomi/ai/api/AutoController$DRDirective;
