...
.field public static final enum AUTO_CHARGING_STATION:Lcom/xiaomi/ai/api/Maps$PoiType;
...
.method static constructor <clinit>()V
    ...
    invoke-direct {v2, v3, v5, v4}, Lcom/xiaomi/ai/api/Maps$PoiType;-><init>(Ljava/lang/String;II)V
    ...
    invoke-direct {v3, v4, v6, v5}, Lcom/xiaomi/ai/api/Maps$PoiType;-><init>(Ljava/lang/String;II)V

    sput-object v3, Lcom/xiaomi/ai/api/Maps$PoiType;->COMPANY:Lcom/xiaomi/ai/api/Maps$PoiType;

    new-instance v4, Lcom/xiaomi/ai/api/Maps$PoiType;

    const-string v5, "MY_LOCATION"

    const/4 v7, 0x4

    invoke-direct {v4, v5, v7, v6}, Lcom/xiaomi/ai/api/Maps$PoiType;-><init>(Ljava/lang/String;II)V

    sput-object v4, Lcom/xiaomi/ai/api/Maps$PoiType;->MY_LOCATION:Lcom/xiaomi/ai/api/Maps$PoiType;

    new-instance v5, Lcom/xiaomi/ai/api/Maps$PoiType;

    const-string v6, "AUTO_CHARGING_STATION"

    const/4 v8, 0x5

    invoke-direct {v5, v6, v8, v7}, Lcom/xiaomi/ai/api/Maps$PoiType;-><init>(Ljava/lang/String;II)V

    sput-object v5, Lcom/xiaomi/ai/api/Maps$PoiType;->AUTO_CHARGING_STATION:Lcom/xiaomi/ai/api/Maps$PoiType;

    filled-new-array/range {v0 .. v5}, [Lcom/xiaomi/ai/api/Maps$PoiType;

    move-result-object v0

    sput-object v0, Lcom/xiaomi/ai/api/Maps$PoiType;->$VALUES:[Lcom/xiaomi/ai/api/Maps$PoiType;
