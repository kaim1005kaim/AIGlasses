.class public Lcom/xiaomi/ai/api/intent/domain/Mobike$code;
...
.method public constructor <init>(Lcom/xiaomi/ai/api/intent/Slot;)V
    ...
    .line 3
    iput-object p1, p0, Lcom/xiaomi/ai/api/intent/domain/Mobike$code;->value:Lcom/xiaomi/ai/api/intent/Slot;

    return-void
.end method

.method public static read(Lcom/fasterxml/jackson/databind/JsonNode;)Lcom/xiaomi/ai/api/intent/domain/Mobike$code;
    .locals 2
    ...
    new-instance v0, Lcom/xiaomi/ai/api/intent/domain/Mobike$code;

    invoke-direct {v0}, Lcom/xiaomi/ai/api/intent/domain/Mobike$code;-><init>()V
    ...
    invoke-virtual {v0, p0}, Lcom/xiaomi/ai/api/intent/domain/Mobike$code;->setValue(Lcom/xiaomi/ai/api/intent/Slot;)Lcom/xiaomi/ai/api/intent/domain/Mobike$code;

    return-object v0
.end method

.method public static write(Lcom/xiaomi/ai/api/intent/domain/Mobike$code;)Lcom/fasterxml/jackson/databind/node/ObjectNode;
    .locals 2
    .annotation system Ldalvik/annotation/Throws;
        value = {
            Ljava/lang/reflect/InvocationTargetException;,
    ...
    iget-object p0, p0, Lcom/xiaomi/ai/api/intent/domain/Mobike$code;->value:Lcom/xiaomi/ai/api/intent/Slot;
...
.method public setValue(Lcom/xiaomi/ai/api/intent/Slot;)Lcom/xiaomi/ai/api/intent/domain/Mobike$code;
    .locals 0
    .annotation runtime Lcom/xiaomi/ai/api/common/Required;
    .end annotation
