.class public Lcom/xiaomi/ai/api/intent/domain/VideoInfo;
...
.method public constructor <init>()V
    ...
    iput-object v0, p0, Lcom/xiaomi/ai/api/intent/domain/VideoInfo;->content_provider:Lcom/xiaomi/common/Optional;
...
.method public constructor <init>(Lcom/xiaomi/ai/api/intent/EntityType;)V
    ...
    .line 5
    iput-object p1, p0, Lcom/xiaomi/ai/api/intent/domain/VideoInfo;->entity_type:Lcom/xiaomi/ai/api/intent/EntityType;

    return-void
.end method

.method public static read(Lcom/fasterxml/jackson/databind/JsonNode;Lcom/xiaomi/common/Optional;)Lcom/xiaomi/ai/api/intent/domain/VideoInfo;
    .locals 2
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "(",
            ...
            "Ljava/lang/String;",
            ">;)",
            "Lcom/xiaomi/ai/api/intent/domain/VideoInfo;"
        }
    .end annotation
    ...
    new-instance v0, Lcom/xiaomi/ai/api/intent/domain/VideoInfo;
    ...
    invoke-direct {v0, p1}, Lcom/xiaomi/ai/api/intent/domain/VideoInfo;-><init>(Lcom/xiaomi/ai/api/intent/EntityType;)V
    ...
    invoke-virtual {v0, p0}, Lcom/xiaomi/ai/api/intent/domain/VideoInfo;->setContentProvider(Lcom/xiaomi/ai/api/intent/Slot;)Lcom/xiaomi/ai/api/intent/domain/VideoInfo;

    :cond_0
    return-object v0
.end method

.method public static write(Lcom/xiaomi/ai/api/intent/domain/VideoInfo;)Lcom/fasterxml/jackson/databind/JsonNode;
    .locals 2
    .annotation system Ldalvik/annotation/Throws;
        value = {
            Ljava/lang/reflect/InvocationTargetException;,
    ...
    iget-object v0, p0, Lcom/xiaomi/ai/api/intent/domain/VideoInfo;->entity_type:Lcom/xiaomi/ai/api/intent/EntityType;
    ...
    iget-object v1, p0, Lcom/xiaomi/ai/api/intent/domain/VideoInfo;->content_provider:Lcom/xiaomi/common/Optional;
    ...
    iget-object p0, p0, Lcom/xiaomi/ai/api/intent/domain/VideoInfo;->content_provider:Lcom/xiaomi/common/Optional;
...
.method protected __1()Lcom/xiaomi/ai/api/intent/EntityType;
    ...
    iget-object p0, p0, Lcom/xiaomi/ai/api/intent/domain/VideoInfo;->entity_type:Lcom/xiaomi/ai/api/intent/EntityType;
...
.method public setContentProvider(Lcom/xiaomi/ai/api/intent/Slot;)Lcom/xiaomi/ai/api/intent/domain/VideoInfo;
    .locals 0
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "(",
    ...
    iput-object p1, p0, Lcom/xiaomi/ai/api/intent/domain/VideoInfo;->content_provider:Lcom/xiaomi/common/Optional;

    return-object p0
.end method

.method public setEntityType(Lcom/xiaomi/ai/api/intent/EntityType;)Lcom/xiaomi/ai/api/intent/domain/VideoInfo;
    .locals 0
    .annotation runtime Lcom/xiaomi/ai/api/common/Required;
    .end annotation
