.class public Lcom/xiaomi/ai/api/intent/domain/Oven$cookTime;
...
.method public constructor <init>()V
    ...
    iput-object v0, p0, Lcom/xiaomi/ai/api/intent/domain/Oven$cookTime;->value:Lcom/xiaomi/common/Optional;

    return-void
.end method

.method public static read(Lcom/fasterxml/jackson/databind/JsonNode;)Lcom/xiaomi/ai/api/intent/domain/Oven$cookTime;
    .locals 3
    ...
    new-instance v0, Lcom/xiaomi/ai/api/intent/domain/Oven$cookTime;

    invoke-direct {v0}, Lcom/xiaomi/ai/api/intent/domain/Oven$cookTime;-><init>()V
    ...
    invoke-virtual {v0, p0}, Lcom/xiaomi/ai/api/intent/domain/Oven$cookTime;->setValue(Lcom/xiaomi/ai/api/intent/Slot;)Lcom/xiaomi/ai/api/intent/domain/Oven$cookTime;

    :cond_0
    return-object v0
.end method

.method public static write(Lcom/xiaomi/ai/api/intent/domain/Oven$cookTime;)Lcom/fasterxml/jackson/databind/node/ObjectNode;
    .locals 2
    .annotation system Ldalvik/annotation/Throws;
        value = {
            Ljava/lang/reflect/InvocationTargetException;,
    ...
    iget-object v1, p0, Lcom/xiaomi/ai/api/intent/domain/Oven$cookTime;->value:Lcom/xiaomi/common/Optional;
    ...
    iget-object p0, p0, Lcom/xiaomi/ai/api/intent/domain/Oven$cookTime;->value:Lcom/xiaomi/common/Optional;
...
.method public setValue(Lcom/xiaomi/ai/api/intent/Slot;)Lcom/xiaomi/ai/api/intent/domain/Oven$cookTime;
    .locals 0
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "(",
    ...
    iput-object p1, p0, Lcom/xiaomi/ai/api/intent/domain/Oven$cookTime;->value:Lcom/xiaomi/common/Optional;
