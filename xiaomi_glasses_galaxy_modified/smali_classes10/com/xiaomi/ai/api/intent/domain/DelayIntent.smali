.class public Lcom/xiaomi/ai/api/intent/domain/DelayIntent;
...
.method public constructor <init>()V
    ...
    iput-object v0, p0, Lcom/xiaomi/ai/api/intent/domain/DelayIntent;->duration:Lcom/xiaomi/common/Optional;

    return-void
.end method

.method public static read(Lcom/fasterxml/jackson/databind/JsonNode;Lcom/xiaomi/common/Optional;)Lcom/xiaomi/ai/api/intent/domain/DelayIntent;
    .locals 2
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "(",
            ...
            "Ljava/lang/String;",
            ">;)",
            "Lcom/xiaomi/ai/api/intent/domain/DelayIntent;"
        }
    .end annotation
    ...
    new-instance p1, Lcom/xiaomi/ai/api/intent/domain/DelayIntent;

    invoke-direct {p1}, Lcom/xiaomi/ai/api/intent/domain/DelayIntent;-><init>()V
    ...
    const-class v0, Lcom/xiaomi/ai/api/intent/slots/Miai$Duration;
    ...
    invoke-virtual {p1, p0}, Lcom/xiaomi/ai/api/intent/domain/DelayIntent;->setDuration(Lcom/xiaomi/ai/api/intent/Slot;)Lcom/xiaomi/ai/api/intent/domain/DelayIntent;

    :cond_0
    return-object p1
.end method

.method public static write(Lcom/xiaomi/ai/api/intent/domain/DelayIntent;)Lcom/fasterxml/jackson/databind/JsonNode;
    .locals 2
    .annotation system Ldalvik/annotation/Throws;
        value = {
            Ljava/lang/reflect/InvocationTargetException;,
    ...
    iget-object v1, p0, Lcom/xiaomi/ai/api/intent/domain/DelayIntent;->duration:Lcom/xiaomi/common/Optional;
    ...
    iget-object p0, p0, Lcom/xiaomi/ai/api/intent/domain/DelayIntent;->duration:Lcom/xiaomi/common/Optional;
...
.method public setDuration(Lcom/xiaomi/ai/api/intent/Slot;)Lcom/xiaomi/ai/api/intent/domain/DelayIntent;
    .locals 0
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "(",
    ...
    iput-object p1, p0, Lcom/xiaomi/ai/api/intent/domain/DelayIntent;->duration:Lcom/xiaomi/common/Optional;
