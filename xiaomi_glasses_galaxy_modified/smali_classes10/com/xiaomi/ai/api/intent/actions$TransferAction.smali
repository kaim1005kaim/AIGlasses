.class public Lcom/xiaomi/ai/api/intent/actions$TransferAction;
.super Lcom/xiaomi/ai/api/intent/IntentionAction3Option;
.source "SourceFile"
...
.annotation system Ldalvik/annotation/Signature;
    value = {
        ...
        "Lcom/xiaomi/ai/api/intent/IntentionEntity<",
        "**>;>",
        "Lcom/xiaomi/ai/api/intent/IntentionAction3Option<",
        "TA;TB;TC;>;"
    }
.end annotation
...
.method public constructor <init>(Lcom/xiaomi/ai/api/intent/IntentionEntity;)V
    ...
    .line 1
    invoke-direct {p0, p1}, Lcom/xiaomi/ai/api/intent/IntentionAction3Option;-><init>(Lcom/xiaomi/ai/api/intent/IntentionEntity;)V
    ...
    iput-object v0, p0, Lcom/xiaomi/ai/api/intent/actions$TransferAction;->to:Lcom/xiaomi/common/Optional;
    ...
    iput-object v0, p0, Lcom/xiaomi/ai/api/intent/actions$TransferAction;->from:Lcom/xiaomi/common/Optional;

    .line 4
    iput-object p1, p0, Lcom/xiaomi/ai/api/intent/actions$TransferAction;->object:Lcom/xiaomi/ai/api/intent/IntentionEntity;

    return-void
.end method

.method public constructor <init>(Lcom/xiaomi/ai/api/intent/IntentionEntity;Lcom/xiaomi/common/Optional;Lcom/xiaomi/common/Optional;)V
    .locals 1
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "(TA;",
    ...
    .line 9
    iput-object p2, p0, Lcom/xiaomi/ai/api/intent/actions$TransferAction;->to:Lcom/xiaomi/common/Optional;

    .line 10
    iput-object p3, p0, Lcom/xiaomi/ai/api/intent/actions$TransferAction;->from:Lcom/xiaomi/common/Optional;

    return-void
.end method

.method public static read(Lcom/fasterxml/jackson/databind/JsonNode;Lcom/xiaomi/ai/api/intent/action$ActionName;)Lcom/xiaomi/ai/api/intent/actions$TransferAction;
    .locals 3
    ...
    new-instance v1, Lcom/xiaomi/ai/api/intent/actions$TransferAction;
    ...
    invoke-direct {v1, v0}, Lcom/xiaomi/ai/api/intent/actions$TransferAction;-><init>(Lcom/xiaomi/ai/api/intent/IntentionEntity;)V
    ...
    invoke-virtual {v1, v0}, Lcom/xiaomi/ai/api/intent/actions$TransferAction;->setTo(Lcom/xiaomi/ai/api/intent/IntentionEntity;)Lcom/xiaomi/ai/api/intent/actions$TransferAction;
    ...
    invoke-virtual {v1, p0}, Lcom/xiaomi/ai/api/intent/actions$TransferAction;->setFrom(Lcom/xiaomi/ai/api/intent/IntentionEntity;)Lcom/xiaomi/ai/api/intent/actions$TransferAction;

    :cond_1
    return-object v1
.end method

.method public static write(Lcom/xiaomi/ai/api/intent/actions$TransferAction;)Lcom/fasterxml/jackson/databind/JsonNode;
    .locals 3
    .annotation system Ldalvik/annotation/Throws;
        value = {
            Ljava/lang/reflect/InvocationTargetException;,
    ...
    iget-object v1, p0, Lcom/xiaomi/ai/api/intent/actions$TransferAction;->object:Lcom/xiaomi/ai/api/intent/IntentionEntity;
    ...
    iget-object v1, p0, Lcom/xiaomi/ai/api/intent/actions$TransferAction;->to:Lcom/xiaomi/common/Optional;
    ...
    :cond_0
    iget-object v1, p0, Lcom/xiaomi/ai/api/intent/actions$TransferAction;->from:Lcom/xiaomi/common/Optional;
    ...
    iget-object p0, p0, Lcom/xiaomi/ai/api/intent/actions$TransferAction;->from:Lcom/xiaomi/common/Optional;
...
.method public __2()Lcom/xiaomi/common/Pair;
    ...
    iget-object p0, p0, Lcom/xiaomi/ai/api/intent/actions$TransferAction;->to:Lcom/xiaomi/common/Optional;
...
.method public getObject()Lcom/xiaomi/ai/api/intent/IntentionEntity;
    ...
    iget-object p0, p0, Lcom/xiaomi/ai/api/intent/actions$TransferAction;->object:Lcom/xiaomi/ai/api/intent/IntentionEntity;
...
.method public setFrom(Lcom/xiaomi/ai/api/intent/IntentionEntity;)Lcom/xiaomi/ai/api/intent/actions$TransferAction;
    .locals 0
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "(TC;)",
    ...
    iput-object p1, p0, Lcom/xiaomi/ai/api/intent/actions$TransferAction;->from:Lcom/xiaomi/common/Optional;

    return-object p0
.end method

.method public setObject(Lcom/xiaomi/ai/api/intent/IntentionEntity;)Lcom/xiaomi/ai/api/intent/actions$TransferAction;
    .locals 0
    .annotation runtime Lcom/xiaomi/ai/api/common/Required;
    .end annotation
...
.method public setTo(Lcom/xiaomi/ai/api/intent/IntentionEntity;)Lcom/xiaomi/ai/api/intent/actions$TransferAction;
    .locals 0
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "(TB;)",
    ...
    iput-object p1, p0, Lcom/xiaomi/ai/api/intent/actions$TransferAction;->to:Lcom/xiaomi/common/Optional;
