...
.field public static final enum UNKNOWN:Lcom/xiaomi/ai/api/Experiments$ExploreCardStyleType;
...
.method static constructor <clinit>()V
    ...
    invoke-direct {v0, v2, v3, v1}, Lcom/xiaomi/ai/api/Experiments$ExploreCardStyleType;-><init>(Ljava/lang/String;II)V

    sput-object v0, Lcom/xiaomi/ai/api/Experiments$ExploreCardStyleType;->UNKNOWN:Lcom/xiaomi/ai/api/Experiments$ExploreCardStyleType;
    ...
    invoke-direct {v1, v2, v4, v3}, Lcom/xiaomi/ai/api/Experiments$ExploreCardStyleType;-><init>(Ljava/lang/String;II)V

    sput-object v1, Lcom/xiaomi/ai/api/Experiments$ExploreCardStyleType;->GENERAL:Lcom/xiaomi/ai/api/Experiments$ExploreCardStyleType;

    new-instance v2, Lcom/xiaomi/ai/api/Experiments$ExploreCardStyleType;

    const-string v3, "EXP_A"

    const/4 v5, 0x2

    invoke-direct {v2, v3, v5, v4}, Lcom/xiaomi/ai/api/Experiments$ExploreCardStyleType;-><init>(Ljava/lang/String;II)V

    sput-object v2, Lcom/xiaomi/ai/api/Experiments$ExploreCardStyleType;->EXP_A:Lcom/xiaomi/ai/api/Experiments$ExploreCardStyleType;

    new-instance v3, Lcom/xiaomi/ai/api/Experiments$ExploreCardStyleType;

    const-string v4, "EXP_B"

    const/4 v6, 0x3

    invoke-direct {v3, v4, v6, v5}, Lcom/xiaomi/ai/api/Experiments$ExploreCardStyleType;-><init>(Ljava/lang/String;II)V
    ...
    new-instance v4, Lcom/xiaomi/ai/api/Experiments$ExploreCardStyleType;

    const-string v5, "EXP_C"

    const/4 v7, 0x4

    invoke-direct {v4, v5, v7, v6}, Lcom/xiaomi/ai/api/Experiments$ExploreCardStyleType;-><init>(Ljava/lang/String;II)V

    sput-object v4, Lcom/xiaomi/ai/api/Experiments$ExploreCardStyleType;->EXP_C:Lcom/xiaomi/ai/api/Experiments$ExploreCardStyleType;

    filled-new-array {v0, v1, v2, v3, v4}, [Lcom/xiaomi/ai/api/Experiments$ExploreCardStyleType;

    move-result-object v0

    sput-object v0, Lcom/xiaomi/ai/api/Experiments$ExploreCardStyleType;->$VALUES:[Lcom/xiaomi/ai/api/Experiments$ExploreCardStyleType;
