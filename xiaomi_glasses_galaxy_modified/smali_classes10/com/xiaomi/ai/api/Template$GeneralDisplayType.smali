...
.method static constructor <clinit>()V
    ...
    const-string v3, "MULTI_IMAGE_1"

    const/4 v5, 0x2

    invoke-direct {v2, v3, v5, v4}, Lcom/xiaomi/ai/api/Template$GeneralDisplayType;-><init>(Ljava/lang/String;II)V
    ...
    const-string v4, "MULTI_IMAGE_2"

    const/4 v6, 0x3

    invoke-direct {v3, v4, v6, v5}, Lcom/xiaomi/ai/api/Template$GeneralDisplayType;-><init>(Ljava/lang/String;II)V

    sput-object v3, Lcom/xiaomi/ai/api/Template$GeneralDisplayType;->MULTI_IMAGE_2:Lcom/xiaomi/ai/api/Template$GeneralDisplayType;

    new-instance v4, Lcom/xiaomi/ai/api/Template$GeneralDisplayType;

    const-string v5, "ARROW_TO_RIGHT"

    const/4 v7, 0x4

    invoke-direct {v4, v5, v7, v6}, Lcom/xiaomi/ai/api/Template$GeneralDisplayType;-><init>(Ljava/lang/String;II)V

    sput-object v4, Lcom/xiaomi/ai/api/Template$GeneralDisplayType;->ARROW_TO_RIGHT:Lcom/xiaomi/ai/api/Template$GeneralDisplayType;

    filled-new-array {v0, v1, v2, v3, v4}, [Lcom/xiaomi/ai/api/Template$GeneralDisplayType;

    move-result-object v0

    sput-object v0, Lcom/xiaomi/ai/api/Template$GeneralDisplayType;->$VALUES:[Lcom/xiaomi/ai/api/Template$GeneralDisplayType;
