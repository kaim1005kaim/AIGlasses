...
.field public static final enum UNKNOWN:Lcom/xiaomi/ai/api/Application$AdsTrackType;
...
.method static constructor <clinit>()V
    ...
    invoke-direct {v0, v2, v3, v1}, Lcom/xiaomi/ai/api/Application$AdsTrackType;-><init>(Ljava/lang/String;II)V

    sput-object v0, Lcom/xiaomi/ai/api/Application$AdsTrackType;->UNKNOWN:Lcom/xiaomi/ai/api/Application$AdsTrackType;
    ...
    invoke-direct {v1, v2, v4, v3}, Lcom/xiaomi/ai/api/Application$AdsTrackType;-><init>(Ljava/lang/String;II)V

    sput-object v1, Lcom/xiaomi/ai/api/Application$AdsTrackType;->TOAST:Lcom/xiaomi/ai/api/Application$AdsTrackType;

    new-instance v2, Lcom/xiaomi/ai/api/Application$AdsTrackType;

    const-string v3, "AUDIO_PLAYER"

    const/4 v5, 0x2

    invoke-direct {v2, v3, v5, v4}, Lcom/xiaomi/ai/api/Application$AdsTrackType;-><init>(Ljava/lang/String;II)V

    sput-object v2, Lcom/xiaomi/ai/api/Application$AdsTrackType;->AUDIO_PLAYER:Lcom/xiaomi/ai/api/Application$AdsTrackType;
    ...
    invoke-direct {v3, v4, v6, v5}, Lcom/xiaomi/ai/api/Application$AdsTrackType;-><init>(Ljava/lang/String;II)V

    sput-object v3, Lcom/xiaomi/ai/api/Application$AdsTrackType;->ATTACHMENT:Lcom/xiaomi/ai/api/Application$AdsTrackType;

    new-instance v4, Lcom/xiaomi/ai/api/Application$AdsTrackType;

    const-string v5, "SPEAKER"

    const/4 v7, 0x4

    invoke-direct {v4, v5, v7, v6}, Lcom/xiaomi/ai/api/Application$AdsTrackType;-><init>(Ljava/lang/String;II)V

    sput-object v4, Lcom/xiaomi/ai/api/Application$AdsTrackType;->SPEAKER:Lcom/xiaomi/ai/api/Application$AdsTrackType;

    filled-new-array {v0, v1, v2, v3, v4}, [Lcom/xiaomi/ai/api/Application$AdsTrackType;

    move-result-object v0

    sput-object v0, Lcom/xiaomi/ai/api/Application$AdsTrackType;->$VALUES:[Lcom/xiaomi/ai/api/Application$AdsTrackType;
