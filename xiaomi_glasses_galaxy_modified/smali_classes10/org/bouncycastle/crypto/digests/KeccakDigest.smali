...
.method public constructor <init>(I)V
    ...
    invoke-direct {p0, p1}, Lorg/bouncycastle/crypto/digests/KeccakDigest;->r(I)V
...
.method public constructor <init>(Lorg/bouncycastle/crypto/digests/KeccakDigest;)V
    ...
    iget-object v1, p1, Lorg/bouncycastle/crypto/digests/KeccakDigest;->a:[J
    ...
    iget-object v1, p0, Lorg/bouncycastle/crypto/digests/KeccakDigest;->b:[B
...
.method private b([BI)V
    ...
    :cond_0
    invoke-direct {p0}, Lorg/bouncycastle/crypto/digests/KeccakDigest;->n()V
...
.method private g()V
    ...
    iget-object v0, p0, Lorg/bouncycastle/crypto/digests/KeccakDigest;->a:[J

    iget v1, p0, Lorg/bouncycastle/crypto/digests/KeccakDigest;->c:I

    shr-int/lit8 v1, v1, 0x6

    iget-object p0, p0, Lorg/bouncycastle/crypto/digests/KeccakDigest;->b:[B

    const/4 v2, 0x0

    invoke-static {v0, v2, v1, p0, v2}, Lorg/bouncycastle/util/Pack;->A([JII[BI)V
...
.method private n()V
    ...
    iget-object v0, v0, Lorg/bouncycastle/crypto/digests/KeccakDigest;->a:[J
    ...
    sget-object v4, Lorg/bouncycastle/crypto/digests/KeccakDigest;->g:[J
...
.method private r(I)V
    ...
    invoke-direct {p0, p1}, Lorg/bouncycastle/crypto/digests/KeccakDigest;->s(I)V
...
.method private s(I)V
    ...
    invoke-static {v2, v1}, Lorg/bouncycastle/util/Arrays;->O([BB)V
...
.method private t()V
    ...
    iget-object v0, p0, Lorg/bouncycastle/crypto/digests/KeccakDigest;->b:[B
    ...
    iget v3, p0, Lorg/bouncycastle/crypto/digests/KeccakDigest;->c:I

    const/4 v4, 0x0

    if-ne v1, v3, :cond_0

    invoke-direct {p0, v0, v4}, Lorg/bouncycastle/crypto/digests/KeccakDigest;->b([BI)V

    iput v4, p0, Lorg/bouncycastle/crypto/digests/KeccakDigest;->d:I
    ...
    iget-object v7, p0, Lorg/bouncycastle/crypto/digests/KeccakDigest;->a:[J

    aget-wide v8, v7, v4

    iget-object v10, p0, Lorg/bouncycastle/crypto/digests/KeccakDigest;->b:[B

    invoke-static {v10, v3}, Lorg/bouncycastle/util/Pack;->r([BI)J
    ...
    iget-object v6, p0, Lorg/bouncycastle/crypto/digests/KeccakDigest;->b:[B

    invoke-static {v6, v3}, Lorg/bouncycastle/util/Pack;->r([BI)J
    ...
    invoke-direct {p0}, Lorg/bouncycastle/crypto/digests/KeccakDigest;->g()V

    iget v0, p0, Lorg/bouncycastle/crypto/digests/KeccakDigest;->c:I

    iput v0, p0, Lorg/bouncycastle/crypto/digests/KeccakDigest;->d:I

    iput-boolean v2, p0, Lorg/bouncycastle/crypto/digests/KeccakDigest;->f:Z
...
.method public l()I
    ...
    iget p0, p0, Lorg/bouncycastle/crypto/digests/KeccakDigest;->c:I
...
.method protected o([BII)V
    ...
    invoke-direct {p0, p1, v5}, Lorg/bouncycastle/crypto/digests/KeccakDigest;->b([BI)V
    ...
    invoke-direct {p0, v0, v2}, Lorg/bouncycastle/crypto/digests/KeccakDigest;->b([BI)V
...
.method protected q([BIBI)I
    ...
    invoke-virtual {p0, p3, p4}, Lorg/bouncycastle/crypto/digests/KeccakDigest;->p(II)V

    :cond_0
    iget p3, p0, Lorg/bouncycastle/crypto/digests/KeccakDigest;->e:I

    int-to-long p3, p3

    invoke-virtual {p0, p1, p2, p3, p4}, Lorg/bouncycastle/crypto/digests/KeccakDigest;->u([BIJ)V
...
.method public reset()V
    ...
    invoke-direct {p0, v0}, Lorg/bouncycastle/crypto/digests/KeccakDigest;->r(I)V

    return-void
.end method

.method protected u([BIJ)V
    .locals 9
    ...
    invoke-direct {p0}, Lorg/bouncycastle/crypto/digests/KeccakDigest;->t()V
    ...
    iget v2, p0, Lorg/bouncycastle/crypto/digests/KeccakDigest;->d:I
    ...
    iget v2, p0, Lorg/bouncycastle/crypto/digests/KeccakDigest;->c:I

    iput v2, p0, Lorg/bouncycastle/crypto/digests/KeccakDigest;->d:I
    ...
    iget v6, p0, Lorg/bouncycastle/crypto/digests/KeccakDigest;->c:I

    iget v7, p0, Lorg/bouncycastle/crypto/digests/KeccakDigest;->d:I
    ...
    iget v3, p0, Lorg/bouncycastle/crypto/digests/KeccakDigest;->d:I

    sub-int/2addr v3, v2

    iput v3, p0, Lorg/bouncycastle/crypto/digests/KeccakDigest;->d:I
...
.method public update(B)V
    ...
    invoke-virtual {p0, v1, v2, v0}, Lorg/bouncycastle/crypto/digests/KeccakDigest;->o([BII)V
...
.method public update([BII)V
    ...
    .line 2
    invoke-virtual {p0, p1, p2, p3}, Lorg/bouncycastle/crypto/digests/KeccakDigest;->o([BII)V
