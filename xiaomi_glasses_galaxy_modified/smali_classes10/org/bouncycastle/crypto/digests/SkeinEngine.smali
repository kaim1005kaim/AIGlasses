...
.field private static final o:I = 0x30

.field private static final p:I = 0x3f

.field private static final q:Ljava/util/Hashtable;


# instance fields
.field final a:Lorg/bouncycastle/crypto/engines/ThreefishEngine;
...
.field private f:[Lorg/bouncycastle/crypto/digests/SkeinEngine$Parameter;

.field private g:[Lorg/bouncycastle/crypto/digests/SkeinEngine$Parameter;

.field private final h:Lorg/bouncycastle/crypto/digests/SkeinEngine$UBI;
...
.method static constructor <clinit>()V
    ...
    sput-object v0, Lorg/bouncycastle/crypto/digests/SkeinEngine;->q:Ljava/util/Hashtable;
    ...
    invoke-static {v2, v3, v1}, Lorg/bouncycastle/crypto/digests/SkeinEngine;->k(II[J)V
    ...
    invoke-static {v2, v4, v1}, Lorg/bouncycastle/crypto/digests/SkeinEngine;->k(II[J)V
    ...
    invoke-static {v2, v5, v1}, Lorg/bouncycastle/crypto/digests/SkeinEngine;->k(II[J)V

    new-array v0, v0, [J

    fill-array-data v0, :array_3

    invoke-static {v2, v2, v0}, Lorg/bouncycastle/crypto/digests/SkeinEngine;->k(II[J)V
...
.method public constructor <init>(Lorg/bouncycastle/crypto/digests/SkeinEngine;)V
    ...
    .line 2
    invoke-virtual {p1}, Lorg/bouncycastle/crypto/digests/SkeinEngine;->g()I

    move-result v0

    mul-int/lit8 v0, v0, 0x8

    invoke-virtual {p1}, Lorg/bouncycastle/crypto/digests/SkeinEngine;->h()I
    ...
    invoke-direct {p0, p1}, Lorg/bouncycastle/crypto/digests/SkeinEngine;->d(Lorg/bouncycastle/crypto/digests/SkeinEngine;)V
...
.method private a()V
    ...
    iget-object p0, p0, Lorg/bouncycastle/crypto/digests/SkeinEngine;->h:Lorg/bouncycastle/crypto/digests/SkeinEngine$UBI;
...
.method private static c([Lorg/bouncycastle/crypto/digests/SkeinEngine$Parameter;[Lorg/bouncycastle/crypto/digests/SkeinEngine$Parameter;)[Lorg/bouncycastle/crypto/digests/SkeinEngine$Parameter;
    .locals 2
...
.method private d(Lorg/bouncycastle/crypto/digests/SkeinEngine;)V
    .locals 2

    iget-object v0, p0, Lorg/bouncycastle/crypto/digests/SkeinEngine;->h:Lorg/bouncycastle/crypto/digests/SkeinEngine$UBI;

    iget-object v1, p1, Lorg/bouncycastle/crypto/digests/SkeinEngine;->h:Lorg/bouncycastle/crypto/digests/SkeinEngine$UBI;

    invoke-virtual {v0, v1}, Lorg/bouncycastle/crypto/digests/SkeinEngine$UBI;->d(Lorg/bouncycastle/crypto/digests/SkeinEngine$UBI;)V
    ...
    invoke-static {v0, v1}, Lorg/bouncycastle/crypto/digests/SkeinEngine;->c([Lorg/bouncycastle/crypto/digests/SkeinEngine$Parameter;[Lorg/bouncycastle/crypto/digests/SkeinEngine$Parameter;)[Lorg/bouncycastle/crypto/digests/SkeinEngine$Parameter;
    ...
    invoke-static {p1, v0}, Lorg/bouncycastle/crypto/digests/SkeinEngine;->c([Lorg/bouncycastle/crypto/digests/SkeinEngine$Parameter;[Lorg/bouncycastle/crypto/digests/SkeinEngine$Parameter;)[Lorg/bouncycastle/crypto/digests/SkeinEngine$Parameter;
...
.method private e()V
    ...
    sget-object v0, Lorg/bouncycastle/crypto/digests/SkeinEngine;->q:Ljava/util/Hashtable;
    ...
    invoke-static {v1, v2}, Lorg/bouncycastle/crypto/digests/SkeinEngine;->u(II)Ljava/lang/Integer;
    ...
    iget-object v0, p0, Lorg/bouncycastle/crypto/digests/SkeinEngine;->e:[B

    if-eqz v0, :cond_1

    invoke-direct {p0, v2, v0}, Lorg/bouncycastle/crypto/digests/SkeinEngine;->p(I[B)V

    :cond_1
    new-instance v0, Lorg/bouncycastle/crypto/digests/SkeinEngine$Configuration;

    iget v1, p0, Lorg/bouncycastle/crypto/digests/SkeinEngine;->b:I
    ...
    invoke-virtual {v0}, Lorg/bouncycastle/crypto/digests/SkeinEngine$Configuration;->a()[B

    move-result-object v0

    const/4 v1, 0x4

    invoke-direct {p0, v1, v0}, Lorg/bouncycastle/crypto/digests/SkeinEngine;->p(I[B)V

    :goto_0
    iget-object v0, p0, Lorg/bouncycastle/crypto/digests/SkeinEngine;->f:[Lorg/bouncycastle/crypto/digests/SkeinEngine$Parameter;
    ...
    invoke-virtual {v0}, Lorg/bouncycastle/crypto/digests/SkeinEngine$Parameter;->a()I

    move-result v1

    invoke-virtual {v0}, Lorg/bouncycastle/crypto/digests/SkeinEngine$Parameter;->b()[B
...
.method private j(Ljava/util/Hashtable;)V
    ...
    iput-object v4, p0, Lorg/bouncycastle/crypto/digests/SkeinEngine;->e:[B
    ...
    invoke-static {p1}, Lorg/bouncycastle/crypto/digests/SkeinEngine;->o([Lorg/bouncycastle/crypto/digests/SkeinEngine$Parameter;)V
    ...
    iget-object p0, p0, Lorg/bouncycastle/crypto/digests/SkeinEngine;->g:[Lorg/bouncycastle/crypto/digests/SkeinEngine$Parameter;

    invoke-static {p0}, Lorg/bouncycastle/crypto/digests/SkeinEngine;->o([Lorg/bouncycastle/crypto/digests/SkeinEngine$Parameter;)V
...
.method private static k(II[J)V
    ...
    invoke-static {p0, p1}, Lorg/bouncycastle/crypto/digests/SkeinEngine;->u(II)Ljava/lang/Integer;
...
.method private l(J[BII)V
    ...
    invoke-static {p1, p2, v1, v2}, Lorg/bouncycastle/crypto/engines/ThreefishEngine;->l(J[BI)V
    ...
    invoke-direct {p0, p2}, Lorg/bouncycastle/crypto/digests/SkeinEngine;->r(I)V

    iget-object p2, p0, Lorg/bouncycastle/crypto/digests/SkeinEngine;->h:Lorg/bouncycastle/crypto/digests/SkeinEngine$UBI;

    invoke-virtual {p2, v1, v2, v0, p1}, Lorg/bouncycastle/crypto/digests/SkeinEngine$UBI;->e([BII[J)V

    iget-object p0, p0, Lorg/bouncycastle/crypto/digests/SkeinEngine;->h:Lorg/bouncycastle/crypto/digests/SkeinEngine$UBI;

    invoke-virtual {p0, p1}, Lorg/bouncycastle/crypto/digests/SkeinEngine$UBI;->a([J)V
    ...
    invoke-static {v4, v5, p3, v3}, Lorg/bouncycastle/crypto/engines/ThreefishEngine;->l(J[BI)V
    ...
    invoke-static {v5, v6, v1, v2}, Lorg/bouncycastle/crypto/engines/ThreefishEngine;->l(J[BI)V
...
.method private static o([Lorg/bouncycastle/crypto/digests/SkeinEngine$Parameter;)V
    .locals 6
    ...
    invoke-virtual {v1}, Lorg/bouncycastle/crypto/digests/SkeinEngine$Parameter;->a()I
    ...
    invoke-virtual {v5}, Lorg/bouncycastle/crypto/digests/SkeinEngine$Parameter;->a()I
...
.method private p(I[B)V
    ...
    invoke-direct {p0, p1}, Lorg/bouncycastle/crypto/digests/SkeinEngine;->r(I)V

    iget-object p1, p0, Lorg/bouncycastle/crypto/digests/SkeinEngine;->h:Lorg/bouncycastle/crypto/digests/SkeinEngine$UBI;
    ...
    invoke-virtual {p1, p2, v2, v0, v1}, Lorg/bouncycastle/crypto/digests/SkeinEngine$UBI;->e([BII[J)V

    invoke-direct {p0}, Lorg/bouncycastle/crypto/digests/SkeinEngine;->q()V
...
.method private q()V
    ...
    iget-object p0, p0, Lorg/bouncycastle/crypto/digests/SkeinEngine;->c:[J

    invoke-virtual {v0, p0}, Lorg/bouncycastle/crypto/digests/SkeinEngine$UBI;->a([J)V
...
.method private r(I)V
    ...
    invoke-virtual {p0, p1}, Lorg/bouncycastle/crypto/digests/SkeinEngine$UBI;->c(I)V

    return-void
.end method

.method private static u(II)Ljava/lang/Integer;
    .locals 1
...
.method public f([BI)I
    ...
    invoke-direct {p0}, Lorg/bouncycastle/crypto/digests/SkeinEngine;->a()V
    ...
    :goto_0
    iget-object v2, p0, Lorg/bouncycastle/crypto/digests/SkeinEngine;->g:[Lorg/bouncycastle/crypto/digests/SkeinEngine$Parameter;
    ...
    invoke-virtual {v2}, Lorg/bouncycastle/crypto/digests/SkeinEngine$Parameter;->a()I

    move-result v3

    invoke-virtual {v2}, Lorg/bouncycastle/crypto/digests/SkeinEngine$Parameter;->b()[B

    move-result-object v2

    invoke-direct {p0, v3, v2}, Lorg/bouncycastle/crypto/digests/SkeinEngine;->p(I[B)V
    ...
    iget v2, p0, Lorg/bouncycastle/crypto/digests/SkeinEngine;->b:I
    ...
    iget v3, p0, Lorg/bouncycastle/crypto/digests/SkeinEngine;->b:I
    ...
    invoke-direct/range {v5 .. v10}, Lorg/bouncycastle/crypto/digests/SkeinEngine;->l(J[BII)V
    ...
    iget p0, p0, Lorg/bouncycastle/crypto/digests/SkeinEngine;->b:I
...
.method public g()I
    ...
    iget-object p0, p0, Lorg/bouncycastle/crypto/digests/SkeinEngine;->a:Lorg/bouncycastle/crypto/engines/ThreefishEngine;
...
.method public i(Lorg/bouncycastle/crypto/params/SkeinParameters;)V
    .locals 2
    ...
    invoke-virtual {p1}, Lorg/bouncycastle/crypto/params/SkeinParameters;->e()Ljava/util/Hashtable;

    move-result-object p1

    invoke-direct {p0, p1}, Lorg/bouncycastle/crypto/digests/SkeinEngine;->j(Ljava/util/Hashtable;)V
    ...
    :cond_1
    :goto_0
    invoke-direct {p0}, Lorg/bouncycastle/crypto/digests/SkeinEngine;->e()V
...
.method public m()V
    ...
    iget-object v0, p0, Lorg/bouncycastle/crypto/digests/SkeinEngine;->d:[J
    ...
    invoke-direct {p0, v0}, Lorg/bouncycastle/crypto/digests/SkeinEngine;->r(I)V
...
.method public s(B)V
    ...
    iget-object v0, p0, Lorg/bouncycastle/crypto/digests/SkeinEngine;->i:[B
    ...
    invoke-virtual {p0, v0, v1, p1}, Lorg/bouncycastle/crypto/digests/SkeinEngine;->t([BII)V
...
.method public t([BII)V
    ...
    invoke-virtual {v0, p1, p2, p3, p0}, Lorg/bouncycastle/crypto/digests/SkeinEngine$UBI;->e([BII[J)V
