...
.method private d([BI[BI)V
    ...
    invoke-direct {p0, p1, v0, p2, v1}, Lorg/bouncycastle/crypto/engines/Shacal2Engine;->b([B[III)V
    ...
    sget-object v2, Lorg/bouncycastle/crypto/engines/Shacal2Engine;->c:[I

    aget v2, v2, p1

    sub-int/2addr p2, v2

    iget-object v2, p0, Lorg/bouncycastle/crypto/engines/Shacal2Engine;->b:[I
    ...
    :cond_0
    invoke-direct {p0, v0, p3, p4}, Lorg/bouncycastle/crypto/engines/Shacal2Engine;->f([I[BI)V
...
.method private e([BI[BI)V
    ...
    sget-object v7, Lorg/bouncycastle/crypto/engines/Shacal2Engine;->c:[I

    aget v7, v7, p1

    add-int/2addr v3, v7

    iget-object v7, p0, Lorg/bouncycastle/crypto/engines/Shacal2Engine;->b:[I
...
.method public a(ZLorg/bouncycastle/crypto/CipherParameters;)V
    ...
    iput-object p1, p0, Lorg/bouncycastle/crypto/engines/Shacal2Engine;->b:[I
    ...
    invoke-virtual {p0, p1}, Lorg/bouncycastle/crypto/engines/Shacal2Engine;->g([B)V
...
.method public g([B)V
    ...
    iget-object v0, p0, Lorg/bouncycastle/crypto/engines/Shacal2Engine;->b:[I

    const/4 v3, 0x0

    invoke-direct {p0, p1, v0, v3, v3}, Lorg/bouncycastle/crypto/engines/Shacal2Engine;->c([B[III)V

    :goto_0
    if-ge v2, v1, :cond_0

    iget-object p1, p0, Lorg/bouncycastle/crypto/engines/Shacal2Engine;->b:[I
...
.method public processBlock([BI[BI)I
    ...
    iget-boolean v0, p0, Lorg/bouncycastle/crypto/engines/Shacal2Engine;->a:Z

    if-eqz v0, :cond_0

    invoke-direct {p0, p1, p2, p3, p4}, Lorg/bouncycastle/crypto/engines/Shacal2Engine;->e([BI[BI)V

    goto :goto_0

    :cond_0
    invoke-direct {p0, p1, p2, p3, p4}, Lorg/bouncycastle/crypto/engines/Shacal2Engine;->d([BI[BI)V
