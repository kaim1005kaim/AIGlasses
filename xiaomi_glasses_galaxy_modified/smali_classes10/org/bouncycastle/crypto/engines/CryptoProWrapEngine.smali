...
.method private static e([B[B[B)[B
    ...
    invoke-static {p0, v6}, Lorg/bouncycastle/util/Pack;->n([BI)I

    move-result v6

    aget-byte v7, p1, v1

    invoke-static {v7, v3}, Lorg/bouncycastle/crypto/engines/CryptoProWrapEngine;->d(BI)Z
    ...
    invoke-static {v4, v3, v0}, Lorg/bouncycastle/util/Pack;->j(I[BI)V

    const/4 v4, 0x4

    invoke-static {v5, v3, v4}, Lorg/bouncycastle/util/Pack;->j(I[BI)V
    ...
    invoke-virtual {v4, v3, v5}, Lorg/bouncycastle/crypto/modes/GCFBBlockCipher;->a(ZLorg/bouncycastle/crypto/CipherParameters;)V
...
.method public a(ZLorg/bouncycastle/crypto/CipherParameters;)V
    ...
    invoke-virtual {v0}, Lorg/bouncycastle/crypto/params/ParametersWithSBox;->a()Lorg/bouncycastle/crypto/CipherParameters;
    ...
    invoke-virtual {v1}, Lorg/bouncycastle/crypto/params/ParametersWithSBox;->b()[B
    ...
    invoke-static {v0, v3, v1}, Lorg/bouncycastle/crypto/engines/CryptoProWrapEngine;->e([B[B[B)[B
    ...
    :goto_1
    invoke-super {p0, p1, v0}, Lorg/bouncycastle/crypto/engines/GOST28147WrapEngine;->a(ZLorg/bouncycastle/crypto/CipherParameters;)V
