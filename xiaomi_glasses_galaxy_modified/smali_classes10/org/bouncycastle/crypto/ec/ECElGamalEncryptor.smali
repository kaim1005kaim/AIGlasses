...
.method public a(Lorg/bouncycastle/crypto/CipherParameters;)V
    ...
    iput-object v0, p0, Lorg/bouncycastle/crypto/ec/ECElGamalEncryptor;->a:Lorg/bouncycastle/crypto/params/ECPublicKeyParameters;
    ...
    :goto_0
    iput-object p1, p0, Lorg/bouncycastle/crypto/ec/ECElGamalEncryptor;->b:Ljava/security/SecureRandom;
    ...
    iput-object p1, p0, Lorg/bouncycastle/crypto/ec/ECElGamalEncryptor;->a:Lorg/bouncycastle/crypto/params/ECPublicKeyParameters;
...
.method public b(Lorg/bouncycastle/math/ec/ECPoint;)Lorg/bouncycastle/crypto/ec/ECPair;
    .locals 4

    iget-object v0, p0, Lorg/bouncycastle/crypto/ec/ECElGamalEncryptor;->a:Lorg/bouncycastle/crypto/params/ECPublicKeyParameters;
    ...
    iget-object v2, p0, Lorg/bouncycastle/crypto/ec/ECElGamalEncryptor;->b:Ljava/security/SecureRandom;

    invoke-static {v1, v2}, Lorg/bouncycastle/crypto/ec/ECUtil;->a(Ljava/math/BigInteger;Ljava/security/SecureRandom;)Ljava/math/BigInteger;

    move-result-object v1

    invoke-virtual {p0}, Lorg/bouncycastle/crypto/ec/ECElGamalEncryptor;->c()Lorg/bouncycastle/math/ec/ECMultiplier;
    ...
    iget-object p0, p0, Lorg/bouncycastle/crypto/ec/ECElGamalEncryptor;->a:Lorg/bouncycastle/crypto/params/ECPublicKeyParameters;
