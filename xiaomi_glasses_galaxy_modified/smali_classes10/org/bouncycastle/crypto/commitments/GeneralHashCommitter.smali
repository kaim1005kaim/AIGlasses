...
.method public constructor <init>(Lorg/bouncycastle/crypto/ExtendedDigest;Ljava/security/SecureRandom;)V
    ...
    iput-object p1, p0, Lorg/bouncycastle/crypto/commitments/GeneralHashCommitter;->a:Lorg/bouncycastle/crypto/Digest;

    invoke-interface {p1}, Lorg/bouncycastle/crypto/ExtendedDigest;->l()I

    move-result p1

    iput p1, p0, Lorg/bouncycastle/crypto/commitments/GeneralHashCommitter;->b:I

    iput-object p2, p0, Lorg/bouncycastle/crypto/commitments/GeneralHashCommitter;->c:Ljava/security/SecureRandom;
...
.method private c([B[B)[B
    ...
    iget-object v0, p0, Lorg/bouncycastle/crypto/commitments/GeneralHashCommitter;->a:Lorg/bouncycastle/crypto/Digest;
    ...
    iget-object v1, p0, Lorg/bouncycastle/crypto/commitments/GeneralHashCommitter;->a:Lorg/bouncycastle/crypto/Digest;
    ...
    iget-object p1, p0, Lorg/bouncycastle/crypto/commitments/GeneralHashCommitter;->a:Lorg/bouncycastle/crypto/Digest;
    ...
    iget-object p0, p0, Lorg/bouncycastle/crypto/commitments/GeneralHashCommitter;->a:Lorg/bouncycastle/crypto/Digest;
...
.method public a(Lorg/bouncycastle/crypto/Commitment;[B)Z
    ...
    iget v1, p0, Lorg/bouncycastle/crypto/commitments/GeneralHashCommitter;->b:I
    ...
    invoke-direct {p0, v0, p2}, Lorg/bouncycastle/crypto/commitments/GeneralHashCommitter;->c([B[B)[B
...
.method public b([B)Lorg/bouncycastle/crypto/Commitment;
    ...
    iget-object v1, p0, Lorg/bouncycastle/crypto/commitments/GeneralHashCommitter;->c:Ljava/security/SecureRandom;

    invoke-virtual {v1, v0}, Ljava/security/SecureRandom;->nextBytes([B)V

    new-instance v1, Lorg/bouncycastle/crypto/Commitment;

    invoke-direct {p0, v0, p1}, Lorg/bouncycastle/crypto/commitments/GeneralHashCommitter;->c([B[B)[B
