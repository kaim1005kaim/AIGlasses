...
.method public a(Lorg/bouncycastle/crypto/DerivationParameters;)V
    ...
    invoke-virtual {p1}, Lorg/bouncycastle/crypto/params/KDFParameters;->b()[B

    move-result-object v0

    iput-object v0, p0, Lorg/bouncycastle/crypto/agreement/kdf/ConcatenationKDFGenerator;->b:[B

    invoke-virtual {p1}, Lorg/bouncycastle/crypto/params/KDFParameters;->a()[B
...
.method public b()Lorg/bouncycastle/crypto/Digest;
    ...
    iget-object p0, p0, Lorg/bouncycastle/crypto/agreement/kdf/ConcatenationKDFGenerator;->a:Lorg/bouncycastle/crypto/Digest;
...
.method public c([BII)I
    ...
    iget-object v3, p0, Lorg/bouncycastle/crypto/agreement/kdf/ConcatenationKDFGenerator;->a:Lorg/bouncycastle/crypto/Digest;

    invoke-interface {v3}, Lorg/bouncycastle/crypto/Digest;->reset()V

    iget v3, p0, Lorg/bouncycastle/crypto/agreement/kdf/ConcatenationKDFGenerator;->d:I
    ...
    :goto_0
    invoke-direct {p0, v4, v2}, Lorg/bouncycastle/crypto/agreement/kdf/ConcatenationKDFGenerator;->d(I[B)V

    iget-object v6, p0, Lorg/bouncycastle/crypto/agreement/kdf/ConcatenationKDFGenerator;->a:Lorg/bouncycastle/crypto/Digest;

    invoke-interface {v6, v2, v5, v1}, Lorg/bouncycastle/crypto/Digest;->update([BII)V

    iget-object v6, p0, Lorg/bouncycastle/crypto/agreement/kdf/ConcatenationKDFGenerator;->a:Lorg/bouncycastle/crypto/Digest;

    iget-object v7, p0, Lorg/bouncycastle/crypto/agreement/kdf/ConcatenationKDFGenerator;->b:[B
    ...
    iget-object v7, p0, Lorg/bouncycastle/crypto/agreement/kdf/ConcatenationKDFGenerator;->c:[B
    ...
    iget v7, p0, Lorg/bouncycastle/crypto/agreement/kdf/ConcatenationKDFGenerator;->d:I

    invoke-static {v0, v5, p1, v6, v7}, Ljava/lang/System;->arraycopy(Ljava/lang/Object;ILjava/lang/Object;II)V

    iget v6, p0, Lorg/bouncycastle/crypto/agreement/kdf/ConcatenationKDFGenerator;->d:I
    ...
    iget-object v1, p0, Lorg/bouncycastle/crypto/agreement/kdf/ConcatenationKDFGenerator;->a:Lorg/bouncycastle/crypto/Digest;

    iget-object v2, p0, Lorg/bouncycastle/crypto/agreement/kdf/ConcatenationKDFGenerator;->b:[B
    ...
    iget-object v2, p0, Lorg/bouncycastle/crypto/agreement/kdf/ConcatenationKDFGenerator;->c:[B
