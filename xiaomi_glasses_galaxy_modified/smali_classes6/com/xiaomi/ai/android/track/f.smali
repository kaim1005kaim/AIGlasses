...
# static fields
.field private static volatile e:Lcom/xiaomi/ai/android/track/f;
...
.field private b:Lcom/xiaomi/ai/android/track/g;
...
.method private constructor <init>()V
    ...
    iput v0, p0, Lcom/xiaomi/ai/android/track/f;->c:I

    const/4 v0, 0x0

    iput-boolean v0, p0, Lcom/xiaomi/ai/android/track/f;->d:Z

    new-instance v0, Ljava/util/HashMap;

    invoke-direct {v0}, Ljava/util/HashMap;-><init>()V

    iput-object v0, p0, Lcom/xiaomi/ai/android/track/f;->a:Ljava/util/HashMap;
...
.method private a(Landroid/content/Context;Ljava/lang/String;)Lcom/xiaomi/ai/android/track/e;
    ...
    .line 1
    iget-boolean v0, p0, Lcom/xiaomi/ai/android/track/f;->d:Z

    if-nez v0, :cond_0

    new-instance v0, Lcom/xiaomi/ai/android/track/g;

    iget v1, p0, Lcom/xiaomi/ai/android/track/f;->c:I
    ...
    iput-object v0, p0, Lcom/xiaomi/ai/android/track/f;->b:Lcom/xiaomi/ai/android/track/g;
    ...
    iget-object v0, p0, Lcom/xiaomi/ai/android/track/f;->b:Lcom/xiaomi/ai/android/track/g;
    ...
    :try_start_0
    iget-object v1, p0, Lcom/xiaomi/ai/android/track/f;->a:Ljava/util/HashMap;
    ...
    iget-object v2, p0, Lcom/xiaomi/ai/android/track/f;->b:Lcom/xiaomi/ai/android/track/g;
    ...
    iget-object p0, p0, Lcom/xiaomi/ai/android/track/f;->a:Ljava/util/HashMap;
...
.method public static a()Lcom/xiaomi/ai/android/track/f;
    ...
    .line 2
    sget-object v0, Lcom/xiaomi/ai/android/track/f;->e:Lcom/xiaomi/ai/android/track/f;
    ...
    :try_start_0
    sget-object v1, Lcom/xiaomi/ai/android/track/f;->e:Lcom/xiaomi/ai/android/track/f;
    ...
    sput-object v1, Lcom/xiaomi/ai/android/track/f;->e:Lcom/xiaomi/ai/android/track/f;
...
.method public a(Landroid/content/Context;Ljava/lang/String;Ljava/lang/String;Z)Ljava/lang/String;
    ...
    invoke-static {p1, p2, p3}, Lcom/xiaomi/ai/android/utils/SharedPreferencesUtils;->readKeyValue(Landroid/content/Context;Ljava/lang/String;Ljava/lang/String;)Ljava/lang/String;
    ...
    invoke-virtual {p0, p3}, Lcom/xiaomi/ai/android/track/e;->b(Ljava/lang/String;)Ljava/lang/String;
    ...
    invoke-static {p2, p0, p1}, Lcom/xiaomi/ai/log/Logger;->a(Ljava/lang/String;Ljava/lang/String;Z)V
...
.method public a(I)V
    ...
    invoke-static {v0, p0, p1}, Lcom/xiaomi/ai/log/Logger;->c(Ljava/lang/String;Ljava/lang/String;Z)V

    return-void

    :cond_0
    iput p1, p0, Lcom/xiaomi/ai/android/track/f;->c:I
...
.method public a(Landroid/content/Context;Ljava/lang/String;Ljava/lang/String;Ljava/lang/String;Z)V
    ...
    invoke-static {p1, p2, p3, p4}, Lcom/xiaomi/ai/android/utils/SharedPreferencesUtils;->writeKeyValue(Landroid/content/Context;Ljava/lang/String;Ljava/lang/String;Ljava/lang/String;)V
...
.method public a(Landroid/content/Context;Ljava/lang/String;Z)V
    ...
    invoke-static {p1, p2}, Lcom/xiaomi/ai/android/utils/SharedPreferencesUtils;->clearKeyValues(Landroid/content/Context;Ljava/lang/String;)V
...
.method public b(Landroid/content/Context;Ljava/lang/String;Ljava/lang/String;Z)V
    ...
    invoke-static {p1, p2, p3}, Lcom/xiaomi/ai/android/utils/SharedPreferencesUtils;->removeKeyValue(Landroid/content/Context;Ljava/lang/String;Ljava/lang/String;)V
    ...
    invoke-virtual {p0, p3}, Lcom/xiaomi/ai/android/track/e;->c(Ljava/lang/String;)V
