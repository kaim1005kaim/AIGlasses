...
.method public constructor <init>(Lcom/xiaomi/ai/android/core/Engine;Lokhttp3/OkHttpClient$Builder;)V
    ...
    invoke-virtual {p2}, Lcom/xiaomi/ai/android/core/e;->o()Lokhttp3/OkHttpClient$Builder;
    ...
    invoke-virtual {p2, v1, v2, v0}, Lokhttp3/OkHttpClient$Builder;->k(JLjava/util/concurrent/TimeUnit;)Lokhttp3/OkHttpClient$Builder;

    move-result-object p2

    invoke-virtual {p2, v1, v2, v0}, Lokhttp3/OkHttpClient$Builder;->j0(JLjava/util/concurrent/TimeUnit;)Lokhttp3/OkHttpClient$Builder;

    move-result-object p2

    invoke-virtual {p2, v1, v2, v0}, Lokhttp3/OkHttpClient$Builder;->R0(JLjava/util/concurrent/TimeUnit;)Lokhttp3/OkHttpClient$Builder;

    move-result-object p2

    :cond_0
    new-instance v0, Lcom/xiaomi/ai/android/helper/AuthorizationHttpHelper$a;

    invoke-direct {v0, p0, p1}, Lcom/xiaomi/ai/android/helper/AuthorizationHttpHelper$a;-><init>(Lcom/xiaomi/ai/android/helper/AuthorizationHttpHelper;Lcom/xiaomi/ai/android/core/Engine;)V
...
.method static synthetic a(Lcom/xiaomi/ai/android/helper/AuthorizationHttpHelper;Lokhttp3/Request;)Z
    .locals 0
