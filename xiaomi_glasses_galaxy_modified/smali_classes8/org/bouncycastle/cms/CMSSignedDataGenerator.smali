...
.method public constructor <init>()V
    ...
    iput-object v0, p0, Lorg/bouncycastle/cms/CMSSignedDataGenerator;->D:Ljava/util/List;
...
# virtual methods
.method public m(Lorg/bouncycastle/cms/CMSTypedData;)Lorg/bouncycastle/cms/CMSSignedData;
    .locals 1
    ...
    invoke-virtual {p0, p1, v0}, Lorg/bouncycastle/cms/CMSSignedDataGenerator;->n(Lorg/bouncycastle/cms/CMSTypedData;Z)Lorg/bouncycastle/cms/CMSSignedData;
...
.method public n(Lorg/bouncycastle/cms/CMSTypedData;Z)Lorg/bouncycastle/cms/CMSSignedData;
    .locals 11
    .annotation system Ldalvik/annotation/Throws;
        value = {
            Lorg/bouncycastle/cms/CMSException;
    ...
    iget-object v0, p0, Lorg/bouncycastle/cms/CMSSignedDataGenerator;->D:Ljava/util/List;
    ...
    iget-object v2, p0, Lorg/bouncycastle/cms/CMSSignedGenerator;->e:Ljava/util/Map;
    ...
    :goto_1
    iget-object v5, p0, Lorg/bouncycastle/cms/CMSSignedGenerator;->d:Ljava/util/List;

    invoke-static {v5, v3}, Lorg/bouncycastle/cms/CMSUtils;->b(Ljava/util/Collection;Ljava/io/OutputStream;)Ljava/io/OutputStream;

    move-result-object v5

    invoke-static {v5}, Lorg/bouncycastle/cms/CMSUtils;->j(Ljava/io/OutputStream;)Ljava/io/OutputStream;

    move-result-object v5

    :try_start_0
    invoke-interface {p1, v5}, Lorg/bouncycastle/cms/CMSProcessable;->a(Ljava/io/OutputStream;)V
    ...
    invoke-virtual {v5, v2}, Lorg/bouncycastle/cms/SignerInfoGenerator;->a(Lorg/bouncycastle/asn1/ASN1ObjectIdentifier;)Lorg/bouncycastle/asn1/cms/SignerInfo;

    move-result-object v6

    invoke-virtual {v6}, Lorg/bouncycastle/asn1/cms/SignerInfo;->h()Lorg/bouncycastle/asn1/x509/AlgorithmIdentifier;
    ...
    invoke-virtual {v5}, Lorg/bouncycastle/cms/SignerInfoGenerator;->e()[B

    move-result-object v5

    if-eqz v5, :cond_3

    iget-object v7, p0, Lorg/bouncycastle/cms/CMSSignedGenerator;->e:Ljava/util/Map;

    invoke-virtual {v6}, Lorg/bouncycastle/asn1/cms/SignerInfo;->h()Lorg/bouncycastle/asn1/x509/AlgorithmIdentifier;

    move-result-object v6

    invoke-virtual {v6}, Lorg/bouncycastle/asn1/x509/AlgorithmIdentifier;->g()Lorg/bouncycastle/asn1/ASN1ObjectIdentifier;
    ...
    :cond_4
    iget-object v3, p0, Lorg/bouncycastle/cms/CMSSignedGenerator;->a:Ljava/util/List;
    ...
    invoke-static {v3}, Lorg/bouncycastle/cms/CMSUtils;->d(Ljava/util/List;)Lorg/bouncycastle/asn1/ASN1Set;
    ...
    :goto_4
    iget-object v3, p0, Lorg/bouncycastle/cms/CMSSignedGenerator;->b:Ljava/util/List;
    ...
    invoke-static {p0}, Lorg/bouncycastle/cms/CMSUtils;->d(Ljava/util/List;)Lorg/bouncycastle/asn1/ASN1Set;
    ...
    sget-object v0, Lorg/bouncycastle/asn1/cms/CMSObjectIdentifiers;->j1:Lorg/bouncycastle/asn1/ASN1ObjectIdentifier;

    invoke-direct {p2, v0, p0}, Lorg/bouncycastle/asn1/cms/ContentInfo;-><init>(Lorg/bouncycastle/asn1/ASN1ObjectIdentifier;Lorg/bouncycastle/asn1/ASN1Encodable;)V

    new-instance p0, Lorg/bouncycastle/cms/CMSSignedData;
...
.method public o(Lorg/bouncycastle/cms/SignerInformation;)Lorg/bouncycastle/cms/SignerInformationStore;
    .locals 2
    .annotation system Ldalvik/annotation/Throws;
        value = {
            Lorg/bouncycastle/cms/CMSException;
    ...
    invoke-virtual {p1}, Lorg/bouncycastle/cms/SignerInformation;->n()[B
    ...
    invoke-virtual {p0, v0, p1}, Lorg/bouncycastle/cms/CMSSignedDataGenerator;->n(Lorg/bouncycastle/cms/CMSTypedData;Z)Lorg/bouncycastle/cms/CMSSignedData;
