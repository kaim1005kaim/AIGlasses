...
# virtual methods
.method public a(Ljava/io/OutputStream;Lorg/bouncycastle/operator/OutputCompressor;)Ljava/io/OutputStream;
    .locals 1
    ...
    invoke-virtual {p0, v0, p1, p2}, Lorg/bouncycastle/cms/CMSCompressedDataStreamGenerator;->b(Lorg/bouncycastle/asn1/ASN1ObjectIdentifier;Ljava/io/OutputStream;Lorg/bouncycastle/operator/OutputCompressor;)Ljava/io/OutputStream;
...
.method public b(Lorg/bouncycastle/asn1/ASN1ObjectIdentifier;Ljava/io/OutputStream;Lorg/bouncycastle/operator/OutputCompressor;)Ljava/io/OutputStream;
    .locals 7
    .annotation system Ldalvik/annotation/Throws;
        value = {
            Ljava/io/IOException;
    ...
    sget-object p2, Lorg/bouncycastle/asn1/cms/CMSObjectIdentifiers;->q1:Lorg/bouncycastle/asn1/ASN1ObjectIdentifier;
    ...
    invoke-interface {p3}, Lorg/bouncycastle/operator/OutputCompressor;->a()Lorg/bouncycastle/asn1/x509/AlgorithmIdentifier;
    ...
    iget p2, p0, Lorg/bouncycastle/cms/CMSCompressedDataStreamGenerator;->a:I

    invoke-static {p1, v0, v1, p2}, Lorg/bouncycastle/cms/CMSUtils;->c(Ljava/io/OutputStream;IZI)Ljava/io/OutputStream;

    move-result-object p1

    new-instance p2, Lorg/bouncycastle/cms/CMSCompressedDataStreamGenerator$CmsCompressedOutputStream;

    invoke-interface {p3, p1}, Lorg/bouncycastle/operator/OutputCompressor;->b(Ljava/io/OutputStream;)Ljava/io/OutputStream;
...
.method public c(I)V
    ...
    iput p1, p0, Lorg/bouncycastle/cms/CMSCompressedDataStreamGenerator;->a:I
