...
.method public create()Landroidx/compose/foundation/ClickableSemanticsNode;
    ...
    .line 5
    iget-object v3, p0, Landroidx/compose/foundation/ClickableSemanticsElement;->onLongClickLabel:Ljava/lang/String;

    .line 6
    iget-object v4, p0, Landroidx/compose/foundation/ClickableSemanticsElement;->onLongClick:Lkotlin/jvm/functions/Function0;

    .line 7
    iget-object v5, p0, Landroidx/compose/foundation/ClickableSemanticsElement;->onClickLabel:Ljava/lang/String;

    .line 8
    iget-object v6, p0, Landroidx/compose/foundation/ClickableSemanticsElement;->onClick:Lkotlin/jvm/functions/Function0;
    ...
    .line 9
    invoke-direct/range {v0 .. v7}, Landroidx/compose/foundation/ClickableSemanticsNode;-><init>(ZLandroidx/compose/ui/semantics/Role;Ljava/lang/String;Lkotlin/jvm/functions/Function0;Ljava/lang/String;Lkotlin/jvm/functions/Function0;Lkotlin/jvm/internal/DefaultConstructorMarker;)V
...
.method public update(Landroidx/compose/foundation/ClickableSemanticsNode;)Landroidx/compose/foundation/ClickableSemanticsNode;
    .locals 1
    ...
    invoke-virtual {p1, v0}, Landroidx/compose/foundation/ClickableSemanticsNode;->setEnabled(Z)V

    .line 3
    iget-object v0, p0, Landroidx/compose/foundation/ClickableSemanticsElement;->role:Landroidx/compose/ui/semantics/Role;

    invoke-virtual {p1, v0}, Landroidx/compose/foundation/ClickableSemanticsNode;->setRole-ytANHLE(Landroidx/compose/ui/semantics/Role;)V

    .line 4
    iget-object v0, p0, Landroidx/compose/foundation/ClickableSemanticsElement;->onLongClickLabel:Ljava/lang/String;

    invoke-virtual {p1, v0}, Landroidx/compose/foundation/ClickableSemanticsNode;->setOnLongClickLabel(Ljava/lang/String;)V

    .line 5
    iget-object v0, p0, Landroidx/compose/foundation/ClickableSemanticsElement;->onLongClick:Lkotlin/jvm/functions/Function0;

    invoke-virtual {p1, v0}, Landroidx/compose/foundation/ClickableSemanticsNode;->setOnLongClick(Lkotlin/jvm/functions/Function0;)V

    .line 6
    iget-object v0, p0, Landroidx/compose/foundation/ClickableSemanticsElement;->onClickLabel:Ljava/lang/String;

    invoke-virtual {p1, v0}, Landroidx/compose/foundation/ClickableSemanticsNode;->setOnClickLabel(Ljava/lang/String;)V

    .line 7
    iget-object p0, p0, Landroidx/compose/foundation/ClickableSemanticsElement;->onClick:Lkotlin/jvm/functions/Function0;

    invoke-virtual {p1, p0}, Landroidx/compose/foundation/ClickableSemanticsNode;->setOnClick(Lkotlin/jvm/functions/Function0;)V
...
.method public bridge synthetic update(Landroidx/compose/ui/Modifier$Node;)Landroidx/compose/ui/Modifier$Node;
    ...
    invoke-virtual {p0, p1}, Landroidx/compose/foundation/ClickableSemanticsElement;->update(Landroidx/compose/foundation/ClickableSemanticsNode;)Landroidx/compose/foundation/ClickableSemanticsNode;
