...
# instance fields
.field protected l:Lorg/bouncycastle/crypto/tls/TlsSignerCredentials;
...
.method public constructor <init>(ILjava/util/Vector;[I[S[S)V
    ...
    iput-object p1, p0, Lorg/bouncycastle/crypto/tls/TlsECDHEKeyExchange;->l:Lorg/bouncycastle/crypto/tls/TlsSignerCredentials;
...
.method public b()[B
    ...
    iget-object v2, p0, Lorg/bouncycastle/crypto/tls/TlsECDHEKeyExchange;->l:Lorg/bouncycastle/crypto/tls/TlsSignerCredentials;
    ...
    iget-object p0, p0, Lorg/bouncycastle/crypto/tls/TlsECDHEKeyExchange;->l:Lorg/bouncycastle/crypto/tls/TlsSignerCredentials;
...
.method public l(Ljava/io/InputStream;)V
    ...
    iget-object v3, p0, Lorg/bouncycastle/crypto/tls/TlsECDHKeyExchange;->e:[I

    iget-object v4, p0, Lorg/bouncycastle/crypto/tls/TlsECDHKeyExchange;->f:[S

    invoke-static {v3, v4, v2}, Lorg/bouncycastle/crypto/tls/TlsECCUtils;->z([I[SLjava/io/InputStream;)Lorg/bouncycastle/crypto/params/ECDomainParameters;

    move-result-object v3

    invoke-static {v2}, Lorg/bouncycastle/crypto/tls/TlsUtils;->E0(Ljava/io/InputStream;)[B
    ...
    iget-object v4, p0, Lorg/bouncycastle/crypto/tls/TlsECDHKeyExchange;->d:Lorg/bouncycastle/crypto/tls/TlsSigner;
    ...
    invoke-virtual {p0, v4, v5, v0}, Lorg/bouncycastle/crypto/tls/TlsECDHEKeyExchange;->q(Lorg/bouncycastle/crypto/tls/TlsSigner;Lorg/bouncycastle/crypto/tls/SignatureAndHashAlgorithm;Lorg/bouncycastle/crypto/tls/SecurityParameters;)Lorg/bouncycastle/crypto/Signer;
    ...
    iget-object p1, p0, Lorg/bouncycastle/crypto/tls/TlsECDHKeyExchange;->f:[S

    invoke-static {p1, v3, v2}, Lorg/bouncycastle/crypto/tls/TlsECCUtils;->k([SLorg/bouncycastle/crypto/params/ECDomainParameters;[B)Lorg/bouncycastle/crypto/params/ECPublicKeyParameters;
...
.method public m(Lorg/bouncycastle/crypto/tls/TlsCredentials;)V
    ...
    invoke-virtual {p0, v0}, Lorg/bouncycastle/crypto/tls/TlsECDHKeyExchange;->i(Lorg/bouncycastle/crypto/tls/Certificate;)V
...
.method protected q(Lorg/bouncycastle/crypto/tls/TlsSigner;Lorg/bouncycastle/crypto/tls/SignatureAndHashAlgorithm;Lorg/bouncycastle/crypto/tls/SecurityParameters;)Lorg/bouncycastle/crypto/Signer;
    .locals 1

    iget-object p0, p0, Lorg/bouncycastle/crypto/tls/TlsECDHKeyExchange;->h:Lorg/bouncycastle/crypto/params/AsymmetricKeyParameter;
