...
.method public c(Lorg/bouncycastle/crypto/tls/SignatureAndHashAlgorithm;Lorg/bouncycastle/crypto/params/AsymmetricKeyParameter;)Lorg/bouncycastle/crypto/Signer;
    ...
    invoke-virtual {p0, p1, p2, v1, v0}, Lorg/bouncycastle/crypto/tls/TlsRSASigner;->l(Lorg/bouncycastle/crypto/tls/SignatureAndHashAlgorithm;ZZLorg/bouncycastle/crypto/CipherParameters;)Lorg/bouncycastle/crypto/Signer;
...
.method public e(Lorg/bouncycastle/crypto/tls/SignatureAndHashAlgorithm;Lorg/bouncycastle/crypto/params/AsymmetricKeyParameter;)Lorg/bouncycastle/crypto/Signer;
    ...
    invoke-virtual {p0, p1, v0, v0, p2}, Lorg/bouncycastle/crypto/tls/TlsRSASigner;->l(Lorg/bouncycastle/crypto/tls/SignatureAndHashAlgorithm;ZZLorg/bouncycastle/crypto/CipherParameters;)Lorg/bouncycastle/crypto/Signer;
...
.method public f(Lorg/bouncycastle/crypto/params/AsymmetricKeyParameter;)Z
    ...
    instance-of p0, p1, Lorg/bouncycastle/crypto/params/RSAKeyParameters;
...
.method public g(Lorg/bouncycastle/crypto/tls/SignatureAndHashAlgorithm;[BLorg/bouncycastle/crypto/params/AsymmetricKeyParameter;[B)Z
    ...
    invoke-virtual {p0, p1, v0, v1, p3}, Lorg/bouncycastle/crypto/tls/TlsRSASigner;->l(Lorg/bouncycastle/crypto/tls/SignatureAndHashAlgorithm;ZZLorg/bouncycastle/crypto/CipherParameters;)Lorg/bouncycastle/crypto/Signer;
...
.method public i(Lorg/bouncycastle/crypto/tls/SignatureAndHashAlgorithm;Lorg/bouncycastle/crypto/params/AsymmetricKeyParameter;[B)[B
    ...
    invoke-virtual {p0, p1, p2, p2, v0}, Lorg/bouncycastle/crypto/tls/TlsRSASigner;->l(Lorg/bouncycastle/crypto/tls/SignatureAndHashAlgorithm;ZZLorg/bouncycastle/crypto/CipherParameters;)Lorg/bouncycastle/crypto/Signer;
...
.method protected k()Lorg/bouncycastle/crypto/AsymmetricBlockCipher;
    .locals 1
...
.method protected l(Lorg/bouncycastle/crypto/tls/SignatureAndHashAlgorithm;ZZLorg/bouncycastle/crypto/CipherParameters;)Lorg/bouncycastle/crypto/Signer;
    .locals 3
    ...
    :goto_0
    iget-object v2, p0, Lorg/bouncycastle/crypto/tls/AbstractTlsSigner;->a:Lorg/bouncycastle/crypto/tls/TlsContext;
    ...
    invoke-static {p2}, Lorg/bouncycastle/crypto/tls/TlsUtils;->x(S)Lorg/bouncycastle/crypto/Digest;
    ...
    invoke-static {p1}, Lorg/bouncycastle/crypto/tls/TlsUtils;->T(S)Lorg/bouncycastle/asn1/ASN1ObjectIdentifier;

    move-result-object p1

    invoke-direct {p0, p2, p1}, Lorg/bouncycastle/crypto/signers/RSADigestSigner;-><init>(Lorg/bouncycastle/crypto/Digest;Lorg/bouncycastle/asn1/ASN1ObjectIdentifier;)V

    goto :goto_3

    :cond_5
    new-instance p1, Lorg/bouncycastle/crypto/signers/GenericSigner;

    invoke-virtual {p0}, Lorg/bouncycastle/crypto/tls/TlsRSASigner;->k()Lorg/bouncycastle/crypto/AsymmetricBlockCipher;

    move-result-object p0

    invoke-direct {p1, p0, p2}, Lorg/bouncycastle/crypto/signers/GenericSigner;-><init>(Lorg/bouncycastle/crypto/AsymmetricBlockCipher;Lorg/bouncycastle/crypto/Digest;)V

    move-object p0, p1

    :goto_3
    invoke-interface {p0, p3, p4}, Lorg/bouncycastle/crypto/Signer;->a(ZLorg/bouncycastle/crypto/CipherParameters;)V
