...
.method public constructor <init>(I)V
    ...
    iput-boolean v0, p0, Lorg/bouncycastle/crypto/tls/ByteQueue;->d:Z

    if-nez p1, :cond_0

    sget-object p1, Lorg/bouncycastle/crypto/tls/TlsUtils;->a:[B
    ...
    :goto_0
    iput-object p1, p0, Lorg/bouncycastle/crypto/tls/ByteQueue;->a:[B
...
.method public constructor <init>([BII)V
    ...
    iput p2, p0, Lorg/bouncycastle/crypto/tls/ByteQueue;->b:I

    iput p3, p0, Lorg/bouncycastle/crypto/tls/ByteQueue;->c:I

    const/4 p1, 0x1

    iput-boolean p1, p0, Lorg/bouncycastle/crypto/tls/ByteQueue;->d:Z
...
.method public a([BII)V
    ...
    iget-boolean v0, p0, Lorg/bouncycastle/crypto/tls/ByteQueue;->d:Z
    ...
    invoke-static {v1}, Lorg/bouncycastle/crypto/tls/ByteQueue;->d(I)I
    ...
    iget v4, p0, Lorg/bouncycastle/crypto/tls/ByteQueue;->c:I
    ...
    const-string p1, "Cannot add data to read-only buffer"
...
.method public b()I
    ...
    iget p0, p0, Lorg/bouncycastle/crypto/tls/ByteQueue;->c:I
...
.method public c(Ljava/io/OutputStream;I)V
    ...
    iget p0, p0, Lorg/bouncycastle/crypto/tls/ByteQueue;->b:I

    invoke-virtual {p1, v0, p0, p2}, Ljava/io/OutputStream;->write([BII)V
...
.method public f(I)Ljava/io/ByteArrayInputStream;
    ...
    iget-object p0, p0, Lorg/bouncycastle/crypto/tls/ByteQueue;->a:[B

    invoke-direct {v0, p0, v1, p1}, Ljava/io/ByteArrayInputStream;-><init>([BII)V
...
.method public h([BIII)V
    ...
    invoke-virtual {p0, p1, p2, p3, p4}, Lorg/bouncycastle/crypto/tls/ByteQueue;->e([BIII)V

    add-int/2addr p4, p3

    invoke-virtual {p0, p4}, Lorg/bouncycastle/crypto/tls/ByteQueue;->g(I)V
...
.method public i(II)[B
    ...
    invoke-virtual {p0, v0, v1, p1, p2}, Lorg/bouncycastle/crypto/tls/ByteQueue;->h([BIII)V
...
.method public j()V
    ...
    :cond_0
    invoke-static {v0}, Lorg/bouncycastle/crypto/tls/ByteQueue;->d(I)I
    ...
    iget v3, p0, Lorg/bouncycastle/crypto/tls/ByteQueue;->b:I
