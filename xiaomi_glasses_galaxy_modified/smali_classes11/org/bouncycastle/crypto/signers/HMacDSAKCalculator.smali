...
# instance fields
.field private final a:Lorg/bouncycastle/crypto/macs/HMac;
...
.method public constructor <init>(Lorg/bouncycastle/crypto/Digest;)V
    ...
    iput-object p1, p0, Lorg/bouncycastle/crypto/signers/HMacDSAKCalculator;->c:[B
...
.method private e([B)Ljava/math/BigInteger;
    ...
    iget-object p0, p0, Lorg/bouncycastle/crypto/signers/HMacDSAKCalculator;->d:Ljava/math/BigInteger;
...
.method public b()Ljava/math/BigInteger;
    ...
    iget-object v4, p0, Lorg/bouncycastle/crypto/signers/HMacDSAKCalculator;->a:Lorg/bouncycastle/crypto/macs/HMac;

    iget-object v5, p0, Lorg/bouncycastle/crypto/signers/HMacDSAKCalculator;->c:[B
    ...
    :cond_0
    invoke-direct {p0, v1}, Lorg/bouncycastle/crypto/signers/HMacDSAKCalculator;->e([B)Ljava/math/BigInteger;

    move-result-object v3

    sget-object v4, Lorg/bouncycastle/crypto/signers/HMacDSAKCalculator;->e:Ljava/math/BigInteger;
    ...
    iget-object v4, p0, Lorg/bouncycastle/crypto/signers/HMacDSAKCalculator;->d:Ljava/math/BigInteger;
    ...
    :cond_1
    iget-object v3, p0, Lorg/bouncycastle/crypto/signers/HMacDSAKCalculator;->a:Lorg/bouncycastle/crypto/macs/HMac;
    ...
    iget-object v4, p0, Lorg/bouncycastle/crypto/signers/HMacDSAKCalculator;->b:[B
    ...
    iget-object v5, p0, Lorg/bouncycastle/crypto/signers/HMacDSAKCalculator;->b:[B

    invoke-direct {v4, v5}, Lorg/bouncycastle/crypto/params/KeyParameter;-><init>([B)V

    invoke-virtual {v3, v4}, Lorg/bouncycastle/crypto/macs/HMac;->a(Lorg/bouncycastle/crypto/CipherParameters;)V
...
.method public d(Ljava/math/BigInteger;Ljava/math/BigInteger;[B)V
    ...
    iget-object v0, p0, Lorg/bouncycastle/crypto/signers/HMacDSAKCalculator;->b:[B
    ...
    invoke-static {p2}, Lorg/bouncycastle/util/BigIntegers;->b(Ljava/math/BigInteger;)[B
    ...
    invoke-direct {p0, p3}, Lorg/bouncycastle/crypto/signers/HMacDSAKCalculator;->e([B)Ljava/math/BigInteger;
    ...
    :cond_0
    invoke-static {p3}, Lorg/bouncycastle/util/BigIntegers;->b(Ljava/math/BigInteger;)[B
    ...
    iget-object p1, p0, Lorg/bouncycastle/crypto/signers/HMacDSAKCalculator;->a:Lorg/bouncycastle/crypto/macs/HMac;
    ...
    invoke-virtual {p1, p3}, Lorg/bouncycastle/crypto/macs/HMac;->a(Lorg/bouncycastle/crypto/CipherParameters;)V

    iget-object p1, p0, Lorg/bouncycastle/crypto/signers/HMacDSAKCalculator;->a:Lorg/bouncycastle/crypto/macs/HMac;

    iget-object p3, p0, Lorg/bouncycastle/crypto/signers/HMacDSAKCalculator;->c:[B
    ...
    iget-object p3, p0, Lorg/bouncycastle/crypto/signers/HMacDSAKCalculator;->b:[B
    ...
    iget-object p2, p0, Lorg/bouncycastle/crypto/signers/HMacDSAKCalculator;->b:[B
    ...
    invoke-virtual {p1, p2}, Lorg/bouncycastle/crypto/macs/HMac;->a(Lorg/bouncycastle/crypto/CipherParameters;)V

    iget-object p1, p0, Lorg/bouncycastle/crypto/signers/HMacDSAKCalculator;->a:Lorg/bouncycastle/crypto/macs/HMac;

    iget-object p2, p0, Lorg/bouncycastle/crypto/signers/HMacDSAKCalculator;->c:[B
    ...
    iget-object p0, p0, Lorg/bouncycastle/crypto/signers/HMacDSAKCalculator;->c:[B

    invoke-virtual {p1, p0, v2}, Lorg/bouncycastle/crypto/macs/HMac;->doFinal([BI)I
