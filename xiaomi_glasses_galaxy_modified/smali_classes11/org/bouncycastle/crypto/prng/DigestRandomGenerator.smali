...
.method private d()V
    ...
    invoke-direct {p0, v0}, Lorg/bouncycastle/crypto/prng/DigestRandomGenerator;->g([B)V
    ...
    invoke-direct {p0, v0, v1}, Lorg/bouncycastle/crypto/prng/DigestRandomGenerator;->e(J)V

    iget-object v0, p0, Lorg/bouncycastle/crypto/prng/DigestRandomGenerator;->e:[B

    invoke-direct {p0, v0}, Lorg/bouncycastle/crypto/prng/DigestRandomGenerator;->f([B)V
...
.method private f([B)V
    ...
    iget-object p0, p0, Lorg/bouncycastle/crypto/prng/DigestRandomGenerator;->c:Lorg/bouncycastle/crypto/Digest;
...
.method private h()V
    ...
    sget-wide v2, Lorg/bouncycastle/crypto/prng/DigestRandomGenerator;->f:J
    ...
    invoke-direct {p0}, Lorg/bouncycastle/crypto/prng/DigestRandomGenerator;->d()V
...
.method public a([BII)V
    ...
    :try_start_0
    invoke-direct {p0}, Lorg/bouncycastle/crypto/prng/DigestRandomGenerator;->h()V
...
.method public b(J)V
    ...
    :try_start_0
    invoke-direct {p0, p1, p2}, Lorg/bouncycastle/crypto/prng/DigestRandomGenerator;->e(J)V

    iget-object p1, p0, Lorg/bouncycastle/crypto/prng/DigestRandomGenerator;->e:[B

    invoke-direct {p0, p1}, Lorg/bouncycastle/crypto/prng/DigestRandomGenerator;->g([B)V

    iget-object p1, p0, Lorg/bouncycastle/crypto/prng/DigestRandomGenerator;->e:[B

    invoke-direct {p0, p1}, Lorg/bouncycastle/crypto/prng/DigestRandomGenerator;->f([B)V
...
.method public nextBytes([B)V
    ...
    invoke-virtual {p0, p1, v1, v0}, Lorg/bouncycastle/crypto/prng/DigestRandomGenerator;->a([BII)V
