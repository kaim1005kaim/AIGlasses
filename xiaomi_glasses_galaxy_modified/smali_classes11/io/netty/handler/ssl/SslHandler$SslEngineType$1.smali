...
.method allocateWrapBuffer(Lio/netty/handler/ssl/SslHandler;Lio/netty/buffer/ByteBufAllocator;II)Lio/netty/buffer/ByteBuf;
    ...
    invoke-virtual {p0, p3, p4}, Lio/netty/handler/ssl/ReferenceCountedOpenSslEngine;->calculateMaxLengthForWrap(II)I
...
.method calculatePendingData(Lio/netty/handler/ssl/SslHandler;I)I
    ...
    invoke-virtual {p0}, Lio/netty/handler/ssl/ReferenceCountedOpenSslEngine;->sslPending()I
...
.method jdkCompatibilityMode(Ljavax/net/ssl/SSLEngine;)Z
    ...
    iget-boolean p0, p1, Lio/netty/handler/ssl/ReferenceCountedOpenSslEngine;->jdkCompatibilityMode:Z
...
.method unwrap(Lio/netty/handler/ssl/SslHandler;Lio/netty/buffer/ByteBuf;ILio/netty/buffer/ByteBuf;)Ljavax/net/ssl/SSLEngineResult;
    ...
    invoke-virtual {p0, p2, p3}, Lio/netty/handler/ssl/ReferenceCountedOpenSslEngine;->unwrap([Ljava/nio/ByteBuffer;[Ljava/nio/ByteBuffer;)Ljavax/net/ssl/SSLEngineResult;
    ...
    :goto_0
    invoke-virtual {p0}, Ljavax/net/ssl/SSLEngineResult;->bytesProduced()I
