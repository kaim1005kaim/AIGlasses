...
.method public constructor <init>()V
    ...
    invoke-direct {v1, v0}, Lio/netty/channel/PreferHeapByteBufAllocator;-><init>(Lio/netty/buffer/ByteBufAllocator;)V

    invoke-interface {p0, v1}, Lio/netty/channel/ChannelConfig;->setAllocator(Lio/netty/buffer/ByteBufAllocator;)Lio/netty/channel/ChannelConfig;
...
.method private finishPeerRead0(Lio/netty/channel/local/LocalChannel;)V
    ...
    invoke-static {p0, p1, v0, v1}, Landroidx/concurrent/futures/a;->a(Ljava/util/concurrent/atomic/AtomicReferenceFieldUpdater;Ljava/lang/Object;Ljava/lang/Object;Ljava/lang/Object;)Z

    :cond_1
    iget-boolean p0, p1, Lio/netty/channel/local/LocalChannel;->readInProgress:Z

    if-eqz p0, :cond_2

    iget-object p0, p1, Lio/netty/channel/local/LocalChannel;->inboundBuffer:Ljava/util/Queue;
    ...
    iput-boolean p0, p1, Lio/netty/channel/local/LocalChannel;->readInProgress:Z
...
.method protected doBeginRead()V
    ...
    iget-object p0, p0, Lio/netty/channel/local/LocalChannel;->peer:Lio/netty/channel/local/LocalChannel;
