...
.method private recycle(Lio/netty/channel/PendingWriteQueue$PendingWrite;Z)V
    ...
    iget-object p0, p0, Lio/netty/channel/PendingWriteQueue;->tracker:Lio/netty/channel/PendingBytesTracker;

    invoke-virtual {p0, v1, v2}, Lio/netty/channel/PendingBytesTracker;->decrementPendingOutboundBytes(J)V
...
.method private size(Ljava/lang/Object;)I
    ...
    invoke-virtual {p0, p1}, Lio/netty/channel/PendingBytesTracker;->size(Ljava/lang/Object;)I
    ...
    .line 3
    :cond_0
    sget p1, Lio/netty/channel/PendingWriteQueue;->PENDING_WRITE_OVERHEAD:I
...
.method public add(Ljava/lang/Object;Lio/netty/channel/ChannelPromise;)V
    ...
    invoke-virtual {p0, p1, p2}, Lio/netty/channel/PendingBytesTracker;->incrementPendingOutboundBytes(J)V
...
.method public removeAndWrite()Lio/netty/channel/ChannelFuture;
    ...
    iget-object p0, p0, Lio/netty/channel/PendingWriteQueue;->invoker:Lio/netty/channel/ChannelOutboundInvoker;
