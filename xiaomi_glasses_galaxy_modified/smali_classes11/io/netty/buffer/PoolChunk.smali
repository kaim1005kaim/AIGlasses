...
.method private allocateRun(I)J
    ...
    iget v0, p0, Lio/netty/buffer/PoolChunk;->pinnedBytes:I

    add-int/2addr v0, p1

    iput v0, p0, Lio/netty/buffer/PoolChunk;->pinnedBytes:I
...
.method private allocateSubpage(I)J
    ...
    iget-object p0, p0, Lio/netty/buffer/PoolChunk;->subpages:[Lio/netty/buffer/PoolSubpage;
...
.method free(JILjava/nio/ByteBuffer;)V
    ...
    iget v1, p0, Lio/netty/buffer/PoolChunk;->pinnedBytes:I

    sub-int/2addr v1, v0

    iput v1, p0, Lio/netty/buffer/PoolChunk;->pinnedBytes:I
...
.method initBuf(Lio/netty/buffer/PooledByteBuf;Ljava/nio/ByteBuffer;JILio/netty/buffer/PoolThreadCache;)V
    ...
    invoke-static {v2, p3, p4}, Lio/netty/buffer/PoolChunk;->runSize(IJ)I
...
.method public pinnedBytes()I
    ...
    :try_start_0
    iget p0, p0, Lio/netty/buffer/PoolChunk;->pinnedBytes:I
