...
.method static constructor <clinit>()V
    ...
    new-instance v0, Lorg/kodein/di/internal/KodeinContainerBuilderImpl$OverrideMode$ALLOW_SILENT;

    const-string v1, "ALLOW_SILENT"

    const/4 v2, 0x0

    invoke-direct {v0, v1, v2}, Lorg/kodein/di/internal/KodeinContainerBuilderImpl$OverrideMode$ALLOW_SILENT;-><init>(Ljava/lang/String;I)V

    sput-object v0, Lorg/kodein/di/internal/KodeinContainerBuilderImpl$OverrideMode;->ALLOW_SILENT:Lorg/kodein/di/internal/KodeinContainerBuilderImpl$OverrideMode;

    new-instance v1, Lorg/kodein/di/internal/KodeinContainerBuilderImpl$OverrideMode$ALLOW_EXPLICIT;

    const-string v3, "ALLOW_EXPLICIT"

    const/4 v4, 0x1

    invoke-direct {v1, v3, v4}, Lorg/kodein/di/internal/KodeinContainerBuilderImpl$OverrideMode$ALLOW_EXPLICIT;-><init>(Ljava/lang/String;I)V
    ...
    new-instance v3, Lorg/kodein/di/internal/KodeinContainerBuilderImpl$OverrideMode$FORBID;

    const-string v5, "FORBID"

    const/4 v6, 0x2

    invoke-direct {v3, v5, v6}, Lorg/kodein/di/internal/KodeinContainerBuilderImpl$OverrideMode$FORBID;-><init>(Ljava/lang/String;I)V

    sput-object v3, Lorg/kodein/di/internal/KodeinContainerBuilderImpl$OverrideMode;->FORBID:Lorg/kodein/di/internal/KodeinContainerBuilderImpl$OverrideMode;

    const/4 v5, 0x3

    new-array v5, v5, [Lorg/kodein/di/internal/KodeinContainerBuilderImpl$OverrideMode;
    ...
    sput-object v5, Lorg/kodein/di/internal/KodeinContainerBuilderImpl$OverrideMode;->$VALUES:[Lorg/kodein/di/internal/KodeinContainerBuilderImpl$OverrideMode;
