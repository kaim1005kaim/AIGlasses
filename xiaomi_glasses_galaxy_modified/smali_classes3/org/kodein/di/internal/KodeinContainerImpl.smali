...
.method private final bindingKodein(Lorg/kodein/di/Kodein$Key;Lorg/kodein/di/KodeinContext;Lorg/kodein/di/KodeinTree;I)Lorg/kodein/di/bindings/BindingKodein;
    ...
    iget-boolean p0, p0, Lorg/kodein/di/internal/KodeinContainerImpl;->fullDescriptionOnError:Z

    invoke-direct {v0, p3, v1, p0}, Lorg/kodein/di/internal/KodeinContainerImpl;-><init>(Lorg/kodein/di/KodeinTree;Lorg/kodein/di/internal/KodeinContainerImpl$Node;Z)V

    new-instance p0, Lorg/kodein/di/internal/BindingKodeinImpl;

    new-instance p3, Lorg/kodein/di/internal/DKodeinImpl;

    invoke-direct {p3, v0, p2}, Lorg/kodein/di/internal/DKodeinImpl;-><init>(Lorg/kodein/di/KodeinContainer;Lorg/kodein/di/KodeinContext;)V

    invoke-interface {p2}, Lorg/kodein/di/KodeinContext;->getValue()Ljava/lang/Object;

    move-result-object p2

    invoke-direct {p0, p3, p1, p2, p4}, Lorg/kodein/di/internal/BindingKodeinImpl;-><init>(Lorg/kodein/di/DKodein;Lorg/kodein/di/Kodein$Key;Ljava/lang/Object;I)V
...
.method public allFactories(Lorg/kodein/di/Kodein$Key;Ljava/lang/Object;I)Ljava/util/List;
    ...
    invoke-virtual {v3}, Lorg/kodein/di/KodeinDefining;->getBinding()Lorg/kodein/di/bindings/KodeinBinding;

    move-result-object v3

    invoke-interface {v3, v2, p1}, Lorg/kodein/di/bindings/Binding;->getFactory(Lorg/kodein/di/bindings/BindingKodein;Lorg/kodein/di/Kodein$Key;)Lkotlin/jvm/functions/Function1;
    ...
    const-string p1, "null cannot be cast to non-null type org.kodein.di.KodeinContext<kotlin.Any>"
...
.method public factory(Lorg/kodein/di/Kodein$Key;Ljava/lang/Object;I)Lkotlin/jvm/functions/Function1;
    ...
    invoke-static {v7, v1}, Lkotlin/jvm/internal/Intrinsics;->q(Ljava/lang/Object;Ljava/lang/String;)V
    ...
    invoke-interface {v1, v0, v7}, Lorg/kodein/di/bindings/Binding;->getFactory(Lorg/kodein/di/bindings/BindingKodein;Lorg/kodein/di/Kodein$Key;)Lkotlin/jvm/functions/Function1;
    ...
    const-string v1, "null cannot be cast to non-null type org.kodein.di.KodeinContext<kotlin.Any>"
    ...
    iget-object v0, v0, Lorg/kodein/di/internal/KodeinContainerImpl;->node:Lorg/kodein/di/internal/KodeinContainerImpl$Node;

    if-eqz v0, :cond_5

    invoke-virtual {v0, v7, v9}, Lorg/kodein/di/internal/KodeinContainerImpl$Node;->check$kodein_di_core(Lorg/kodein/di/Kodein$Key;I)V

    :cond_5
    invoke-static {v6, v4}, Lkotlin/jvm/internal/TypeIntrinsics;->q(Ljava/lang/Object;I)Ljava/lang/Object;
    ...
    invoke-static {v2, v9}, Lkotlin/collections/CollectionsKt;->b0(Ljava/lang/Iterable;I)I

    move-result v6

    invoke-static {v6}, Lkotlin/collections/MapsKt;->j(I)I

    move-result v6

    invoke-static {v6, v8}, Lkotlin/ranges/RangesKt;->u(II)I
    ...
    invoke-virtual {v6}, Lkotlin/Triple;->f()Ljava/lang/Object;

    move-result-object v9

    invoke-virtual {v6}, Lkotlin/Triple;->g()Ljava/lang/Object;
    ...
    invoke-direct {v1, v7, v0}, Lorg/kodein/di/Kodein$NotFoundException;-><init>(Lorg/kodein/di/Kodein$Key;Ljava/lang/String;)V
    ...
    invoke-static {v1, v9}, Lkotlin/collections/CollectionsKt;->b0(Ljava/lang/Iterable;I)I
    ...
    invoke-static {v2, v8}, Lkotlin/ranges/RangesKt;->u(II)I
    ...
    invoke-virtual {v2}, Lkotlin/Triple;->f()Ljava/lang/Object;
    ...
    :cond_10
    new-instance v0, Lorg/kodein/di/Kodein$NotFoundException;
    ...
    const-string v4, "Other bindings registered in Kodein:\n"
    ...
    invoke-direct {v0, v7, v1}, Lorg/kodein/di/Kodein$NotFoundException;-><init>(Lorg/kodein/di/Kodein$Key;Ljava/lang/String;)V
...
.method public factoryOrNull(Lorg/kodein/di/Kodein$Key;Ljava/lang/Object;I)Lkotlin/jvm/functions/Function1;
    ...
    iget-object v3, p0, Lorg/kodein/di/internal/KodeinContainerImpl;->node:Lorg/kodein/di/internal/KodeinContainerImpl$Node;

    if-eqz v3, :cond_0

    invoke-virtual {v3, p1, v2}, Lorg/kodein/di/internal/KodeinContainerImpl$Node;->check$kodein_di_core(Lorg/kodein/di/Kodein$Key;I)V
    ...
    invoke-interface {p2, p0, p1}, Lorg/kodein/di/bindings/Binding;->getFactory(Lorg/kodein/di/bindings/BindingKodein;Lorg/kodein/di/Kodein$Key;)Lkotlin/jvm/functions/Function1;
    ...
    iget-object p0, p0, Lorg/kodein/di/internal/KodeinContainerImpl;->node:Lorg/kodein/di/internal/KodeinContainerImpl$Node;

    if-eqz p0, :cond_5

    invoke-virtual {p0, p1, v2}, Lorg/kodein/di/internal/KodeinContainerImpl$Node;->check$kodein_di_core(Lorg/kodein/di/Kodein$Key;I)V
...
.method public getTree()Lorg/kodein/di/KodeinTree;
    ...
    iget-object p0, p0, Lorg/kodein/di/internal/KodeinContainerImpl;->tree:Lorg/kodein/di/KodeinTree;
