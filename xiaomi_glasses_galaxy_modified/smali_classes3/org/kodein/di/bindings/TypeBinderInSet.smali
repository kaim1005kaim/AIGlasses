...
.method public constructor <init>(Lorg/kodein/di/Kodein$Builder$TypeBinder;Lorg/kodein/di/TypeToken;)V
    .locals 1
    .param p1    # Lorg/kodein/di/Kodein$Builder$TypeBinder;
...
.method public final with(Lorg/kodein/di/bindings/KodeinBinding;)V
    ...
    iget-object p0, p0, Lorg/kodein/di/bindings/TypeBinderInSet;->_binder:Lorg/kodein/di/Kodein$Builder$TypeBinder;

    check-cast p0, Lorg/kodein/di/internal/KodeinBuilderImpl$TypeBinder;
    ...
    check-cast p0, Lorg/kodein/di/KodeinDefining;

    if-eqz p0, :cond_3

    invoke-virtual {p0}, Lorg/kodein/di/KodeinDefining;->getBinding()Lorg/kodein/di/bindings/KodeinBinding;
    ...
    invoke-virtual {p0}, Lorg/kodein/di/bindings/BaseMultiBinding;->getSet$kodein_di_core()Ljava/util/Set;

    move-result-object p0

    if-eqz p0, :cond_1

    invoke-static {p0}, Lkotlin/jvm/internal/TypeIntrinsics;->o(Ljava/lang/Object;)Ljava/util/Set;
    ...
    const-string p1, "null cannot be cast to non-null type kotlin.collections.MutableSet<org.kodein.di.bindings.KodeinBinding<*, *, *>>"
    ...
    const-string p1, "null cannot be cast to non-null type org.kodein.di.internal.KodeinBuilderImpl.TypeBinder<T>"
