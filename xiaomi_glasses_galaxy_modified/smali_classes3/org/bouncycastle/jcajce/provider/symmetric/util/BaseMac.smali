...
.method static constructor <clinit>()V
    ...
    sput-object v0, Lorg/bouncycastle/jcajce/provider/symmetric/util/BaseMac;->e:Ljava/lang/Class;
...
.method protected constructor <init>(Lorg/bouncycastle/crypto/Mac;)V
    ...
    iput v0, p0, Lorg/bouncycastle/jcajce/provider/symmetric/util/BaseMac;->b:I

    const/4 v0, 0x1

    iput v0, p0, Lorg/bouncycastle/jcajce/provider/symmetric/util/BaseMac;->c:I

    const/16 v0, 0xa0

    iput v0, p0, Lorg/bouncycastle/jcajce/provider/symmetric/util/BaseMac;->d:I
...
.method protected constructor <init>(Lorg/bouncycastle/crypto/Mac;III)V
    ...
    iput p2, p0, Lorg/bouncycastle/jcajce/provider/symmetric/util/BaseMac;->b:I

    iput p3, p0, Lorg/bouncycastle/jcajce/provider/symmetric/util/BaseMac;->c:I

    iput p4, p0, Lorg/bouncycastle/jcajce/provider/symmetric/util/BaseMac;->d:I
...
.method protected engineDoFinal()[B
    ...
    iget-object p0, p0, Lorg/bouncycastle/jcajce/provider/symmetric/util/BaseMac;->a:Lorg/bouncycastle/crypto/Mac;
...
.method protected engineInit(Ljava/security/Key;Ljava/security/spec/AlgorithmParameterSpec;)V
    ...
    :goto_1
    invoke-static {v0, v3, v2, v4, v1}, Lorg/bouncycastle/jcajce/provider/symmetric/util/PBE$Util;->c(Ljavax/crypto/SecretKey;IIILjavax/crypto/spec/PBEParameterSpec;)Lorg/bouncycastle/crypto/CipherParameters;
    ...
    invoke-virtual {v0}, Lorg/bouncycastle/jcajce/provider/symmetric/util/BCPBEKey;->e()Lorg/bouncycastle/crypto/CipherParameters;
    ...
    invoke-virtual {v1}, Lorg/bouncycastle/crypto/params/ParametersWithIV;->b()Lorg/bouncycastle/crypto/CipherParameters;
    ...
    invoke-virtual {p2}, Lorg/bouncycastle/jcajce/spec/AEADParameterSpec;->c()[B
    ...
    invoke-virtual {v1}, Lorg/bouncycastle/crypto/params/KeyParameter;->a()[B
    ...
    invoke-virtual {p2}, Lorg/bouncycastle/jcajce/spec/SkeinParameterSpec;->e()Ljava/util/Map;

    move-result-object p2

    invoke-static {p2}, Lorg/bouncycastle/jcajce/provider/symmetric/util/BaseMac;->a(Ljava/util/Map;)Ljava/util/Hashtable;
    ...
    invoke-virtual {p1, p2}, Lorg/bouncycastle/crypto/params/SkeinParameters$Builder;->c([B)Lorg/bouncycastle/crypto/params/SkeinParameters$Builder;
    ...
    :cond_11
    sget-object p1, Lorg/bouncycastle/jcajce/provider/symmetric/util/BaseMac;->e:Ljava/lang/Class;
    ...
    invoke-interface {p0, v0}, Lorg/bouncycastle/crypto/Mac;->a(Lorg/bouncycastle/crypto/CipherParameters;)V
    :try_end_3
