...
.method private static a(Lorg/bouncycastle/jcajce/spec/TLSKeyMaterialSpec;)[B
    .locals 9
    ...
    invoke-virtual {p0}, Lorg/bouncycastle/jcajce/spec/TLSKeyMaterialSpec;->a()Ljava/lang/String;

    move-result-object v2

    invoke-static {v2}, Lorg/bouncycastle/util/Strings;->h(Ljava/lang/String;)[B

    move-result-object v2

    invoke-virtual {p0}, Lorg/bouncycastle/jcajce/spec/TLSKeyMaterialSpec;->d()[B

    move-result-object v3

    invoke-static {v2, v3}, Lorg/bouncycastle/util/Arrays;->x([B[B)[B

    move-result-object v2

    invoke-virtual {p0}, Lorg/bouncycastle/jcajce/spec/TLSKeyMaterialSpec;->c()[B
    ...
    invoke-virtual {p0}, Lorg/bouncycastle/jcajce/spec/TLSKeyMaterialSpec;->b()I
    ...
    invoke-static {v0, v5, v2, v3}, Lorg/bouncycastle/jcajce/provider/symmetric/TLSKDF;->d(Lorg/bouncycastle/crypto/Mac;[B[B[B)V

    invoke-static {v1, v6, v2, v4}, Lorg/bouncycastle/jcajce/provider/symmetric/TLSKDF;->d(Lorg/bouncycastle/crypto/Mac;[B[B[B)V
...
.method static synthetic b(Lorg/bouncycastle/jcajce/spec/TLSKeyMaterialSpec;)[B
    .locals 0

    invoke-static {p0}, Lorg/bouncycastle/jcajce/provider/symmetric/TLSKDF;->a(Lorg/bouncycastle/jcajce/spec/TLSKeyMaterialSpec;)[B
...
.method static synthetic c(Lorg/bouncycastle/crypto/Mac;[B[B[B)V
    .locals 0

    invoke-static {p0, p1, p2, p3}, Lorg/bouncycastle/jcajce/provider/symmetric/TLSKDF;->d(Lorg/bouncycastle/crypto/Mac;[B[B[B)V

    return-void
.end method

.method private static d(Lorg/bouncycastle/crypto/Mac;[B[B[B)V
    .locals 8
