...
.method static constructor <clinit>()V
    ...
    sput-object v0, Lorg/bouncycastle/jce/provider/CertPathValidatorUtilities;->s:[Ljava/lang/String;
...
.method protected static A(I[Ljava/util/List;Lorg/bouncycastle/asn1/ASN1ObjectIdentifier;Ljava/util/Set;)V
    .locals 11
...
.method protected static B(Lorg/bouncycastle/jce/provider/PKIXPolicyNode;[Ljava/util/List;Lorg/bouncycastle/jce/provider/PKIXPolicyNode;)Lorg/bouncycastle/jce/provider/PKIXPolicyNode;
    .locals 2
    ...
    invoke-static {p1, p2}, Lorg/bouncycastle/jce/provider/CertPathValidatorUtilities;->C([Ljava/util/List;Lorg/bouncycastle/jce/provider/PKIXPolicyNode;)V

    return-object p0
.end method

.method private static C([Ljava/util/List;Lorg/bouncycastle/jce/provider/PKIXPolicyNode;)V
    .locals 1
    ...
    invoke-static {p0, v0}, Lorg/bouncycastle/jce/provider/CertPathValidatorUtilities;->C([Ljava/util/List;Lorg/bouncycastle/jce/provider/PKIXPolicyNode;)V
...
.method protected static D(Ljava/security/cert/X509Certificate;Ljava/security/PublicKey;Ljava/lang/String;)V
    .locals 0
...
.method static a(Ljava/util/Set;Ljava/lang/Object;)V
    .locals 3
    .annotation system Ldalvik/annotation/Throws;
        value = {
    ...
    sget-object v1, Lorg/bouncycastle/asn1/x500/style/RFC4519Style;->V:Lorg/bouncycastle/asn1/x500/X500NameStyle;

    invoke-static {p1}, Lorg/bouncycastle/jce/provider/PrincipalUtils;->d(Ljava/security/cert/X509Certificate;)Lorg/bouncycastle/asn1/x500/X500Name;

    move-result-object p1

    invoke-interface {v1, p1}, Lorg/bouncycastle/asn1/x500/X500NameStyle;->h(Lorg/bouncycastle/asn1/x500/X500Name;)Ljava/lang/String;
...
.method protected static b(Lorg/bouncycastle/jcajce/PKIXCertStoreSelector;Ljava/util/List;)Ljava/util/Collection;
    .locals 3
    .annotation system Ldalvik/annotation/Throws;
        value = {
            Lorg/bouncycastle/jce/provider/AnnotatedException;
...
.method static c(Ljava/security/cert/X509Certificate;Ljava/util/List;Ljava/util/List;)Ljava/util/Collection;
    ...
    :try_start_1
    sget-object v1, Lorg/bouncycastle/jce/provider/CertPathValidatorUtilities;->n:Ljava/lang/String;
    ...
    invoke-virtual {p0}, Lorg/bouncycastle/asn1/x509/AuthorityKeyIdentifier;->l()[B
    ...
    invoke-static {p0, p2}, Lorg/bouncycastle/jce/provider/CertPathValidatorUtilities;->b(Lorg/bouncycastle/jcajce/PKIXCertStoreSelector;Ljava/util/List;)Ljava/util/Collection;
...
.method protected static d(Ljava/security/cert/X509Certificate;Ljava/util/Set;)Ljava/security/cert/TrustAnchor;
    .locals 1
    .annotation system Ldalvik/annotation/Throws;
        value = {
            Lorg/bouncycastle/jce/provider/AnnotatedException;
    ...
    invoke-static {p0, p1, v0}, Lorg/bouncycastle/jce/provider/CertPathValidatorUtilities;->e(Ljava/security/cert/X509Certificate;Ljava/util/Set;Ljava/lang/String;)Ljava/security/cert/TrustAnchor;
...
.method protected static e(Ljava/security/cert/X509Certificate;Ljava/util/Set;Ljava/lang/String;)Ljava/security/cert/TrustAnchor;
    ...
    invoke-static {p0}, Lorg/bouncycastle/jce/provider/PrincipalUtils;->b(Ljava/lang/Object;)Lorg/bouncycastle/asn1/x500/X500Name;
    ...
    :try_start_1
    invoke-static {v3}, Lorg/bouncycastle/jce/provider/PrincipalUtils;->a(Ljava/security/cert/TrustAnchor;)Lorg/bouncycastle/asn1/x500/X500Name;
    ...
    :try_start_2
    invoke-static {p0, v5, p2}, Lorg/bouncycastle/jce/provider/CertPathValidatorUtilities;->D(Ljava/security/cert/X509Certificate;Ljava/security/PublicKey;Ljava/lang/String;)V
    :try_end_2
...
.method static f([BLjava/util/Map;)Ljava/util/List;
    .locals 3
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "([B",
...
.method static g(Lorg/bouncycastle/asn1/x509/CRLDistPoint;Ljava/util/Map;)Ljava/util/List;
    .locals 6
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "(",
    ...
    invoke-virtual {v3}, Lorg/bouncycastle/asn1/x509/DistributionPoint;->i()Lorg/bouncycastle/asn1/x509/DistributionPointName;

    move-result-object v3

    if-eqz v3, :cond_1

    invoke-virtual {v3}, Lorg/bouncycastle/asn1/x509/DistributionPointName;->k()I

    move-result v4

    if-nez v4, :cond_1

    invoke-virtual {v3}, Lorg/bouncycastle/asn1/x509/DistributionPointName;->j()Lorg/bouncycastle/asn1/ASN1Encodable;
...
.method protected static h(Ljava/security/PublicKey;)Lorg/bouncycastle/asn1/x509/AlgorithmIdentifier;
    .locals 2
    .annotation system Ldalvik/annotation/Throws;
        value = {
...
.method protected static i(Lorg/bouncycastle/asn1/x509/DistributionPoint;Ljava/util/Collection;Ljava/security/cert/X509CRLSelector;)V
    .locals 3
    .annotation system Ldalvik/annotation/Throws;
        value = {
            Lorg/bouncycastle/jce/provider/AnnotatedException;
...
.method protected static j(Ljava/util/Date;Ljava/security/cert/X509CRL;Ljava/lang/Object;Lorg/bouncycastle/jce/provider/CertStatus;)V
    .locals 5
    .annotation system Ldalvik/annotation/Throws;
        value = {
            Lorg/bouncycastle/jce/provider/AnnotatedException;
    ...
    :try_start_0
    invoke-static {p1}, Lorg/bouncycastle/jce/provider/X509CRLObject;->f(Ljava/security/cert/X509CRL;)Z
    ...
    invoke-static {p2}, Lorg/bouncycastle/jce/provider/CertPathValidatorUtilities;->q(Ljava/lang/Object;)Ljava/math/BigInteger;
    ...
    :goto_0
    invoke-static {p2}, Lorg/bouncycastle/jce/provider/PrincipalUtils;->b(Ljava/lang/Object;)Lorg/bouncycastle/asn1/x500/X500Name;
    ...
    :try_start_1
    sget-object p1, Lorg/bouncycastle/asn1/x509/Extension;->l:Lorg/bouncycastle/asn1/ASN1ObjectIdentifier;

    invoke-virtual {p1}, Lorg/bouncycastle/asn1/ASN1ObjectIdentifier;->r()Ljava/lang/String;

    move-result-object p1

    invoke-static {v0, p1}, Lorg/bouncycastle/jce/provider/CertPathValidatorUtilities;->m(Ljava/security/cert/X509Extension;Ljava/lang/String;)Lorg/bouncycastle/asn1/ASN1Primitive;
    ...
    :goto_2
    invoke-virtual {p3, p0}, Lorg/bouncycastle/jce/provider/CertStatus;->c(I)V
    ...
    invoke-virtual {p3, p0}, Lorg/bouncycastle/jce/provider/CertStatus;->d(Ljava/util/Date;)V
...
.method protected static k(Lorg/bouncycastle/asn1/x509/DistributionPoint;Ljava/lang/Object;Ljava/util/Date;Lorg/bouncycastle/jcajce/PKIXExtendedParameters;)Ljava/util/Set;
    .locals 3
    .annotation system Ldalvik/annotation/Throws;
        value = {
            Lorg/bouncycastle/jce/provider/AnnotatedException;
    ...
    invoke-static {p0, v1, v0}, Lorg/bouncycastle/jce/provider/CertPathValidatorUtilities;->i(Lorg/bouncycastle/asn1/x509/DistributionPoint;Ljava/util/Collection;Ljava/security/cert/X509CRLSelector;)V
    :try_end_0
    ...
    invoke-virtual {p0, v0}, Lorg/bouncycastle/jcajce/PKIXCRLStoreSelector$Builder;->h(Z)Lorg/bouncycastle/jcajce/PKIXCRLStoreSelector$Builder;

    move-result-object p0

    invoke-virtual {p0}, Lorg/bouncycastle/jcajce/PKIXCRLStoreSelector$Builder;->g()Lorg/bouncycastle/jcajce/PKIXCRLStoreSelector;

    move-result-object p0

    invoke-virtual {p3}, Lorg/bouncycastle/jcajce/PKIXExtendedParameters;->n()Ljava/util/Date;
    ...
    :cond_1
    sget-object v0, Lorg/bouncycastle/jce/provider/CertPathValidatorUtilities;->a:Lorg/bouncycastle/jce/provider/PKIXCRLUtil;

    invoke-virtual {p3}, Lorg/bouncycastle/jcajce/PKIXExtendedParameters;->l()Ljava/util/List;

    move-result-object v1

    invoke-virtual {p3}, Lorg/bouncycastle/jcajce/PKIXExtendedParameters;->j()Ljava/util/List;

    move-result-object p3

    invoke-virtual {v0, p0, p2, v1, p3}, Lorg/bouncycastle/jce/provider/PKIXCRLUtil;->b(Lorg/bouncycastle/jcajce/PKIXCRLStoreSelector;Ljava/util/Date;Ljava/util/List;Ljava/util/List;)Ljava/util/Set;

    move-result-object p0

    invoke-static {p0, p1}, Lorg/bouncycastle/jce/provider/CertPathValidatorUtilities;->a(Ljava/util/Set;Ljava/lang/Object;)V
...
.method protected static l(Ljava/util/Date;Ljava/security/cert/X509CRL;Ljava/util/List;Ljava/util/List;)Ljava/util/Set;
    .locals 4
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "(",
    ...
    :try_start_1
    sget-object v1, Lorg/bouncycastle/jce/provider/CertPathValidatorUtilities;->p:Ljava/lang/String;

    invoke-static {p1, v1}, Lorg/bouncycastle/jce/provider/CertPathValidatorUtilities;->m(Ljava/security/cert/X509Extension;Ljava/lang/String;)Lorg/bouncycastle/asn1/ASN1Primitive;
    ...
    invoke-virtual {v2, p1}, Lorg/bouncycastle/jcajce/PKIXCRLStoreSelector$Builder;->j([B)V

    const/4 p1, 0x1

    invoke-virtual {v2, p1}, Lorg/bouncycastle/jcajce/PKIXCRLStoreSelector$Builder;->k(Z)V

    invoke-virtual {v2, v1}, Lorg/bouncycastle/jcajce/PKIXCRLStoreSelector$Builder;->l(Ljava/math/BigInteger;)V

    invoke-virtual {v2}, Lorg/bouncycastle/jcajce/PKIXCRLStoreSelector$Builder;->g()Lorg/bouncycastle/jcajce/PKIXCRLStoreSelector;

    move-result-object p1

    sget-object v0, Lorg/bouncycastle/jce/provider/CertPathValidatorUtilities;->a:Lorg/bouncycastle/jce/provider/PKIXCRLUtil;

    invoke-virtual {v0, p1, p0, p2, p3}, Lorg/bouncycastle/jce/provider/PKIXCRLUtil;->b(Lorg/bouncycastle/jcajce/PKIXCRLStoreSelector;Ljava/util/Date;Ljava/util/List;Ljava/util/List;)Ljava/util/Set;
    ...
    invoke-static {p2}, Lorg/bouncycastle/jce/provider/CertPathValidatorUtilities;->u(Ljava/security/cert/X509CRL;)Z
...
.method protected static m(Ljava/security/cert/X509Extension;Ljava/lang/String;)Lorg/bouncycastle/asn1/ASN1Primitive;
    .locals 0
    .annotation system Ldalvik/annotation/Throws;
        value = {
            Lorg/bouncycastle/jce/provider/AnnotatedException;
    ...
    :cond_0
    invoke-static {p1, p0}, Lorg/bouncycastle/jce/provider/CertPathValidatorUtilities;->o(Ljava/lang/String;[B)Lorg/bouncycastle/asn1/ASN1Primitive;
...
.method protected static n(Ljava/util/List;ILorg/bouncycastle/jcajce/util/JcaJceHelper;)Ljava/security/PublicKey;
    .locals 4
    .annotation system Ldalvik/annotation/Throws;
        value = {
            Ljava/security/cert/CertPathValidatorException;
    ...
    invoke-interface {p2, p0}, Lorg/bouncycastle/jcajce/util/JcaJceHelper;->a(Ljava/lang/String;)Ljava/security/KeyFactory;
...
.method private static o(Ljava/lang/String;[B)Lorg/bouncycastle/asn1/ASN1Primitive;
    .locals 3
    .annotation system Ldalvik/annotation/Throws;
        value = {
            Lorg/bouncycastle/jce/provider/AnnotatedException;
...
.method protected static final p(Lorg/bouncycastle/asn1/ASN1Sequence;)Ljava/util/Set;
    .locals 5
    .annotation system Ldalvik/annotation/Throws;
        value = {
            Ljava/security/cert/CertPathValidatorException;
...
.method private static q(Ljava/lang/Object;)Ljava/math/BigInteger;
    .locals 0
...
.method protected static r(Lorg/bouncycastle/jcajce/PKIXExtendedParameters;Ljava/security/cert/CertPath;I)Ljava/util/Date;
    .locals 3
    .annotation system Ldalvik/annotation/Throws;
        value = {
            Lorg/bouncycastle/jce/provider/AnnotatedException;
    ...
    invoke-virtual {p0}, Lorg/bouncycastle/jcajce/PKIXExtendedParameters;->u()I
    ...
    invoke-static {p0}, Lorg/bouncycastle/jce/provider/CertPathValidatorUtilities;->s(Lorg/bouncycastle/jcajce/PKIXExtendedParameters;)Ljava/util/Date;
...
.method protected static s(Lorg/bouncycastle/jcajce/PKIXExtendedParameters;)Ljava/util/Date;
    .locals 0

    invoke-virtual {p0}, Lorg/bouncycastle/jcajce/PKIXExtendedParameters;->n()Ljava/util/Date;
...
.method protected static t(Ljava/util/Set;)Z
    .locals 1
...
.method private static u(Ljava/security/cert/X509CRL;)Z
    .locals 1
...
.method static v(Ljava/security/cert/X509Certificate;Ljava/util/Set;Ljava/lang/String;)Z
    .locals 1
    .annotation system Ldalvik/annotation/Throws;
        value = {
            Lorg/bouncycastle/jce/provider/AnnotatedException;
    ...
    :try_start_0
    invoke-static {p0, p1, p2}, Lorg/bouncycastle/jce/provider/CertPathValidatorUtilities;->e(Ljava/security/cert/X509Certificate;Ljava/util/Set;Ljava/lang/String;)Ljava/security/cert/TrustAnchor;
...
.method protected static w(Ljava/security/cert/X509Certificate;)Z
    .locals 1
...
.method protected static x(I[Ljava/util/List;Ljava/lang/String;Ljava/util/Map;Ljava/security/cert/X509Certificate;)V
    .locals 11
    .annotation system Ldalvik/annotation/Throws;
        value = {
            Lorg/bouncycastle/jce/provider/AnnotatedException;,
    ...
    iput-object v0, v3, Lorg/bouncycastle/jce/provider/PKIXPolicyNode;->c:Ljava/util/Set;
    ...
    :try_start_0
    sget-object v2, Lorg/bouncycastle/jce/provider/CertPathValidatorUtilities;->b:Ljava/lang/String;

    invoke-static {p4, v2}, Lorg/bouncycastle/jce/provider/CertPathValidatorUtilities;->m(Ljava/security/cert/X509Extension;Ljava/lang/String;)Lorg/bouncycastle/asn1/ASN1Primitive;
    ...
    invoke-static {v2}, Lorg/bouncycastle/jce/provider/CertPathValidatorUtilities;->p(Lorg/bouncycastle/asn1/ASN1Sequence;)Ljava/util/Set;
    ...
    sget-object v4, Lorg/bouncycastle/jce/provider/CertPathValidatorUtilities;->b:Ljava/lang/String;
...
.method protected static y(I[Ljava/util/List;Ljava/lang/String;Lorg/bouncycastle/jce/provider/PKIXPolicyNode;)Lorg/bouncycastle/jce/provider/PKIXPolicyNode;
    .locals 6
    ...
    invoke-static {p3, p1, v4}, Lorg/bouncycastle/jce/provider/CertPathValidatorUtilities;->B(Lorg/bouncycastle/jce/provider/PKIXPolicyNode;[Ljava/util/List;Lorg/bouncycastle/jce/provider/PKIXPolicyNode;)Lorg/bouncycastle/jce/provider/PKIXPolicyNode;
...
.method protected static z(I[Ljava/util/List;Lorg/bouncycastle/asn1/ASN1ObjectIdentifier;Ljava/util/Set;)Z
    .locals 12
