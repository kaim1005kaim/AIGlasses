...
# static fields
.field private static final a:Lorg/bouncycastle/jce/provider/PKIXCRLUtil;
...
.method static constructor <clinit>()V
    ...
    sput-object v0, Lorg/bouncycastle/jce/provider/RFC3280CertPathUtilities;->a:Lorg/bouncycastle/jce/provider/PKIXCRLUtil;
    ...
    sput-object v0, Lorg/bouncycastle/jce/provider/RFC3280CertPathUtilities;->s:[Ljava/lang/String;
...
.method protected static A(Ljava/util/Date;Ljava/security/cert/X509CRL;Ljava/lang/Object;Lorg/bouncycastle/jce/provider/CertStatus;)V
    .locals 2
    ...
    invoke-virtual {p3}, Lorg/bouncycastle/jce/provider/CertStatus;->a()I
    ...
    invoke-static {p0, p1, p2, p3}, Lorg/bouncycastle/jce/provider/CertPathValidatorUtilities;->j(Ljava/util/Date;Ljava/security/cert/X509CRL;Ljava/lang/Object;Lorg/bouncycastle/jce/provider/CertStatus;)V

    :cond_0
    return-void
.end method

.method protected static B(Ljava/security/cert/CertPath;Lorg/bouncycastle/jcajce/PKIXExtendedParameters;ILjava/security/PublicKey;ZLorg/bouncycastle/asn1/x500/X500Name;Ljava/security/cert/X509Certificate;Lorg/bouncycastle/jcajce/util/JcaJceHelper;)V
    .locals 12
    .annotation system Ldalvik/annotation/Throws;
        value = {
    ...
    :try_start_0
    invoke-virtual {p1}, Lorg/bouncycastle/jcajce/PKIXExtendedParameters;->r()Ljava/lang/String;

    move-result-object v3

    move-object v6, p3

    invoke-static {v11, p3, v3}, Lorg/bouncycastle/jce/provider/CertPathValidatorUtilities;->D(Ljava/security/cert/X509Certificate;Ljava/security/PublicKey;Ljava/lang/String;)V
    :try_end_0
    ...
    :goto_0
    :try_start_1
    invoke-static {p1, p0, p2}, Lorg/bouncycastle/jce/provider/CertPathValidatorUtilities;->r(Lorg/bouncycastle/jcajce/PKIXExtendedParameters;Ljava/security/cert/CertPath;I)Ljava/util/Date;
    ...
    :cond_2
    :goto_2
    invoke-static {v11}, Lorg/bouncycastle/jce/provider/PrincipalUtils;->b(Ljava/lang/Object;)Lorg/bouncycastle/asn1/x500/X500Name;
...
.method protected static C(Ljava/security/cert/CertPath;ILorg/bouncycastle/jce/provider/PKIXNameConstraintValidator;)V
    .locals 7
    .annotation system Ldalvik/annotation/Throws;
        value = {
    ...
    invoke-static {v1}, Lorg/bouncycastle/jce/provider/CertPathValidatorUtilities;->w(Ljava/security/cert/X509Certificate;)Z
    ...
    :cond_0
    invoke-static {v1}, Lorg/bouncycastle/jce/provider/PrincipalUtils;->e(Ljava/security/cert/X509Certificate;)Lorg/bouncycastle/asn1/x500/X500Name;
    ...
    :try_start_1
    invoke-virtual {p2, v0}, Lorg/bouncycastle/jce/provider/PKIXNameConstraintValidator;->k(Lorg/bouncycastle/asn1/ASN1Sequence;)V

    invoke-virtual {p2, v0}, Lorg/bouncycastle/jce/provider/PKIXNameConstraintValidator;->d(Lorg/bouncycastle/asn1/ASN1Sequence;)V
    :try_end_1
    ...
    invoke-static {v1, v2}, Lorg/bouncycastle/jce/provider/CertPathValidatorUtilities;->m(Ljava/security/cert/X509Extension;Ljava/lang/String;)Lorg/bouncycastle/asn1/ASN1Primitive;
    ...
    invoke-virtual {v0, v2}, Lorg/bouncycastle/asn1/x500/X500Name;->m(Lorg/bouncycastle/asn1/ASN1ObjectIdentifier;)[Lorg/bouncycastle/asn1/x500/RDN;
    ...
    invoke-virtual {v4}, Lorg/bouncycastle/asn1/x500/AttributeTypeAndValue;->i()Lorg/bouncycastle/asn1/ASN1Encodable;
    ...
    :try_start_3
    invoke-virtual {p2, v5}, Lorg/bouncycastle/jce/provider/PKIXNameConstraintValidator;->i(Lorg/bouncycastle/asn1/x509/GeneralName;)V

    invoke-virtual {p2, v5}, Lorg/bouncycastle/jce/provider/PKIXNameConstraintValidator;->b(Lorg/bouncycastle/asn1/x509/GeneralName;)V
    :try_end_3
    ...
    invoke-virtual {p2, v1}, Lorg/bouncycastle/jce/provider/PKIXNameConstraintValidator;->i(Lorg/bouncycastle/asn1/x509/GeneralName;)V

    aget-object v1, v0, v2

    invoke-virtual {p2, v1}, Lorg/bouncycastle/jce/provider/PKIXNameConstraintValidator;->b(Lorg/bouncycastle/asn1/x509/GeneralName;)V
    :try_end_5
...
.method protected static D(Ljava/security/cert/CertPath;ILjava/util/Set;Lorg/bouncycastle/jce/provider/PKIXPolicyNode;[Ljava/util/List;I)Lorg/bouncycastle/jce/provider/PKIXPolicyNode;
    .locals 18
    .annotation system Ldalvik/annotation/Throws;
        value = {
            Ljava/security/cert/CertPathValidatorException;
    ...
    :try_start_0
    sget-object v6, Lorg/bouncycastle/jce/provider/RFC3280CertPathUtilities;->b:Ljava/lang/String;

    invoke-static {v5, v6}, Lorg/bouncycastle/jce/provider/CertPathValidatorUtilities;->m(Ljava/security/cert/X509Extension;Ljava/lang/String;)Lorg/bouncycastle/asn1/ASN1Primitive;
    ...
    invoke-virtual {v6}, Lorg/bouncycastle/asn1/ASN1Sequence;->r()Ljava/util/Enumeration;
    ...
    invoke-static {v9}, Lorg/bouncycastle/asn1/x509/PolicyInformation;->g(Ljava/lang/Object;)Lorg/bouncycastle/asn1/x509/PolicyInformation;

    move-result-object v9

    invoke-virtual {v9}, Lorg/bouncycastle/asn1/x509/PolicyInformation;->h()Lorg/bouncycastle/asn1/ASN1ObjectIdentifier;
    ...
    :try_start_1
    invoke-virtual {v9}, Lorg/bouncycastle/asn1/x509/PolicyInformation;->i()Lorg/bouncycastle/asn1/ASN1Sequence;

    move-result-object v9

    invoke-static {v9}, Lorg/bouncycastle/jce/provider/CertPathValidatorUtilities;->p(Lorg/bouncycastle/asn1/ASN1Sequence;)Ljava/util/Set;

    move-result-object v9
    :try_end_1
    .catch Ljava/security/cert/CertPathValidatorException; {:try_start_1 .. :try_end_1} :catch_0

    invoke-static {v14, v3, v11, v9}, Lorg/bouncycastle/jce/provider/CertPathValidatorUtilities;->z(I[Ljava/util/List;Lorg/bouncycastle/asn1/ASN1ObjectIdentifier;Ljava/util/Set;)Z

    move-result v10

    if-nez v10, :cond_0

    invoke-static {v14, v3, v11, v9}, Lorg/bouncycastle/jce/provider/CertPathValidatorUtilities;->A(I[Ljava/util/List;Lorg/bouncycastle/asn1/ASN1ObjectIdentifier;Ljava/util/Set;)V
    ...
    invoke-static {v5}, Lorg/bouncycastle/jce/provider/CertPathValidatorUtilities;->w(Ljava/security/cert/X509Certificate;)Z
    ...
    invoke-static {v1}, Lorg/bouncycastle/jce/provider/CertPathValidatorUtilities;->p(Lorg/bouncycastle/asn1/ASN1Sequence;)Ljava/util/Set;
    ...
    invoke-virtual {v15, v0}, Lorg/bouncycastle/jce/provider/PKIXPolicyNode;->a(Lorg/bouncycastle/jce/provider/PKIXPolicyNode;)V
    ...
    invoke-virtual {v6}, Lorg/bouncycastle/jce/provider/PKIXPolicyNode;->c()Z

    move-result v7

    if-nez v7, :cond_e

    invoke-static {v0, v3, v6}, Lorg/bouncycastle/jce/provider/CertPathValidatorUtilities;->B(Lorg/bouncycastle/jce/provider/PKIXPolicyNode;[Ljava/util/List;Lorg/bouncycastle/jce/provider/PKIXPolicyNode;)Lorg/bouncycastle/jce/provider/PKIXPolicyNode;
    ...
    invoke-virtual {v4, v1}, Lorg/bouncycastle/jce/provider/PKIXPolicyNode;->e(Z)V
...
.method protected static E(Ljava/security/cert/CertPath;ILorg/bouncycastle/jce/provider/PKIXPolicyNode;)Lorg/bouncycastle/jce/provider/PKIXPolicyNode;
    .locals 2
    .annotation system Ldalvik/annotation/Throws;
        value = {
            Ljava/security/cert/CertPathValidatorException;
    ...
    invoke-static {v0, v1}, Lorg/bouncycastle/jce/provider/CertPathValidatorUtilities;->m(Ljava/security/cert/X509Extension;Ljava/lang/String;)Lorg/bouncycastle/asn1/ASN1Primitive;
...
.method protected static F(Ljava/security/cert/CertPath;ILorg/bouncycastle/jce/provider/PKIXPolicyNode;I)V
    .locals 1
    .annotation system Ldalvik/annotation/Throws;
        value = {
            Ljava/security/cert/CertPathValidatorException;
...
.method protected static G(ILjava/security/cert/X509Certificate;)I
    .locals 0

    invoke-static {p1}, Lorg/bouncycastle/jce/provider/CertPathValidatorUtilities;->w(Ljava/security/cert/X509Certificate;)Z
...
.method protected static I(Ljava/security/cert/CertPath;ILjava/util/List;Ljava/util/Set;)V
    .locals 2
    .annotation system Ldalvik/annotation/Throws;
        value = {
            Ljava/security/cert/CertPathValidatorException;
...
.method protected static J(Ljava/security/cert/CertPath;Lorg/bouncycastle/jcajce/PKIXExtendedParameters;Ljava/util/Set;I[Ljava/util/List;Lorg/bouncycastle/jce/provider/PKIXPolicyNode;Ljava/util/Set;)Lorg/bouncycastle/jce/provider/PKIXPolicyNode;
    .locals 6
    .annotation system Ldalvik/annotation/Throws;
        value = {
            Ljava/security/cert/CertPathValidatorException;
    ...
    invoke-virtual {p1}, Lorg/bouncycastle/jcajce/PKIXExtendedParameters;->w()Z
    ...
    :cond_1
    invoke-static {p2}, Lorg/bouncycastle/jce/provider/CertPathValidatorUtilities;->t(Ljava/util/Set;)Z
    ...
    invoke-virtual {p2}, Lorg/bouncycastle/jce/provider/PKIXPolicyNode;->c()Z

    move-result p3

    if-nez p3, :cond_6

    invoke-static {p5, p4, p2}, Lorg/bouncycastle/jce/provider/CertPathValidatorUtilities;->B(Lorg/bouncycastle/jce/provider/PKIXPolicyNode;[Ljava/util/List;Lorg/bouncycastle/jce/provider/PKIXPolicyNode;)Lorg/bouncycastle/jce/provider/PKIXPolicyNode;
    ...
    invoke-static {p5, p4, p1}, Lorg/bouncycastle/jce/provider/CertPathValidatorUtilities;->B(Lorg/bouncycastle/jce/provider/PKIXPolicyNode;[Ljava/util/List;Lorg/bouncycastle/jce/provider/PKIXPolicyNode;)Lorg/bouncycastle/jce/provider/PKIXPolicyNode;
...
.method private static a(Lorg/bouncycastle/asn1/x509/DistributionPoint;Lorg/bouncycastle/jcajce/PKIXExtendedParameters;Ljava/security/cert/X509Certificate;Ljava/util/Date;Ljava/security/cert/X509Certificate;Ljava/security/PublicKey;Lorg/bouncycastle/jce/provider/CertStatus;Lorg/bouncycastle/jce/provider/ReasonsMask;Ljava/util/List;Lorg/bouncycastle/jcajce/util/JcaJceHelper;)V
    ...
    invoke-static {v1, v10, v14, v9}, Lorg/bouncycastle/jce/provider/CertPathValidatorUtilities;->k(Lorg/bouncycastle/asn1/x509/DistributionPoint;Ljava/lang/Object;Ljava/util/Date;Lorg/bouncycastle/jcajce/PKIXExtendedParameters;)Ljava/util/Set;
    ...
    invoke-virtual/range {p6 .. p6}, Lorg/bouncycastle/jce/provider/CertStatus;->a()I
    ...
    invoke-virtual/range {p7 .. p7}, Lorg/bouncycastle/jce/provider/ReasonsMask;->e()Z
    ...
    invoke-static {v7, v1}, Lorg/bouncycastle/jce/provider/RFC3280CertPathUtilities;->v(Ljava/security/cert/X509CRL;Lorg/bouncycastle/asn1/x509/DistributionPoint;)Lorg/bouncycastle/jce/provider/ReasonsMask;

    move-result-object v6

    invoke-virtual {v6, v13}, Lorg/bouncycastle/jce/provider/ReasonsMask;->c(Lorg/bouncycastle/jce/provider/ReasonsMask;)Z
    ...
    :try_start_1
    invoke-static/range {v2 .. v8}, Lorg/bouncycastle/jce/provider/RFC3280CertPathUtilities;->w(Ljava/security/cert/X509CRL;Ljava/lang/Object;Ljava/security/cert/X509Certificate;Ljava/security/PublicKey;Lorg/bouncycastle/jcajce/PKIXExtendedParameters;Ljava/util/List;Lorg/bouncycastle/jcajce/util/JcaJceHelper;)Ljava/util/Set;

    move-result-object v2

    invoke-static {v15, v2}, Lorg/bouncycastle/jce/provider/RFC3280CertPathUtilities;->x(Ljava/security/cert/X509CRL;Ljava/util/Set;)Ljava/security/PublicKey;

    move-result-object v2

    invoke-virtual/range {p1 .. p1}, Lorg/bouncycastle/jcajce/PKIXExtendedParameters;->n()Ljava/util/Date;
    ...
    :goto_1
    invoke-virtual/range {p1 .. p1}, Lorg/bouncycastle/jcajce/PKIXExtendedParameters;->z()Z

    move-result v4

    if-eqz v4, :cond_2

    invoke-virtual/range {p1 .. p1}, Lorg/bouncycastle/jcajce/PKIXExtendedParameters;->l()Ljava/util/List;

    move-result-object v4

    invoke-virtual/range {p1 .. p1}, Lorg/bouncycastle/jcajce/PKIXExtendedParameters;->j()Ljava/util/List;

    move-result-object v5

    invoke-static {v3, v15, v4, v5}, Lorg/bouncycastle/jce/provider/CertPathValidatorUtilities;->l(Ljava/util/Date;Ljava/security/cert/X509CRL;Ljava/util/List;Ljava/util/List;)Ljava/util/Set;

    move-result-object v3

    invoke-static {v3, v2}, Lorg/bouncycastle/jce/provider/RFC3280CertPathUtilities;->y(Ljava/util/Set;Ljava/security/PublicKey;)Ljava/security/cert/X509CRL;
    ...
    :goto_2
    invoke-virtual/range {p1 .. p1}, Lorg/bouncycastle/jcajce/PKIXExtendedParameters;->u()I
    ...
    :cond_4
    :goto_3
    invoke-static {v1, v10, v15}, Lorg/bouncycastle/jce/provider/RFC3280CertPathUtilities;->s(Lorg/bouncycastle/asn1/x509/DistributionPoint;Ljava/lang/Object;Ljava/security/cert/X509CRL;)V

    invoke-static {v1, v10, v15}, Lorg/bouncycastle/jce/provider/RFC3280CertPathUtilities;->t(Lorg/bouncycastle/asn1/x509/DistributionPoint;Ljava/lang/Object;Ljava/security/cert/X509CRL;)V

    invoke-static {v2, v15, v9}, Lorg/bouncycastle/jce/provider/RFC3280CertPathUtilities;->u(Ljava/security/cert/X509CRL;Ljava/security/cert/X509CRL;Lorg/bouncycastle/jcajce/PKIXExtendedParameters;)V

    invoke-static {v11, v2, v10, v12, v9}, Lorg/bouncycastle/jce/provider/RFC3280CertPathUtilities;->z(Ljava/util/Date;Ljava/security/cert/X509CRL;Ljava/lang/Object;Lorg/bouncycastle/jce/provider/CertStatus;Lorg/bouncycastle/jcajce/PKIXExtendedParameters;)V

    invoke-static {v11, v15, v10, v12}, Lorg/bouncycastle/jce/provider/RFC3280CertPathUtilities;->A(Ljava/util/Date;Ljava/security/cert/X509CRL;Ljava/lang/Object;Lorg/bouncycastle/jce/provider/CertStatus;)V
    ...
    invoke-virtual {v12, v0}, Lorg/bouncycastle/jce/provider/CertStatus;->c(I)V

    :cond_5
    invoke-virtual {v13, v14}, Lorg/bouncycastle/jce/provider/ReasonsMask;->a(Lorg/bouncycastle/jce/provider/ReasonsMask;)V
...
.method protected static b(Lorg/bouncycastle/jcajce/PKIXExtendedParameters;Ljava/security/cert/X509Certificate;Ljava/util/Date;Ljava/security/cert/X509Certificate;Ljava/security/PublicKey;Ljava/util/List;Lorg/bouncycastle/jcajce/util/JcaJceHelper;)V
    .locals 20
    .annotation system Ldalvik/annotation/Throws;
        value = {
            Lorg/bouncycastle/jce/provider/AnnotatedException;
    ...
    invoke-static {v11, v0}, Lorg/bouncycastle/jce/provider/CertPathValidatorUtilities;->m(Ljava/security/cert/X509Extension;Ljava/lang/String;)Lorg/bouncycastle/asn1/ASN1Primitive;
    ...
    :try_start_1
    invoke-virtual/range {p0 .. p0}, Lorg/bouncycastle/jcajce/PKIXExtendedParameters;->p()Ljava/util/Map;

    move-result-object v2

    invoke-static {v0, v2}, Lorg/bouncycastle/jce/provider/CertPathValidatorUtilities;->g(Lorg/bouncycastle/asn1/x509/CRLDistPoint;Ljava/util/Map;)Ljava/util/List;
    ...
    invoke-virtual {v1, v3}, Lorg/bouncycastle/jcajce/PKIXExtendedParameters$Builder;->l(Lorg/bouncycastle/jcajce/PKIXCRLStore;)Lorg/bouncycastle/jcajce/PKIXExtendedParameters$Builder;
    :try_end_1
    .catch Lorg/bouncycastle/jce/provider/AnnotatedException; {:try_start_1 .. :try_end_1} :catch_0
    ...
    :try_start_2
    invoke-virtual {v0}, Lorg/bouncycastle/asn1/x509/CRLDistPoint;->g()[Lorg/bouncycastle/asn1/x509/DistributionPoint;
    ...
    invoke-virtual {v13}, Lorg/bouncycastle/jce/provider/CertStatus;->a()I

    move-result v1

    if-ne v1, v9, :cond_1

    invoke-virtual {v14}, Lorg/bouncycastle/jce/provider/ReasonsMask;->e()Z
    ...
    invoke-static/range {p1 .. p1}, Lorg/bouncycastle/jce/provider/PrincipalUtils;->b(Ljava/lang/Object;)Lorg/bouncycastle/asn1/x500/X500Name;
    ...
    invoke-virtual {v13, v1}, Lorg/bouncycastle/jce/provider/CertStatus;->c(I)V
    ...
    invoke-virtual {v13}, Lorg/bouncycastle/jce/provider/CertStatus;->b()Ljava/util/Date;
    ...
    sget-object v0, Lorg/bouncycastle/jce/provider/RFC3280CertPathUtilities;->s:[Ljava/lang/String;
...
.method protected static c(Ljava/security/cert/CertPath;I[Ljava/util/List;Lorg/bouncycastle/jce/provider/PKIXPolicyNode;I)Lorg/bouncycastle/jce/provider/PKIXPolicyNode;
    .locals 18
    .annotation system Ldalvik/annotation/Throws;
        value = {
            Ljava/security/cert/CertPathValidatorException;
    ...
    invoke-static {v4, v5}, Lorg/bouncycastle/jce/provider/CertPathValidatorUtilities;->m(Ljava/security/cert/X509Extension;Ljava/lang/String;)Lorg/bouncycastle/asn1/ASN1Primitive;

    move-result-object v5

    invoke-static {v5}, Lorg/bouncycastle/asn1/ASN1Sequence;->n(Ljava/lang/Object;)Lorg/bouncycastle/asn1/ASN1Sequence;
    ...
    invoke-virtual {v5, v7}, Lorg/bouncycastle/asn1/ASN1Sequence;->q(I)Lorg/bouncycastle/asn1/ASN1Encodable;

    move-result-object v8

    check-cast v8, Lorg/bouncycastle/asn1/ASN1Sequence;

    invoke-virtual {v8, v14}, Lorg/bouncycastle/asn1/ASN1Sequence;->q(I)Lorg/bouncycastle/asn1/ASN1Encodable;
    ...
    invoke-virtual {v8, v10}, Lorg/bouncycastle/asn1/ASN1Sequence;->q(I)Lorg/bouncycastle/asn1/ASN1Encodable;
    ...
    iput-object v5, v6, Lorg/bouncycastle/jce/provider/PKIXPolicyNode;->c:Ljava/util/Set;
    ...
    invoke-virtual {v5}, Lorg/bouncycastle/asn1/ASN1Sequence;->r()Ljava/util/Enumeration;
    ...
    invoke-static {v7}, Lorg/bouncycastle/asn1/x509/PolicyInformation;->g(Ljava/lang/Object;)Lorg/bouncycastle/asn1/x509/PolicyInformation;

    move-result-object v7
    :try_end_2
    .catch Ljava/lang/Exception; {:try_start_2 .. :try_end_2} :catch_1

    invoke-virtual {v7}, Lorg/bouncycastle/asn1/x509/PolicyInformation;->h()Lorg/bouncycastle/asn1/ASN1ObjectIdentifier;
    ...
    :try_start_3
    invoke-virtual {v7}, Lorg/bouncycastle/asn1/x509/PolicyInformation;->i()Lorg/bouncycastle/asn1/ASN1Sequence;

    move-result-object v5

    invoke-static {v5}, Lorg/bouncycastle/jce/provider/CertPathValidatorUtilities;->p(Lorg/bouncycastle/asn1/ASN1Sequence;)Ljava/util/Set;
    ...
    invoke-virtual {v5, v14}, Lorg/bouncycastle/jce/provider/PKIXPolicyNode;->a(Lorg/bouncycastle/jce/provider/PKIXPolicyNode;)V
    ...
    invoke-virtual {v7, v6}, Lorg/bouncycastle/jce/provider/PKIXPolicyNode;->d(Lorg/bouncycastle/jce/provider/PKIXPolicyNode;)V
    ...
    invoke-virtual {v10}, Lorg/bouncycastle/jce/provider/PKIXPolicyNode;->c()Z

    move-result v12

    if-nez v12, :cond_b

    invoke-static {v8, v0, v10}, Lorg/bouncycastle/jce/provider/CertPathValidatorUtilities;->B(Lorg/bouncycastle/jce/provider/PKIXPolicyNode;[Ljava/util/List;Lorg/bouncycastle/jce/provider/PKIXPolicyNode;)Lorg/bouncycastle/jce/provider/PKIXPolicyNode;
...
.method protected static d(Ljava/security/cert/CertPath;I)V
    ...
    invoke-static {v4}, Lorg/bouncycastle/asn1/ASN1ObjectIdentifier;->s(Ljava/lang/Object;)Lorg/bouncycastle/asn1/ASN1ObjectIdentifier;

    move-result-object v4

    const/4 v5, 0x1

    invoke-virtual {v3, v5}, Lorg/bouncycastle/asn1/ASN1Sequence;->q(I)Lorg/bouncycastle/asn1/ASN1Encodable;
...
.method protected static e(Ljava/security/cert/CertPath;ILorg/bouncycastle/jce/provider/PKIXNameConstraintValidator;)V
    .locals 3
    .annotation system Ldalvik/annotation/Throws;
        value = {
            Ljava/security/cert/CertPathValidatorException;
    ...
    invoke-static {v0}, Lorg/bouncycastle/asn1/x509/NameConstraints;->j(Ljava/lang/Object;)Lorg/bouncycastle/asn1/x509/NameConstraints;
    ...
    invoke-virtual {v0}, Lorg/bouncycastle/asn1/x509/NameConstraints;->k()[Lorg/bouncycastle/asn1/x509/GeneralSubtree;
    ...
    :try_start_1
    invoke-virtual {p2, v1}, Lorg/bouncycastle/jce/provider/PKIXNameConstraintValidator;->F([Lorg/bouncycastle/asn1/x509/GeneralSubtree;)V
    :try_end_1
    ...
    :cond_1
    :goto_1
    invoke-virtual {v0}, Lorg/bouncycastle/asn1/x509/NameConstraints;->i()[Lorg/bouncycastle/asn1/x509/GeneralSubtree;
    ...
    invoke-virtual {p2, v2}, Lorg/bouncycastle/jce/provider/PKIXNameConstraintValidator;->a(Lorg/bouncycastle/asn1/x509/GeneralSubtree;)V
    :try_end_2
...
.method protected static f(Ljava/security/cert/CertPath;II)I
    ...
    invoke-static {p0}, Lorg/bouncycastle/jce/provider/CertPathValidatorUtilities;->w(Ljava/security/cert/X509Certificate;)Z
...
.method protected static i(Ljava/security/cert/CertPath;II)I
    ...
    invoke-static {v1, v0}, Lorg/bouncycastle/asn1/ASN1Integer;->o(Lorg/bouncycastle/asn1/ASN1TaggedObject;Z)Lorg/bouncycastle/asn1/ASN1Integer;
...
.method protected static k(Ljava/security/cert/CertPath;II)I
    .locals 2
    .annotation system Ldalvik/annotation/Throws;
        value = {
            Ljava/security/cert/CertPathValidatorException;
...
.method protected static l(Ljava/security/cert/CertPath;I)V
    .locals 3
    .annotation system Ldalvik/annotation/Throws;
        value = {
            Ljava/security/cert/CertPathValidatorException;
    ...
    invoke-static {v0}, Lorg/bouncycastle/asn1/x509/BasicConstraints;->h(Ljava/lang/Object;)Lorg/bouncycastle/asn1/x509/BasicConstraints;
    ...
    invoke-virtual {p0}, Lorg/bouncycastle/asn1/x509/BasicConstraints;->k()Z
...
.method protected static m(Ljava/security/cert/CertPath;II)I
    .locals 2
    .annotation system Ldalvik/annotation/Throws;
        value = {
            Ljava/security/cert/CertPathValidatorException;
    ...
    invoke-static {v0}, Lorg/bouncycastle/jce/provider/CertPathValidatorUtilities;->w(Ljava/security/cert/X509Certificate;)Z
...
.method protected static n(Ljava/security/cert/CertPath;II)I
    .locals 2
    .annotation system Ldalvik/annotation/Throws;
        value = {
            Ljava/security/cert/CertPathValidatorException;
    ...
    invoke-virtual {p0}, Lorg/bouncycastle/asn1/x509/BasicConstraints;->j()Ljava/math/BigInteger;
...
.method protected static o(Ljava/security/cert/CertPath;I)V
    .locals 3
    .annotation system Ldalvik/annotation/Throws;
        value = {
            Ljava/security/cert/CertPathValidatorException;
...
.method protected static p(Ljava/security/cert/CertPath;ILjava/util/Set;Ljava/util/List;)V
    .locals 2
    .annotation system Ldalvik/annotation/Throws;
        value = {
            Ljava/security/cert/CertPathValidatorException;
...
.method protected static q(Ljava/util/Date;Lorg/bouncycastle/jcajce/PKIXExtendedParameters;Ljava/security/cert/X509Certificate;Ljava/security/cert/X509CRL;)Ljava/util/Set;
    .locals 3
    .annotation system Ldalvik/annotation/Throws;
        value = {
            Lorg/bouncycastle/jce/provider/AnnotatedException;
    ...
    invoke-virtual {p1}, Lorg/bouncycastle/jcajce/PKIXExtendedParameters;->z()Z
    ...
    invoke-static {p2, v1}, Lorg/bouncycastle/jce/provider/CertPathValidatorUtilities;->m(Ljava/security/cert/X509Extension;Ljava/lang/String;)Lorg/bouncycastle/asn1/ASN1Primitive;

    move-result-object p2

    invoke-static {p2}, Lorg/bouncycastle/asn1/x509/CRLDistPoint;->h(Ljava/lang/Object;)Lorg/bouncycastle/asn1/x509/CRLDistPoint;
    ...
    :try_start_1
    invoke-static {p3, v1}, Lorg/bouncycastle/jce/provider/CertPathValidatorUtilities;->m(Ljava/security/cert/X509Extension;Ljava/lang/String;)Lorg/bouncycastle/asn1/ASN1Primitive;
    ...
    invoke-virtual {p1}, Lorg/bouncycastle/jcajce/PKIXExtendedParameters;->j()Ljava/util/List;
    ...
    :try_start_2
    invoke-virtual {p1}, Lorg/bouncycastle/jcajce/PKIXExtendedParameters;->p()Ljava/util/Map;

    move-result-object v2

    invoke-static {p2, v2}, Lorg/bouncycastle/jce/provider/CertPathValidatorUtilities;->g(Lorg/bouncycastle/asn1/x509/CRLDistPoint;Ljava/util/Map;)Ljava/util/List;
    ...
    :try_start_3
    invoke-virtual {p1}, Lorg/bouncycastle/jcajce/PKIXExtendedParameters;->l()Ljava/util/List;

    move-result-object p1

    invoke-static {p0, p3, p1, v1}, Lorg/bouncycastle/jce/provider/CertPathValidatorUtilities;->l(Ljava/util/Date;Ljava/security/cert/X509CRL;Ljava/util/List;Ljava/util/List;)Ljava/util/Set;
...
.method protected static r(Ljava/util/Date;Lorg/bouncycastle/jcajce/PKIXExtendedParameters;Ljava/security/cert/X509Certificate;Ljava/security/cert/X509CRL;)[Ljava/util/Set;
    .locals 5
    .annotation system Ldalvik/annotation/Throws;
        value = {
            Lorg/bouncycastle/jce/provider/AnnotatedException;
    ...
    invoke-virtual {v2, p2}, Ljava/security/cert/X509CRLSelector;->setCertificateChecking(Ljava/security/cert/X509Certificate;)V

    :try_start_0
    invoke-static {p3}, Lorg/bouncycastle/jce/provider/PrincipalUtils;->c(Ljava/security/cert/X509CRL;)Lorg/bouncycastle/asn1/x500/X500Name;
    ...
    invoke-virtual {v2, p2}, Ljava/security/cert/X509CRLSelector;->addIssuerName([B)V
    :try_end_0
    .catch Ljava/io/IOException; {:try_start_0 .. :try_end_0} :catch_1

    new-instance p2, Lorg/bouncycastle/jcajce/PKIXCRLStoreSelector$Builder;

    invoke-direct {p2, v2}, Lorg/bouncycastle/jcajce/PKIXCRLStoreSelector$Builder;-><init>(Ljava/security/cert/CRLSelector;)V

    invoke-virtual {p2, v0}, Lorg/bouncycastle/jcajce/PKIXCRLStoreSelector$Builder;->h(Z)Lorg/bouncycastle/jcajce/PKIXCRLStoreSelector$Builder;

    move-result-object p2

    invoke-virtual {p2}, Lorg/bouncycastle/jcajce/PKIXCRLStoreSelector$Builder;->g()Lorg/bouncycastle/jcajce/PKIXCRLStoreSelector;

    move-result-object p2

    invoke-virtual {p1}, Lorg/bouncycastle/jcajce/PKIXExtendedParameters;->n()Ljava/util/Date;
    ...
    :cond_0
    sget-object v2, Lorg/bouncycastle/jce/provider/RFC3280CertPathUtilities;->a:Lorg/bouncycastle/jce/provider/PKIXCRLUtil;
    ...
    invoke-virtual {v2, p2, p0, v3, v4}, Lorg/bouncycastle/jce/provider/PKIXCRLUtil;->b(Lorg/bouncycastle/jcajce/PKIXCRLStoreSelector;Ljava/util/Date;Ljava/util/List;Ljava/util/List;)Ljava/util/Set;
    ...
    invoke-static {p0, p3, v2, p1}, Lorg/bouncycastle/jce/provider/CertPathValidatorUtilities;->l(Ljava/util/Date;Ljava/security/cert/X509CRL;Ljava/util/List;Ljava/util/List;)Ljava/util/Set;
...
.method protected static s(Lorg/bouncycastle/asn1/x509/DistributionPoint;Ljava/lang/Object;Ljava/security/cert/X509CRL;)V
    .locals 5
    .annotation system Ldalvik/annotation/Throws;
        value = {
            Lorg/bouncycastle/jce/provider/AnnotatedException;
    ...
    invoke-static {p2, v0}, Lorg/bouncycastle/jce/provider/CertPathValidatorUtilities;->m(Ljava/security/cert/X509Extension;Ljava/lang/String;)Lorg/bouncycastle/asn1/ASN1Primitive;
    ...
    invoke-virtual {v0}, Lorg/bouncycastle/asn1/x509/IssuingDistributionPoint;->m()Z
    ...
    :goto_0
    :try_start_0
    invoke-static {p2}, Lorg/bouncycastle/jce/provider/PrincipalUtils;->c(Ljava/security/cert/X509CRL;)Lorg/bouncycastle/asn1/x500/X500Name;
    ...
    invoke-static {p2, v3}, Lorg/bouncycastle/util/Arrays;->e([B[B)Z
    ...
    invoke-static {p1}, Lorg/bouncycastle/jce/provider/PrincipalUtils;->b(Ljava/lang/Object;)Lorg/bouncycastle/asn1/x500/X500Name;
...
.method protected static t(Lorg/bouncycastle/asn1/x509/DistributionPoint;Ljava/lang/Object;Ljava/security/cert/X509CRL;)V
    .locals 8
    .annotation system Ldalvik/annotation/Throws;
        value = {
            Lorg/bouncycastle/jce/provider/AnnotatedException;
    ...
    invoke-virtual {v0}, Lorg/bouncycastle/asn1/x509/IssuingDistributionPoint;->i()Lorg/bouncycastle/asn1/x509/DistributionPointName;
    ...
    invoke-virtual {v1}, Lorg/bouncycastle/asn1/x509/DistributionPointName;->k()I
    ...
    invoke-virtual {v1}, Lorg/bouncycastle/asn1/x509/DistributionPointName;->j()Lorg/bouncycastle/asn1/ASN1Encodable;

    move-result-object v3

    invoke-static {v3}, Lorg/bouncycastle/asn1/x509/GeneralNames;->h(Ljava/lang/Object;)Lorg/bouncycastle/asn1/x509/GeneralNames;

    move-result-object v3

    invoke-virtual {v3}, Lorg/bouncycastle/asn1/x509/GeneralNames;->j()[Lorg/bouncycastle/asn1/x509/GeneralName;
    ...
    invoke-static {p2}, Lorg/bouncycastle/asn1/ASN1Sequence;->n(Ljava/lang/Object;)Lorg/bouncycastle/asn1/ASN1Sequence;

    move-result-object p2

    invoke-virtual {p2}, Lorg/bouncycastle/asn1/ASN1Sequence;->r()Ljava/util/Enumeration;
    ...
    invoke-virtual {v3, p2}, Lorg/bouncycastle/asn1/ASN1EncodableVector;->a(Lorg/bouncycastle/asn1/ASN1Encodable;)V
    ...
    invoke-virtual {p2}, Lorg/bouncycastle/asn1/x509/DistributionPointName;->k()I

    move-result v3

    if-nez v3, :cond_3

    invoke-virtual {p2}, Lorg/bouncycastle/asn1/x509/DistributionPointName;->j()Lorg/bouncycastle/asn1/ASN1Encodable;
    ...
    invoke-static {v7}, Lorg/bouncycastle/asn1/x500/X500Name;->i(Ljava/lang/Object;)Lorg/bouncycastle/asn1/x500/X500Name;
    ...
    sget-object p2, Lorg/bouncycastle/jce/provider/RFC3280CertPathUtilities;->i:Ljava/lang/String;

    invoke-static {p0, p2}, Lorg/bouncycastle/jce/provider/CertPathValidatorUtilities;->m(Ljava/security/cert/X509Extension;Ljava/lang/String;)Lorg/bouncycastle/asn1/ASN1Primitive;

    move-result-object p0

    invoke-static {p0}, Lorg/bouncycastle/asn1/x509/BasicConstraints;->h(Ljava/lang/Object;)Lorg/bouncycastle/asn1/x509/BasicConstraints;
...
.method protected static u(Ljava/security/cert/X509CRL;Ljava/security/cert/X509CRL;Lorg/bouncycastle/jcajce/PKIXExtendedParameters;)V
    .locals 3
    .annotation system Ldalvik/annotation/Throws;
        value = {
            Lorg/bouncycastle/jce/provider/AnnotatedException;
    ...
    invoke-static {p1, v0}, Lorg/bouncycastle/jce/provider/CertPathValidatorUtilities;->m(Ljava/security/cert/X509Extension;Ljava/lang/String;)Lorg/bouncycastle/asn1/ASN1Primitive;

    move-result-object v1

    invoke-static {v1}, Lorg/bouncycastle/asn1/x509/IssuingDistributionPoint;->j(Ljava/lang/Object;)Lorg/bouncycastle/asn1/x509/IssuingDistributionPoint;

    move-result-object v1
    :try_end_0
    .catch Ljava/lang/Exception; {:try_start_0 .. :try_end_0} :catch_3

    invoke-virtual {p2}, Lorg/bouncycastle/jcajce/PKIXExtendedParameters;->z()Z

    move-result p2

    if-eqz p2, :cond_7

    invoke-static {p0}, Lorg/bouncycastle/jce/provider/PrincipalUtils;->c(Ljava/security/cert/X509CRL;)Lorg/bouncycastle/asn1/x500/X500Name;

    move-result-object p2

    invoke-static {p1}, Lorg/bouncycastle/jce/provider/PrincipalUtils;->c(Ljava/security/cert/X509CRL;)Lorg/bouncycastle/asn1/x500/X500Name;
    ...
    :try_start_1
    invoke-static {p0, v0}, Lorg/bouncycastle/jce/provider/CertPathValidatorUtilities;->m(Ljava/security/cert/X509Extension;Ljava/lang/String;)Lorg/bouncycastle/asn1/ASN1Primitive;

    move-result-object p2

    invoke-static {p2}, Lorg/bouncycastle/asn1/x509/IssuingDistributionPoint;->j(Ljava/lang/Object;)Lorg/bouncycastle/asn1/x509/IssuingDistributionPoint;
    ...
    :goto_0
    :try_start_2
    sget-object p2, Lorg/bouncycastle/jce/provider/RFC3280CertPathUtilities;->m:Ljava/lang/String;

    invoke-static {p1, p2}, Lorg/bouncycastle/jce/provider/CertPathValidatorUtilities;->m(Ljava/security/cert/X509Extension;Ljava/lang/String;)Lorg/bouncycastle/asn1/ASN1Primitive;
...
.method protected static v(Ljava/security/cert/X509CRL;Lorg/bouncycastle/asn1/x509/DistributionPoint;)Lorg/bouncycastle/jce/provider/ReasonsMask;
    .locals 1
    .annotation system Ldalvik/annotation/Throws;
        value = {
            Lorg/bouncycastle/jce/provider/AnnotatedException;
    ...
    invoke-virtual {p0}, Lorg/bouncycastle/asn1/x509/IssuingDistributionPoint;->l()Lorg/bouncycastle/asn1/x509/ReasonFlags;

    move-result-object v0

    if-eqz v0, :cond_0

    invoke-virtual {p1}, Lorg/bouncycastle/asn1/x509/DistributionPoint;->l()Lorg/bouncycastle/asn1/x509/ReasonFlags;
    ...
    invoke-virtual {v0, p1}, Lorg/bouncycastle/jce/provider/ReasonsMask;->d(Lorg/bouncycastle/jce/provider/ReasonsMask;)Lorg/bouncycastle/jce/provider/ReasonsMask;
    ...
    sget-object p0, Lorg/bouncycastle/jce/provider/ReasonsMask;->b:Lorg/bouncycastle/jce/provider/ReasonsMask;
    ...
    sget-object p1, Lorg/bouncycastle/jce/provider/ReasonsMask;->b:Lorg/bouncycastle/jce/provider/ReasonsMask;
    ...
    :goto_1
    invoke-virtual {p1, p0}, Lorg/bouncycastle/jce/provider/ReasonsMask;->d(Lorg/bouncycastle/jce/provider/ReasonsMask;)Lorg/bouncycastle/jce/provider/ReasonsMask;
...
.method protected static w(Ljava/security/cert/X509CRL;Ljava/lang/Object;Ljava/security/cert/X509Certificate;Ljava/security/PublicKey;Lorg/bouncycastle/jcajce/PKIXExtendedParameters;Ljava/util/List;Lorg/bouncycastle/jcajce/util/JcaJceHelper;)Ljava/util/Set;
    .locals 7
    .annotation system Ldalvik/annotation/Throws;
        value = {
            Lorg/bouncycastle/jce/provider/AnnotatedException;
    ...
    :try_start_1
    invoke-virtual {p4}, Lorg/bouncycastle/jcajce/PKIXExtendedParameters;->m()Ljava/util/List;

    move-result-object p1

    invoke-static {p0, p1}, Lorg/bouncycastle/jce/provider/CertPathValidatorUtilities;->b(Lorg/bouncycastle/jcajce/PKIXCertStoreSelector;Ljava/util/List;)Ljava/util/Collection;

    move-result-object p1

    invoke-virtual {p4}, Lorg/bouncycastle/jcajce/PKIXExtendedParameters;->l()Ljava/util/List;

    move-result-object v0

    invoke-static {p0, v0}, Lorg/bouncycastle/jce/provider/CertPathValidatorUtilities;->b(Lorg/bouncycastle/jcajce/PKIXCertStoreSelector;Ljava/util/List;)Ljava/util/Collection;
    ...
    invoke-virtual {v6}, Lorg/bouncycastle/jcajce/PKIXCertStoreSelector$Builder;->a()Lorg/bouncycastle/jcajce/PKIXCertStoreSelector;

    move-result-object v4

    invoke-virtual {v5, v4}, Lorg/bouncycastle/jcajce/PKIXExtendedParameters$Builder;->r(Lorg/bouncycastle/jcajce/PKIXCertStoreSelector;)Lorg/bouncycastle/jcajce/PKIXExtendedParameters$Builder;
    ...
    invoke-virtual {v4, v2}, Lorg/bouncycastle/jcajce/PKIXExtendedParameters$Builder;->q(Z)V
    ...
    invoke-virtual {v4, v5}, Lorg/bouncycastle/jcajce/PKIXExtendedParameters$Builder;->q(Z)V

    :goto_1
    new-instance v5, Lorg/bouncycastle/jcajce/PKIXExtendedBuilderParameters$Builder;

    invoke-virtual {v4}, Lorg/bouncycastle/jcajce/PKIXExtendedParameters$Builder;->p()Lorg/bouncycastle/jcajce/PKIXExtendedParameters;
    ...
    invoke-virtual {v5}, Lorg/bouncycastle/jcajce/PKIXExtendedBuilderParameters$Builder;->e()Lorg/bouncycastle/jcajce/PKIXExtendedBuilderParameters;
    ...
    invoke-static {v3, v2, p6}, Lorg/bouncycastle/jce/provider/CertPathValidatorUtilities;->n(Ljava/util/List;ILorg/bouncycastle/jcajce/util/JcaJceHelper;)Ljava/security/PublicKey;
...
.method protected static x(Ljava/security/cert/X509CRL;Ljava/util/Set;)Ljava/security/PublicKey;
    .locals 2
    .annotation system Ldalvik/annotation/Throws;
        value = {
            Lorg/bouncycastle/jce/provider/AnnotatedException;
...
.method protected static y(Ljava/util/Set;Ljava/security/PublicKey;)Ljava/security/cert/X509CRL;
    .locals 3
    .annotation system Ldalvik/annotation/Throws;
        value = {
            Lorg/bouncycastle/jce/provider/AnnotatedException;
...
.method protected static z(Ljava/util/Date;Ljava/security/cert/X509CRL;Ljava/lang/Object;Lorg/bouncycastle/jce/provider/CertStatus;Lorg/bouncycastle/jcajce/PKIXExtendedParameters;)V
    .locals 0
    .annotation system Ldalvik/annotation/Throws;
        value = {
            Lorg/bouncycastle/jce/provider/AnnotatedException;
    ...
    invoke-virtual {p4}, Lorg/bouncycastle/jcajce/PKIXExtendedParameters;->z()Z
