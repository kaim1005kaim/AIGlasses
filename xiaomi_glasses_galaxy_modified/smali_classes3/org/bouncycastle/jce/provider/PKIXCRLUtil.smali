...
.method private final a(Lorg/bouncycastle/jcajce/PKIXCRLStoreSelector;Ljava/util/List;)Ljava/util/Collection;
    .locals 6
    ...
    :try_start_0
    invoke-interface {v2, p1}, Lorg/bouncycastle/util/Store;->a(Lorg/bouncycastle/util/Selector;)Ljava/util/Collection;
    ...
    :try_start_1
    invoke-static {p1, v2}, Lorg/bouncycastle/jcajce/PKIXCRLStoreSelector;->b(Lorg/bouncycastle/jcajce/PKIXCRLStoreSelector;Ljava/security/cert/CertStore;)Ljava/util/Collection;
...
# virtual methods
.method public b(Lorg/bouncycastle/jcajce/PKIXCRLStoreSelector;Ljava/util/Date;Ljava/util/List;Ljava/util/List;)Ljava/util/Set;
    .locals 2
    .annotation system Ldalvik/annotation/Throws;
        value = {
            Lorg/bouncycastle/jce/provider/AnnotatedException;
    ...
    :try_start_0
    invoke-direct {p0, p1, p4}, Lorg/bouncycastle/jce/provider/PKIXCRLUtil;->a(Lorg/bouncycastle/jcajce/PKIXCRLStoreSelector;Ljava/util/List;)Ljava/util/Collection;

    move-result-object p4

    invoke-interface {v0, p4}, Ljava/util/Set;->addAll(Ljava/util/Collection;)Z

    invoke-direct {p0, p1, p3}, Lorg/bouncycastle/jce/provider/PKIXCRLUtil;->a(Lorg/bouncycastle/jcajce/PKIXCRLStoreSelector;Ljava/util/List;)Ljava/util/Collection;
    ...
    invoke-virtual {p1}, Lorg/bouncycastle/jcajce/PKIXCRLStoreSelector;->c()Ljava/security/cert/X509Certificate;
