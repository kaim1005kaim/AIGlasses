...
.method protected static a(Lorg/bouncycastle/x509/X509AttributeCertificate;Ljava/util/Set;Ljava/util/Set;)V
    .locals 3
    ...
    invoke-interface {p0, v0}, Lorg/bouncycastle/x509/X509AttributeCertificate;->c(Ljava/lang/String;)[Lorg/bouncycastle/x509/X509Attribute;
    ...
    invoke-interface {p0, p2}, Lorg/bouncycastle/x509/X509AttributeCertificate;->c(Ljava/lang/String;)[Lorg/bouncycastle/x509/X509Attribute;
...
.method private static b(Lorg/bouncycastle/asn1/x509/DistributionPoint;Lorg/bouncycastle/x509/X509AttributeCertificate;Lorg/bouncycastle/jcajce/PKIXExtendedParameters;Ljava/util/Date;Ljava/security/cert/X509Certificate;Lorg/bouncycastle/jce/provider/CertStatus;Lorg/bouncycastle/jce/provider/ReasonsMask;Ljava/util/List;Lorg/bouncycastle/jcajce/util/JcaJceHelper;)V
    ...
    sget-object v0, Lorg/bouncycastle/asn1/x509/X509Extensions;->F:Lorg/bouncycastle/asn1/ASN1ObjectIdentifier;
    ...
    invoke-static {v1, v9, v14, v10}, Lorg/bouncycastle/jce/provider/CertPathValidatorUtilities;->k(Lorg/bouncycastle/asn1/x509/DistributionPoint;Ljava/lang/Object;Ljava/util/Date;Lorg/bouncycastle/jcajce/PKIXExtendedParameters;)Ljava/util/Set;
    ...
    invoke-virtual/range {p5 .. p5}, Lorg/bouncycastle/jce/provider/CertStatus;->a()I
    ...
    invoke-virtual/range {p6 .. p6}, Lorg/bouncycastle/jce/provider/ReasonsMask;->e()Z
    ...
    invoke-static {v3, v2}, Lorg/bouncycastle/jce/provider/RFC3280CertPathUtilities;->x(Ljava/security/cert/X509CRL;Ljava/util/Set;)Ljava/security/PublicKey;

    move-result-object v2

    invoke-virtual/range {p2 .. p2}, Lorg/bouncycastle/jcajce/PKIXExtendedParameters;->z()Z

    move-result v4

    if-eqz v4, :cond_2

    invoke-virtual/range {p2 .. p2}, Lorg/bouncycastle/jcajce/PKIXExtendedParameters;->l()Ljava/util/List;

    move-result-object v4

    invoke-virtual/range {p2 .. p2}, Lorg/bouncycastle/jcajce/PKIXExtendedParameters;->j()Ljava/util/List;

    move-result-object v5

    invoke-static {v14, v3, v4, v5}, Lorg/bouncycastle/jce/provider/CertPathValidatorUtilities;->l(Ljava/util/Date;Ljava/security/cert/X509CRL;Ljava/util/List;Ljava/util/List;)Ljava/util/Set;

    move-result-object v4

    invoke-static {v4, v2}, Lorg/bouncycastle/jce/provider/RFC3280CertPathUtilities;->y(Ljava/util/Set;Ljava/security/PublicKey;)Ljava/security/cert/X509CRL;
    ...
    :goto_1
    invoke-virtual/range {p2 .. p2}, Lorg/bouncycastle/jcajce/PKIXExtendedParameters;->u()I
    ...
    :cond_4
    :goto_2
    invoke-static {v1, v9, v3}, Lorg/bouncycastle/jce/provider/RFC3280CertPathUtilities;->s(Lorg/bouncycastle/asn1/x509/DistributionPoint;Ljava/lang/Object;Ljava/security/cert/X509CRL;)V

    invoke-static {v1, v9, v3}, Lorg/bouncycastle/jce/provider/RFC3280CertPathUtilities;->t(Lorg/bouncycastle/asn1/x509/DistributionPoint;Ljava/lang/Object;Ljava/security/cert/X509CRL;)V

    invoke-static {v2, v3, v10}, Lorg/bouncycastle/jce/provider/RFC3280CertPathUtilities;->u(Ljava/security/cert/X509CRL;Ljava/security/cert/X509CRL;Lorg/bouncycastle/jcajce/PKIXExtendedParameters;)V

    invoke-static {v11, v2, v9, v12, v10}, Lorg/bouncycastle/jce/provider/RFC3280CertPathUtilities;->z(Ljava/util/Date;Ljava/security/cert/X509CRL;Ljava/lang/Object;Lorg/bouncycastle/jce/provider/CertStatus;Lorg/bouncycastle/jcajce/PKIXExtendedParameters;)V

    invoke-static {v11, v3, v9, v12}, Lorg/bouncycastle/jce/provider/RFC3280CertPathUtilities;->A(Ljava/util/Date;Ljava/security/cert/X509CRL;Ljava/lang/Object;Lorg/bouncycastle/jce/provider/CertStatus;)V
    ...
    invoke-virtual {v12, v15}, Lorg/bouncycastle/jce/provider/CertStatus;->c(I)V

    :cond_5
    move-object/from16 v2, v18

    invoke-virtual {v13, v2}, Lorg/bouncycastle/jce/provider/ReasonsMask;->a(Lorg/bouncycastle/jce/provider/ReasonsMask;)V
    :try_end_1
...
.method protected static c(Lorg/bouncycastle/x509/X509AttributeCertificate;Lorg/bouncycastle/jcajce/PKIXExtendedParameters;Ljava/security/cert/X509Certificate;Ljava/util/Date;Ljava/util/List;Lorg/bouncycastle/jcajce/util/JcaJceHelper;)V
    .locals 18
    .annotation system Ldalvik/annotation/Throws;
        value = {
            Ljava/security/cert/CertPathValidatorException;
    ...
    invoke-virtual/range {p1 .. p1}, Lorg/bouncycastle/jcajce/PKIXExtendedParameters;->y()Z
    ...
    :try_start_0
    sget-object v0, Lorg/bouncycastle/jce/provider/RFC3281CertPathUtilities;->c:Ljava/lang/String;

    invoke-static {v10, v0}, Lorg/bouncycastle/jce/provider/CertPathValidatorUtilities;->m(Ljava/security/cert/X509Extension;Ljava/lang/String;)Lorg/bouncycastle/asn1/ASN1Primitive;
    ...
    :try_start_1
    invoke-virtual/range {p1 .. p1}, Lorg/bouncycastle/jcajce/PKIXExtendedParameters;->p()Ljava/util/Map;
    ...
    invoke-virtual {v2, v4}, Lorg/bouncycastle/jcajce/PKIXExtendedParameters$Builder;->l(Lorg/bouncycastle/jcajce/PKIXCRLStore;)Lorg/bouncycastle/jcajce/PKIXExtendedParameters$Builder;
    ...
    invoke-virtual {v12}, Lorg/bouncycastle/jce/provider/CertStatus;->a()I

    move-result v1

    if-ne v1, v8, :cond_1

    invoke-virtual {v13}, Lorg/bouncycastle/jce/provider/ReasonsMask;->e()Z
    ...
    :try_start_4
    invoke-static/range {v1 .. v9}, Lorg/bouncycastle/jce/provider/RFC3281CertPathUtilities;->b(Lorg/bouncycastle/asn1/x509/DistributionPoint;Lorg/bouncycastle/x509/X509AttributeCertificate;Lorg/bouncycastle/jcajce/PKIXExtendedParameters;Ljava/util/Date;Ljava/security/cert/X509Certificate;Lorg/bouncycastle/jce/provider/CertStatus;Lorg/bouncycastle/jce/provider/ReasonsMask;Ljava/util/List;Lorg/bouncycastle/jcajce/util/JcaJceHelper;)V
    :try_end_4
    ...
    invoke-interface/range {p0 .. p0}, Lorg/bouncycastle/x509/X509AttributeCertificate;->e()Lorg/bouncycastle/x509/AttributeCertificateIssuer;
    ...
    invoke-virtual {v12, v1}, Lorg/bouncycastle/jce/provider/CertStatus;->c(I)V
    ...
    invoke-virtual {v12}, Lorg/bouncycastle/jce/provider/CertStatus;->b()Ljava/util/Date;
...
.method protected static d(Lorg/bouncycastle/x509/X509AttributeCertificate;Lorg/bouncycastle/jcajce/PKIXExtendedParameters;)Ljava/security/cert/CertPath;
    .locals 10
    .annotation system Ldalvik/annotation/Throws;
        value = {
            Ljava/security/cert/CertPathValidatorException;
    ...
    invoke-interface {p0}, Lorg/bouncycastle/x509/X509AttributeCertificate;->b()Lorg/bouncycastle/x509/AttributeCertificateHolder;

    move-result-object v2

    invoke-virtual {v2}, Lorg/bouncycastle/x509/AttributeCertificateHolder;->e()[Ljava/security/Principal;
    ...
    invoke-virtual {v6}, Lorg/bouncycastle/x509/AttributeCertificateHolder;->j()Ljava/math/BigInteger;
    ...
    invoke-virtual {v6}, Lorg/bouncycastle/x509/AttributeCertificateHolder;->e()[Ljava/security/Principal;
    ...
    invoke-static {v8, v9}, Lorg/bouncycastle/jce/provider/CertPathValidatorUtilities;->b(Lorg/bouncycastle/jcajce/PKIXCertStoreSelector;Ljava/util/List;)Ljava/util/Collection;
    ...
    invoke-virtual {p0}, Lorg/bouncycastle/x509/AttributeCertificateHolder;->d()[Ljava/security/Principal;
    ...
    invoke-static {v6, v7}, Lorg/bouncycastle/jce/provider/CertPathValidatorUtilities;->b(Lorg/bouncycastle/jcajce/PKIXCertStoreSelector;Ljava/util/List;)Ljava/util/Collection;
    ...
    invoke-virtual {v4}, Lorg/bouncycastle/jcajce/PKIXCertStoreSelector$Builder;->a()Lorg/bouncycastle/jcajce/PKIXCertStoreSelector;

    move-result-object v3

    invoke-virtual {p0, v3}, Lorg/bouncycastle/jcajce/PKIXExtendedParameters$Builder;->r(Lorg/bouncycastle/jcajce/PKIXCertStoreSelector;)Lorg/bouncycastle/jcajce/PKIXExtendedParameters$Builder;
    ...
    invoke-virtual {p0}, Lorg/bouncycastle/jcajce/PKIXExtendedParameters$Builder;->p()Lorg/bouncycastle/jcajce/PKIXExtendedParameters;
    ...
    invoke-virtual {v4}, Lorg/bouncycastle/jcajce/PKIXExtendedBuilderParameters$Builder;->e()Lorg/bouncycastle/jcajce/PKIXExtendedBuilderParameters;
...
.method protected static e(Ljava/security/cert/CertPath;Lorg/bouncycastle/jcajce/PKIXExtendedParameters;)Ljava/security/cert/CertPathValidatorResult;
    .locals 3
    .annotation system Ldalvik/annotation/Throws;
        value = {
            Ljava/security/cert/CertPathValidatorException;
...
.method protected static f(Ljava/security/cert/X509Certificate;Lorg/bouncycastle/jcajce/PKIXExtendedParameters;)V
    .locals 1
    .annotation system Ldalvik/annotation/Throws;
        value = {
            Ljava/security/cert/CertPathValidatorException;
...
.method protected static g(Ljava/security/cert/X509Certificate;Ljava/util/Set;)V
    .locals 4
    .annotation system Ldalvik/annotation/Throws;
        value = {
            Ljava/security/cert/CertPathValidatorException;
...
.method protected static h(Lorg/bouncycastle/x509/X509AttributeCertificate;Lorg/bouncycastle/jcajce/PKIXExtendedParameters;)V
    .locals 1
    .annotation system Ldalvik/annotation/Throws;
        value = {
            Ljava/security/cert/CertPathValidatorException;
    ...
    :try_start_0
    invoke-static {p1}, Lorg/bouncycastle/jce/provider/CertPathValidatorUtilities;->s(Lorg/bouncycastle/jcajce/PKIXExtendedParameters;)Ljava/util/Date;
...
.method protected static i(Lorg/bouncycastle/x509/X509AttributeCertificate;Ljava/security/cert/CertPath;Ljava/security/cert/CertPath;Lorg/bouncycastle/jcajce/PKIXExtendedParameters;Ljava/util/Set;)V
    .locals 3
    .annotation system Ldalvik/annotation/Throws;
        value = {
            Ljava/security/cert/CertPathValidatorException;
    ...
    sget-object v1, Lorg/bouncycastle/jce/provider/RFC3281CertPathUtilities;->a:Ljava/lang/String;
    ...
    :try_start_0
    invoke-static {p0, v1}, Lorg/bouncycastle/jce/provider/CertPathValidatorUtilities;->m(Ljava/security/cert/X509Extension;Ljava/lang/String;)Lorg/bouncycastle/asn1/ASN1Primitive;

    move-result-object v2

    invoke-static {v2}, Lorg/bouncycastle/asn1/x509/TargetInformation;->g(Ljava/lang/Object;)Lorg/bouncycastle/asn1/x509/TargetInformation;
    :try_end_0
    .catch Lorg/bouncycastle/jce/provider/AnnotatedException; {:try_start_0 .. :try_end_0} :catch_1
    ...
    invoke-virtual {p4, p0, p1, p2, v0}, Lorg/bouncycastle/x509/PKIXAttrCertChecker;->a(Lorg/bouncycastle/x509/X509AttributeCertificate;Ljava/security/cert/CertPath;Ljava/security/cert/CertPath;Ljava/util/Collection;)V
