...
.method public a(Lorg/bouncycastle/util/Selector;)Ljava/util/Collection;
    ...
    invoke-virtual {v1, p1}, Lorg/bouncycastle/x509/util/LDAPStoreHelper;->k(Lorg/bouncycastle/x509/X509AttributeCertStoreSelector;)Ljava/util/Collection;
    ...
    invoke-virtual {v1, p1}, Lorg/bouncycastle/x509/util/LDAPStoreHelper;->m(Lorg/bouncycastle/x509/X509AttributeCertStoreSelector;)Ljava/util/Collection;

    move-result-object v1

    invoke-interface {v0, v1}, Ljava/util/Set;->addAll(Ljava/util/Collection;)Z

    iget-object p0, p0, Lorg/bouncycastle/jce/provider/X509StoreLDAPAttrCerts;->a:Lorg/bouncycastle/x509/util/LDAPStoreHelper;

    invoke-virtual {p0, p1}, Lorg/bouncycastle/x509/util/LDAPStoreHelper;->o(Lorg/bouncycastle/x509/X509AttributeCertStoreSelector;)Ljava/util/Collection;
