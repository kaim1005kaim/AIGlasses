...
.field private static final H:Ljava/lang/String; = "org.bouncycastle.x509.CertPathReviewerMessages"
...
.method static constructor <clinit>()V
    ...
    sput-object v0, Lorg/bouncycastle/x509/PKIXCertPathReviewer;->E:Ljava/lang/String;
    ...
    sput-object v0, Lorg/bouncycastle/x509/PKIXCertPathReviewer;->F:Ljava/lang/String;
    ...
    sput-object v0, Lorg/bouncycastle/x509/PKIXCertPathReviewer;->G:Ljava/lang/String;
...
.method public constructor <init>(Ljava/security/cert/CertPath;Ljava/security/cert/PKIXParameters;)V
    ...
    invoke-virtual {p0, p1, p2}, Lorg/bouncycastle/x509/PKIXCertPathReviewer;->j0(Ljava/security/cert/CertPath;Ljava/security/cert/PKIXParameters;)V
...
.method private P()V
    ...
    iget-object v1, p0, Lorg/bouncycastle/x509/PKIXCertPathReviewer;->u:Ljava/security/cert/PKIXParameters;
    ...
    :cond_0
    :try_start_1
    iget-object v2, p0, Lorg/bouncycastle/x509/PKIXCertPathReviewer;->w:Ljava/util/List;
    ...
    iget-object v3, p0, Lorg/bouncycastle/x509/PKIXCertPathReviewer;->w:Ljava/util/List;
    ...
    :cond_1
    sget-object v5, Lorg/bouncycastle/x509/CertPathValidatorUtilities;->g:Ljava/lang/String;

    invoke-interface {v4, v5}, Ljava/util/Set;->remove(Ljava/lang/Object;)Z

    sget-object v5, Lorg/bouncycastle/x509/CertPathValidatorUtilities;->b:Ljava/lang/String;

    invoke-interface {v4, v5}, Ljava/util/Set;->remove(Ljava/lang/Object;)Z

    sget-object v5, Lorg/bouncycastle/x509/CertPathValidatorUtilities;->d:Ljava/lang/String;

    invoke-interface {v4, v5}, Ljava/util/Set;->remove(Ljava/lang/Object;)Z

    sget-object v5, Lorg/bouncycastle/x509/CertPathValidatorUtilities;->h:Ljava/lang/String;

    invoke-interface {v4, v5}, Ljava/util/Set;->remove(Ljava/lang/Object;)Z

    sget-object v5, Lorg/bouncycastle/x509/CertPathValidatorUtilities;->i:Ljava/lang/String;

    invoke-interface {v4, v5}, Ljava/util/Set;->remove(Ljava/lang/Object;)Z

    sget-object v5, Lorg/bouncycastle/x509/CertPathValidatorUtilities;->j:Ljava/lang/String;

    invoke-interface {v4, v5}, Ljava/util/Set;->remove(Ljava/lang/Object;)Z

    sget-object v5, Lorg/bouncycastle/x509/CertPathValidatorUtilities;->k:Ljava/lang/String;

    invoke-interface {v4, v5}, Ljava/util/Set;->remove(Ljava/lang/Object;)Z

    sget-object v5, Lorg/bouncycastle/x509/CertPathValidatorUtilities;->c:Ljava/lang/String;

    invoke-interface {v4, v5}, Ljava/util/Set;->remove(Ljava/lang/Object;)Z

    sget-object v5, Lorg/bouncycastle/x509/CertPathValidatorUtilities;->e:Ljava/lang/String;

    invoke-interface {v4, v5}, Ljava/util/Set;->remove(Ljava/lang/Object;)Z

    sget-object v5, Lorg/bouncycastle/x509/CertPathValidatorUtilities;->f:Ljava/lang/String;

    invoke-interface {v4, v5}, Ljava/util/Set;->remove(Ljava/lang/Object;)Z

    sget-object v5, Lorg/bouncycastle/x509/PKIXCertPathReviewer;->E:Ljava/lang/String;
    ...
    invoke-direct {p0, v3, v2}, Lorg/bouncycastle/x509/PKIXCertPathReviewer;->l0(Ljava/security/cert/X509Certificate;I)Z
    ...
    iget-object v4, p0, Lorg/bouncycastle/x509/PKIXCertPathReviewer;->t:Ljava/security/cert/CertPath;
    ...
    invoke-virtual {p0, v4, v2}, Lorg/bouncycastle/x509/PKIXCertPathReviewer;->L(Lorg/bouncycastle/i18n/ErrorBundle;I)V
    ...
    :goto_6
    invoke-virtual {v0}, Lorg/bouncycastle/i18n/LocalizedException;->a()Lorg/bouncycastle/i18n/ErrorBundle;

    move-result-object v1

    invoke-virtual {v0}, Lorg/bouncycastle/x509/CertPathReviewerException;->c()I

    move-result v0

    invoke-virtual {p0, v1, v0}, Lorg/bouncycastle/x509/PKIXCertPathReviewer;->L(Lorg/bouncycastle/i18n/ErrorBundle;I)V
...
.method private Q()V
    ...
    :try_start_0
    iget-object v1, p0, Lorg/bouncycastle/x509/PKIXCertPathReviewer;->w:Ljava/util/List;
    ...
    invoke-static {v2}, Lorg/bouncycastle/x509/CertPathValidatorUtilities;->B(Ljava/security/cert/X509Certificate;)Z
    ...
    :try_start_1
    invoke-static {v2}, Lorg/bouncycastle/x509/CertPathValidatorUtilities;->v(Ljava/security/cert/X509Certificate;)Ljavax/security/auth/x500/X500Principal;
    ...
    :try_start_3
    invoke-virtual {v0, v6}, Lorg/bouncycastle/jce/provider/PKIXNameConstraintValidator;->k(Lorg/bouncycastle/asn1/ASN1Sequence;)V
    :try_end_3
    .catch Lorg/bouncycastle/jce/provider/PKIXNameConstraintValidatorException; {:try_start_3 .. :try_end_3} :catch_4
    .catch Lorg/bouncycastle/x509/CertPathReviewerException; {:try_start_3 .. :try_end_3} :catch_0

    :try_start_4
    invoke-virtual {v0, v6}, Lorg/bouncycastle/jce/provider/PKIXNameConstraintValidator;->d(Lorg/bouncycastle/asn1/ASN1Sequence;)V
    :try_end_4
    ...
    :try_start_5
    sget-object v3, Lorg/bouncycastle/x509/CertPathValidatorUtilities;->e:Ljava/lang/String;

    invoke-static {v2, v3}, Lorg/bouncycastle/x509/CertPathValidatorUtilities;->p(Ljava/security/cert/X509Extension;Ljava/lang/String;)Lorg/bouncycastle/asn1/ASN1Primitive;
    ...
    invoke-virtual {v3, v6}, Lorg/bouncycastle/asn1/ASN1Sequence;->q(I)Lorg/bouncycastle/asn1/ASN1Encodable;
    ...
    :try_start_7
    invoke-virtual {v0, v7}, Lorg/bouncycastle/jce/provider/PKIXNameConstraintValidator;->i(Lorg/bouncycastle/asn1/x509/GeneralName;)V

    invoke-virtual {v0, v7}, Lorg/bouncycastle/jce/provider/PKIXNameConstraintValidator;->b(Lorg/bouncycastle/asn1/x509/GeneralName;)V
    :try_end_7
    ...
    :cond_0
    :try_start_9
    sget-object v3, Lorg/bouncycastle/x509/CertPathValidatorUtilities;->f:Ljava/lang/String;
    ...
    :try_start_a
    invoke-static {v2}, Lorg/bouncycastle/asn1/x509/NameConstraints;->j(Ljava/lang/Object;)Lorg/bouncycastle/asn1/x509/NameConstraints;

    move-result-object v2

    invoke-virtual {v2}, Lorg/bouncycastle/asn1/x509/NameConstraints;->k()[Lorg/bouncycastle/asn1/x509/GeneralSubtree;

    move-result-object v3

    if-eqz v3, :cond_1

    invoke-virtual {v0, v3}, Lorg/bouncycastle/jce/provider/PKIXNameConstraintValidator;->F([Lorg/bouncycastle/asn1/x509/GeneralSubtree;)V

    :cond_1
    invoke-virtual {v2}, Lorg/bouncycastle/asn1/x509/NameConstraints;->i()[Lorg/bouncycastle/asn1/x509/GeneralSubtree;
    ...
    invoke-virtual {v0, v3}, Lorg/bouncycastle/jce/provider/PKIXNameConstraintValidator;->a(Lorg/bouncycastle/asn1/x509/GeneralSubtree;)V
...
.method private R()V
    ...
    iget v0, p0, Lorg/bouncycastle/x509/PKIXCertPathReviewer;->x:I
    ...
    iget-object v4, p0, Lorg/bouncycastle/x509/PKIXCertPathReviewer;->w:Ljava/util/List;
    ...
    invoke-static {v4}, Lorg/bouncycastle/x509/CertPathValidatorUtilities;->B(Ljava/security/cert/X509Certificate;)Z
    ...
    invoke-virtual {p0, v5}, Lorg/bouncycastle/x509/PKIXCertPathReviewer;->K(Lorg/bouncycastle/i18n/ErrorBundle;)V
    ...
    invoke-static {v4, v5}, Lorg/bouncycastle/x509/CertPathValidatorUtilities;->p(Ljava/security/cert/X509Extension;Ljava/lang/String;)Lorg/bouncycastle/asn1/ASN1Primitive;

    move-result-object v4

    invoke-static {v4}, Lorg/bouncycastle/asn1/x509/BasicConstraints;->h(Ljava/lang/Object;)Lorg/bouncycastle/asn1/x509/BasicConstraints;
    ...
    invoke-virtual {p0, v4, v1}, Lorg/bouncycastle/x509/PKIXCertPathReviewer;->L(Lorg/bouncycastle/i18n/ErrorBundle;I)V
    ...
    invoke-virtual {v3}, Lorg/bouncycastle/asn1/x509/BasicConstraints;->j()Ljava/math/BigInteger;
    ...
    invoke-virtual {p0, v0}, Lorg/bouncycastle/x509/PKIXCertPathReviewer;->M(Lorg/bouncycastle/i18n/ErrorBundle;)V
...
.method private S()V
    ...
    iget-object v0, v1, Lorg/bouncycastle/x509/PKIXCertPathReviewer;->u:Ljava/security/cert/PKIXParameters;

    invoke-virtual {v0}, Ljava/security/cert/PKIXParameters;->getInitialPolicies()Ljava/util/Set;

    move-result-object v0

    iget v3, v1, Lorg/bouncycastle/x509/PKIXCertPathReviewer;->x:I
    ...
    iget-object v8, v1, Lorg/bouncycastle/x509/PKIXCertPathReviewer;->u:Ljava/security/cert/PKIXParameters;
    ...
    :cond_1
    iget v8, v1, Lorg/bouncycastle/x509/PKIXCertPathReviewer;->x:I
    ...
    :goto_1
    iget-object v10, v1, Lorg/bouncycastle/x509/PKIXCertPathReviewer;->u:Ljava/security/cert/PKIXParameters;
    ...
    :cond_2
    iget v10, v1, Lorg/bouncycastle/x509/PKIXCertPathReviewer;->x:I

    add-int/2addr v10, v9

    :goto_2
    iget-object v11, v1, Lorg/bouncycastle/x509/PKIXCertPathReviewer;->u:Ljava/security/cert/PKIXParameters;
    ...
    :cond_3
    iget v11, v1, Lorg/bouncycastle/x509/PKIXCertPathReviewer;->x:I

    add-int/2addr v11, v9

    :goto_3
    :try_start_0
    iget-object v12, v1, Lorg/bouncycastle/x509/PKIXCertPathReviewer;->w:Ljava/util/List;
    ...
    :try_start_1
    iget v4, v1, Lorg/bouncycastle/x509/PKIXCertPathReviewer;->x:I

    sub-int/2addr v4, v12

    iget-object v6, v1, Lorg/bouncycastle/x509/PKIXCertPathReviewer;->w:Ljava/util/List;
    ...
    :try_start_2
    sget-object v3, Lorg/bouncycastle/x509/CertPathValidatorUtilities;->b:Ljava/lang/String;

    invoke-static {v6, v3}, Lorg/bouncycastle/x509/CertPathValidatorUtilities;->p(Ljava/security/cert/X509Extension;Ljava/lang/String;)Lorg/bouncycastle/asn1/ASN1Primitive;
    ...
    :try_start_3
    invoke-virtual {v3}, Lorg/bouncycastle/asn1/ASN1Sequence;->r()Ljava/util/Enumeration;
    ...
    invoke-static/range {v18 .. v18}, Lorg/bouncycastle/asn1/x509/PolicyInformation;->g(Ljava/lang/Object;)Lorg/bouncycastle/asn1/x509/PolicyInformation;

    move-result-object v18

    move-object/from16 v28, v15

    invoke-virtual/range {v18 .. v18}, Lorg/bouncycastle/asn1/x509/PolicyInformation;->h()Lorg/bouncycastle/asn1/ASN1ObjectIdentifier;
    ...
    :try_start_4
    invoke-virtual/range {v18 .. v18}, Lorg/bouncycastle/asn1/x509/PolicyInformation;->i()Lorg/bouncycastle/asn1/ASN1Sequence;
    ...
    :try_start_5
    invoke-static {v4, v5, v15, v2}, Lorg/bouncycastle/x509/CertPathValidatorUtilities;->E(I[Ljava/util/List;Lorg/bouncycastle/asn1/ASN1ObjectIdentifier;Ljava/util/Set;)Z

    move-result v18

    if-nez v18, :cond_4

    invoke-static {v4, v5, v15, v2}, Lorg/bouncycastle/x509/CertPathValidatorUtilities;->F(I[Ljava/util/List;Lorg/bouncycastle/asn1/ASN1ObjectIdentifier;Ljava/util/Set;)V
    ...
    iget-object v4, v1, Lorg/bouncycastle/x509/PKIXCertPathReviewer;->t:Ljava/security/cert/CertPath;
    ...
    iget v0, v1, Lorg/bouncycastle/x509/PKIXCertPathReviewer;->x:I

    if-ge v4, v0, :cond_a

    invoke-static {v6}, Lorg/bouncycastle/x509/CertPathValidatorUtilities;->B(Ljava/security/cert/X509Certificate;)Z
    ...
    invoke-virtual {v2}, Lorg/bouncycastle/asn1/x509/PolicyInformation;->h()Lorg/bouncycastle/asn1/ASN1ObjectIdentifier;
    ...
    :try_start_6
    invoke-virtual {v2}, Lorg/bouncycastle/asn1/x509/PolicyInformation;->i()Lorg/bouncycastle/asn1/ASN1Sequence;

    move-result-object v0

    invoke-static {v0}, Lorg/bouncycastle/x509/CertPathValidatorUtilities;->t(Lorg/bouncycastle/asn1/ASN1Sequence;)Ljava/util/Set;
    ...
    invoke-virtual {v13, v11}, Lorg/bouncycastle/jce/provider/PKIXPolicyNode;->a(Lorg/bouncycastle/jce/provider/PKIXPolicyNode;)V
    ...
    invoke-virtual {v11}, Lorg/bouncycastle/jce/provider/PKIXPolicyNode;->c()Z

    move-result v13

    if-nez v13, :cond_14

    invoke-static {v15, v5, v11}, Lorg/bouncycastle/x509/CertPathValidatorUtilities;->G(Lorg/bouncycastle/jce/provider/PKIXPolicyNode;[Ljava/util/List;Lorg/bouncycastle/jce/provider/PKIXPolicyNode;)Lorg/bouncycastle/jce/provider/PKIXPolicyNode;
    ...
    invoke-virtual {v11, v0}, Lorg/bouncycastle/jce/provider/PKIXPolicyNode;->e(Z)V
    ...
    :try_start_8
    sget-object v0, Lorg/bouncycastle/x509/CertPathValidatorUtilities;->d:Ljava/lang/String;

    invoke-static {v6, v0}, Lorg/bouncycastle/x509/CertPathValidatorUtilities;->p(Ljava/security/cert/X509Extension;Ljava/lang/String;)Lorg/bouncycastle/asn1/ASN1Primitive;
    ...
    invoke-virtual {v10, v11}, Lorg/bouncycastle/asn1/ASN1Sequence;->q(I)Lorg/bouncycastle/asn1/ASN1Encodable;
    ...
    invoke-virtual/range {v17 .. v17}, Lorg/bouncycastle/asn1/ASN1ObjectIdentifier;->r()Ljava/lang/String;
    ...
    iget-object v3, v1, Lorg/bouncycastle/x509/PKIXCertPathReviewer;->t:Ljava/security/cert/CertPath;
    ...
    invoke-virtual {v0, v10}, Lorg/bouncycastle/asn1/ASN1Sequence;->q(I)Lorg/bouncycastle/asn1/ASN1Encodable;
    ...
    invoke-virtual {v11, v0}, Lorg/bouncycastle/asn1/ASN1Sequence;->q(I)Lorg/bouncycastle/asn1/ASN1Encodable;
    ...
    invoke-virtual {v11, v13}, Lorg/bouncycastle/asn1/ASN1Sequence;->q(I)Lorg/bouncycastle/asn1/ASN1Encodable;
    ...
    :try_start_b
    invoke-static {v4, v5, v3, v2, v6}, Lorg/bouncycastle/x509/CertPathValidatorUtilities;->C(I[Ljava/util/List;Ljava/lang/String;Ljava/util/Map;Ljava/security/cert/X509Certificate;)V
    :try_end_b
    ...
    invoke-static {v4, v5, v3, v15}, Lorg/bouncycastle/x509/CertPathValidatorUtilities;->D(I[Ljava/util/List;Ljava/lang/String;Lorg/bouncycastle/jce/provider/PKIXPolicyNode;)Lorg/bouncycastle/jce/provider/PKIXPolicyNode;
    ...
    :goto_1e
    :try_start_d
    sget-object v2, Lorg/bouncycastle/x509/CertPathValidatorUtilities;->k:Ljava/lang/String;

    invoke-static {v6, v2}, Lorg/bouncycastle/x509/CertPathValidatorUtilities;->p(Ljava/security/cert/X509Extension;Ljava/lang/String;)Lorg/bouncycastle/asn1/ASN1Primitive;
    ...
    invoke-static {v3, v4}, Lorg/bouncycastle/asn1/ASN1Integer;->o(Lorg/bouncycastle/asn1/ASN1TaggedObject;Z)Lorg/bouncycastle/asn1/ASN1Integer;
    ...
    :cond_2c
    :try_start_e
    sget-object v2, Lorg/bouncycastle/x509/CertPathValidatorUtilities;->h:Ljava/lang/String;
    ...
    :cond_30
    :try_start_10
    sget-object v0, Lorg/bouncycastle/x509/CertPathValidatorUtilities;->k:Ljava/lang/String;

    invoke-static {v4, v0}, Lorg/bouncycastle/x509/CertPathValidatorUtilities;->p(Ljava/security/cert/X509Extension;Ljava/lang/String;)Lorg/bouncycastle/asn1/ASN1Primitive;
    ...
    :try_start_11
    iget-object v2, v1, Lorg/bouncycastle/x509/PKIXCertPathReviewer;->u:Ljava/security/cert/PKIXParameters;
    ...
    :cond_36
    invoke-static/range {v27 .. v27}, Lorg/bouncycastle/x509/CertPathValidatorUtilities;->y(Ljava/util/Set;)Z
    ...
    invoke-virtual {v3}, Lorg/bouncycastle/jce/provider/PKIXPolicyNode;->c()Z

    move-result v6

    if-nez v6, :cond_3b

    invoke-static {v15, v5, v3}, Lorg/bouncycastle/x509/CertPathValidatorUtilities;->G(Lorg/bouncycastle/jce/provider/PKIXPolicyNode;[Ljava/util/List;Lorg/bouncycastle/jce/provider/PKIXPolicyNode;)Lorg/bouncycastle/jce/provider/PKIXPolicyNode;
    ...
    invoke-static {v15, v5, v2}, Lorg/bouncycastle/x509/CertPathValidatorUtilities;->G(Lorg/bouncycastle/jce/provider/PKIXPolicyNode;[Ljava/util/List;Lorg/bouncycastle/jce/provider/PKIXPolicyNode;)Lorg/bouncycastle/jce/provider/PKIXPolicyNode;
    ...
    invoke-virtual {v1, v2, v0}, Lorg/bouncycastle/x509/PKIXCertPathReviewer;->L(Lorg/bouncycastle/i18n/ErrorBundle;I)V
...
.method private U()V
    ...
    iget-object v2, v10, Lorg/bouncycastle/x509/PKIXCertPathReviewer;->v:Ljava/util/Date;
    ...
    invoke-virtual {v10, v0}, Lorg/bouncycastle/x509/PKIXCertPathReviewer;->M(Lorg/bouncycastle/i18n/ErrorBundle;)V

    const/4 v12, 0x1

    :try_start_0
    iget-object v0, v10, Lorg/bouncycastle/x509/PKIXCertPathReviewer;->w:Ljava/util/List;
    ...
    iget-object v1, v10, Lorg/bouncycastle/x509/PKIXCertPathReviewer;->u:Ljava/security/cert/PKIXParameters;

    invoke-virtual {v1}, Ljava/security/cert/PKIXParameters;->getTrustAnchors()Ljava/util/Set;

    move-result-object v1

    invoke-virtual {v10, v0, v1}, Lorg/bouncycastle/x509/PKIXCertPathReviewer;->i0(Ljava/security/cert/X509Certificate;Ljava/util/Set;)Ljava/util/Collection;
    ...
    invoke-virtual {v10, v2}, Lorg/bouncycastle/x509/PKIXCertPathReviewer;->K(Lorg/bouncycastle/i18n/ErrorBundle;)V
    ...
    iget-object v0, v10, Lorg/bouncycastle/x509/PKIXCertPathReviewer;->u:Ljava/security/cert/PKIXParameters;
    ...
    invoke-virtual {v10, v1}, Lorg/bouncycastle/x509/PKIXCertPathReviewer;->K(Lorg/bouncycastle/i18n/ErrorBundle;)V
    ...
    :goto_1
    :try_start_2
    iget-object v3, v10, Lorg/bouncycastle/x509/PKIXCertPathReviewer;->u:Ljava/security/cert/PKIXParameters;

    invoke-virtual {v3}, Ljava/security/cert/PKIXParameters;->getSigProvider()Ljava/lang/String;

    move-result-object v3

    invoke-static {v0, v2, v3}, Lorg/bouncycastle/x509/CertPathValidatorUtilities;->I(Ljava/security/cert/X509Certificate;Ljava/security/PublicKey;Ljava/lang/String;)V
    :try_end_2
    ...
    invoke-virtual {v10, v0}, Lorg/bouncycastle/x509/PKIXCertPathReviewer;->K(Lorg/bouncycastle/i18n/ErrorBundle;)V
    :try_end_3
    ...
    :try_start_4
    invoke-static {v0}, Lorg/bouncycastle/x509/CertPathValidatorUtilities;->v(Ljava/security/cert/X509Certificate;)Ljavax/security/auth/x500/X500Principal;
    ...
    :goto_8
    :try_start_5
    invoke-static {v2}, Lorg/bouncycastle/x509/CertPathValidatorUtilities;->j(Ljava/security/PublicKey;)Lorg/bouncycastle/asn1/x509/AlgorithmIdentifier;
    ...
    invoke-virtual {v10, v3}, Lorg/bouncycastle/x509/PKIXCertPathReviewer;->K(Lorg/bouncycastle/i18n/ErrorBundle;)V
    ...
    :goto_9
    iget-object v3, v10, Lorg/bouncycastle/x509/PKIXCertPathReviewer;->w:Ljava/util/List;
    ...
    iget v0, v10, Lorg/bouncycastle/x509/PKIXCertPathReviewer;->x:I
    ...
    invoke-static {v4, v8, v0}, Lorg/bouncycastle/x509/CertPathValidatorUtilities;->I(Ljava/security/cert/X509Certificate;Ljava/security/PublicKey;Ljava/lang/String;)V
    :try_end_6
    ...
    :goto_b
    invoke-virtual {v10, v2, v7}, Lorg/bouncycastle/x509/PKIXCertPathReviewer;->L(Lorg/bouncycastle/i18n/ErrorBundle;I)V
    ...
    iget-object v2, v10, Lorg/bouncycastle/x509/PKIXCertPathReviewer;->u:Ljava/security/cert/PKIXParameters;

    invoke-virtual {v2}, Ljava/security/cert/PKIXParameters;->getSigProvider()Ljava/lang/String;

    move-result-object v2

    invoke-static {v4, v0, v2}, Lorg/bouncycastle/x509/CertPathValidatorUtilities;->I(Ljava/security/cert/X509Certificate;Ljava/security/PublicKey;Ljava/lang/String;)V
    ...
    invoke-virtual {v10, v0, v7}, Lorg/bouncycastle/x509/PKIXCertPathReviewer;->L(Lorg/bouncycastle/i18n/ErrorBundle;I)V
    :try_end_7
    ...
    sget-object v1, Lorg/bouncycastle/asn1/x509/Extension;->v:Lorg/bouncycastle/asn1/ASN1ObjectIdentifier;
    ...
    invoke-static {v1}, Lorg/bouncycastle/asn1/x509/AuthorityKeyIdentifier;->j(Ljava/lang/Object;)Lorg/bouncycastle/asn1/x509/AuthorityKeyIdentifier;

    move-result-object v1

    invoke-virtual {v1}, Lorg/bouncycastle/asn1/x509/AuthorityKeyIdentifier;->h()Lorg/bouncycastle/asn1/x509/GeneralNames;
    ...
    invoke-virtual {v1}, Lorg/bouncycastle/asn1/x509/AuthorityKeyIdentifier;->i()Ljava/math/BigInteger;
    ...
    invoke-virtual {v0, v1}, Lorg/bouncycastle/i18n/LocalizedMessage;->l([Ljava/lang/Object;)V
    ...
    :goto_c
    :try_start_8
    iget-object v0, v10, Lorg/bouncycastle/x509/PKIXCertPathReviewer;->v:Ljava/util/Date;
    ...
    :try_start_9
    sget-object v0, Lorg/bouncycastle/x509/PKIXCertPathReviewer;->F:Ljava/lang/String;
    ...
    invoke-static {v0}, Lorg/bouncycastle/asn1/x509/CRLDistPoint;->h(Ljava/lang/Object;)Lorg/bouncycastle/asn1/x509/CRLDistPoint;
    ...
    :goto_f
    :try_start_a
    sget-object v1, Lorg/bouncycastle/x509/PKIXCertPathReviewer;->G:Ljava/lang/String;

    invoke-static {v4, v1}, Lorg/bouncycastle/x509/CertPathValidatorUtilities;->p(Ljava/security/cert/X509Extension;Ljava/lang/String;)Lorg/bouncycastle/asn1/ASN1Primitive;

    move-result-object v1

    if-eqz v1, :cond_c

    invoke-static {v1}, Lorg/bouncycastle/asn1/x509/AuthorityInformationAccess;->i(Ljava/lang/Object;)Lorg/bouncycastle/asn1/x509/AuthorityInformationAccess;
    ...
    invoke-virtual {v10, v1, v7}, Lorg/bouncycastle/x509/PKIXCertPathReviewer;->L(Lorg/bouncycastle/i18n/ErrorBundle;I)V

    :cond_c
    const/4 v1, 0x0

    :goto_10
    invoke-virtual {v10, v0}, Lorg/bouncycastle/x509/PKIXCertPathReviewer;->X(Lorg/bouncycastle/asn1/x509/CRLDistPoint;)Ljava/util/Vector;

    move-result-object v0

    invoke-virtual {v10, v1}, Lorg/bouncycastle/x509/PKIXCertPathReviewer;->e0(Lorg/bouncycastle/asn1/x509/AuthorityInformationAccess;)Ljava/util/Vector;
    ...
    invoke-virtual {v10, v2, v7}, Lorg/bouncycastle/x509/PKIXCertPathReviewer;->N(Lorg/bouncycastle/i18n/ErrorBundle;I)V
    ...
    iget-object v15, v10, Lorg/bouncycastle/x509/PKIXCertPathReviewer;->v:Ljava/util/Date;
    :try_end_b
    ...
    :try_start_c
    invoke-virtual/range {v1 .. v9}, Lorg/bouncycastle/x509/PKIXCertPathReviewer;->T(Ljava/security/cert/PKIXParameters;Ljava/security/cert/X509Certificate;Ljava/util/Date;Ljava/security/cert/X509Certificate;Ljava/security/PublicKey;Ljava/util/Vector;Ljava/util/Vector;I)V
    :try_end_c
    ...
    invoke-virtual {v10, v0, v3}, Lorg/bouncycastle/x509/PKIXCertPathReviewer;->L(Lorg/bouncycastle/i18n/ErrorBundle;I)V
    ...
    invoke-virtual {v10, v2, v3}, Lorg/bouncycastle/x509/PKIXCertPathReviewer;->L(Lorg/bouncycastle/i18n/ErrorBundle;I)V

    :cond_11
    :try_start_d
    sget-object v2, Lorg/bouncycastle/x509/CertPathValidatorUtilities;->c:Ljava/lang/String;

    invoke-static {v1, v2}, Lorg/bouncycastle/x509/CertPathValidatorUtilities;->p(Ljava/security/cert/X509Extension;Ljava/lang/String;)Lorg/bouncycastle/asn1/ASN1Primitive;

    move-result-object v2

    invoke-static {v2}, Lorg/bouncycastle/asn1/x509/BasicConstraints;->h(Ljava/lang/Object;)Lorg/bouncycastle/asn1/x509/BasicConstraints;

    move-result-object v2

    if-eqz v2, :cond_12

    invoke-virtual {v2}, Lorg/bouncycastle/asn1/x509/BasicConstraints;->k()Z
    ...
    invoke-direct {v0, v11, v4}, Lorg/bouncycastle/i18n/ErrorBundle;-><init>(Ljava/lang/String;Ljava/lang/String;)V
    ...
    invoke-static {v0, v3}, Lorg/bouncycastle/x509/CertPathValidatorUtilities;->r(Ljava/util/List;I)Ljava/security/PublicKey;
    ...
    :try_start_f
    invoke-static {v8}, Lorg/bouncycastle/x509/CertPathValidatorUtilities;->j(Ljava/security/PublicKey;)Lorg/bouncycastle/asn1/x509/AlgorithmIdentifier;
    ...
    iput-object v14, v10, Lorg/bouncycastle/x509/PKIXCertPathReviewer;->A:Ljava/security/cert/TrustAnchor;

    move-object/from16 v2, v24

    iput-object v2, v10, Lorg/bouncycastle/x509/PKIXCertPathReviewer;->B:Ljava/security/PublicKey;
...
.method private l0(Ljava/security/cert/X509Certificate;I)Z
    ...
    :try_start_0
    sget-object v2, Lorg/bouncycastle/x509/PKIXCertPathReviewer;->E:Ljava/lang/String;

    invoke-static {p1, v2}, Lorg/bouncycastle/x509/CertPathValidatorUtilities;->p(Ljava/security/cert/X509Extension;Ljava/lang/String;)Lorg/bouncycastle/asn1/ASN1Primitive;
    ...
    invoke-static {v4}, Lorg/bouncycastle/asn1/x509/qualified/QCStatement;->g(Ljava/lang/Object;)Lorg/bouncycastle/asn1/x509/qualified/QCStatement;

    move-result-object v4

    sget-object v6, Lorg/bouncycastle/asn1/x509/qualified/ETSIQCObjectIdentifiers;->Y4:Lorg/bouncycastle/asn1/ASN1ObjectIdentifier;

    invoke-virtual {v4}, Lorg/bouncycastle/asn1/x509/qualified/QCStatement;->h()Lorg/bouncycastle/asn1/ASN1ObjectIdentifier;

    move-result-object v7

    invoke-virtual {v6, v7}, Lorg/bouncycastle/asn1/ASN1Primitive;->equals(Ljava/lang/Object;)Z
    ...
    :goto_1
    invoke-virtual {p0, v4, p2}, Lorg/bouncycastle/x509/PKIXCertPathReviewer;->N(Lorg/bouncycastle/i18n/ErrorBundle;I)V

    goto/16 :goto_3

    :cond_0
    sget-object v6, Lorg/bouncycastle/asn1/x509/qualified/RFC3739QCObjectIdentifiers;->h5:Lorg/bouncycastle/asn1/ASN1ObjectIdentifier;
    ...
    :cond_1
    sget-object v6, Lorg/bouncycastle/asn1/x509/qualified/ETSIQCObjectIdentifiers;->b5:Lorg/bouncycastle/asn1/ASN1ObjectIdentifier;
    ...
    :cond_2
    sget-object v6, Lorg/bouncycastle/asn1/x509/qualified/ETSIQCObjectIdentifiers;->Z4:Lorg/bouncycastle/asn1/ASN1ObjectIdentifier;
    ...
    invoke-virtual {v4}, Lorg/bouncycastle/asn1/x509/qualified/QCStatement;->i()Lorg/bouncycastle/asn1/ASN1Encodable;

    move-result-object v4

    invoke-static {v4}, Lorg/bouncycastle/asn1/x509/qualified/MonetaryValue;->j(Ljava/lang/Object;)Lorg/bouncycastle/asn1/x509/qualified/MonetaryValue;

    move-result-object v4

    invoke-virtual {v4}, Lorg/bouncycastle/asn1/x509/qualified/MonetaryValue;->h()Lorg/bouncycastle/asn1/x509/qualified/Iso4217CurrencyCode;

    invoke-virtual {v4}, Lorg/bouncycastle/asn1/x509/qualified/MonetaryValue;->g()Ljava/math/BigInteger;
    ...
    invoke-virtual {v4}, Lorg/bouncycastle/asn1/x509/qualified/MonetaryValue;->i()Ljava/math/BigInteger;
    ...
    invoke-virtual {v7}, Lorg/bouncycastle/asn1/x509/qualified/Iso4217CurrencyCode;->j()Z
    ...
    invoke-virtual {v9}, Lorg/bouncycastle/asn1/x509/qualified/Iso4217CurrencyCode;->g()Ljava/lang/String;
    ...
    invoke-virtual {v9}, Lorg/bouncycastle/asn1/x509/qualified/Iso4217CurrencyCode;->i()I
    ...
    :goto_2
    invoke-virtual {p0, v7, p2}, Lorg/bouncycastle/x509/PKIXCertPathReviewer;->N(Lorg/bouncycastle/i18n/ErrorBundle;I)V
    ...
    invoke-virtual {p0, v3, p2}, Lorg/bouncycastle/x509/PKIXCertPathReviewer;->N(Lorg/bouncycastle/i18n/ErrorBundle;I)V
    :try_end_0
    .catch Lorg/bouncycastle/jce/provider/AnnotatedException; {:try_start_0 .. :try_end_0} :catch_0
    ...
    invoke-virtual {p0, p1, p2}, Lorg/bouncycastle/x509/PKIXCertPathReviewer;->L(Lorg/bouncycastle/i18n/ErrorBundle;I)V
...
# virtual methods
.method protected K(Lorg/bouncycastle/i18n/ErrorBundle;)V
    .locals 1

    iget-object p0, p0, Lorg/bouncycastle/x509/PKIXCertPathReviewer;->z:[Ljava/util/List;
...
.method protected L(Lorg/bouncycastle/i18n/ErrorBundle;I)V
    .locals 1
...
.method protected M(Lorg/bouncycastle/i18n/ErrorBundle;)V
    .locals 1

    iget-object p0, p0, Lorg/bouncycastle/x509/PKIXCertPathReviewer;->y:[Ljava/util/List;
...
.method protected N(Lorg/bouncycastle/i18n/ErrorBundle;I)V
    .locals 1
...
.method protected O(Ljava/security/cert/PKIXParameters;Ljava/security/cert/X509Certificate;Ljava/util/Date;Ljava/security/cert/X509Certificate;Ljava/security/PublicKey;Ljava/util/Vector;I)V
    ...
    :try_start_0
    invoke-static/range {p2 .. p2}, Lorg/bouncycastle/x509/CertPathValidatorUtilities;->o(Ljava/lang/Object;)Ljavax/security/auth/x500/X500Principal;
    ...
    :try_start_1
    sget-object v10, Lorg/bouncycastle/x509/CertPathValidatorUtilities;->a:Lorg/bouncycastle/x509/PKIXCRLUtil;

    invoke-virtual {v10, v0, v2}, Lorg/bouncycastle/x509/PKIXCRLUtil;->b(Lorg/bouncycastle/x509/X509CRLStoreSelector;Ljava/security/cert/PKIXParameters;)Ljava/util/Set;
    ...
    invoke-virtual {v10, v11, v2}, Lorg/bouncycastle/x509/PKIXCRLUtil;->b(Lorg/bouncycastle/x509/X509CRLStoreSelector;Ljava/security/cert/PKIXParameters;)Ljava/util/Set;
    ...
    invoke-direct {v15, v0}, Lorg/bouncycastle/i18n/filter/UntrustedInput;-><init>(Ljava/lang/Object;)V
    ...
    invoke-static {v10}, Lorg/bouncycastle/util/Integers;->c(I)Ljava/lang/Integer;
    ...
    invoke-direct {v13, v9, v14, v0}, Lorg/bouncycastle/i18n/ErrorBundle;-><init>(Ljava/lang/String;Ljava/lang/String;[Ljava/lang/Object;)V

    invoke-virtual {v1, v13, v5}, Lorg/bouncycastle/x509/PKIXCertPathReviewer;->N(Lorg/bouncycastle/i18n/ErrorBundle;I)V
    :try_end_1
    ...
    invoke-direct {v10, v9, v8, v0}, Lorg/bouncycastle/i18n/ErrorBundle;-><init>(Ljava/lang/String;Ljava/lang/String;[Ljava/lang/Object;)V

    invoke-virtual {v1, v10, v5}, Lorg/bouncycastle/x509/PKIXCertPathReviewer;->L(Lorg/bouncycastle/i18n/ErrorBundle;I)V
    ...
    invoke-virtual {v11, v14}, Ljava/util/Date;->before(Ljava/util/Date;)Z
    ...
    invoke-direct {v11, v9, v14, v13}, Lorg/bouncycastle/i18n/ErrorBundle;-><init>(Ljava/lang/String;Ljava/lang/String;[Ljava/lang/Object;)V

    invoke-virtual {v1, v11, v5}, Lorg/bouncycastle/x509/PKIXCertPathReviewer;->N(Lorg/bouncycastle/i18n/ErrorBundle;I)V
    ...
    invoke-direct {v11, v9, v14, v12}, Lorg/bouncycastle/i18n/ErrorBundle;-><init>(Ljava/lang/String;Ljava/lang/String;[Ljava/lang/Object;)V
    ...
    invoke-direct {v1, v0}, Lorg/bouncycastle/x509/PKIXCertPathReviewer;->W(Ljava/lang/String;)Ljava/security/cert/X509CRL;
    ...
    :try_end_2
    .catch Lorg/bouncycastle/x509/CertPathReviewerException; {:try_start_2 .. :try_end_2} :catch_3
    ...
    invoke-direct {v11, v15}, Lorg/bouncycastle/i18n/filter/UntrustedInput;-><init>(Ljava/lang/Object;)V
    ...
    invoke-direct {v15, v12}, Lorg/bouncycastle/i18n/filter/UntrustedInput;-><init>(Ljava/lang/Object;)V
    ...
    invoke-direct {v10, v9, v13, v0}, Lorg/bouncycastle/i18n/ErrorBundle;-><init>(Ljava/lang/String;Ljava/lang/String;[Ljava/lang/Object;)V

    :goto_7
    invoke-virtual {v1, v10, v5}, Lorg/bouncycastle/x509/PKIXCertPathReviewer;->N(Lorg/bouncycastle/i18n/ErrorBundle;I)V
    ...
    invoke-direct {v10, v9, v11, v0}, Lorg/bouncycastle/i18n/ErrorBundle;-><init>(Ljava/lang/String;Ljava/lang/String;[Ljava/lang/Object;)V
    :try_end_4
    ...
    invoke-virtual {v1, v0, v5}, Lorg/bouncycastle/x509/PKIXCertPathReviewer;->N(Lorg/bouncycastle/i18n/ErrorBundle;I)V
    ...
    invoke-direct {v0, v9, v1}, Lorg/bouncycastle/i18n/ErrorBundle;-><init>(Ljava/lang/String;Ljava/lang/String;)V
    ...
    :try_start_7
    sget-object v10, Lorg/bouncycastle/asn1/x509/Extension;->l:Lorg/bouncycastle/asn1/ASN1ObjectIdentifier;

    invoke-virtual {v10}, Lorg/bouncycastle/asn1/ASN1ObjectIdentifier;->r()Ljava/lang/String;

    move-result-object v10

    invoke-static {v4, v10}, Lorg/bouncycastle/x509/CertPathValidatorUtilities;->p(Ljava/security/cert/X509Extension;Ljava/lang/String;)Lorg/bouncycastle/asn1/ASN1Primitive;

    move-result-object v10

    invoke-static {v10}, Lorg/bouncycastle/asn1/ASN1Enumerated;->o(Ljava/lang/Object;)Lorg/bouncycastle/asn1/ASN1Enumerated;
    ...
    sget-object v12, Lorg/bouncycastle/x509/CertPathValidatorUtilities;->s:[Ljava/lang/String;

    invoke-virtual {v10}, Lorg/bouncycastle/asn1/ASN1Enumerated;->q()Ljava/math/BigInteger;
    ...
    invoke-direct {v1, v9, v2}, Lorg/bouncycastle/i18n/ErrorBundle;-><init>(Ljava/lang/String;Ljava/lang/String;)V
    ...
    sget-object v10, Lorg/bouncycastle/x509/CertPathValidatorUtilities;->s:[Ljava/lang/String;
    ...
    invoke-direct {v10, v9, v4, v0}, Lorg/bouncycastle/i18n/ErrorBundle;-><init>(Ljava/lang/String;Ljava/lang/String;[Ljava/lang/Object;)V
    ...
    invoke-direct {v1, v9, v2, v0}, Lorg/bouncycastle/i18n/ErrorBundle;-><init>(Ljava/lang/String;Ljava/lang/String;[Ljava/lang/Object;)V
    ...
    iget-object v4, v1, Lorg/bouncycastle/x509/PKIXCertPathReviewer;->u:Ljava/security/cert/PKIXParameters;
    ...
    invoke-direct {v4, v10}, Lorg/bouncycastle/i18n/filter/TrustedInput;-><init>(Ljava/lang/Object;)V
    ...
    invoke-direct {v0, v9, v10, v4}, Lorg/bouncycastle/i18n/ErrorBundle;-><init>(Ljava/lang/String;Ljava/lang/String;[Ljava/lang/Object;)V

    invoke-virtual {v1, v0, v5}, Lorg/bouncycastle/x509/PKIXCertPathReviewer;->N(Lorg/bouncycastle/i18n/ErrorBundle;I)V

    :cond_11
    :try_start_8
    sget-object v0, Lorg/bouncycastle/x509/CertPathValidatorUtilities;->i:Ljava/lang/String;

    invoke-static {v11, v0}, Lorg/bouncycastle/x509/CertPathValidatorUtilities;->p(Ljava/security/cert/X509Extension;Ljava/lang/String;)Lorg/bouncycastle/asn1/ASN1Primitive;
    ...
    :try_start_9
    sget-object v1, Lorg/bouncycastle/x509/CertPathValidatorUtilities;->j:Ljava/lang/String;

    invoke-static {v11, v1}, Lorg/bouncycastle/x509/CertPathValidatorUtilities;->p(Ljava/security/cert/X509Extension;Ljava/lang/String;)Lorg/bouncycastle/asn1/ASN1Primitive;
    ...
    :try_start_a
    invoke-static {v11}, Lorg/bouncycastle/x509/CertPathValidatorUtilities;->q(Ljava/security/cert/X509CRL;)Ljavax/security/auth/x500/X500Principal;
    ...
    :try_start_c
    sget-object v1, Lorg/bouncycastle/x509/CertPathValidatorUtilities;->a:Lorg/bouncycastle/x509/PKIXCRLUtil;

    invoke-virtual {v1, v4, v2}, Lorg/bouncycastle/x509/PKIXCRLUtil;->b(Lorg/bouncycastle/x509/X509CRLStoreSelector;Ljava/security/cert/PKIXParameters;)Ljava/util/Set;
    ...
    :try_start_d
    sget-object v4, Lorg/bouncycastle/x509/CertPathValidatorUtilities;->i:Ljava/lang/String;

    invoke-static {v2, v4}, Lorg/bouncycastle/x509/CertPathValidatorUtilities;->p(Ljava/security/cert/X509Extension;Ljava/lang/String;)Lorg/bouncycastle/asn1/ASN1Primitive;
    ...
    invoke-direct {v1, v9, v7}, Lorg/bouncycastle/i18n/ErrorBundle;-><init>(Ljava/lang/String;Ljava/lang/String;)V
    ...
    invoke-direct {v1, v9, v8}, Lorg/bouncycastle/i18n/ErrorBundle;-><init>(Ljava/lang/String;Ljava/lang/String;)V
    ...
    invoke-direct {v1, v9, v6}, Lorg/bouncycastle/i18n/ErrorBundle;-><init>(Ljava/lang/String;Ljava/lang/String;)V
    ...
    invoke-static {v0}, Lorg/bouncycastle/asn1/x509/IssuingDistributionPoint;->j(Ljava/lang/Object;)Lorg/bouncycastle/asn1/x509/IssuingDistributionPoint;

    move-result-object v0

    :try_start_e
    sget-object v1, Lorg/bouncycastle/x509/CertPathValidatorUtilities;->c:Ljava/lang/String;

    invoke-static {v3, v1}, Lorg/bouncycastle/x509/CertPathValidatorUtilities;->p(Ljava/security/cert/X509Extension;Ljava/lang/String;)Lorg/bouncycastle/asn1/ASN1Primitive;

    move-result-object v1

    invoke-static {v1}, Lorg/bouncycastle/asn1/x509/BasicConstraints;->h(Ljava/lang/Object;)Lorg/bouncycastle/asn1/x509/BasicConstraints;

    move-result-object v1
    :try_end_e
    .catch Lorg/bouncycastle/jce/provider/AnnotatedException; {:try_start_e .. :try_end_e} :catch_a

    invoke-virtual {v0}, Lorg/bouncycastle/asn1/x509/IssuingDistributionPoint;->p()Z
    ...
    invoke-virtual {v1}, Lorg/bouncycastle/asn1/x509/BasicConstraints;->k()Z
    ...
    :cond_17
    :goto_11
    invoke-virtual {v0}, Lorg/bouncycastle/asn1/x509/IssuingDistributionPoint;->o()Z
    ...
    :cond_19
    :goto_12
    invoke-virtual {v0}, Lorg/bouncycastle/asn1/x509/IssuingDistributionPoint;->n()Z
...
.method protected T(Ljava/security/cert/PKIXParameters;Ljava/security/cert/X509Certificate;Ljava/util/Date;Ljava/security/cert/X509Certificate;Ljava/security/PublicKey;Ljava/util/Vector;Ljava/util/Vector;I)V
    ...
    invoke-virtual/range {v0 .. v7}, Lorg/bouncycastle/x509/PKIXCertPathReviewer;->O(Ljava/security/cert/PKIXParameters;Ljava/security/cert/X509Certificate;Ljava/util/Date;Ljava/security/cert/X509Certificate;Ljava/security/PublicKey;Ljava/util/Vector;I)V
...
.method protected V()V
    ...
    iget-boolean v0, p0, Lorg/bouncycastle/x509/PKIXCertPathReviewer;->D:Z

    if-eqz v0, :cond_2

    iget-object v0, p0, Lorg/bouncycastle/x509/PKIXCertPathReviewer;->y:[Ljava/util/List;
    ...
    iput-object v1, p0, Lorg/bouncycastle/x509/PKIXCertPathReviewer;->y:[Ljava/util/List;

    add-int/lit8 v0, v0, 0x1

    new-array v0, v0, [Ljava/util/List;

    iput-object v0, p0, Lorg/bouncycastle/x509/PKIXCertPathReviewer;->z:[Ljava/util/List;

    const/4 v0, 0x0

    :goto_0
    iget-object v1, p0, Lorg/bouncycastle/x509/PKIXCertPathReviewer;->y:[Ljava/util/List;
    ...
    iget-object v1, p0, Lorg/bouncycastle/x509/PKIXCertPathReviewer;->z:[Ljava/util/List;
    ...
    :cond_0
    invoke-direct {p0}, Lorg/bouncycastle/x509/PKIXCertPathReviewer;->U()V

    invoke-direct {p0}, Lorg/bouncycastle/x509/PKIXCertPathReviewer;->Q()V

    invoke-direct {p0}, Lorg/bouncycastle/x509/PKIXCertPathReviewer;->R()V

    invoke-direct {p0}, Lorg/bouncycastle/x509/PKIXCertPathReviewer;->S()V

    invoke-direct {p0}, Lorg/bouncycastle/x509/PKIXCertPathReviewer;->P()V
...
.method protected X(Lorg/bouncycastle/asn1/x509/CRLDistPoint;)Ljava/util/Vector;
    .locals 6
    ...
    invoke-virtual {p1}, Lorg/bouncycastle/asn1/x509/CRLDistPoint;->g()[Lorg/bouncycastle/asn1/x509/DistributionPoint;
...
.method public Y()Ljava/security/cert/CertPath;
    ...
    iget-object p0, p0, Lorg/bouncycastle/x509/PKIXCertPathReviewer;->t:Ljava/security/cert/CertPath;
...
.method public Z()I
    ...
    iget p0, p0, Lorg/bouncycastle/x509/PKIXCertPathReviewer;->x:I
...
.method public a0(I)Ljava/util/List;
    ...
    invoke-virtual {p0}, Lorg/bouncycastle/x509/PKIXCertPathReviewer;->V()V
...
.method protected e0(Lorg/bouncycastle/asn1/x509/AuthorityInformationAccess;)Ljava/util/Vector;
    .locals 4
    ...
    invoke-virtual {p1}, Lorg/bouncycastle/asn1/x509/AuthorityInformationAccess;->h()[Lorg/bouncycastle/asn1/x509/AccessDescription;
    ...
    invoke-virtual {v1}, Lorg/bouncycastle/asn1/x509/AccessDescription;->h()Lorg/bouncycastle/asn1/ASN1ObjectIdentifier;

    move-result-object v1

    sget-object v2, Lorg/bouncycastle/asn1/x509/AccessDescription;->d:Lorg/bouncycastle/asn1/ASN1ObjectIdentifier;
    ...
    invoke-virtual {v1}, Lorg/bouncycastle/asn1/x509/AccessDescription;->g()Lorg/bouncycastle/asn1/x509/GeneralName;
...
.method public f0()Ljava/security/cert/PolicyNode;
    ...
    iget-object p0, p0, Lorg/bouncycastle/x509/PKIXCertPathReviewer;->C:Ljava/security/cert/PolicyNode;
...
.method public g0()Ljava/security/PublicKey;
    ...
    iget-object p0, p0, Lorg/bouncycastle/x509/PKIXCertPathReviewer;->B:Ljava/security/PublicKey;
...
.method public h0()Ljava/security/cert/TrustAnchor;
    ...
    iget-object p0, p0, Lorg/bouncycastle/x509/PKIXCertPathReviewer;->A:Ljava/security/cert/TrustAnchor;
...
.method protected i0(Ljava/security/cert/X509Certificate;Ljava/util/Set;)Ljava/util/Collection;
    ...
    invoke-virtual {v1}, Lorg/bouncycastle/asn1/x509/AuthorityKeyIdentifier;->l()[B
...
.method public j0(Ljava/security/cert/CertPath;Ljava/security/cert/PKIXParameters;)V
    ...
    iput-boolean v0, p0, Lorg/bouncycastle/x509/PKIXCertPathReviewer;->D:Z

    if-eqz p1, :cond_1

    iput-object p1, p0, Lorg/bouncycastle/x509/PKIXCertPathReviewer;->t:Ljava/security/cert/CertPath;

    invoke-virtual {p1}, Ljava/security/cert/CertPath;->getCertificates()Ljava/util/List;

    move-result-object p1

    iput-object p1, p0, Lorg/bouncycastle/x509/PKIXCertPathReviewer;->w:Ljava/util/List;

    invoke-interface {p1}, Ljava/util/List;->size()I

    move-result p1

    iput p1, p0, Lorg/bouncycastle/x509/PKIXCertPathReviewer;->x:I

    iget-object p1, p0, Lorg/bouncycastle/x509/PKIXCertPathReviewer;->w:Ljava/util/List;
    ...
    iput-object p1, p0, Lorg/bouncycastle/x509/PKIXCertPathReviewer;->u:Ljava/security/cert/PKIXParameters;

    invoke-static {p1}, Lorg/bouncycastle/x509/CertPathValidatorUtilities;->x(Ljava/security/cert/PKIXParameters;)Ljava/util/Date;

    move-result-object p1

    iput-object p1, p0, Lorg/bouncycastle/x509/PKIXCertPathReviewer;->v:Ljava/util/Date;

    const/4 p1, 0x0

    iput-object p1, p0, Lorg/bouncycastle/x509/PKIXCertPathReviewer;->y:[Ljava/util/List;

    iput-object p1, p0, Lorg/bouncycastle/x509/PKIXCertPathReviewer;->z:[Ljava/util/List;

    iput-object p1, p0, Lorg/bouncycastle/x509/PKIXCertPathReviewer;->A:Ljava/security/cert/TrustAnchor;

    iput-object p1, p0, Lorg/bouncycastle/x509/PKIXCertPathReviewer;->B:Ljava/security/PublicKey;

    iput-object p1, p0, Lorg/bouncycastle/x509/PKIXCertPathReviewer;->C:Ljava/security/cert/PolicyNode;
...
.method public k0()Z
    ...
    :goto_0
    iget-object v2, p0, Lorg/bouncycastle/x509/PKIXCertPathReviewer;->z:[Ljava/util/List;
