...
.method static constructor <clinit>()V
    ...
    sput-object v0, Lorg/bouncycastle/openssl/bc/PEMUtilities;->a:Ljava/util/Map;

    new-instance v1, Ljava/util/HashSet;

    invoke-direct {v1}, Ljava/util/HashSet;-><init>()V

    sput-object v1, Lorg/bouncycastle/openssl/bc/PEMUtilities;->b:Ljava/util/Set;

    new-instance v2, Ljava/util/HashSet;

    invoke-direct {v2}, Ljava/util/HashSet;-><init>()V

    sput-object v2, Lorg/bouncycastle/openssl/bc/PEMUtilities;->c:Ljava/util/Set;
...
.method static a(Z[B[CLjava/lang/String;[B)[B
    ...
    invoke-static {v2, v5, v4, v3}, Lorg/bouncycastle/openssl/bc/PEMUtilities;->d([CI[BZ)Lorg/bouncycastle/crypto/params/KeyParameter;
    ...
    invoke-static {v2, v13, v4}, Lorg/bouncycastle/openssl/bc/PEMUtilities;->c([CI[B)Lorg/bouncycastle/crypto/params/KeyParameter;
    ...
    invoke-static {v2, v3, v4}, Lorg/bouncycastle/openssl/bc/PEMUtilities;->c([CI[B)Lorg/bouncycastle/crypto/params/KeyParameter;
    ...
    invoke-static {v2, v5, v4}, Lorg/bouncycastle/openssl/bc/PEMUtilities;->c([CI[B)Lorg/bouncycastle/crypto/params/KeyParameter;

    move-result-object v2

    invoke-virtual {v2}, Lorg/bouncycastle/crypto/params/KeyParameter;->a()[B
    ...
    invoke-static {v2, v11, v4}, Lorg/bouncycastle/openssl/bc/PEMUtilities;->c([CI[B)Lorg/bouncycastle/crypto/params/KeyParameter;

    move-result-object v2

    new-instance v3, Lorg/bouncycastle/crypto/engines/AESFastEngine;

    invoke-direct {v3}, Lorg/bouncycastle/crypto/engines/AESFastEngine;-><init>()V
    ...
    invoke-virtual {v6, v0, v2}, Lorg/bouncycastle/crypto/BufferedBlockCipher;->f(ZLorg/bouncycastle/crypto/CipherParameters;)V
    ...
    invoke-virtual {v6, v0, v3}, Lorg/bouncycastle/crypto/BufferedBlockCipher;->f(ZLorg/bouncycastle/crypto/CipherParameters;)V

    :goto_b
    array-length v0, v1

    invoke-virtual {v6, v0}, Lorg/bouncycastle/crypto/BufferedBlockCipher;->c(I)I
    ...
    invoke-virtual {v6, v8, v0}, Lorg/bouncycastle/crypto/BufferedBlockCipher;->a([BI)I
...
.method public static b(Ljava/lang/String;[C[BI)Lorg/bouncycastle/crypto/params/KeyParameter;
    .locals 2
    ...
    invoke-static {p1}, Lorg/bouncycastle/crypto/PBEParametersGenerator;->b([C)[B

    move-result-object p1

    invoke-virtual {v0, p1, p2, p3}, Lorg/bouncycastle/crypto/PBEParametersGenerator;->j([B[BI)V

    invoke-static {p0}, Lorg/bouncycastle/openssl/bc/PEMUtilities;->e(Ljava/lang/String;)I
...
.method private static c([CI[B)Lorg/bouncycastle/crypto/params/KeyParameter;
    .locals 1
    .annotation system Ldalvik/annotation/Throws;
        value = {
            Lorg/bouncycastle/openssl/PEMException;
    ...
    invoke-static {p0, p1, p2, v0}, Lorg/bouncycastle/openssl/bc/PEMUtilities;->d([CI[BZ)Lorg/bouncycastle/crypto/params/KeyParameter;
...
.method private static d([CI[BZ)Lorg/bouncycastle/crypto/params/KeyParameter;
    .locals 2
    .annotation system Ldalvik/annotation/Throws;
        value = {
            Lorg/bouncycastle/openssl/PEMException;
    ...
    invoke-virtual {v0, p0, p2, v1}, Lorg/bouncycastle/crypto/PBEParametersGenerator;->j([B[BI)V

    const/16 p0, 0x8

    mul-int/2addr p1, p0

    invoke-virtual {v0, p1}, Lorg/bouncycastle/crypto/PBEParametersGenerator;->e(I)Lorg/bouncycastle/crypto/CipherParameters;
...
.method static e(Ljava/lang/String;)I
    ...
    sget-object v0, Lorg/bouncycastle/openssl/bc/PEMUtilities;->a:Ljava/util/Map;
...
.method static g(Lorg/bouncycastle/asn1/ASN1ObjectIdentifier;)Z
    ...
    sget-object v0, Lorg/bouncycastle/openssl/bc/PEMUtilities;->b:Ljava/util/Set;
...
.method static h(Lorg/bouncycastle/asn1/ASN1ObjectIdentifier;)Z
    ...
    sget-object v0, Lorg/bouncycastle/openssl/bc/PEMUtilities;->c:Ljava/util/Set;
