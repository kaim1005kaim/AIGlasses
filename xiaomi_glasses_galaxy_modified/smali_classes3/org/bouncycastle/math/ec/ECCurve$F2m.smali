...
.field private v:Lorg/bouncycastle/math/ec/ECPoint$F2m;
...
.method public constructor <init>(IIIILjava/math/BigInteger;Ljava/math/BigInteger;Ljava/math/BigInteger;Ljava/math/BigInteger;)V
    ...
    iput p1, p0, Lorg/bouncycastle/math/ec/ECCurve$F2m;->r:I

    iput p2, p0, Lorg/bouncycastle/math/ec/ECCurve$F2m;->s:I

    iput p3, p0, Lorg/bouncycastle/math/ec/ECCurve$F2m;->t:I

    iput p4, p0, Lorg/bouncycastle/math/ec/ECCurve$F2m;->u:I
    ...
    iput-object p1, p0, Lorg/bouncycastle/math/ec/ECCurve$F2m;->v:Lorg/bouncycastle/math/ec/ECPoint$F2m;

    invoke-virtual {p0, p5}, Lorg/bouncycastle/math/ec/ECCurve$F2m;->o(Ljava/math/BigInteger;)Lorg/bouncycastle/math/ec/ECFieldElement;

    move-result-object p1

    iput-object p1, p0, Lorg/bouncycastle/math/ec/ECCurve;->b:Lorg/bouncycastle/math/ec/ECFieldElement;

    invoke-virtual {p0, p6}, Lorg/bouncycastle/math/ec/ECCurve$F2m;->o(Ljava/math/BigInteger;)Lorg/bouncycastle/math/ec/ECFieldElement;
...
.method static synthetic O(Lorg/bouncycastle/math/ec/ECCurve$F2m;)I
    .locals 0

    iget p0, p0, Lorg/bouncycastle/math/ec/ECCurve$F2m;->r:I
...
.method public Q()I
    ...
    iget p0, p0, Lorg/bouncycastle/math/ec/ECCurve$F2m;->s:I
...
.method public R()I
    ...
    iget p0, p0, Lorg/bouncycastle/math/ec/ECCurve$F2m;->t:I
...
.method public S()I
    ...
    iget p0, p0, Lorg/bouncycastle/math/ec/ECCurve$F2m;->u:I
...
.method public V()Z
    ...
    iget v0, p0, Lorg/bouncycastle/math/ec/ECCurve$F2m;->t:I
...
.method protected d()Lorg/bouncycastle/math/ec/ECCurve;
    ...
    iget v1, p0, Lorg/bouncycastle/math/ec/ECCurve$F2m;->r:I

    iget v2, p0, Lorg/bouncycastle/math/ec/ECCurve$F2m;->s:I

    iget v3, p0, Lorg/bouncycastle/math/ec/ECCurve$F2m;->t:I

    iget v4, p0, Lorg/bouncycastle/math/ec/ECCurve$F2m;->u:I
...
.method public f([Lorg/bouncycastle/math/ec/ECPoint;II)Lorg/bouncycastle/math/ec/ECLookupTable;
    ...
    iget v0, p0, Lorg/bouncycastle/math/ec/ECCurve$F2m;->r:I

    add-int/lit8 v0, v0, 0x3f

    ushr-int/lit8 v4, v0, 0x6

    invoke-virtual {p0}, Lorg/bouncycastle/math/ec/ECCurve$F2m;->V()Z
    ...
    iget v5, p0, Lorg/bouncycastle/math/ec/ECCurve$F2m;->s:I

    aput v5, v0, v3

    iget v5, p0, Lorg/bouncycastle/math/ec/ECCurve$F2m;->t:I

    aput v5, v0, v2

    iget v2, p0, Lorg/bouncycastle/math/ec/ECCurve$F2m;->u:I
    ...
    invoke-virtual {v1}, Lorg/bouncycastle/math/ec/ECPoint;->o()Lorg/bouncycastle/math/ec/ECFieldElement;
    ...
    invoke-virtual {v2, v5, v0}, Lorg/bouncycastle/math/ec/LongArray;->j([JI)V

    add-int/2addr v0, v4

    invoke-virtual {v1}, Lorg/bouncycastle/math/ec/ECPoint;->p()Lorg/bouncycastle/math/ec/ECFieldElement;

    move-result-object v1

    check-cast v1, Lorg/bouncycastle/math/ec/ECFieldElement$F2m;

    iget-object v1, v1, Lorg/bouncycastle/math/ec/ECFieldElement$F2m;->j:Lorg/bouncycastle/math/ec/LongArray;

    invoke-virtual {v1, v5, v0}, Lorg/bouncycastle/math/ec/LongArray;->j([JI)V
...
.method protected g()Lorg/bouncycastle/math/ec/ECMultiplier;
    ...
    :cond_0
    invoke-super {p0}, Lorg/bouncycastle/math/ec/ECCurve;->g()Lorg/bouncycastle/math/ec/ECMultiplier;
...
.method public x()Lorg/bouncycastle/math/ec/ECPoint;
    ...
    iget-object p0, p0, Lorg/bouncycastle/math/ec/ECCurve$F2m;->v:Lorg/bouncycastle/math/ec/ECPoint$F2m;
