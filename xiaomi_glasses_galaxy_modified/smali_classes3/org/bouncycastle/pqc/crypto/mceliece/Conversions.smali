...
.method public static a(IILorg/bouncycastle/pqc/math/linearalgebra/GF2Vector;)[B
    .locals 7

    invoke-virtual {p2}, Lorg/bouncycastle/pqc/math/linearalgebra/Vector;->c()I

    move-result v0

    if-ne v0, p0, :cond_3

    invoke-virtual {p2}, Lorg/bouncycastle/pqc/math/linearalgebra/GF2Vector;->k()I

    move-result v0

    if-ne v0, p1, :cond_3

    invoke-virtual {p2}, Lorg/bouncycastle/pqc/math/linearalgebra/GF2Vector;->l()[I

    move-result-object p2

    invoke-static {p0, p1}, Lorg/bouncycastle/pqc/math/linearalgebra/IntegerFunctions;->a(II)Ljava/math/BigInteger;

    move-result-object v0

    sget-object v1, Lorg/bouncycastle/pqc/crypto/mceliece/Conversions;->a:Ljava/math/BigInteger;
    ...
    :cond_2
    invoke-static {v1}, Lorg/bouncycastle/pqc/math/linearalgebra/BigIntUtils;->f(Ljava/math/BigInteger;)[B
...
.method public static b(II[B)Lorg/bouncycastle/pqc/math/linearalgebra/GF2Vector;
    .locals 7
    ...
    invoke-virtual {p2, v2}, Lorg/bouncycastle/pqc/math/linearalgebra/GF2Vector;->m(I)V
...
.method public static c(II[B)[B
    ...
    :cond_3
    sget-object p2, Lorg/bouncycastle/pqc/crypto/mceliece/Conversions;->a:Ljava/math/BigInteger;
