...
.method private createServer()Lcom/facebook/stetho/server/http/LightHttpServer;
    ...
    iget-object p0, p0, Lcom/facebook/stetho/inspector/DevtoolsSocketHandler;->mModules:Ljava/lang/Iterable;

    invoke-direct {v3, p0}, Lcom/facebook/stetho/inspector/ChromeDevtoolsServer;-><init>(Ljava/lang/Iterable;)V
    ...
    new-instance p0, Lcom/facebook/stetho/server/http/LightHttpServer;

    invoke-direct {p0, v0}, Lcom/facebook/stetho/server/http/LightHttpServer;-><init>(Lcom/facebook/stetho/server/http/HandlerRegistry;)V
...
.method public onAccepted(Lcom/facebook/stetho/server/SocketLike;)V
    ...
    iget-object p0, p0, Lcom/facebook/stetho/inspector/DevtoolsSocketHandler;->mServer:Lcom/facebook/stetho/server/http/LightHttpServer;

    invoke-virtual {p0, p1}, Lcom/facebook/stetho/server/http/LightHttpServer;->serve(Lcom/facebook/stetho/server/SocketLike;)V
