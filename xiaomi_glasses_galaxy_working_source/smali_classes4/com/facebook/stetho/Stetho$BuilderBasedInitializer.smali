...
.method protected getDumperPlugins()Ljava/lang/Iterable;
    ...
    iget-object p0, p0, Lcom/facebook/stetho/Stetho$BuilderBasedInitializer;->mDumperPlugins:Lcom/facebook/stetho/DumperPluginsProvider;

    if-eqz p0, :cond_0

    invoke-interface {p0}, Lcom/facebook/stetho/DumperPluginsProvider;->get()Ljava/lang/Iterable;
...
.method protected getInspectorModules()Ljava/lang/Iterable;
    ...
    iget-object p0, p0, Lcom/facebook/stetho/Stetho$BuilderBasedInitializer;->mInspectorModules:Lcom/facebook/stetho/InspectorModulesProvider;

    if-eqz p0, :cond_0

    invoke-interface {p0}, Lcom/facebook/stetho/InspectorModulesProvider;->get()Ljava/lang/Iterable;
