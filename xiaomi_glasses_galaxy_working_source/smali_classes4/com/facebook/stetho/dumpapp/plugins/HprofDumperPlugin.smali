...
.method private handlePipeOutput(Ljava/io/OutputStream;)V
    ...
    invoke-static {p0, p1, v1}, Lcom/facebook/stetho/common/Util;->copy(Ljava/io/InputStream;Ljava/io/OutputStream;[B)V
    :try_end_2
    ...
    const-string v1, "Failure copying "

    invoke-virtual {p1, v1}, Ljava/lang/StringBuilder;->append(Ljava/lang/String;)Ljava/lang/StringBuilder;

    invoke-virtual {p1, v0}, Ljava/lang/StringBuilder;->append(Ljava/lang/Object;)Ljava/lang/StringBuilder;

    const-string v1, " to dumper output"
...
.method private usage(Ljava/io/PrintStream;)V
    ...
    const-string p0, "Usage: dumpapp hprof [ path ]"

    invoke-virtual {p1, p0}, Ljava/io/PrintStream;->println(Ljava/lang/String;)V

    const-string p0, "Dump HPROF memory usage data from the running application."

    invoke-virtual {p1, p0}, Ljava/io/PrintStream;->println(Ljava/lang/String;)V

    invoke-virtual {p1}, Ljava/io/PrintStream;->println()V

    const-string p0, "Where path can be any of:"

    invoke-virtual {p1, p0}, Ljava/io/PrintStream;->println(Ljava/lang/String;)V

    const-string p0, "  -           Output directly to stdout"

    invoke-virtual {p1, p0}, Ljava/io/PrintStream;->println(Ljava/lang/String;)V

    const-string p0, "  <path>      Full path to a writable file on the device"

    invoke-virtual {p1, p0}, Ljava/io/PrintStream;->println(Ljava/lang/String;)V

    const-string p0, "  <filename>  Relative filename that will be stored in the app internal storage"

    invoke-virtual {p1, p0}, Ljava/io/PrintStream;->println(Ljava/lang/String;)V

    new-instance p0, Lcom/facebook/stetho/dumpapp/DumpUsageException;

    const-string p1, "Missing path"
...
.method private writeHprof(Ljava/io/File;)V
    ...
    invoke-direct {v0, p0}, Lcom/facebook/stetho/dumpapp/DumpException;-><init>(Ljava/lang/String;)V
