...
.method private doDump(Ljava/io/InputStream;Ljava/io/PrintStream;Ljava/io/PrintStream;[Ljava/lang/String;)I
    ...
    invoke-interface {v0, v1, p4, v2}, Lorg/apache/commons/cli/CommandLineParser;->a(Lorg/apache/commons/cli/Options;[Ljava/lang/String;Z)Lorg/apache/commons/cli/CommandLine;
    ...
    invoke-virtual {p4, v0}, Lorg/apache/commons/cli/CommandLine;->q(Ljava/lang/String;)Z
    ...
    :cond_1
    invoke-virtual {p4}, Lorg/apache/commons/cli/CommandLine;->c()Ljava/util/List;
...
.method private dumpAvailablePlugins(Ljava/io/PrintStream;)V
    ...
    iget-object p0, p0, Lcom/facebook/stetho/dumpapp/Dumper;->mDumperPlugins:Ljava/util/Map;
...
.method private dumpPluginOutput(Ljava/io/InputStream;Ljava/io/PrintStream;Ljava/io/PrintStream;Lorg/apache/commons/cli/CommandLine;)V
    ...
    :cond_0
    new-instance p0, Lcom/facebook/stetho/dumpapp/DumpException;
    ...
    const-string p1, "Expected plugin argument"
...
.method private dumpUsage(Ljava/io/PrintStream;)V
    ...
    :try_start_0
    invoke-virtual {v0}, Lorg/apache/commons/cli/HelpFormatter;->m()I

    move-result v2

    iget-object p0, p0, Lcom/facebook/stetho/dumpapp/Dumper;->mGlobalOptions:Lcom/facebook/stetho/dumpapp/GlobalOptions;

    iget-object v3, p0, Lcom/facebook/stetho/dumpapp/GlobalOptions;->options:Lorg/apache/commons/cli/Options;

    invoke-virtual {v0}, Lorg/apache/commons/cli/HelpFormatter;->g()I

    move-result v4

    invoke-virtual {v0}, Lorg/apache/commons/cli/HelpFormatter;->f()I
...
.method public dump(Ljava/io/InputStream;Ljava/io/PrintStream;Ljava/io/PrintStream;[Ljava/lang/String;)I
    ...
    invoke-virtual {p0, p3}, Ljava/lang/Throwable;->printStackTrace(Ljava/io/PrintStream;)V
