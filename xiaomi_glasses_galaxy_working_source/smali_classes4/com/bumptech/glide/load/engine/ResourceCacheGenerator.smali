...
.field private j:Lcom/bumptech/glide/load/engine/ResourceCacheKey;
...
.method private b()Z
    ...
    iget-object p0, p0, Lcom/bumptech/glide/load/engine/ResourceCacheGenerator;->f:Ljava/util/List;
...
.method public a()Z
    ...
    invoke-virtual {v0}, Lcom/bumptech/glide/load/engine/DecodeHelper;->c()Ljava/util/List;
    ...
    invoke-virtual {v1}, Lcom/bumptech/glide/load/engine/DecodeHelper;->m()Ljava/util/List;
    ...
    invoke-virtual {v1}, Lcom/bumptech/glide/load/engine/DecodeHelper;->r()Ljava/lang/Class;
    ...
    invoke-virtual {v2}, Lcom/bumptech/glide/load/engine/DecodeHelper;->i()Ljava/lang/Class;
    ...
    iget-object p0, p0, Lcom/bumptech/glide/load/engine/ResourceCacheGenerator;->b:Lcom/bumptech/glide/load/engine/DecodeHelper;

    invoke-virtual {p0}, Lcom/bumptech/glide/load/engine/DecodeHelper;->r()Ljava/lang/Class;
    ...
    invoke-direct {p0}, Lcom/bumptech/glide/load/engine/ResourceCacheGenerator;->b()Z
    ...
    invoke-virtual {v3}, Lcom/bumptech/glide/load/engine/DecodeHelper;->t()I
    ...
    iget-object v6, p0, Lcom/bumptech/glide/load/engine/ResourceCacheGenerator;->b:Lcom/bumptech/glide/load/engine/DecodeHelper;

    invoke-virtual {v6}, Lcom/bumptech/glide/load/engine/DecodeHelper;->k()Lcom/bumptech/glide/load/Options;

    move-result-object v6

    invoke-interface {v0, v1, v3, v5, v6}, Lcom/bumptech/glide/load/model/ModelLoader;->a(Ljava/lang/Object;IILcom/bumptech/glide/load/Options;)Lcom/bumptech/glide/load/model/ModelLoader$LoadData;
    ...
    invoke-virtual {v0, v1}, Lcom/bumptech/glide/load/engine/DecodeHelper;->u(Ljava/lang/Class;)Z
    ...
    invoke-interface {v0, v1, p0}, Lcom/bumptech/glide/load/data/DataFetcher;->c(Lcom/bumptech/glide/Priority;Lcom/bumptech/glide/load/data/DataFetcher$DataCallback;)V
    :try_end_2
    ...
    invoke-virtual {v4, v11}, Lcom/bumptech/glide/load/engine/DecodeHelper;->s(Ljava/lang/Class;)Lcom/bumptech/glide/load/Transformation;
    ...
    invoke-virtual {v4}, Lcom/bumptech/glide/load/engine/DecodeHelper;->b()Lcom/bumptech/glide/load/engine/bitmap_recycle/ArrayPool;

    move-result-object v5

    iget-object v4, p0, Lcom/bumptech/glide/load/engine/ResourceCacheGenerator;->b:Lcom/bumptech/glide/load/engine/DecodeHelper;

    invoke-virtual {v4}, Lcom/bumptech/glide/load/engine/DecodeHelper;->p()Lcom/bumptech/glide/load/Key;
    ...
    invoke-virtual {v4}, Lcom/bumptech/glide/load/engine/DecodeHelper;->f()I

    move-result v9

    iget-object v4, p0, Lcom/bumptech/glide/load/engine/ResourceCacheGenerator;->b:Lcom/bumptech/glide/load/engine/DecodeHelper;

    invoke-virtual {v4}, Lcom/bumptech/glide/load/engine/DecodeHelper;->k()Lcom/bumptech/glide/load/Options;
    ...
    invoke-virtual {v4}, Lcom/bumptech/glide/load/engine/DecodeHelper;->d()Lcom/bumptech/glide/load/engine/cache/DiskCache;
    ...
    invoke-virtual {v3, v4}, Lcom/bumptech/glide/load/engine/DecodeHelper;->j(Ljava/io/File;)Ljava/util/List;
...
.method public cancel()V
    ...
    iget-object p0, p0, Lcom/bumptech/glide/load/engine/ResourceCacheGenerator;->h:Lcom/bumptech/glide/load/model/ModelLoader$LoadData;
