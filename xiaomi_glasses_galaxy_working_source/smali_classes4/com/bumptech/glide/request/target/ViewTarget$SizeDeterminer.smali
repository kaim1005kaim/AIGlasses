...
.method private static c(Landroid/content/Context;)I
    ...
    sget-object v0, Lcom/bumptech/glide/request/target/ViewTarget$SizeDeterminer;->f:Ljava/lang/Integer;
    ...
    sput-object p0, Lcom/bumptech/glide/request/target/ViewTarget$SizeDeterminer;->f:Ljava/lang/Integer;

    :cond_0
    sget-object p0, Lcom/bumptech/glide/request/target/ViewTarget$SizeDeterminer;->f:Ljava/lang/Integer;
...
.method private e(III)I
    ...
    :cond_3
    iget-object p0, p0, Lcom/bumptech/glide/request/target/ViewTarget$SizeDeterminer;->a:Landroid/view/View;

    invoke-virtual {p0}, Landroid/view/View;->getContext()Landroid/content/Context;

    move-result-object p0

    invoke-static {p0}, Lcom/bumptech/glide/request/target/ViewTarget$SizeDeterminer;->c(Landroid/content/Context;)I
...
.method private f()I
    ...
    invoke-direct {p0, v2, v1, v0}, Lcom/bumptech/glide/request/target/ViewTarget$SizeDeterminer;->e(III)I
...
.method private i(II)Z
    ...
    invoke-direct {p0, p1}, Lcom/bumptech/glide/request/target/ViewTarget$SizeDeterminer;->h(I)Z

    move-result p1

    if-eqz p1, :cond_0

    invoke-direct {p0, p2}, Lcom/bumptech/glide/request/target/ViewTarget$SizeDeterminer;->h(I)Z
...
.method private j(II)V
    ...
    iget-object p0, p0, Lcom/bumptech/glide/request/target/ViewTarget$SizeDeterminer;->b:Ljava/util/List;
...
.method a()V
    ...
    invoke-direct {p0, v0, v1}, Lcom/bumptech/glide/request/target/ViewTarget$SizeDeterminer;->i(II)Z
    ...
    :cond_1
    invoke-direct {p0, v0, v1}, Lcom/bumptech/glide/request/target/ViewTarget$SizeDeterminer;->j(II)V
...
.method d(Lcom/bumptech/glide/request/target/SizeReadyCallback;)V
    ...
    :cond_1
    iget-object p1, p0, Lcom/bumptech/glide/request/target/ViewTarget$SizeDeterminer;->d:Lcom/bumptech/glide/request/target/ViewTarget$SizeDeterminer$SizeDeterminerLayoutListener;
