...
.method private insertException(Landroid/database/sqlite/SQLiteStatement;Ljava/lang/String;SJ)V
    ...
    invoke-virtual {p1, p0, p4, p5}, Landroid/database/sqlite/SQLiteProgram;->bindLong(IJ)V

    const/4 p0, 0x2

    int-to-long p3, p3

    invoke-virtual {p1, p0, p3, p4}, Landroid/database/sqlite/SQLiteProgram;->bindLong(IJ)V
...
.method private insertProperties(Ljava/util/Map;J)V
    ...
    invoke-virtual {p0, v1, p2, p3}, Landroid/database/sqlite/SQLiteProgram;->bindLong(IJ)V
...
.method public start()V
    ...
    invoke-virtual {p0, v0}, Lch/qos/logback/classic/android/SQLiteAppender;->getDatabaseFile(Ljava/lang/String;)Ljava/io/File;
