...
.method public close()V
    ...
    iget-object p0, p0, Lch/qos/logback/classic/net/SimpleSocketServer;->logger:Lorg/slf4j/Logger;

    const-string v0, "Was expecting a 0-sized socketNodeList after server shutdown"
...
.method public getLatch()Ljava/util/concurrent/CountDownLatch;
    ...
    iget-object p0, p0, Lch/qos/logback/classic/net/SimpleSocketServer;->latch:Ljava/util/concurrent/CountDownLatch;
...
.method protected getServerThreadName()Ljava/lang/String;
    ...
    iget p0, p0, Lch/qos/logback/classic/net/SimpleSocketServer;->port:I
...
.method public isClosed()Z
    ...
    iget-boolean p0, p0, Lch/qos/logback/classic/net/SimpleSocketServer;->closed:Z
...
.method public run()V
    ...
    const-string v1, "Exception in run method for a closed server. This is normal."
    ...
    const-string v2, "Unexpected failure in run method"

    invoke-interface {p0, v2, v1}, Lorg/slf4j/Logger;->error(Ljava/lang/String;Ljava/lang/Throwable;)V
    :try_end_5
...
.method public socketNodeClosing(Lch/qos/logback/classic/net/SocketNode;)V
    ...
    :try_start_0
    iget-object p0, p0, Lch/qos/logback/classic/net/SimpleSocketServer;->socketNodeList:Ljava/util/List;
