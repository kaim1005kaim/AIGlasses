...
.annotation system Ldalvik/annotation/EnclosingMethod;
    value = Lcoil/disk/DiskLruCache;->G()V
.end annotation
...
.method public final create(Ljava/lang/Object;Lkotlin/coroutines/Continuation;)Lkotlin/coroutines/Continuation;
    ...
    iget-object p0, p0, Lcoil/disk/DiskLruCache$launchCleanup$1;->b:Lcoil/disk/DiskLruCache;
...
.method public final invokeSuspend(Ljava/lang/Object;)Ljava/lang/Object;
    ...
    :try_start_0
    invoke-static {p0}, Lcoil/disk/DiskLruCache;->f(Lcoil/disk/DiskLruCache;)Z

    move-result p1

    if-eqz p1, :cond_2

    invoke-static {p0}, Lcoil/disk/DiskLruCache;->b(Lcoil/disk/DiskLruCache;)Z
    ...
    :try_start_1
    invoke-static {p0}, Lcoil/disk/DiskLruCache;->r(Lcoil/disk/DiskLruCache;)V
    :try_end_1
    ...
    :catch_0
    :try_start_2
    invoke-static {p0, p1}, Lcoil/disk/DiskLruCache;->q(Lcoil/disk/DiskLruCache;Z)V
    :try_end_2
    .catchall {:try_start_2 .. :try_end_2} :catchall_0

    :goto_0
    :try_start_3
    invoke-static {p0}, Lcoil/disk/DiskLruCache;->h(Lcoil/disk/DiskLruCache;)Z

    move-result v0

    if-eqz v0, :cond_1

    invoke-static {p0}, Lcoil/disk/DiskLruCache;->t(Lcoil/disk/DiskLruCache;)V
    :try_end_3
    ...
    :catch_1
    :try_start_4
    invoke-static {p0, p1}, Lcoil/disk/DiskLruCache;->o(Lcoil/disk/DiskLruCache;Z)V
    ...
    invoke-static {p0, p1}, Lcoil/disk/DiskLruCache;->m(Lcoil/disk/DiskLruCache;Lokio/BufferedSink;)V
