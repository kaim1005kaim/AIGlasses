...
.method static constructor <clinit>()V
    ...
    sput-object v0, Lio/reactivex/internal/schedulers/SingleScheduler;->g:Ljava/util/concurrent/ScheduledExecutorService;
    ...
    sput-object v2, Lio/reactivex/internal/schedulers/SingleScheduler;->f:Lio/reactivex/internal/schedulers/RxThreadFactory;
...
.method public constructor <init>()V
    ...
    .line 1
    sget-object v0, Lio/reactivex/internal/schedulers/SingleScheduler;->f:Lio/reactivex/internal/schedulers/RxThreadFactory;
...
.method public constructor <init>(Ljava/util/concurrent/ThreadFactory;)V
    ...
    .line 5
    invoke-static {p1}, Lio/reactivex/internal/schedulers/SingleScheduler;->k(Ljava/util/concurrent/ThreadFactory;)Ljava/util/concurrent/ScheduledExecutorService;
...
.method public c()Lio/reactivex/Scheduler$Worker;
    ...
    iget-object p0, p0, Lio/reactivex/internal/schedulers/SingleScheduler;->c:Ljava/util/concurrent/atomic/AtomicReference;
...
.method public g(Ljava/lang/Runnable;JJLjava/util/concurrent/TimeUnit;)Lio/reactivex/disposables/Disposable;
    ...
    :goto_0
    invoke-virtual {p4, p0}, Lio/reactivex/internal/schedulers/InstantPeriodicTask;->b(Ljava/util/concurrent/Future;)V
    :try_end_0
    .catch Ljava/util/concurrent/RejectedExecutionException; {:try_start_0 .. :try_end_0} :catch_0
...
.method public h()V
    ...
    sget-object v1, Lio/reactivex/internal/schedulers/SingleScheduler;->g:Ljava/util/concurrent/ScheduledExecutorService;
...
.method public i()V
    ...
    sget-object v2, Lio/reactivex/internal/schedulers/SingleScheduler;->g:Ljava/util/concurrent/ScheduledExecutorService;
    ...
    invoke-static {v0}, Lio/reactivex/internal/schedulers/SingleScheduler;->k(Ljava/util/concurrent/ThreadFactory;)Ljava/util/concurrent/ScheduledExecutorService;
