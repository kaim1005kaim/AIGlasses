...
# instance fields
.field final a:Lio/reactivex/internal/operators/flowable/FlowableAmb$AmbCoordinator;
    .annotation system Ldalvik/annotation/Signature;
        value = {
...
.method constructor <init>(Lio/reactivex/internal/operators/flowable/FlowableAmb$AmbCoordinator;ILorg/reactivestreams/Subscriber;)V
    ...
    iput-object p1, p0, Lio/reactivex/internal/operators/flowable/FlowableAmb$AmbInnerSubscriber;->a:Lio/reactivex/internal/operators/flowable/FlowableAmb$AmbCoordinator;

    iput p2, p0, Lio/reactivex/internal/operators/flowable/FlowableAmb$AmbInnerSubscriber;->b:I

    iput-object p3, p0, Lio/reactivex/internal/operators/flowable/FlowableAmb$AmbInnerSubscriber;->c:Lorg/reactivestreams/Subscriber;
...
.method public g(Lorg/reactivestreams/Subscription;)V
    ...
    invoke-static {p0, v0, p1}, Lio/reactivex/internal/subscriptions/SubscriptionHelper;->c(Ljava/util/concurrent/atomic/AtomicReference;Ljava/util/concurrent/atomic/AtomicLong;Lorg/reactivestreams/Subscription;)Z
...
.method public onComplete()V
    ...
    iget-object p0, p0, Lio/reactivex/internal/operators/flowable/FlowableAmb$AmbInnerSubscriber;->c:Lorg/reactivestreams/Subscriber;
    ...
    :cond_0
    iget-object v0, p0, Lio/reactivex/internal/operators/flowable/FlowableAmb$AmbInnerSubscriber;->a:Lio/reactivex/internal/operators/flowable/FlowableAmb$AmbCoordinator;

    iget v1, p0, Lio/reactivex/internal/operators/flowable/FlowableAmb$AmbInnerSubscriber;->b:I

    invoke-virtual {v0, v1}, Lio/reactivex/internal/operators/flowable/FlowableAmb$AmbCoordinator;->b(I)Z
...
.method public request(J)V
    ...
    invoke-static {p0, v0, p1, p2}, Lio/reactivex/internal/subscriptions/SubscriptionHelper;->b(Ljava/util/concurrent/atomic/AtomicReference;Ljava/util/concurrent/atomic/AtomicLong;J)V
