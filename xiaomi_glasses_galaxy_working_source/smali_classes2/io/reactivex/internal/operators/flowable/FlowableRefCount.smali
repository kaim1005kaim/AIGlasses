...
# virtual methods
.method N8(Lio/reactivex/internal/operators/flowable/FlowableRefCount$RefConnection;)V
    .locals 4
    ...
    invoke-virtual {p0, p1}, Lio/reactivex/internal/operators/flowable/FlowableRefCount;->R8(Lio/reactivex/internal/operators/flowable/FlowableRefCount$RefConnection;)V
    ...
    iget-object p0, p0, Lio/reactivex/internal/operators/flowable/FlowableRefCount;->e:Ljava/util/concurrent/TimeUnit;
...
.method O8(Lio/reactivex/internal/operators/flowable/FlowableRefCount$RefConnection;)V
    .locals 0

    iget-object p0, p1, Lio/reactivex/internal/operators/flowable/FlowableRefCount$RefConnection;->b:Lio/reactivex/disposables/Disposable;
    ...
    iput-object p0, p1, Lio/reactivex/internal/operators/flowable/FlowableRefCount$RefConnection;->b:Lio/reactivex/disposables/Disposable;

    :cond_0
    return-void
.end method

.method P8(Lio/reactivex/internal/operators/flowable/FlowableRefCount$RefConnection;)V
    .locals 1
...
.method Q8(Lio/reactivex/internal/operators/flowable/FlowableRefCount$RefConnection;)V
    .locals 8
    ...
    invoke-virtual {p0, p1}, Lio/reactivex/internal/operators/flowable/FlowableRefCount;->O8(Lio/reactivex/internal/operators/flowable/FlowableRefCount$RefConnection;)V
    ...
    invoke-virtual {p0, p1}, Lio/reactivex/internal/operators/flowable/FlowableRefCount;->P8(Lio/reactivex/internal/operators/flowable/FlowableRefCount$RefConnection;)V
...
.method R8(Lio/reactivex/internal/operators/flowable/FlowableRefCount$RefConnection;)V
    .locals 4
...
.method protected l6(Lorg/reactivestreams/Subscriber;)V
    ...
    invoke-virtual {v2, v3}, Lio/reactivex/Flowable;->k6(Lio/reactivex/FlowableSubscriber;)V
