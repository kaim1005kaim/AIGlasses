...
.method constructor <init>(Lio/reactivex/processors/ReplayProcessor$ReplayBuffer;)V
    ...
    iput-object p1, p0, Lio/reactivex/processors/ReplayProcessor;->b:Lio/reactivex/processors/ReplayProcessor$ReplayBuffer;
...
.method public static U8()Lio/reactivex/processors/ReplayProcessor;
    .locals 3
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "<T:",
...
.method public static V8(I)Lio/reactivex/processors/ReplayProcessor;
    .locals 2
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "<T:",
...
.method static W8()Lio/reactivex/processors/ReplayProcessor;
    .locals 3
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "<T:",
...
.method public static X8(I)Lio/reactivex/processors/ReplayProcessor;
    .locals 2
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "<T:",
...
.method public static Y8(JLjava/util/concurrent/TimeUnit;Lio/reactivex/Scheduler;)Lio/reactivex/processors/ReplayProcessor;
    .locals 8
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "<T:",
...
.method public static Z8(JLjava/util/concurrent/TimeUnit;Lio/reactivex/Scheduler;I)Lio/reactivex/processors/ReplayProcessor;
    .locals 8
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "<T:",
...
.method public N8()Ljava/lang/Throwable;
    ...
    iget-object p0, p0, Lio/reactivex/processors/ReplayProcessor;->b:Lio/reactivex/processors/ReplayProcessor$ReplayBuffer;
...
.method public P8()Z
    ...
    iget-object p0, p0, Lio/reactivex/processors/ReplayProcessor;->d:Ljava/util/concurrent/atomic/AtomicReference;
...
.method S8(Lio/reactivex/processors/ReplayProcessor$ReplaySubscription;)Z
    .locals 4
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "(",
...
.method public T8()V
    ...
    invoke-interface {p0}, Lio/reactivex/processors/ReplayProcessor$ReplayBuffer;->b()V
...
.method public b9()[Ljava/lang/Object;
    ...
    invoke-virtual {p0, v0}, Lio/reactivex/processors/ReplayProcessor;->c9([Ljava/lang/Object;)[Ljava/lang/Object;
...
.method public c9([Ljava/lang/Object;)[Ljava/lang/Object;
    ...
    invoke-interface {p0, p1}, Lio/reactivex/processors/ReplayProcessor$ReplayBuffer;->c([Ljava/lang/Object;)[Ljava/lang/Object;
...
.method e9(Lio/reactivex/processors/ReplayProcessor$ReplaySubscription;)V
    .locals 6
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "(",
...
.method public g(Lorg/reactivestreams/Subscription;)V
    ...
    iget-boolean p0, p0, Lio/reactivex/processors/ReplayProcessor;->c:Z
...
.method protected l6(Lorg/reactivestreams/Subscriber;)V
    ...
    invoke-virtual {p0, v0}, Lio/reactivex/processors/ReplayProcessor;->S8(Lio/reactivex/processors/ReplayProcessor$ReplaySubscription;)Z

    move-result p1

    if-eqz p1, :cond_0

    iget-boolean p1, v0, Lio/reactivex/processors/ReplayProcessor$ReplaySubscription;->e:Z

    if-eqz p1, :cond_0

    invoke-virtual {p0, v0}, Lio/reactivex/processors/ReplayProcessor;->e9(Lio/reactivex/processors/ReplayProcessor$ReplaySubscription;)V
    ...
    invoke-interface {p0, v0}, Lio/reactivex/processors/ReplayProcessor$ReplayBuffer;->d(Lio/reactivex/processors/ReplayProcessor$ReplaySubscription;)V
...
.method public onError(Ljava/lang/Throwable;)V
    ...
    sget-object p1, Lio/reactivex/processors/ReplayProcessor;->g:[Lio/reactivex/processors/ReplayProcessor$ReplaySubscription;
    ...
    invoke-interface {v0, v2}, Lio/reactivex/processors/ReplayProcessor$ReplayBuffer;->d(Lio/reactivex/processors/ReplayProcessor$ReplaySubscription;)V
