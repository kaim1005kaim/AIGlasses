...
.method public constructor <init>(Lokio/ByteString;Lokhttp3/MediaType;Ljava/util/List;)V
    ...
    iput-object p1, p0, Lokhttp3/MultipartBody;->b:Lokio/ByteString;
    ...
    invoke-virtual {p0}, Lokhttp3/MultipartBody;->e()Ljava/lang/String;
...
.method private final j(Lokio/BufferedSink;Z)J
    ...
    iget-object v7, p0, Lokhttp3/MultipartBody;->d:Ljava/util/List;
    ...
    invoke-virtual {v5}, Lokhttp3/MultipartBody$Part;->h()Lokhttp3/Headers;

    move-result-object v7

    invoke-virtual {v5}, Lokhttp3/MultipartBody$Part;->c()Lokhttp3/RequestBody;
    ...
    iget-object v8, p0, Lokhttp3/MultipartBody;->b:Lokio/ByteString;
    ...
    sget-object v12, Lokhttp3/MultipartBody;->m:[B

    invoke-interface {v11, v12}, Lokio/BufferedSink;->write([B)Lokio/BufferedSink;

    move-result-object v11

    invoke-virtual {v7, v9}, Lokhttp3/Headers;->o(I)Ljava/lang/String;
    ...
    iget-object p0, p0, Lokhttp3/MultipartBody;->b:Lokio/ByteString;

    invoke-interface {p1, p0}, Lokio/BufferedSink;->write(Lokio/ByteString;)Lokio/BufferedSink;

    invoke-interface {p1, v1}, Lokio/BufferedSink;->write([B)Lokio/BufferedSink;

    sget-object p0, Lokhttp3/MultipartBody;->n:[B
...
.method public final c()I
    ...
    invoke-virtual {p0}, Lokhttp3/MultipartBody;->h()I
...
.method public contentLength()J
    ...
    invoke-direct {p0, v0, v1}, Lokhttp3/MultipartBody;->j(Lokio/BufferedSink;Z)J
...
.method public final f(I)Lokhttp3/MultipartBody$Part;
    .locals 0
    .annotation build Lorg/jetbrains/annotations/NotNull;
    .end annotation
...
.method public writeTo(Lokio/BufferedSink;)V
    ...
    invoke-direct {p0, p1, v0}, Lokhttp3/MultipartBody;->j(Lokio/BufferedSink;Z)J
