...
.method public static final synthetic j(Lkotlinx/coroutines/sync/SemaphoreImpl;Lkotlin/coroutines/Continuation;)Ljava/lang/Object;
    .locals 0

    invoke-direct {p0, p1}, Lkotlinx/coroutines/sync/SemaphoreImpl;->o(Lkotlin/coroutines/Continuation;)Ljava/lang/Object;
...
.method public static final synthetic k(Lkotlinx/coroutines/sync/SemaphoreImpl;Lkotlinx/coroutines/Waiter;)Z
    .locals 0

    invoke-direct {p0, p1}, Lkotlinx/coroutines/sync/SemaphoreImpl;->p(Lkotlinx/coroutines/Waiter;)Z
...
.method private final l(Ljava/lang/Object;Lkotlin/jvm/functions/Function1;Lkotlin/jvm/functions/Function1;)V
    .locals 1
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "<W:",
    ...
    :cond_0
    invoke-direct {p0}, Lkotlinx/coroutines/sync/SemaphoreImpl;->r()I
...
.method static synthetic n(Lkotlinx/coroutines/sync/SemaphoreImpl;Lkotlin/coroutines/Continuation;)Ljava/lang/Object;
    .locals 1
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "(",
...
.method private final o(Lkotlin/coroutines/Continuation;)Ljava/lang/Object;
    ...
    :try_start_0
    invoke-static {p0, v0}, Lkotlinx/coroutines/sync/SemaphoreImpl;->k(Lkotlinx/coroutines/sync/SemaphoreImpl;Lkotlinx/coroutines/Waiter;)Z

    move-result v1

    if-nez v1, :cond_0

    invoke-virtual {p0, v0}, Lkotlinx/coroutines/sync/SemaphoreImpl;->m(Lkotlinx/coroutines/CancellableContinuation;)V
    :try_end_0
...
.method private final p(Lkotlinx/coroutines/Waiter;)Z
    .locals 14
    ...
    :goto_0
    invoke-static {v1, v5, v6, v4}, Lkotlinx/coroutines/internal/ConcurrentLinkedListKt;->g(Lkotlinx/coroutines/internal/Segment;JLkotlin/jvm/functions/Function2;)Ljava/lang/Object;
    ...
    :cond_1
    invoke-virtual {v8}, Lkotlinx/coroutines/internal/Segment;->s()Z
    ...
    invoke-virtual {v9}, Lkotlinx/coroutines/internal/Segment;->o()Z
    ...
    invoke-static {v2, v1, v3, p1}, Lcom/google/common/util/concurrent/g0;->a(Ljava/util/concurrent/atomic/AtomicReferenceArray;ILjava/lang/Object;Ljava/lang/Object;)Z
    ...
    invoke-static {v0, v1, v2, v4}, Lcom/google/common/util/concurrent/g0;->a(Ljava/util/concurrent/atomic/AtomicReferenceArray;ILjava/lang/Object;Ljava/lang/Object;)Z
    ...
    invoke-interface {p1, v0, p0}, Lkotlinx/coroutines/CancellableContinuation;->n(Ljava/lang/Object;Lkotlin/jvm/functions/Function1;)V
...
.method private final t(Ljava/lang/Object;)Z
    ...
    invoke-interface {p1, v0, v1, p0}, Lkotlinx/coroutines/CancellableContinuation;->Q(Ljava/lang/Object;Ljava/lang/Object;Lkotlin/jvm/functions/Function1;)Ljava/lang/Object;

    move-result-object p0

    if-eqz p0, :cond_0

    invoke-interface {p1, p0}, Lkotlinx/coroutines/CancellableContinuation;->J(Ljava/lang/Object;)V
...
.method private final u()Z
    ...
    :goto_0
    invoke-static {v1, v4, v5, v6}, Lkotlinx/coroutines/internal/ConcurrentLinkedListKt;->g(Lkotlinx/coroutines/internal/Segment;JLkotlin/jvm/functions/Function2;)Ljava/lang/Object;
    ...
    invoke-static {v0, v1, p0, v3}, Lcom/google/common/util/concurrent/g0;->a(Ljava/util/concurrent/atomic/AtomicReferenceArray;ILjava/lang/Object;Ljava/lang/Object;)Z
...
.method public a()Z
    ...
    invoke-direct {p0}, Lkotlinx/coroutines/sync/SemaphoreImpl;->q()V
...
.method public g(Lkotlin/coroutines/Continuation;)Ljava/lang/Object;
    ...
    invoke-static {p0, p1}, Lkotlinx/coroutines/sync/SemaphoreImpl;->n(Lkotlinx/coroutines/sync/SemaphoreImpl;Lkotlin/coroutines/Continuation;)Ljava/lang/Object;
...
.method protected final m(Lkotlinx/coroutines/CancellableContinuation;)V
    .locals 1
    ...
    invoke-direct {p0, v0}, Lkotlinx/coroutines/sync/SemaphoreImpl;->p(Lkotlinx/coroutines/Waiter;)Z
...
.method protected final s(Lkotlinx/coroutines/selects/SelectInstance;Ljava/lang/Object;)V
    .locals 0
    ...
    invoke-direct {p0, p2}, Lkotlinx/coroutines/sync/SemaphoreImpl;->p(Lkotlinx/coroutines/Waiter;)Z
