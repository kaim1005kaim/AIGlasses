.class public final LBrightDialogKt;
...
.method public static final a(Landroidx/compose/runtime/State;ZLcom/superhexa/supervision/feature/miwearglasses/presentation/setting/MiWearSettingViewModel;Landroidx/compose/runtime/Composer;I)V
    ...
    const-string/jumbo v4, "settingState"
    ...
    const-string v6, "BrightDialog (BrightDialog.kt:21)"

    invoke-static {v4, v3, v5, v6}, Landroidx/compose/runtime/ComposerKt;->traceEventStart(IIILjava/lang/String;)V

    :cond_0
    new-instance v4, Lcom/superhexa/supervision/library/base/data/model/SelectItem$MiWearBightSelectItem;

    sget v5, Lcom/superhexa/supervision/feature/miwearglasses/R$string;->libs_low:I
    ...
    invoke-virtual {v6}, Lcom/superhexa/supervision/feature/miwearglasses/presentation/setting/MiWearSettingState;->getBrightness()I
    ...
    :goto_0
    invoke-direct {v4, v5, v6, v8}, Lcom/superhexa/supervision/library/base/data/model/SelectItem$MiWearBightSelectItem;-><init>(IZI)V

    new-instance v5, Lcom/superhexa/supervision/library/base/data/model/SelectItem$MiWearBightSelectItem;

    sget v6, Lcom/superhexa/supervision/feature/miwearglasses/R$string;->libs_middle:I
    ...
    invoke-virtual {v9}, Lcom/superhexa/supervision/feature/miwearglasses/presentation/setting/MiWearSettingState;->getBrightness()I
    ...
    :goto_1
    invoke-direct {v5, v6, v9, v10}, Lcom/superhexa/supervision/library/base/data/model/SelectItem$MiWearBightSelectItem;-><init>(IZI)V

    new-instance v6, Lcom/superhexa/supervision/library/base/data/model/SelectItem$MiWearBightSelectItem;

    sget v9, Lcom/superhexa/supervision/feature/miwearglasses/R$string;->libs_high:I

    invoke-interface/range {p0 .. p0}, Landroidx/compose/runtime/State;->getValue()Ljava/lang/Object;

    move-result-object v10

    check-cast v10, Lcom/superhexa/supervision/feature/miwearglasses/presentation/setting/MiWearSettingState;

    invoke-virtual {v10}, Lcom/superhexa/supervision/feature/miwearglasses/presentation/setting/MiWearSettingState;->getBrightness()I
    ...
    :goto_2
    invoke-direct {v6, v9, v8, v11}, Lcom/superhexa/supervision/library/base/data/model/SelectItem$MiWearBightSelectItem;-><init>(IZI)V

    filled-new-array {v4, v5, v6}, [Lcom/superhexa/supervision/library/base/data/model/SelectItem$MiWearBightSelectItem;
    ...
    sget v4, Lcom/superhexa/supervision/feature/miwearglasses/R$string;->tip_lights_brightness:I
    ...
    invoke-virtual {v4}, Lcom/superhexa/supervision/feature/miwearglasses/presentation/setting/MiWearSettingState;->getShowBrightDialog()Z
    ...
    :cond_4
    new-instance v7, LBrightDialogKt$BrightDialog$1$1;

    invoke-direct {v7, v1}, LBrightDialogKt$BrightDialog$1$1;-><init>(Z)V
    ...
    new-instance v8, LBrightDialogKt$BrightDialog$2;

    invoke-direct {v8, v2, v0}, LBrightDialogKt$BrightDialog$2;-><init>(Lcom/superhexa/supervision/feature/miwearglasses/presentation/setting/MiWearSettingViewModel;Landroidx/compose/runtime/State;)V

    new-instance v9, LBrightDialogKt$BrightDialog$3;

    invoke-direct {v9, v2}, LBrightDialogKt$BrightDialog$3;-><init>(Lcom/superhexa/supervision/feature/miwearglasses/presentation/setting/MiWearSettingViewModel;)V
    ...
    :cond_7
    new-instance v5, LBrightDialogKt$BrightDialog$4;

    invoke-direct {v5, v0, v1, v2, v3}, LBrightDialogKt$BrightDialog$4;-><init>(Landroidx/compose/runtime/State;ZLcom/superhexa/supervision/feature/miwearglasses/presentation/setting/MiWearSettingViewModel;I)V
