...
.field private d:Lorg/bouncycastle/crypto/prng/EntropySource;

.field private e:Lorg/bouncycastle/crypto/Mac;
...
.method public constructor <init>(Lorg/bouncycastle/crypto/Mac;ILorg/bouncycastle/crypto/prng/EntropySource;[B[B)V
    ...
    invoke-static {p1}, Lorg/bouncycastle/crypto/prng/drbg/Utils;->b(Lorg/bouncycastle/crypto/Mac;)I
    ...
    invoke-direct {p0}, Lorg/bouncycastle/crypto/prng/drbg/HMacSP800DRBG;->c()[B

    move-result-object p2

    invoke-static {p2, p5, p4}, Lorg/bouncycastle/util/Arrays;->y([B[B[B)[B
    ...
    iput-object p1, p0, Lorg/bouncycastle/crypto/prng/drbg/HMacSP800DRBG;->a:[B
    ...
    invoke-static {p1, p3}, Lorg/bouncycastle/util/Arrays;->O([BB)V

    invoke-direct {p0, p2}, Lorg/bouncycastle/crypto/prng/drbg/HMacSP800DRBG;->d([B)V
...
.method private c()[B
    ...
    iget p0, p0, Lorg/bouncycastle/crypto/prng/drbg/HMacSP800DRBG;->f:I
...
.method private d([B)V
    ...
    invoke-direct {p0, p1, v0}, Lorg/bouncycastle/crypto/prng/drbg/HMacSP800DRBG;->e([BB)V
...
.method private e([BB)V
    ...
    iget-object v0, p0, Lorg/bouncycastle/crypto/prng/drbg/HMacSP800DRBG;->e:Lorg/bouncycastle/crypto/Mac;

    new-instance v1, Lorg/bouncycastle/crypto/params/KeyParameter;

    iget-object v2, p0, Lorg/bouncycastle/crypto/prng/drbg/HMacSP800DRBG;->a:[B
    ...
    iget-object v1, p0, Lorg/bouncycastle/crypto/prng/drbg/HMacSP800DRBG;->b:[B
    ...
    iget-object p2, p0, Lorg/bouncycastle/crypto/prng/drbg/HMacSP800DRBG;->e:Lorg/bouncycastle/crypto/Mac;
    ...
    :cond_0
    iget-object p1, p0, Lorg/bouncycastle/crypto/prng/drbg/HMacSP800DRBG;->e:Lorg/bouncycastle/crypto/Mac;

    iget-object p2, p0, Lorg/bouncycastle/crypto/prng/drbg/HMacSP800DRBG;->a:[B
    ...
    iget-object v0, p0, Lorg/bouncycastle/crypto/prng/drbg/HMacSP800DRBG;->a:[B

    invoke-direct {p2, v0}, Lorg/bouncycastle/crypto/params/KeyParameter;-><init>([B)V

    invoke-interface {p1, p2}, Lorg/bouncycastle/crypto/Mac;->a(Lorg/bouncycastle/crypto/CipherParameters;)V

    iget-object p1, p0, Lorg/bouncycastle/crypto/prng/drbg/HMacSP800DRBG;->e:Lorg/bouncycastle/crypto/Mac;

    iget-object p2, p0, Lorg/bouncycastle/crypto/prng/drbg/HMacSP800DRBG;->b:[B
    ...
    iget-object p0, p0, Lorg/bouncycastle/crypto/prng/drbg/HMacSP800DRBG;->b:[B
...
.method public a([B[BZ)I
    ...
    invoke-virtual {p0, p2}, Lorg/bouncycastle/crypto/prng/drbg/HMacSP800DRBG;->b([B)V
    ...
    iget-object v3, p0, Lorg/bouncycastle/crypto/prng/drbg/HMacSP800DRBG;->e:Lorg/bouncycastle/crypto/Mac;
    ...
    invoke-interface {v3, v4}, Lorg/bouncycastle/crypto/Mac;->a(Lorg/bouncycastle/crypto/CipherParameters;)V
    ...
    iget-object v6, p0, Lorg/bouncycastle/crypto/prng/drbg/HMacSP800DRBG;->b:[B
    ...
    iget-object v5, p0, Lorg/bouncycastle/crypto/prng/drbg/HMacSP800DRBG;->b:[B
    ...
    :cond_3
    iget-object v4, p0, Lorg/bouncycastle/crypto/prng/drbg/HMacSP800DRBG;->b:[B
    ...
    iget-object v4, p0, Lorg/bouncycastle/crypto/prng/drbg/HMacSP800DRBG;->e:Lorg/bouncycastle/crypto/Mac;
    ...
    iget-wide p2, p0, Lorg/bouncycastle/crypto/prng/drbg/HMacSP800DRBG;->c:J

    const-wide/16 v4, 0x1

    add-long/2addr p2, v4

    iput-wide p2, p0, Lorg/bouncycastle/crypto/prng/drbg/HMacSP800DRBG;->c:J
...
.method public b([B)V
    ...
    invoke-direct {p0, p1}, Lorg/bouncycastle/crypto/prng/drbg/HMacSP800DRBG;->d([B)V
