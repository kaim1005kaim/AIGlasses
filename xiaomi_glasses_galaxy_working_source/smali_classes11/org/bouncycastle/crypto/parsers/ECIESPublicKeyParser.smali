...
# instance fields
.field private a:Lorg/bouncycastle/crypto/params/ECDomainParameters;
...
# virtual methods
.method public a(Ljava/io/InputStream;)Lorg/bouncycastle/crypto/params/AsymmetricKeyParameter;
    .locals 5
    ...
    :cond_1
    :goto_0
    iget-object v4, p0, Lorg/bouncycastle/crypto/parsers/ECIESPublicKeyParser;->a:Lorg/bouncycastle/crypto/params/ECDomainParameters;

    invoke-virtual {v4}, Lorg/bouncycastle/crypto/params/ECDomainParameters;->a()Lorg/bouncycastle/math/ec/ECCurve;

    move-result-object v4

    invoke-virtual {v4}, Lorg/bouncycastle/math/ec/ECCurve;->w()I
    ...
    :cond_2
    iget-object v1, p0, Lorg/bouncycastle/crypto/parsers/ECIESPublicKeyParser;->a:Lorg/bouncycastle/crypto/params/ECDomainParameters;

    invoke-virtual {v1}, Lorg/bouncycastle/crypto/params/ECDomainParameters;->a()Lorg/bouncycastle/math/ec/ECCurve;

    move-result-object v1

    invoke-virtual {v1}, Lorg/bouncycastle/math/ec/ECCurve;->w()I
    ...
    invoke-static {p1, v1, v3, v0}, Lorg/bouncycastle/util/io/Streams;->g(Ljava/io/InputStream;[BII)I

    new-instance p1, Lorg/bouncycastle/crypto/params/ECPublicKeyParameters;

    iget-object v0, p0, Lorg/bouncycastle/crypto/parsers/ECIESPublicKeyParser;->a:Lorg/bouncycastle/crypto/params/ECDomainParameters;
    ...
    iget-object p0, p0, Lorg/bouncycastle/crypto/parsers/ECIESPublicKeyParser;->a:Lorg/bouncycastle/crypto/params/ECDomainParameters;
