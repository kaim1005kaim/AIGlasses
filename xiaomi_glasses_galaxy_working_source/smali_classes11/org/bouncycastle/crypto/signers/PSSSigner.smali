...
# static fields
.field public static final t:B = -0x44t
...
.field private i:Lorg/bouncycastle/crypto/AsymmetricBlockCipher;
...
.method public constructor <init>(Lorg/bouncycastle/crypto/AsymmetricBlockCipher;Lorg/bouncycastle/crypto/Digest;Lorg/bouncycastle/crypto/Digest;IB)V
    ...
    iput p1, p0, Lorg/bouncycastle/crypto/signers/PSSSigner;->l:I

    const/4 p1, 0x0

    iput-boolean p1, p0, Lorg/bouncycastle/crypto/signers/PSSSigner;->m:Z

    iput p4, p0, Lorg/bouncycastle/crypto/signers/PSSSigner;->n:I
    ...
    iget p1, p0, Lorg/bouncycastle/crypto/signers/PSSSigner;->k:I
    ...
    iput-byte p5, p0, Lorg/bouncycastle/crypto/signers/PSSSigner;->s:B
...
.method public constructor <init>(Lorg/bouncycastle/crypto/AsymmetricBlockCipher;Lorg/bouncycastle/crypto/Digest;Lorg/bouncycastle/crypto/Digest;[BB)V
    ...
    iput-object p4, p0, Lorg/bouncycastle/crypto/signers/PSSSigner;->p:[B
...
.method private i([BIII)[B
    ...
    iget v1, p0, Lorg/bouncycastle/crypto/signers/PSSSigner;->l:I
    ...
    iget-object v4, p0, Lorg/bouncycastle/crypto/signers/PSSSigner;->h:Lorg/bouncycastle/crypto/Digest;
    ...
    :goto_0
    iget v6, p0, Lorg/bouncycastle/crypto/signers/PSSSigner;->l:I

    div-int v7, p4, v6

    if-ge v5, v7, :cond_0

    invoke-direct {p0, v5, v3}, Lorg/bouncycastle/crypto/signers/PSSSigner;->g(I[B)V

    iget-object v6, p0, Lorg/bouncycastle/crypto/signers/PSSSigner;->h:Lorg/bouncycastle/crypto/Digest;
    ...
    iget-object p1, p0, Lorg/bouncycastle/crypto/signers/PSSSigner;->h:Lorg/bouncycastle/crypto/Digest;
    ...
    iget p0, p0, Lorg/bouncycastle/crypto/signers/PSSSigner;->l:I
...
.method public a(ZLorg/bouncycastle/crypto/CipherParameters;)V
    ...
    invoke-virtual {v1}, Lorg/bouncycastle/crypto/params/RSABlindingParameters;->b()Lorg/bouncycastle/crypto/params/RSAKeyParameters;
    ...
    iget-object p2, p0, Lorg/bouncycastle/crypto/signers/PSSSigner;->i:Lorg/bouncycastle/crypto/AsymmetricBlockCipher;
    ...
    iput p2, p0, Lorg/bouncycastle/crypto/signers/PSSSigner;->o:I

    iget v0, p0, Lorg/bouncycastle/crypto/signers/PSSSigner;->k:I

    mul-int/lit8 v0, v0, 0x8

    iget v1, p0, Lorg/bouncycastle/crypto/signers/PSSSigner;->n:I
    ...
    iput-object p1, p0, Lorg/bouncycastle/crypto/signers/PSSSigner;->r:[B
...
.method public b([B)Z
    ...
    iget v3, p0, Lorg/bouncycastle/crypto/signers/PSSSigner;->k:I

    sub-int/2addr v2, v3

    iget v3, p0, Lorg/bouncycastle/crypto/signers/PSSSigner;->n:I
    ...
    iget-object v1, p0, Lorg/bouncycastle/crypto/signers/PSSSigner;->r:[B
    ...
    iget-object p1, p0, Lorg/bouncycastle/crypto/signers/PSSSigner;->r:[B
    ...
    iget-byte v3, p0, Lorg/bouncycastle/crypto/signers/PSSSigner;->s:B

    if-eq v1, v3, :cond_0

    invoke-direct {p0, p1}, Lorg/bouncycastle/crypto/signers/PSSSigner;->h([B)V
    ...
    invoke-direct {p0, p1, v1, v3, v4}, Lorg/bouncycastle/crypto/signers/PSSSigner;->i([BIII)[B
    ...
    iget-object v3, p0, Lorg/bouncycastle/crypto/signers/PSSSigner;->r:[B
    ...
    iget v4, p0, Lorg/bouncycastle/crypto/signers/PSSSigner;->o:I
    ...
    iget v4, p0, Lorg/bouncycastle/crypto/signers/PSSSigner;->k:I

    sub-int/2addr v3, v4

    iget v5, p0, Lorg/bouncycastle/crypto/signers/PSSSigner;->n:I
    ...
    invoke-direct {p0, v1}, Lorg/bouncycastle/crypto/signers/PSSSigner;->h([B)V
    ...
    :cond_4
    iget-boolean p1, p0, Lorg/bouncycastle/crypto/signers/PSSSigner;->m:Z

    if-eqz p1, :cond_5

    iget-object p1, p0, Lorg/bouncycastle/crypto/signers/PSSSigner;->p:[B
    ...
    iget v1, p0, Lorg/bouncycastle/crypto/signers/PSSSigner;->k:I
    ...
    iget-object v4, p0, Lorg/bouncycastle/crypto/signers/PSSSigner;->r:[B
...
.method public c()[B
    ...
    iget v0, p0, Lorg/bouncycastle/crypto/signers/PSSSigner;->n:I

    const/4 v1, 0x0

    if-eqz v0, :cond_1

    iget-boolean v0, p0, Lorg/bouncycastle/crypto/signers/PSSSigner;->m:Z

    if-nez v0, :cond_0

    iget-object v0, p0, Lorg/bouncycastle/crypto/signers/PSSSigner;->j:Ljava/security/SecureRandom;

    iget-object v2, p0, Lorg/bouncycastle/crypto/signers/PSSSigner;->p:[B
    ...
    iget v4, p0, Lorg/bouncycastle/crypto/signers/PSSSigner;->n:I
    ...
    iget-object v3, p0, Lorg/bouncycastle/crypto/signers/PSSSigner;->g:Lorg/bouncycastle/crypto/Digest;

    iget-object v4, p0, Lorg/bouncycastle/crypto/signers/PSSSigner;->q:[B
    ...
    iget v7, p0, Lorg/bouncycastle/crypto/signers/PSSSigner;->k:I
    ...
    iget-object v4, p0, Lorg/bouncycastle/crypto/signers/PSSSigner;->p:[B
    ...
    invoke-direct {p0, v2, v1, v0, v3}, Lorg/bouncycastle/crypto/signers/PSSSigner;->i([BIII)[B
    ...
    :cond_2
    iget-object v0, p0, Lorg/bouncycastle/crypto/signers/PSSSigner;->r:[B
    ...
    iget v5, p0, Lorg/bouncycastle/crypto/signers/PSSSigner;->o:I
    ...
    invoke-interface {v2, v0, v1, v3}, Lorg/bouncycastle/crypto/AsymmetricBlockCipher;->b([BII)[B
...
.method public reset()V
    ...
    iget-object p0, p0, Lorg/bouncycastle/crypto/signers/PSSSigner;->g:Lorg/bouncycastle/crypto/Digest;
