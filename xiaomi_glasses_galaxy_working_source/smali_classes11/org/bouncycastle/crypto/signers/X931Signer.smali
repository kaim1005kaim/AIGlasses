...
.field private i:Lorg/bouncycastle/crypto/params/RSAKeyParameters;
...
.method private h(I)V
    ...
    iget-object p1, p0, Lorg/bouncycastle/crypto/signers/X931Signer;->l:[B
    ...
    :cond_0
    iget-object v1, p0, Lorg/bouncycastle/crypto/signers/X931Signer;->l:[B
    ...
    iget-object v2, p0, Lorg/bouncycastle/crypto/signers/X931Signer;->g:Lorg/bouncycastle/crypto/Digest;
    ...
    iget-object v0, p0, Lorg/bouncycastle/crypto/signers/X931Signer;->l:[B
    ...
    :cond_1
    iget-object p0, p0, Lorg/bouncycastle/crypto/signers/X931Signer;->l:[B
...
.method public a(ZLorg/bouncycastle/crypto/CipherParameters;)V
    ...
    iput p1, p0, Lorg/bouncycastle/crypto/signers/X931Signer;->k:I
    ...
    iput-object p1, p0, Lorg/bouncycastle/crypto/signers/X931Signer;->l:[B
...
.method public b([B)Z
    ...
    iget-object v2, p0, Lorg/bouncycastle/crypto/signers/X931Signer;->l:[B
    ...
    invoke-direct {p0, v0}, Lorg/bouncycastle/crypto/signers/X931Signer;->h(I)V

    iget-object v0, p0, Lorg/bouncycastle/crypto/signers/X931Signer;->l:[B

    array-length v0, v0

    invoke-static {v0, p1}, Lorg/bouncycastle/util/BigIntegers;->a(ILjava/math/BigInteger;)[B

    move-result-object p1

    iget-object v0, p0, Lorg/bouncycastle/crypto/signers/X931Signer;->l:[B

    invoke-static {v0, p1}, Lorg/bouncycastle/util/Arrays;->C([B[B)Z
    ...
    invoke-direct {p0, v1}, Lorg/bouncycastle/crypto/signers/X931Signer;->g([B)V

    invoke-direct {p0, p1}, Lorg/bouncycastle/crypto/signers/X931Signer;->g([B)V
...
.method public c()[B
    ...
    invoke-interface {v1, v2, v3, v4}, Lorg/bouncycastle/crypto/AsymmetricBlockCipher;->b([BII)[B
    ...
    iget-object p0, p0, Lorg/bouncycastle/crypto/signers/X931Signer;->i:Lorg/bouncycastle/crypto/params/RSAKeyParameters;
...
.method public reset()V
    ...
    iget-object p0, p0, Lorg/bouncycastle/crypto/signers/X931Signer;->g:Lorg/bouncycastle/crypto/Digest;
