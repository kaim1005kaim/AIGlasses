...
.method public a(ZLorg/bouncycastle/crypto/CipherParameters;)V
    ...
    iput-object v0, p0, Lorg/bouncycastle/crypto/signers/ECDSASigner;->h:Lorg/bouncycastle/crypto/params/ECKeyParameters;
    ...
    :goto_3
    invoke-virtual {p0, p1, p2}, Lorg/bouncycastle/crypto/signers/ECDSASigner;->g(ZLjava/security/SecureRandom;)Ljava/security/SecureRandom;

    move-result-object p1

    iput-object p1, p0, Lorg/bouncycastle/crypto/signers/ECDSASigner;->i:Ljava/security/SecureRandom;
...
.method public b([B)[Ljava/math/BigInteger;
    ...
    invoke-virtual {p0, v1, p1}, Lorg/bouncycastle/crypto/signers/ECDSASigner;->d(Ljava/math/BigInteger;[B)Ljava/math/BigInteger;

    move-result-object v2

    iget-object v3, p0, Lorg/bouncycastle/crypto/signers/ECDSASigner;->h:Lorg/bouncycastle/crypto/params/ECKeyParameters;
    ...
    iget-object v4, p0, Lorg/bouncycastle/crypto/signers/ECDSASigner;->g:Lorg/bouncycastle/crypto/signers/DSAKCalculator;
    ...
    iget-object v4, p0, Lorg/bouncycastle/crypto/signers/ECDSASigner;->i:Ljava/security/SecureRandom;
    ...
    :goto_0
    invoke-virtual {p0}, Lorg/bouncycastle/crypto/signers/ECDSASigner;->e()Lorg/bouncycastle/math/ec/ECMultiplier;
    ...
    invoke-interface {p1, v5, v4}, Lorg/bouncycastle/math/ec/ECMultiplier;->a(Lorg/bouncycastle/math/ec/ECPoint;Ljava/math/BigInteger;)Lorg/bouncycastle/math/ec/ECPoint;
...
.method public c([BLjava/math/BigInteger;Ljava/math/BigInteger;)Z
    ...
    invoke-static {v0, p1, v2, p3}, Lorg/bouncycastle/math/ec/ECAlgorithms;->s(Lorg/bouncycastle/math/ec/ECPoint;Ljava/math/BigInteger;Lorg/bouncycastle/math/ec/ECPoint;Ljava/math/BigInteger;)Lorg/bouncycastle/math/ec/ECPoint;
    ...
    invoke-virtual {p3}, Lorg/bouncycastle/math/ec/ECCurve;->s()Ljava/math/BigInteger;
    ...
    invoke-virtual {p3}, Lorg/bouncycastle/math/ec/ECCurve;->t()I

    move-result v0

    invoke-virtual {p0, v0, p1}, Lorg/bouncycastle/crypto/signers/ECDSASigner;->f(ILorg/bouncycastle/math/ec/ECPoint;)Lorg/bouncycastle/math/ec/ECFieldElement;
    ...
    :goto_0
    invoke-virtual {p3, p2}, Lorg/bouncycastle/math/ec/ECCurve;->C(Ljava/math/BigInteger;)Z

    move-result v0

    if-eqz v0, :cond_4

    invoke-virtual {p3, p2}, Lorg/bouncycastle/math/ec/ECCurve;->o(Ljava/math/BigInteger;)Lorg/bouncycastle/math/ec/ECFieldElement;

    move-result-object v0

    invoke-virtual {v0, p0}, Lorg/bouncycastle/math/ec/ECFieldElement;->k(Lorg/bouncycastle/math/ec/ECFieldElement;)Lorg/bouncycastle/math/ec/ECFieldElement;
...
.method protected e()Lorg/bouncycastle/math/ec/ECMultiplier;
    .locals 0
...
.method protected f(ILorg/bouncycastle/math/ec/ECPoint;)Lorg/bouncycastle/math/ec/ECFieldElement;
    .locals 1
    ...
    :cond_0
    invoke-virtual {p2, v0}, Lorg/bouncycastle/math/ec/ECPoint;->v(I)Lorg/bouncycastle/math/ec/ECFieldElement;
