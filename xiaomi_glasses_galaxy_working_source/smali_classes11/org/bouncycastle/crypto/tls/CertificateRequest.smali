...
.method public constructor <init>([SLjava/util/Vector;Ljava/util/Vector;)V
    ...
    iput-object p3, p0, Lorg/bouncycastle/crypto/tls/CertificateRequest;->c:Ljava/util/Vector;

    return-void
.end method

.method public static e(Lorg/bouncycastle/crypto/tls/TlsContext;Ljava/io/InputStream;)Lorg/bouncycastle/crypto/tls/CertificateRequest;
    .locals 5
    ...
    invoke-static {v2, p1}, Lorg/bouncycastle/crypto/tls/TlsUtils;->w0(ZLjava/io/InputStream;)Ljava/util/Vector;
    ...
    invoke-static {p1}, Lorg/bouncycastle/crypto/tls/TlsUtils;->z0([B)Lorg/bouncycastle/asn1/ASN1Primitive;
...
.method public a(Ljava/io/OutputStream;)V
    ...
    :cond_0
    invoke-static {v0, p1}, Lorg/bouncycastle/crypto/tls/TlsUtils;->y1([SLjava/io/OutputStream;)V

    goto :goto_1

    :cond_1
    :goto_0
    invoke-static {v1, p1}, Lorg/bouncycastle/crypto/tls/TlsUtils;->s1(ILjava/io/OutputStream;)V
    ...
    invoke-static {v0, v1, p1}, Lorg/bouncycastle/crypto/tls/TlsUtils;->C(Ljava/util/Vector;ZLjava/io/OutputStream;)V

    :cond_2
    iget-object v0, p0, Lorg/bouncycastle/crypto/tls/CertificateRequest;->c:Ljava/util/Vector;
    ...
    iget-object v2, p0, Lorg/bouncycastle/crypto/tls/CertificateRequest;->c:Ljava/util/Vector;
    ...
    :goto_2
    iget-object v4, p0, Lorg/bouncycastle/crypto/tls/CertificateRequest;->c:Ljava/util/Vector;
...
.method public b()Ljava/util/Vector;
    ...
    iget-object p0, p0, Lorg/bouncycastle/crypto/tls/CertificateRequest;->c:Ljava/util/Vector;
...
.method public c()[S
    ...
    iget-object p0, p0, Lorg/bouncycastle/crypto/tls/CertificateRequest;->a:[S
...
.method public d()Ljava/util/Vector;
    ...
    iget-object p0, p0, Lorg/bouncycastle/crypto/tls/CertificateRequest;->b:Ljava/util/Vector;
