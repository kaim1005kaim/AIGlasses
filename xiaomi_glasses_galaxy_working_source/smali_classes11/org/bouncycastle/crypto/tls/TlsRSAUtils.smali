...
.method public static a(Lorg/bouncycastle/crypto/tls/TlsContext;Lorg/bouncycastle/crypto/params/RSAKeyParameters;Ljava/io/OutputStream;)[B
    .locals 6
    ...
    invoke-interface {p0}, Lorg/bouncycastle/crypto/tls/TlsContext;->a()Lorg/bouncycastle/crypto/tls/ProtocolVersion;

    move-result-object v2

    const/4 v3, 0x0

    invoke-static {v2, v1, v3}, Lorg/bouncycastle/crypto/tls/TlsUtils;->B1(Lorg/bouncycastle/crypto/tls/ProtocolVersion;[BI)V
    ...
    invoke-virtual {v2, p1, v4}, Lorg/bouncycastle/crypto/encodings/PKCS1Encoding;->a(ZLorg/bouncycastle/crypto/CipherParameters;)V

    :try_start_0
    invoke-virtual {v2, v1, v3, v0}, Lorg/bouncycastle/crypto/encodings/PKCS1Encoding;->b([BII)[B
    ...
    :cond_0
    invoke-static {p1, p2}, Lorg/bouncycastle/crypto/tls/TlsUtils;->b1([BLjava/io/OutputStream;)V
    :try_end_0
...
.method public static b(Lorg/bouncycastle/crypto/tls/TlsContext;Lorg/bouncycastle/crypto/params/RSAKeyParameters;[B)[B
    .locals 7
    ...
    invoke-virtual {v5, v4, v6}, Lorg/bouncycastle/crypto/encodings/PKCS1Encoding;->a(ZLorg/bouncycastle/crypto/CipherParameters;)V

    array-length p0, p2

    invoke-virtual {v5, p2, v4, p0}, Lorg/bouncycastle/crypto/encodings/PKCS1Encoding;->b([BII)[B
    ...
    :catch_0
    invoke-virtual {v0}, Lorg/bouncycastle/crypto/tls/ProtocolVersion;->e()I
    ...
    invoke-virtual {v0}, Lorg/bouncycastle/crypto/tls/ProtocolVersion;->f()I
