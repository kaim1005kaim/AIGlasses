...
.method public chunkSize()I
    ...
    iget-object p0, p0, Lio/netty/buffer/PooledByteBufAllocatorMetric;->allocator:Lio/netty/buffer/PooledByteBufAllocator;

    invoke-virtual {p0}, Lio/netty/buffer/PooledByteBufAllocator;->chunkSize()I
...
.method public directArenas()Ljava/util/List;
    ...
    invoke-virtual {p0}, Lio/netty/buffer/PooledByteBufAllocator;->directArenas()Ljava/util/List;
...
.method public heapArenas()Ljava/util/List;
    ...
    invoke-virtual {p0}, Lio/netty/buffer/PooledByteBufAllocator;->heapArenas()Ljava/util/List;
...
.method public normalCacheSize()I
    ...
    invoke-virtual {p0}, Lio/netty/buffer/PooledByteBufAllocator;->normalCacheSize()I
...
.method public numDirectArenas()I
    ...
    invoke-virtual {p0}, Lio/netty/buffer/PooledByteBufAllocator;->numDirectArenas()I
...
.method public numHeapArenas()I
    ...
    invoke-virtual {p0}, Lio/netty/buffer/PooledByteBufAllocator;->numHeapArenas()I
...
.method public numThreadLocalCaches()I
    ...
    invoke-virtual {p0}, Lio/netty/buffer/PooledByteBufAllocator;->numThreadLocalCaches()I
...
.method public smallCacheSize()I
    ...
    invoke-virtual {p0}, Lio/netty/buffer/PooledByteBufAllocator;->smallCacheSize()I
...
.method public tinyCacheSize()I
    ...
    invoke-virtual {p0}, Lio/netty/buffer/PooledByteBufAllocator;->tinyCacheSize()I
...
.method public usedDirectMemory()J
    ...
    invoke-virtual {p0}, Lio/netty/buffer/PooledByteBufAllocator;->usedDirectMemory()J
...
.method public usedHeapMemory()J
    ...
    invoke-virtual {p0}, Lio/netty/buffer/PooledByteBufAllocator;->usedHeapMemory()J
