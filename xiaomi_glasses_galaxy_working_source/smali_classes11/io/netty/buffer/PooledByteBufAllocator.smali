...
.method static constructor <clinit>()V
    ...
    invoke-static {v2, v8}, Lio/netty/util/internal/SystemPropertyUtil;->getInt(Ljava/lang/String;I)I

    move-result v2

    sput v2, Lio/netty/buffer/PooledByteBufAllocator;->DEFAULT_SMALL_CACHE_SIZE:I

    const-string v8, "io.netty.allocator.normalCacheSize"
    ...
    sput v8, Lio/netty/buffer/PooledByteBufAllocator;->DEFAULT_NORMAL_CACHE_SIZE:I

    const-string v9, "io.netty.allocator.maxCachedBufferCapacity"
    ...
    sput v9, Lio/netty/buffer/PooledByteBufAllocator;->DEFAULT_MAX_CACHED_BUFFER_CAPACITY:I

    const-string v10, "io.netty.allocator.cacheTrimInterval"

    invoke-static {v10, v3}, Lio/netty/util/internal/SystemPropertyUtil;->getInt(Ljava/lang/String;I)I

    move-result v3

    sput v3, Lio/netty/buffer/PooledByteBufAllocator;->DEFAULT_CACHE_TRIM_INTERVAL:I

    const-string v10, "io.netty.allocation.cacheTrimIntervalMillis"
    ...
    const-string v14, "io.netty.allocator.cacheTrimIntervalMillis"
    ...
    invoke-interface {v11, v15}, Lio/netty/util/internal/logging/InternalLogger;->warn(Ljava/lang/String;)V

    invoke-static {v14}, Lio/netty/util/internal/SystemPropertyUtil;->contains(Ljava/lang/String;)Z
    ...
    sput-wide v10, Lio/netty/buffer/PooledByteBufAllocator;->DEFAULT_CACHE_TRIM_INTERVAL_MILLIS:J

    goto :goto_2

    :cond_0
    invoke-static {v10, v12, v13}, Lio/netty/util/internal/SystemPropertyUtil;->getLong(Ljava/lang/String;J)J
    ...
    :goto_2
    const-string v10, "io.netty.allocator.useCacheForAllThreads"

    const/4 v11, 0x1

    invoke-static {v10, v11}, Lio/netty/util/internal/SystemPropertyUtil;->getBoolean(Ljava/lang/String;Z)Z
    ...
    invoke-interface {v12, v0, v1, v5}, Lio/netty/util/internal/logging/InternalLogger;->debug(Ljava/lang/String;Ljava/lang/Object;Ljava/lang/Object;)V
    ...
    invoke-interface {v12, v0, v1, v4}, Lio/netty/util/internal/logging/InternalLogger;->debug(Ljava/lang/String;Ljava/lang/Object;Ljava/lang/Object;)V
...
.method public constructor <init>(ZIIIIIIZI)V
    ...
    const-string p1, "Buffer alignment is not supported. Either Unsafe or ByteBuffer.alignSlice() must be available."
    ...
    const-string p1, "directMemoryCacheAlignment is not supported"
    ...
    iget p6, p0, Lio/netty/buffer/PooledByteBufAllocator;->chunkSize:I
    ...
    invoke-direct/range {p2 .. p7}, Lio/netty/buffer/PoolArena$DirectArena;-><init>(Lio/netty/buffer/PooledByteBufAllocator;IIII)V
    ...
    const-string p2, " (expected: power of two)"
