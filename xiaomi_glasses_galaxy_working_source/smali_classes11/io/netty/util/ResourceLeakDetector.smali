...
.method private track0(Ljava/lang/Object;)Lio/netty/util/ResourceLeakDetector$DefaultResourceLeak;
    ...
    iget-object p0, p0, Lio/netty/util/ResourceLeakDetector;->allLeaks:Ljava/util/Set;

    invoke-direct {v0, p1, v1, p0}, Lio/netty/util/ResourceLeakDetector$DefaultResourceLeak;-><init>(Ljava/lang/Object;Ljava/lang/ref/ReferenceQueue;Ljava/util/Set;)V
...
.method protected needReport()Z
    ...
    sget-object p0, Lio/netty/util/ResourceLeakDetector;->logger:Lio/netty/util/internal/logging/InternalLogger;
...
.method protected reportTracedLeak(Ljava/lang/String;Ljava/lang/String;)V
    ...
    const-string v0, "LEAK: {}.release() was not called before it\'s garbage-collected. See https://netty.io/wiki/reference-counted-objects.html for more information.{}"

    invoke-interface {p0, v0, p1, p2}, Lio/netty/util/internal/logging/InternalLogger;->error(Ljava/lang/String;Ljava/lang/Object;Ljava/lang/Object;)V
...
.method protected reportUntracedLeak(Ljava/lang/String;)V
    ...
    filled-new-array {p1, v2, v1, p0}, [Ljava/lang/Object;
    ...
    invoke-interface {v0, p1, p0}, Lio/netty/util/internal/logging/InternalLogger;->error(Ljava/lang/String;[Ljava/lang/Object;)V
