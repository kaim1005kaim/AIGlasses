...
.method varargs constructor <init>(Ljava/lang/Iterable;Lio/netty/handler/ssl/CipherSuiteFilter;Lio/netty/handler/ssl/OpenSslApplicationProtocolNegotiator;I[Ljava/security/cert/Certificate;Lio/netty/handler/ssl/ClientAuth;[Ljava/lang/String;ZZZ[Ljava/util/Map$Entry;)V
    ...
    const-string v1, "OCSP is not supported."
    ...
    const-string v1, "mode most be either SSL.SSL_MODE_SERVER or SSL.SSL_MODE_CLIENT"
    ...
    check-cast v15, Lio/netty/handler/ssl/SslContextOption;

    sget-object v6, Lio/netty/handler/ssl/OpenSslContextOption;->TLS_FALSE_START:Lio/netty/handler/ssl/OpenSslContextOption;
    ...
    :cond_4
    sget-object v6, Lio/netty/handler/ssl/OpenSslContextOption;->USE_TASKS:Lio/netty/handler/ssl/OpenSslContextOption;
    ...
    :cond_5
    sget-object v6, Lio/netty/handler/ssl/OpenSslContextOption;->PRIVATE_KEY_METHOD:Lio/netty/handler/ssl/OpenSslContextOption;
    ...
    :cond_6
    sget-object v6, Lio/netty/handler/ssl/OpenSslContextOption;->ASYNC_PRIVATE_KEY_METHOD:Lio/netty/handler/ssl/OpenSslContextOption;
    ...
    :cond_7
    sget-object v6, Lio/netty/handler/ssl/ReferenceCountedOpenSslContext;->logger:Lio/netty/util/internal/logging/InternalLogger;
    ...
    invoke-interface {v6, v5}, Lio/netty/util/internal/logging/InternalLogger;->debug(Ljava/lang/String;)V
    ...
    const-string v2, "You can either only use "

    invoke-virtual {v1, v2}, Ljava/lang/StringBuilder;->append(Ljava/lang/String;)Ljava/lang/StringBuilder;

    const-class v2, Lio/netty/handler/ssl/OpenSslAsyncPrivateKeyMethod;
    ...
    const-class v2, Lio/netty/handler/ssl/OpenSslPrivateKeyMethod;
    ...
    invoke-interface {v3, v9, v5, v6}, Lio/netty/handler/ssl/CipherSuiteFilter;->filterCipherSuites(Ljava/lang/Iterable;Ljava/util/List;Ljava/util/Set;)[Ljava/lang/String;
    ...
    invoke-static {v9, v10, v4, v8}, Lio/netty/internal/tcnative/SSLContext;->setCipherSuite(JLjava/lang/String;Z)Z
    ...
    invoke-static {v9, v10, v4, v3}, Lio/netty/internal/tcnative/SSLContext;->setCipherSuite(JLjava/lang/String;Z)Z
    ...
    invoke-static {v3, v0, v9, v4}, Lio/netty/handler/ssl/CipherSuiteConverter;->convertToCipherStrings(Ljava/lang/Iterable;Ljava/lang/StringBuilder;Ljava/lang/StringBuilder;Z)V
    ...
    invoke-static {v3, v4, v10, v8}, Lio/netty/internal/tcnative/SSLContext;->setCipherSuite(JLjava/lang/String;Z)Z
    ...
    invoke-static {v5, v9}, Lio/netty/handler/ssl/OpenSsl;->checkTls13Ciphers(Lio/netty/util/internal/logging/InternalLogger;Ljava/lang/String;)Ljava/lang/String;

    move-result-object v5

    const/4 v9, 0x1

    invoke-static {v3, v4, v5, v9}, Lio/netty/internal/tcnative/SSLContext;->setCipherSuite(JLjava/lang/String;Z)Z
    :try_end_3
    ...
    sget v9, Lio/netty/internal/tcnative/SSL;->SSL_OP_NO_TLSv1:I
    ...
    sget v11, Lio/netty/internal/tcnative/SSL;->SSL_OP_CIPHER_SERVER_PREFERENCE:I

    or-int/2addr v3, v11

    sget v11, Lio/netty/internal/tcnative/SSL;->SSL_OP_NO_COMPRESSION:I

    or-int/2addr v3, v11

    sget v11, Lio/netty/internal/tcnative/SSL;->SSL_OP_NO_TICKET:I
    ...
    invoke-direct {v0, v4, v12}, Lio/netty/handler/ssl/ReferenceCountedOpenSslContext$PrivateKeyMethod;-><init>(Lio/netty/handler/ssl/OpenSslEngineMap;Lio/netty/handler/ssl/OpenSslPrivateKeyMethod;)V
    ...
    invoke-direct {v0, v4, v13}, Lio/netty/handler/ssl/ReferenceCountedOpenSslContext$AsyncPrivateKeyMethod;-><init>(Lio/netty/handler/ssl/OpenSslEngineMap;Lio/netty/handler/ssl/OpenSslAsyncPrivateKeyMethod;)V
...
.method static synthetic access$400([B)[B
    .locals 0
    .annotation system Ldalvik/annotation/Throws;
        value = {
...
.method public setRejectRemoteInitiatedRenegotiation(Z)V
    ...
    const-string p1, "Renegotiation is not supported"
