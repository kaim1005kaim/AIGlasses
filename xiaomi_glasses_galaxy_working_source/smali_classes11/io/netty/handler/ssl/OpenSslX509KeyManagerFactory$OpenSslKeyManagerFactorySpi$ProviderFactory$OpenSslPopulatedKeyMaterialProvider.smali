...
.method constructor <init>(Ljavax/net/ssl/X509KeyManager;Ljava/lang/String;Ljava/lang/Iterable;)V
    ...
    :cond_1
    iget-object p0, p0, Lio/netty/handler/ssl/OpenSslX509KeyManagerFactory$OpenSslKeyManagerFactorySpi$ProviderFactory$OpenSslPopulatedKeyMaterialProvider;->materialMap:Ljava/util/Map;

    const-string p1, "materialMap"

    invoke-static {p0, p1}, Lio/netty/util/internal/ObjectUtil;->checkNonEmpty(Ljava/util/Map;Ljava/lang/String;)Ljava/util/Map;
...
.method chooseKeyMaterial(Lio/netty/buffer/ByteBufAllocator;Ljava/lang/String;)Lio/netty/handler/ssl/OpenSslKeyMaterial;
    ...
    :cond_0
    instance-of p1, p0, Lio/netty/handler/ssl/OpenSslKeyMaterial;

    if-eqz p1, :cond_1

    check-cast p0, Lio/netty/handler/ssl/OpenSslKeyMaterial;
