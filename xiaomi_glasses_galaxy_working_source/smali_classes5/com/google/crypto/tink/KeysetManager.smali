...
.method public declared-synchronized add(Lcom/google/crypto/tink/tinkkey/KeyHandle;Lcom/google/crypto/tink/tinkkey/KeyAccess;)Lcom/google/crypto/tink/KeysetManager;
    ...
    .line 5
    :try_start_0
    invoke-virtual {p1, p2}, Lcom/google/crypto/tink/tinkkey/KeyHandle;->getKey(Lcom/google/crypto/tink/tinkkey/KeyAccess;)Lcom/google/crypto/tink/tinkkey/TinkKey;

    move-result-object p1

    check-cast p1, Lcom/google/crypto/tink/tinkkey/ProtoKey;
    :try_end_0
    ...
    .line 7
    invoke-virtual {p1}, Lcom/google/crypto/tink/tinkkey/ProtoKey;->getProtoKey()Lcom/google/crypto/tink/proto/KeyData;

    move-result-object v0

    invoke-virtual {p1}, Lcom/google/crypto/tink/tinkkey/ProtoKey;->getOutputPrefixType()Lcom/google/crypto/tink/KeyTemplate$OutputPrefixType;

    move-result-object p1

    invoke-static {p1}, Lcom/google/crypto/tink/KeyTemplate;->toProto(Lcom/google/crypto/tink/KeyTemplate$OutputPrefixType;)Lcom/google/crypto/tink/proto/OutputPrefixType;
    ...
    .line 8
    invoke-virtual {p2, p1}, Lcom/google/crypto/tink/proto/Keyset$Builder;->addKey(Lcom/google/crypto/tink/proto/Keyset$Key;)Lcom/google/crypto/tink/proto/Keyset$Builder;
    :try_end_1
    .catchall {:try_start_1 .. :try_end_1} :catchall_0
    ...
    const-string v0, "KeyHandles which contain TinkKeys that are not ProtoKeys are not yet supported."
