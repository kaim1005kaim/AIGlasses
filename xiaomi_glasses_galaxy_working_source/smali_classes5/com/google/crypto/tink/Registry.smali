...
.method private static declared-synchronized ensureKeyManagerInsertable(Ljava/lang/String;Ljava/lang/Class;Ljava/util/Map;Z)V
    .locals 4
    .annotation system Ldalvik/annotation/MethodParameters;
        accessFlags = {
            0x0,
    ...
    check-cast v2, Lcom/google/crypto/tink/Registry$KeyManagerContainer;

    if-eqz v2, :cond_1

    invoke-interface {v2}, Lcom/google/crypto/tink/Registry$KeyManagerContainer;->getImplementingClass()Ljava/lang/Class;
    ...
    sget-object p3, Lcom/google/crypto/tink/Registry;->keyTemplateMap:Ljava/util/concurrent/ConcurrentMap;
    ...
    const-string p3, "Attempted overwrite of a registered key template "
...
.method public static declared-synchronized registerAsymmetricKeyManagers(Lcom/google/crypto/tink/PrivateKeyTypeManager;Lcom/google/crypto/tink/KeyTypeManager;Z)V
    ...
    invoke-virtual {v4}, Lcom/google/crypto/tink/KeyTypeManager$KeyFactory;->keyFormats()Ljava/util/Map;
    ...
    :goto_0
    invoke-static {v1, v3, v4, p2}, Lcom/google/crypto/tink/Registry;->ensureKeyManagerInsertable(Ljava/lang/String;Ljava/lang/Class;Ljava/util/Map;Z)V
    ...
    invoke-static {v2, v3, v4, v5}, Lcom/google/crypto/tink/Registry;->ensureKeyManagerInsertable(Ljava/lang/String;Ljava/lang/Class;Ljava/util/Map;Z)V
    ...
    invoke-virtual {p0}, Lcom/google/crypto/tink/KeyTypeManager$KeyFactory;->keyFormats()Ljava/util/Map;
...
.method public static declared-synchronized registerKeyManager(Lcom/google/crypto/tink/KeyManager;Z)V
    ...
    invoke-static {v1, v2, v3, p1}, Lcom/google/crypto/tink/Registry;->ensureKeyManagerInsertable(Ljava/lang/String;Ljava/lang/Class;Ljava/util/Map;Z)V
...
.method public static declared-synchronized registerKeyManager(Lcom/google/crypto/tink/KeyTypeManager;Z)V
    ...
    invoke-virtual {v3}, Lcom/google/crypto/tink/KeyTypeManager$KeyFactory;->keyFormats()Ljava/util/Map;
    ...
    invoke-static {v1, p0}, Lcom/google/crypto/tink/Registry;->registerKeyTemplates(Ljava/lang/String;Ljava/util/Map;)V
...
.method private static registerKeyTemplates(Ljava/lang/String;Ljava/util/Map;)V
    ...
    check-cast v3, Lcom/google/crypto/tink/KeyTypeManager$KeyFactory$KeyFormat;

    iget-object v3, v3, Lcom/google/crypto/tink/KeyTypeManager$KeyFactory$KeyFormat;->keyFormat:Ljava/lang/Object;
    ...
    check-cast v0, Lcom/google/crypto/tink/KeyTypeManager$KeyFactory$KeyFormat;

    iget-object v0, v0, Lcom/google/crypto/tink/KeyTypeManager$KeyFactory$KeyFormat;->outputPrefixType:Lcom/google/crypto/tink/KeyTemplate$OutputPrefixType;
