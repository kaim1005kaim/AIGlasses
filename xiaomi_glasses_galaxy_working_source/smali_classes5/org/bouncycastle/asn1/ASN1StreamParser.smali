...
.method public constructor <init>(Ljava/io/InputStream;I)V
    ...
    iput-object p1, p0, Lorg/bouncycastle/asn1/ASN1StreamParser;->c:[[B
...
.method private f(Z)V
    ...
    iget-object p0, p0, Lorg/bouncycastle/asn1/ASN1StreamParser;->a:Ljava/io/InputStream;
...
# virtual methods
.method a(ZI)Lorg/bouncycastle/asn1/ASN1Encodable;
    .locals 4
    ...
    invoke-virtual {p0, p2}, Lorg/bouncycastle/asn1/ASN1StreamParser;->b(I)Lorg/bouncycastle/asn1/ASN1Encodable;
...
.method b(I)Lorg/bouncycastle/asn1/ASN1Encodable;
    .locals 2
    .annotation system Ldalvik/annotation/Throws;
        value = {
            Ljava/io/IOException;
...
.method public c()Lorg/bouncycastle/asn1/ASN1Encodable;
    ...
    invoke-direct {p0, v1}, Lorg/bouncycastle/asn1/ASN1StreamParser;->f(Z)V

    iget-object v2, p0, Lorg/bouncycastle/asn1/ASN1StreamParser;->a:Ljava/io/InputStream;

    invoke-static {v2, v0}, Lorg/bouncycastle/asn1/ASN1InputStream;->o(Ljava/io/InputStream;I)I
    ...
    invoke-static {v3, v5}, Lorg/bouncycastle/asn1/ASN1InputStream;->k(Ljava/io/InputStream;I)I
    ...
    iget p0, p0, Lorg/bouncycastle/asn1/ASN1StreamParser;->b:I
    ...
    :cond_3
    invoke-virtual {v3, v2}, Lorg/bouncycastle/asn1/ASN1StreamParser;->b(I)Lorg/bouncycastle/asn1/ASN1Encodable;
    ...
    iget-object v5, p0, Lorg/bouncycastle/asn1/ASN1StreamParser;->a:Ljava/io/InputStream;
    ...
    invoke-virtual {v4}, Lorg/bouncycastle/asn1/DefiniteLengthInputStream;->c()[B

    move-result-object v0

    invoke-direct {p0, v1, v2, v0}, Lorg/bouncycastle/asn1/DERApplicationSpecific;-><init>(ZI[B)V
    ...
    invoke-direct {p0, v1, v2, v0}, Lorg/bouncycastle/asn1/BERTaggedObjectParser;-><init>(ZILorg/bouncycastle/asn1/ASN1StreamParser;)V
    ...
    new-instance p0, Lorg/bouncycastle/asn1/DERSetParser;

    new-instance v0, Lorg/bouncycastle/asn1/ASN1StreamParser;

    invoke-direct {v0, v4}, Lorg/bouncycastle/asn1/ASN1StreamParser;-><init>(Ljava/io/InputStream;)V

    invoke-direct {p0, v0}, Lorg/bouncycastle/asn1/DERSetParser;-><init>(Lorg/bouncycastle/asn1/ASN1StreamParser;)V
    ...
    :cond_9
    new-instance p0, Lorg/bouncycastle/asn1/DERSequenceParser;

    new-instance v0, Lorg/bouncycastle/asn1/ASN1StreamParser;

    invoke-direct {v0, v4}, Lorg/bouncycastle/asn1/ASN1StreamParser;-><init>(Ljava/io/InputStream;)V

    invoke-direct {p0, v0}, Lorg/bouncycastle/asn1/DERSequenceParser;-><init>(Lorg/bouncycastle/asn1/ASN1StreamParser;)V
    ...
    :try_start_0
    iget-object p0, p0, Lorg/bouncycastle/asn1/ASN1StreamParser;->c:[[B

    invoke-static {v2, v4, p0}, Lorg/bouncycastle/asn1/ASN1InputStream;->d(ILorg/bouncycastle/asn1/DefiniteLengthInputStream;[[B)Lorg/bouncycastle/asn1/ASN1Primitive;
...
.method d(ZI)Lorg/bouncycastle/asn1/ASN1Primitive;
    .locals 2
    .annotation system Ldalvik/annotation/Throws;
        value = {
            Ljava/io/IOException;
    ...
    invoke-direct {p1, v0, p2, v1}, Lorg/bouncycastle/asn1/DERTaggedObject;-><init>(ZILorg/bouncycastle/asn1/ASN1Encodable;)V
    ...
    invoke-static {p1}, Lorg/bouncycastle/asn1/BERFactory;->a(Lorg/bouncycastle/asn1/ASN1EncodableVector;)Lorg/bouncycastle/asn1/BERSequence;
    ...
    invoke-direct {p0, v1, p2, p1}, Lorg/bouncycastle/asn1/DERTaggedObject;-><init>(ZILorg/bouncycastle/asn1/ASN1Encodable;)V
    ...
    invoke-static {p1}, Lorg/bouncycastle/asn1/DERFactory;->a(Lorg/bouncycastle/asn1/ASN1EncodableVector;)Lorg/bouncycastle/asn1/ASN1Sequence;

    move-result-object p1

    invoke-direct {p0, v0, p2, p1}, Lorg/bouncycastle/asn1/DERTaggedObject;-><init>(ZILorg/bouncycastle/asn1/ASN1Encodable;)V

    :goto_1
    return-object p0
.end method

.method e()Lorg/bouncycastle/asn1/ASN1EncodableVector;
    .locals 3
    .annotation system Ldalvik/annotation/Throws;
        value = {
            Ljava/io/IOException;
