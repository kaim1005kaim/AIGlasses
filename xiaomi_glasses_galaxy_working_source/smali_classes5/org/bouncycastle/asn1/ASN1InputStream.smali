...
.method public constructor <init>(Ljava/io/InputStream;)V
    ...
    .line 1
    invoke-static {p1}, Lorg/bouncycastle/asn1/StreamUtil;->c(Ljava/io/InputStream;)I
...
.method public constructor <init>(Ljava/io/InputStream;IZ)V
    ...
    iput-object p1, p0, Lorg/bouncycastle/asn1/ASN1InputStream;->c:[[B
...
.method static d(ILorg/bouncycastle/asn1/DefiniteLengthInputStream;[[B)Lorg/bouncycastle/asn1/ASN1Primitive;
    .locals 1
    ...
    invoke-virtual {p1}, Lorg/bouncycastle/asn1/DefiniteLengthInputStream;->c()[B
    ...
    :pswitch_b
    invoke-static {p1, p2}, Lorg/bouncycastle/asn1/ASN1InputStream;->g(Lorg/bouncycastle/asn1/DefiniteLengthInputStream;[[B)[B

    move-result-object p0

    invoke-static {p0}, Lorg/bouncycastle/asn1/ASN1ObjectIdentifier;->p([B)Lorg/bouncycastle/asn1/ASN1ObjectIdentifier;
    ...
    :pswitch_e
    invoke-virtual {p1}, Lorg/bouncycastle/asn1/DefiniteLengthInputStream;->a()I

    move-result p0

    invoke-static {p0, p1}, Lorg/bouncycastle/asn1/ASN1BitString;->o(ILjava/io/InputStream;)Lorg/bouncycastle/asn1/ASN1BitString;
    ...
    invoke-static {p1}, Lorg/bouncycastle/asn1/ASN1InputStream;->f(Lorg/bouncycastle/asn1/DefiniteLengthInputStream;)[C
...
.method private static f(Lorg/bouncycastle/asn1/DefiniteLengthInputStream;)[C
    .locals 6
    .annotation system Ldalvik/annotation/Throws;
        value = {
            Ljava/io/IOException;
    ...
    invoke-virtual {p0}, Lorg/bouncycastle/asn1/DefiniteLengthInputStream;->a()I
...
.method private static g(Lorg/bouncycastle/asn1/DefiniteLengthInputStream;[[B)[B
    .locals 3
    .annotation system Ldalvik/annotation/Throws;
        value = {
            Ljava/io/IOException;
    ...
    :cond_0
    invoke-static {p0, v1}, Lorg/bouncycastle/util/io/Streams;->f(Ljava/io/InputStream;[B)I

    return-object v1

    :cond_1
    invoke-virtual {p0}, Lorg/bouncycastle/asn1/DefiniteLengthInputStream;->c()[B
...
# virtual methods
.method a(Lorg/bouncycastle/asn1/DefiniteLengthInputStream;)Lorg/bouncycastle/asn1/ASN1EncodableVector;
    .locals 0
    .annotation system Ldalvik/annotation/Throws;
        value = {
            Ljava/io/IOException;
    ...
    invoke-virtual {p0}, Lorg/bouncycastle/asn1/ASN1InputStream;->b()Lorg/bouncycastle/asn1/ASN1EncodableVector;
...
.method b()Lorg/bouncycastle/asn1/ASN1EncodableVector;
    .locals 2
    .annotation system Ldalvik/annotation/Throws;
        value = {
            Ljava/io/IOException;
...
.method protected c(III)Lorg/bouncycastle/asn1/ASN1Primitive;
    .locals 3
    .annotation system Ldalvik/annotation/Throws;
        value = {
            Ljava/io/IOException;
    ...
    invoke-virtual {v2}, Lorg/bouncycastle/asn1/DefiniteLengthInputStream;->c()[B

    move-result-object p1

    invoke-direct {p0, v0, p2, p1}, Lorg/bouncycastle/asn1/DERApplicationSpecific;-><init>(ZI[B)V
    ...
    new-instance p0, Lorg/bouncycastle/asn1/ASN1StreamParser;

    invoke-direct {p0, v2}, Lorg/bouncycastle/asn1/ASN1StreamParser;-><init>(Ljava/io/InputStream;)V

    invoke-virtual {p0, v0, p2}, Lorg/bouncycastle/asn1/ASN1StreamParser;->d(ZI)Lorg/bouncycastle/asn1/ASN1Primitive;
    ...
    invoke-virtual {p0, v2}, Lorg/bouncycastle/asn1/ASN1InputStream;->a(Lorg/bouncycastle/asn1/DefiniteLengthInputStream;)Lorg/bouncycastle/asn1/ASN1EncodableVector;

    move-result-object p0

    invoke-static {p0}, Lorg/bouncycastle/asn1/DERFactory;->b(Lorg/bouncycastle/asn1/ASN1EncodableVector;)Lorg/bouncycastle/asn1/ASN1Set;
    ...
    invoke-static {p0}, Lorg/bouncycastle/asn1/DERFactory;->a(Lorg/bouncycastle/asn1/ASN1EncodableVector;)Lorg/bouncycastle/asn1/ASN1Sequence;
    ...
    invoke-direct {p1, p0}, Lorg/bouncycastle/asn1/DERExternal;-><init>(Lorg/bouncycastle/asn1/ASN1EncodableVector;)V
    ...
    invoke-virtual {p0, v1}, Lorg/bouncycastle/asn1/ASN1EncodableVector;->c(I)Lorg/bouncycastle/asn1/ASN1Encodable;
    ...
    invoke-direct {p0, p2}, Lorg/bouncycastle/asn1/BEROctetString;-><init>([Lorg/bouncycastle/asn1/ASN1OctetString;)V

    return-object p0

    :cond_9
    iget-object p0, p0, Lorg/bouncycastle/asn1/ASN1InputStream;->c:[[B

    invoke-static {p2, v2, p0}, Lorg/bouncycastle/asn1/ASN1InputStream;->d(ILorg/bouncycastle/asn1/DefiniteLengthInputStream;[[B)Lorg/bouncycastle/asn1/ASN1Primitive;
...
.method h()I
    ...
    iget p0, p0, Lorg/bouncycastle/asn1/ASN1InputStream;->a:I
...
.method public m()Lorg/bouncycastle/asn1/ASN1Primitive;
    .locals 5
    .annotation system Ldalvik/annotation/Throws;
        value = {
            Ljava/io/IOException;
    ...
    :cond_1
    invoke-static {p0, v0}, Lorg/bouncycastle/asn1/ASN1InputStream;->o(Ljava/io/InputStream;I)I
    ...
    :goto_0
    invoke-virtual {p0}, Lorg/bouncycastle/asn1/ASN1InputStream;->j()I
    ...
    invoke-direct {v4, v2, p0}, Lorg/bouncycastle/asn1/ASN1StreamParser;-><init>(Ljava/io/InputStream;I)V
    ...
    invoke-direct {p0, v1, v4}, Lorg/bouncycastle/asn1/BERApplicationSpecificParser;-><init>(ILorg/bouncycastle/asn1/ASN1StreamParser;)V
    ...
    invoke-direct {p0, v3, v1, v4}, Lorg/bouncycastle/asn1/BERTaggedObjectParser;-><init>(ZILorg/bouncycastle/asn1/ASN1StreamParser;)V
    ...
    new-instance p0, Lorg/bouncycastle/asn1/BERSetParser;

    invoke-direct {p0, v4}, Lorg/bouncycastle/asn1/BERSetParser;-><init>(Lorg/bouncycastle/asn1/ASN1StreamParser;)V
    ...
    :cond_6
    new-instance p0, Lorg/bouncycastle/asn1/BERSequenceParser;

    invoke-direct {p0, v4}, Lorg/bouncycastle/asn1/BERSequenceParser;-><init>(Lorg/bouncycastle/asn1/ASN1StreamParser;)V
    ...
    invoke-direct {p0, v4}, Lorg/bouncycastle/asn1/DERExternalParser;-><init>(Lorg/bouncycastle/asn1/ASN1StreamParser;)V
    ...
    invoke-direct {p0, v4}, Lorg/bouncycastle/asn1/BEROctetStringParser;-><init>(Lorg/bouncycastle/asn1/ASN1StreamParser;)V
    ...
    :cond_a
    :try_start_0
    invoke-virtual {p0, v0, v1, v4}, Lorg/bouncycastle/asn1/ASN1InputStream;->c(III)Lorg/bouncycastle/asn1/ASN1Primitive;
...
.method protected readFully([B)V
    ...
    invoke-static {p0, p1}, Lorg/bouncycastle/util/io/Streams;->f(Ljava/io/InputStream;[B)I
