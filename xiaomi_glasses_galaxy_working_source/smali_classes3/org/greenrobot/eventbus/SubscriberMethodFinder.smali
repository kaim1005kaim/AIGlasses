...
.method static constructor <clinit>()V
    ...
    sput-object v0, Lorg/greenrobot/eventbus/SubscriberMethodFinder;->g:Ljava/util/Map;
...
.method constructor <init>(Ljava/util/List;ZZ)V
    ...
    iput-object p1, p0, Lorg/greenrobot/eventbus/SubscriberMethodFinder;->a:Ljava/util/List;

    iput-boolean p2, p0, Lorg/greenrobot/eventbus/SubscriberMethodFinder;->b:Z

    iput-boolean p3, p0, Lorg/greenrobot/eventbus/SubscriberMethodFinder;->c:Z
...
.method static a()V
    ...
    sget-object v0, Lorg/greenrobot/eventbus/SubscriberMethodFinder;->g:Ljava/util/Map;
...
.method private c(Ljava/lang/Class;)Ljava/util/List;
    ...
    invoke-direct {p0}, Lorg/greenrobot/eventbus/SubscriberMethodFinder;->h()Lorg/greenrobot/eventbus/SubscriberMethodFinder$FindState;

    move-result-object v0

    invoke-virtual {v0, p1}, Lorg/greenrobot/eventbus/SubscriberMethodFinder$FindState;->c(Ljava/lang/Class;)V
    ...
    invoke-direct {p0, v0}, Lorg/greenrobot/eventbus/SubscriberMethodFinder;->g(Lorg/greenrobot/eventbus/SubscriberMethodFinder$FindState;)Lorg/greenrobot/eventbus/meta/SubscriberInfo;
    ...
    invoke-interface {p1}, Lorg/greenrobot/eventbus/meta/SubscriberInfo;->a()[Lorg/greenrobot/eventbus/SubscriberMethod;
    ...
    :cond_1
    invoke-direct {p0, v0}, Lorg/greenrobot/eventbus/SubscriberMethodFinder;->e(Lorg/greenrobot/eventbus/SubscriberMethodFinder$FindState;)V

    :cond_2
    invoke-virtual {v0}, Lorg/greenrobot/eventbus/SubscriberMethodFinder$FindState;->d()V

    goto :goto_0

    :cond_3
    invoke-direct {p0, v0}, Lorg/greenrobot/eventbus/SubscriberMethodFinder;->f(Lorg/greenrobot/eventbus/SubscriberMethodFinder$FindState;)Ljava/util/List;
...
.method private e(Lorg/greenrobot/eventbus/SubscriberMethodFinder$FindState;)V
    .locals 14
    ...
    :cond_0
    iget-boolean v7, p0, Lorg/greenrobot/eventbus/SubscriberMethodFinder;->b:Z
    ...
    :cond_2
    iget-boolean v5, p0, Lorg/greenrobot/eventbus/SubscriberMethodFinder;->b:Z
    ...
    iget-boolean p0, p0, Lorg/greenrobot/eventbus/SubscriberMethodFinder;->c:Z
    ...
    invoke-direct {p1, p0, v0}, Lorg/greenrobot/eventbus/EventBusException;-><init>(Ljava/lang/String;Ljava/lang/Throwable;)V

    throw p1
.end method

.method private f(Lorg/greenrobot/eventbus/SubscriberMethodFinder$FindState;)Ljava/util/List;
    .locals 4
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "(",
    ...
    invoke-virtual {p1}, Lorg/greenrobot/eventbus/SubscriberMethodFinder$FindState;->e()V
...
.method private g(Lorg/greenrobot/eventbus/SubscriberMethodFinder$FindState;)Lorg/greenrobot/eventbus/meta/SubscriberInfo;
    .locals 3
    ...
    invoke-interface {v0}, Lorg/greenrobot/eventbus/meta/SubscriberInfo;->d()Lorg/greenrobot/eventbus/meta/SubscriberInfo;
    ...
    invoke-interface {v0}, Lorg/greenrobot/eventbus/meta/SubscriberInfo;->b()Ljava/lang/Class;
    ...
    :cond_0
    iget-object p0, p0, Lorg/greenrobot/eventbus/SubscriberMethodFinder;->a:Ljava/util/List;
    ...
    invoke-interface {v0, v1}, Lorg/greenrobot/eventbus/meta/SubscriberInfoIndex;->a(Ljava/lang/Class;)Lorg/greenrobot/eventbus/meta/SubscriberInfo;
...
.method private h()Lorg/greenrobot/eventbus/SubscriberMethodFinder$FindState;
    .locals 4

    sget-object p0, Lorg/greenrobot/eventbus/SubscriberMethodFinder;->i:[Lorg/greenrobot/eventbus/SubscriberMethodFinder$FindState;
    ...
    :try_start_0
    sget-object v1, Lorg/greenrobot/eventbus/SubscriberMethodFinder;->i:[Lorg/greenrobot/eventbus/SubscriberMethodFinder$FindState;
...
.method b(Ljava/lang/Class;)Ljava/util/List;
    ...
    :cond_0
    iget-boolean v1, p0, Lorg/greenrobot/eventbus/SubscriberMethodFinder;->c:Z

    if-eqz v1, :cond_1

    invoke-direct {p0, p1}, Lorg/greenrobot/eventbus/SubscriberMethodFinder;->d(Ljava/lang/Class;)Ljava/util/List;
