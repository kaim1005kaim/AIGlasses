...
.method public constructor <init>(Lorg/kodein/di/Kodein$Key;ILorg/kodein/di/internal/KodeinContainerImpl$Node;Z)V
    ...
    .param p1    # Lorg/kodein/di/Kodein$Key;
        ...
        .end annotation
    .end param
    .param p3    # Lorg/kodein/di/internal/KodeinContainerImpl$Node;
...
.method private final displayString(Lorg/kodein/di/Kodein$Key;I)Ljava/lang/String;
    ...
    iget-boolean p0, p0, Lorg/kodein/di/internal/KodeinContainerImpl$Node;->fullDescriptionOnError:Z

    if-eqz p0, :cond_0

    new-instance p0, Lorg/kodein/di/internal/KodeinContainerImpl$Node$displayString$descProp$1;

    invoke-direct {p0, p1}, Lorg/kodein/di/internal/KodeinContainerImpl$Node$displayString$descProp$1;-><init>(Lorg/kodein/di/Kodein$Key;)V

    goto :goto_0

    :cond_0
    new-instance p0, Lorg/kodein/di/internal/KodeinContainerImpl$Node$displayString$descProp$2;

    invoke-direct {p0, p1}, Lorg/kodein/di/internal/KodeinContainerImpl$Node$displayString$descProp$2;-><init>(Lorg/kodein/di/Kodein$Key;)V
...
.method private final recursiveCheck(Lorg/kodein/di/internal/KodeinContainerImpl$Node;Lorg/kodein/di/Kodein$Key;I)Z
    ...
    :cond_0
    iget-object p0, p1, Lorg/kodein/di/internal/KodeinContainerImpl$Node;->key:Lorg/kodein/di/Kodein$Key;
    ...
    iget p0, p1, Lorg/kodein/di/internal/KodeinContainerImpl$Node;->overrideLevel:I
...
.method private final recursiveLoop(Lorg/kodein/di/internal/KodeinContainerImpl$Node;Lorg/kodein/di/Kodein$Key;ILjava/util/List;)Ljava/util/List;
    ...
    invoke-static {p1, p4}, Lkotlin/collections/CollectionsKt;->D4(Ljava/util/Collection;Ljava/lang/Iterable;)Ljava/util/List;
    ...
    invoke-static {p0, p4}, Lkotlin/collections/CollectionsKt;->D4(Ljava/util/Collection;Ljava/lang/Iterable;)Ljava/util/List;
...
.method public final check$kodein_di_core(Lorg/kodein/di/Kodein$Key;I)V
    ...
    invoke-static {p2, p0}, Lkotlin/collections/CollectionsKt;->E4(Ljava/util/Collection;Ljava/lang/Object;)Ljava/util/List;
    ...
    invoke-static {v4, v0}, Lkotlin/text/StringsKt;->e2(Ljava/lang/CharSequence;I)Ljava/lang/String;
    ...
    invoke-static {p2, p0}, Lkotlin/text/StringsKt;->e2(Ljava/lang/CharSequence;I)Ljava/lang/String;
    ...
    new-instance p0, Lorg/kodein/di/Kodein$DependencyLoopException;
    ...
    invoke-direct {p0, p1}, Lorg/kodein/di/Kodein$DependencyLoopException;-><init>(Ljava/lang/String;)V
