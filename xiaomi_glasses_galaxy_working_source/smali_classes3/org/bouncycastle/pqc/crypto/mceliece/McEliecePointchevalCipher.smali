...
.method private g(Lorg/bouncycastle/pqc/crypto/mceliece/McElieceCCA2PrivateKeyParameters;)V
    .locals 1
    ...
    iput-object v0, p0, Lorg/bouncycastle/pqc/crypto/mceliece/McEliecePointchevalCipher;->a:Lorg/bouncycastle/crypto/Digest;

    invoke-virtual {p1}, Lorg/bouncycastle/pqc/crypto/mceliece/McElieceCCA2PrivateKeyParameters;->g()I

    move-result v0

    iput v0, p0, Lorg/bouncycastle/pqc/crypto/mceliece/McEliecePointchevalCipher;->c:I

    invoke-virtual {p1}, Lorg/bouncycastle/pqc/crypto/mceliece/McElieceCCA2PrivateKeyParameters;->f()I

    move-result v0

    iput v0, p0, Lorg/bouncycastle/pqc/crypto/mceliece/McEliecePointchevalCipher;->d:I
...
.method private h(Lorg/bouncycastle/pqc/crypto/mceliece/McElieceCCA2PublicKeyParameters;)V
    .locals 1

    iget-object v0, p0, Lorg/bouncycastle/pqc/crypto/mceliece/McEliecePointchevalCipher;->b:Ljava/security/SecureRandom;
    ...
    :goto_0
    iput-object v0, p0, Lorg/bouncycastle/pqc/crypto/mceliece/McEliecePointchevalCipher;->b:Ljava/security/SecureRandom;
...
.method public a(ZLorg/bouncycastle/crypto/CipherParameters;)V
    ...
    invoke-direct {p0, p1}, Lorg/bouncycastle/pqc/crypto/mceliece/McEliecePointchevalCipher;->h(Lorg/bouncycastle/pqc/crypto/mceliece/McElieceCCA2PublicKeyParameters;)V
    ...
    invoke-direct {p0, p2}, Lorg/bouncycastle/pqc/crypto/mceliece/McEliecePointchevalCipher;->h(Lorg/bouncycastle/pqc/crypto/mceliece/McElieceCCA2PublicKeyParameters;)V
    ...
    invoke-direct {p0, p2}, Lorg/bouncycastle/pqc/crypto/mceliece/McEliecePointchevalCipher;->g(Lorg/bouncycastle/pqc/crypto/mceliece/McElieceCCA2PrivateKeyParameters;)V
...
.method public b([B)[B
    ...
    invoke-static {v3, v5, p1}, Lorg/bouncycastle/pqc/crypto/mceliece/Conversions;->b(II[B)Lorg/bouncycastle/pqc/math/linearalgebra/GF2Vector;
    ...
    iget p0, p0, Lorg/bouncycastle/pqc/crypto/mceliece/McEliecePointchevalCipher;->d:I

    shr-int/lit8 p0, p0, 0x3

    sub-int/2addr v1, p0

    invoke-static {v4, v1}, Lorg/bouncycastle/pqc/math/linearalgebra/ByteUtils;->k([BI)[[B
...
.method public c([B)[B
    ...
    invoke-virtual {v2}, Lorg/bouncycastle/pqc/math/linearalgebra/GF2Vector;->b()[B

    move-result-object v3

    invoke-static {p1, v1}, Lorg/bouncycastle/pqc/math/linearalgebra/ByteUtils;->b([B[B)[B
    ...
    invoke-static {v5, v6, v4}, Lorg/bouncycastle/pqc/crypto/mceliece/Conversions;->b(II[B)Lorg/bouncycastle/pqc/math/linearalgebra/GF2Vector;

    move-result-object v4

    iget-object p0, p0, Lorg/bouncycastle/pqc/crypto/mceliece/McEliecePointchevalCipher;->f:Lorg/bouncycastle/pqc/crypto/mceliece/McElieceCCA2KeyParameters;
    ...
    invoke-virtual {v2, v3}, Lorg/bouncycastle/crypto/prng/DigestRandomGenerator;->c([B)V
    ...
    :cond_1
    invoke-static {p0, v3}, Lorg/bouncycastle/pqc/math/linearalgebra/ByteUtils;->b([B[B)[B
...
.method public f(Lorg/bouncycastle/pqc/crypto/mceliece/McElieceCCA2KeyParameters;)I
    .locals 0
    .annotation system Ldalvik/annotation/Throws;
        value = {
