...
.method static a(Lorg/bouncycastle/pqc/crypto/sphincs/HashFunctions;[BI[BLorg/bouncycastle/pqc/crypto/sphincs/Tree$leafaddr;)V
    .locals 8
    ...
    iget-wide v6, p4, Lorg/bouncycastle/pqc/crypto/sphincs/Tree$leafaddr;->b:J
    ...
    invoke-static {p3, p4, v1, v3}, Lorg/bouncycastle/util/Pack;->z(J[BI)V

    invoke-virtual {p0, p1, p2, v1, v0}, Lorg/bouncycastle/pqc/crypto/sphincs/HashFunctions;->f([BI[BI)I

    return-void
.end method

.method static b([BIJ[BI)V
    .locals 7
    ...
    invoke-interface {v1, p4, v2}, Lorg/bouncycastle/crypto/StreamCipher;->a(ZLorg/bouncycastle/crypto/CipherParameters;)V
