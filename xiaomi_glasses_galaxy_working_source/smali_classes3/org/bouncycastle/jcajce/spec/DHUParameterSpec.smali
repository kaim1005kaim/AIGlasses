...
.method public constructor <init>(Ljava/security/PublicKey;Ljava/security/PrivateKey;Ljava/security/PublicKey;[B)V
    ...
    iput-object p1, p0, Lorg/bouncycastle/jcajce/spec/DHUParameterSpec;->a:Ljava/security/PublicKey;

    iput-object p2, p0, Lorg/bouncycastle/jcajce/spec/DHUParameterSpec;->b:Ljava/security/PrivateKey;

    iput-object p3, p0, Lorg/bouncycastle/jcajce/spec/DHUParameterSpec;->c:Ljava/security/PublicKey;

    invoke-static {p4}, Lorg/bouncycastle/util/Arrays;->m([B)[B

    move-result-object p1

    iput-object p1, p0, Lorg/bouncycastle/jcajce/spec/DHUParameterSpec;->d:[B
...
.method public a()Ljava/security/PrivateKey;
    ...
    iget-object p0, p0, Lorg/bouncycastle/jcajce/spec/DHUParameterSpec;->b:Ljava/security/PrivateKey;
...
.method public b()Ljava/security/PublicKey;
    ...
    iget-object p0, p0, Lorg/bouncycastle/jcajce/spec/DHUParameterSpec;->a:Ljava/security/PublicKey;
...
.method public c()Ljava/security/PublicKey;
    ...
    iget-object p0, p0, Lorg/bouncycastle/jcajce/spec/DHUParameterSpec;->c:Ljava/security/PublicKey;
...
.method public d()[B
    ...
    iget-object p0, p0, Lorg/bouncycastle/jcajce/spec/DHUParameterSpec;->d:[B
