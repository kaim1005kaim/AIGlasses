...
.method public generateKeyPair()Ljava/security/KeyPair;
    ...
    :cond_0
    sget-object v1, Lorg/bouncycastle/jcajce/provider/asymmetric/dsa/KeyPairGeneratorSpi;->g:Ljava/lang/Object;

    monitor-enter v1

    :try_start_0
    sget-object v2, Lorg/bouncycastle/jcajce/provider/asymmetric/dsa/KeyPairGeneratorSpi;->f:Ljava/util/Hashtable;
    ...
    :cond_1
    iget v2, p0, Lorg/bouncycastle/jcajce/provider/asymmetric/dsa/KeyPairGeneratorSpi;->c:I
    ...
    invoke-static {v5}, Lorg/bouncycastle/util/Properties;->e(Ljava/lang/String;)Z
    ...
    :goto_0
    invoke-virtual {v3, v4, v2, v5}, Lorg/bouncycastle/crypto/generators/DSAParametersGenerator;->k(IILjava/security/SecureRandom;)V
    ...
    invoke-virtual {v3, v5}, Lorg/bouncycastle/crypto/generators/DSAParametersGenerator;->l(Lorg/bouncycastle/crypto/params/DSAParameterGenerationParameters;)V
    ...
    invoke-virtual {v3, v4}, Lorg/bouncycastle/crypto/generators/DSAParametersGenerator;->l(Lorg/bouncycastle/crypto/params/DSAParameterGenerationParameters;)V
    ...
    iget-object v4, p0, Lorg/bouncycastle/jcajce/provider/asymmetric/dsa/KeyPairGeneratorSpi;->d:Ljava/security/SecureRandom;

    invoke-virtual {v3}, Lorg/bouncycastle/crypto/generators/DSAParametersGenerator;->d()Lorg/bouncycastle/crypto/params/DSAParameters;
    ...
    iput-object v2, p0, Lorg/bouncycastle/jcajce/provider/asymmetric/dsa/KeyPairGeneratorSpi;->a:Lorg/bouncycastle/crypto/params/DSAKeyGenerationParameters;

    sget-object v3, Lorg/bouncycastle/jcajce/provider/asymmetric/dsa/KeyPairGeneratorSpi;->f:Ljava/util/Hashtable;
    ...
    invoke-virtual {v0, v1}, Lorg/bouncycastle/crypto/generators/DSAKeyPairGenerator;->b(Lorg/bouncycastle/crypto/KeyGenerationParameters;)V
    ...
    :cond_5
    :goto_5
    iget-object p0, p0, Lorg/bouncycastle/jcajce/provider/asymmetric/dsa/KeyPairGeneratorSpi;->b:Lorg/bouncycastle/crypto/generators/DSAKeyPairGenerator;

    invoke-virtual {p0}, Lorg/bouncycastle/crypto/generators/DSAKeyPairGenerator;->a()Lorg/bouncycastle/crypto/AsymmetricCipherKeyPair;
...
.method public initialize(Ljava/security/spec/AlgorithmParameterSpec;Ljava/security/SecureRandom;)V
    ...
    invoke-virtual {p1, v0}, Lorg/bouncycastle/crypto/generators/DSAKeyPairGenerator;->b(Lorg/bouncycastle/crypto/KeyGenerationParameters;)V
