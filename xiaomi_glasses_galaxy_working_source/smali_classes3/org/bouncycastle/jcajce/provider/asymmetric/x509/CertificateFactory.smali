...
# static fields
.field private static final h:Lorg/bouncycastle/jcajce/provider/asymmetric/x509/PEMUtil;

.field private static final i:Lorg/bouncycastle/jcajce/provider/asymmetric/x509/PEMUtil;

.field private static final j:Lorg/bouncycastle/jcajce/provider/asymmetric/x509/PEMUtil;
...
.method static constructor <clinit>()V
    ...
    sput-object v0, Lorg/bouncycastle/jcajce/provider/asymmetric/x509/CertificateFactory;->j:Lorg/bouncycastle/jcajce/provider/asymmetric/x509/PEMUtil;
...
.method public constructor <init>()V
    ...
    iput-object v0, p0, Lorg/bouncycastle/jcajce/provider/asymmetric/x509/CertificateFactory;->a:Lorg/bouncycastle/jcajce/util/JcaJceHelper;
...
.method private b()Ljava/security/cert/CRL;
    ...
    invoke-virtual {p0, v0}, Lorg/bouncycastle/jcajce/provider/asymmetric/x509/CertificateFactory;->a(Lorg/bouncycastle/asn1/x509/CertificateList;)Ljava/security/cert/CRL;
...
.method private c(Lorg/bouncycastle/asn1/ASN1Sequence;)Ljava/security/cert/CRL;
    .locals 3
    .annotation system Ldalvik/annotation/Throws;
        value = {
            Ljava/security/cert/CRLException;
    ...
    invoke-static {p1}, Lorg/bouncycastle/asn1/pkcs/SignedData;->k(Ljava/lang/Object;)Lorg/bouncycastle/asn1/pkcs/SignedData;

    move-result-object p1

    invoke-virtual {p1}, Lorg/bouncycastle/asn1/pkcs/SignedData;->g()Lorg/bouncycastle/asn1/ASN1Set;

    move-result-object p1

    iput-object p1, p0, Lorg/bouncycastle/jcajce/provider/asymmetric/x509/CertificateFactory;->e:Lorg/bouncycastle/asn1/ASN1Set;

    invoke-direct {p0}, Lorg/bouncycastle/jcajce/provider/asymmetric/x509/CertificateFactory;->b()Ljava/security/cert/CRL;
    ...
    :cond_1
    invoke-static {p1}, Lorg/bouncycastle/asn1/x509/CertificateList;->g(Ljava/lang/Object;)Lorg/bouncycastle/asn1/x509/CertificateList;

    move-result-object p1

    invoke-virtual {p0, p1}, Lorg/bouncycastle/jcajce/provider/asymmetric/x509/CertificateFactory;->a(Lorg/bouncycastle/asn1/x509/CertificateList;)Ljava/security/cert/CRL;
...
.method private d()Ljava/security/cert/Certificate;
    ...
    iget-object p0, p0, Lorg/bouncycastle/jcajce/provider/asymmetric/x509/CertificateFactory;->a:Lorg/bouncycastle/jcajce/util/JcaJceHelper;
...
.method private e(Lorg/bouncycastle/asn1/ASN1Sequence;)Ljava/security/cert/Certificate;
    .locals 3
    .annotation system Ldalvik/annotation/Throws;
        value = {
            Ljava/security/cert/CertificateParsingException;
    ...
    invoke-virtual {p1}, Lorg/bouncycastle/asn1/pkcs/SignedData;->h()Lorg/bouncycastle/asn1/ASN1Set;

    move-result-object p1

    iput-object p1, p0, Lorg/bouncycastle/jcajce/provider/asymmetric/x509/CertificateFactory;->b:Lorg/bouncycastle/asn1/ASN1Set;

    invoke-direct {p0}, Lorg/bouncycastle/jcajce/provider/asymmetric/x509/CertificateFactory;->d()Ljava/security/cert/Certificate;
...
.method private f(Lorg/bouncycastle/asn1/ASN1InputStream;)Ljava/security/cert/CRL;
    .locals 0
    .annotation system Ldalvik/annotation/Throws;
        value = {
    ...
    invoke-direct {p0, p1}, Lorg/bouncycastle/jcajce/provider/asymmetric/x509/CertificateFactory;->c(Lorg/bouncycastle/asn1/ASN1Sequence;)Ljava/security/cert/CRL;
...
.method private g(Lorg/bouncycastle/asn1/ASN1InputStream;)Ljava/security/cert/Certificate;
    .locals 0
    .annotation system Ldalvik/annotation/Throws;
        value = {
            Ljava/io/IOException;,
    ...
    invoke-direct {p0, p1}, Lorg/bouncycastle/jcajce/provider/asymmetric/x509/CertificateFactory;->e(Lorg/bouncycastle/asn1/ASN1Sequence;)Ljava/security/cert/Certificate;
...
.method private h(Ljava/io/InputStream;)Ljava/security/cert/CRL;
    ...
    invoke-virtual {v0, p1}, Lorg/bouncycastle/jcajce/provider/asymmetric/x509/PEMUtil;->b(Ljava/io/InputStream;)Lorg/bouncycastle/asn1/ASN1Sequence;
...
# virtual methods
.method protected a(Lorg/bouncycastle/asn1/x509/CertificateList;)Ljava/security/cert/CRL;
    .locals 1
    .annotation system Ldalvik/annotation/Throws;
        value = {
            Ljava/security/cert/CRLException;
...
.method public engineGenerateCRL(Ljava/io/InputStream;)Ljava/security/cert/CRL;
    ...
    invoke-direct {p0, p1}, Lorg/bouncycastle/jcajce/provider/asymmetric/x509/CertificateFactory;->h(Ljava/io/InputStream;)Ljava/security/cert/CRL;
    ...
    invoke-direct {p0, v1}, Lorg/bouncycastle/jcajce/provider/asymmetric/x509/CertificateFactory;->f(Lorg/bouncycastle/asn1/ASN1InputStream;)Ljava/security/cert/CRL;
...
.method public engineGenerateCertificate(Ljava/io/InputStream;)Ljava/security/cert/Certificate;
    ...
    invoke-direct {p0, p1}, Lorg/bouncycastle/jcajce/provider/asymmetric/x509/CertificateFactory;->i(Ljava/io/InputStream;)Ljava/security/cert/Certificate;
    ...
    invoke-direct {p0, v0}, Lorg/bouncycastle/jcajce/provider/asymmetric/x509/CertificateFactory;->g(Lorg/bouncycastle/asn1/ASN1InputStream;)Ljava/security/cert/Certificate;
...
.method public engineGetCertPathEncodings()Ljava/util/Iterator;
    ...
    sget-object p0, Lorg/bouncycastle/jcajce/provider/asymmetric/x509/PKIXCertPath;->c:Ljava/util/List;
