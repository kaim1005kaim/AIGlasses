...
.method static constructor <clinit>()V
    ...
    sput-object v0, Lorg/bouncycastle/jcajce/provider/asymmetric/x509/PKIXCertPath;->c:Ljava/util/List;
...
.method constructor <init>(Ljava/io/InputStream;Ljava/lang/String;)V
    ...
    iput-object v1, p0, Lorg/bouncycastle/jcajce/provider/asymmetric/x509/PKIXCertPath;->a:Lorg/bouncycastle/jcajce/util/JcaJceHelper;
    ...
    iput-object p2, p0, Lorg/bouncycastle/jcajce/provider/asymmetric/x509/PKIXCertPath;->b:Ljava/util/List;

    invoke-interface {v1, v0}, Lorg/bouncycastle/jcajce/util/JcaJceHelper;->k(Ljava/lang/String;)Ljava/security/cert/CertificateFactory;
    ...
    iget-object v1, p0, Lorg/bouncycastle/jcajce/provider/asymmetric/x509/PKIXCertPath;->b:Ljava/util/List;
    ...
    iput-object p1, p0, Lorg/bouncycastle/jcajce/provider/asymmetric/x509/PKIXCertPath;->b:Ljava/util/List;
    ...
    :cond_4
    iget-object p1, p0, Lorg/bouncycastle/jcajce/provider/asymmetric/x509/PKIXCertPath;->b:Ljava/util/List;

    invoke-direct {p0, p1}, Lorg/bouncycastle/jcajce/provider/asymmetric/x509/PKIXCertPath;->a(Ljava/util/List;)Ljava/util/List;
...
.method constructor <init>(Ljava/util/List;)V
    ...
    iput-object v0, p0, Lorg/bouncycastle/jcajce/provider/asymmetric/x509/PKIXCertPath;->a:Lorg/bouncycastle/jcajce/util/JcaJceHelper;

    new-instance v0, Ljava/util/ArrayList;

    invoke-direct {v0, p1}, Ljava/util/ArrayList;-><init>(Ljava/util/Collection;)V

    invoke-direct {p0, v0}, Lorg/bouncycastle/jcajce/provider/asymmetric/x509/PKIXCertPath;->a(Ljava/util/List;)Ljava/util/List;
...
.method private b(Ljava/security/cert/X509Certificate;)Lorg/bouncycastle/asn1/ASN1Primitive;
    .locals 2
    .annotation system Ldalvik/annotation/Throws;
        value = {
...
.method public getCertificates()Ljava/util/List;
    ...
    iget-object p0, p0, Lorg/bouncycastle/jcajce/provider/asymmetric/x509/PKIXCertPath;->b:Ljava/util/List;
...
.method public getEncoded(Ljava/lang/String;)[B
    ...
    iget-object v0, p0, Lorg/bouncycastle/jcajce/provider/asymmetric/x509/PKIXCertPath;->b:Ljava/util/List;
    ...
    invoke-direct {p0, v1}, Lorg/bouncycastle/jcajce/provider/asymmetric/x509/PKIXCertPath;->b(Ljava/security/cert/X509Certificate;)Lorg/bouncycastle/asn1/ASN1Primitive;
    ...
    invoke-direct {p0, v0}, Lorg/bouncycastle/jcajce/provider/asymmetric/x509/PKIXCertPath;->c(Lorg/bouncycastle/asn1/ASN1Encodable;)[B
    ...
    sget-object p1, Lorg/bouncycastle/asn1/pkcs/PKCSObjectIdentifiers;->A2:Lorg/bouncycastle/asn1/ASN1ObjectIdentifier;
    ...
    invoke-direct {p0, v0}, Lorg/bouncycastle/jcajce/provider/asymmetric/x509/PKIXCertPath;->b(Ljava/security/cert/X509Certificate;)Lorg/bouncycastle/asn1/ASN1Primitive;
    ...
    invoke-direct {p0, p1}, Lorg/bouncycastle/jcajce/provider/asymmetric/x509/PKIXCertPath;->c(Lorg/bouncycastle/asn1/ASN1Encodable;)[B
    ...
    :goto_2
    :try_start_0
    iget-object v2, p0, Lorg/bouncycastle/jcajce/provider/asymmetric/x509/PKIXCertPath;->b:Ljava/util/List;
    ...
    iget-object v4, p0, Lorg/bouncycastle/jcajce/provider/asymmetric/x509/PKIXCertPath;->b:Ljava/util/List;
    ...
    invoke-virtual {v0, v2}, Lorg/bouncycastle/util/io/pem/PemWriter;->c(Lorg/bouncycastle/util/io/pem/PemObjectGenerator;)V
