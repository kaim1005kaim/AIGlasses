...
# static fields
.field private static final m:Lorg/bouncycastle/asn1/x9/X9IntegerConverter;
...
.field private k:Lorg/bouncycastle/crypto/agreement/ECVKOAgreement;
...
.method static constructor <clinit>()V
    ...
    sput-object v0, Lorg/bouncycastle/jcajce/provider/asymmetric/ecgost/KeyAgreementSpi;->m:Lorg/bouncycastle/asn1/x9/X9IntegerConverter;
...
.method protected constructor <init>(Ljava/lang/String;Lorg/bouncycastle/crypto/agreement/ECVKOAgreement;Lorg/bouncycastle/crypto/DerivationFunction;)V
    ...
    iput-object p1, p0, Lorg/bouncycastle/jcajce/provider/asymmetric/ecgost/KeyAgreementSpi;->i:Ljava/lang/String;

    iput-object p2, p0, Lorg/bouncycastle/jcajce/provider/asymmetric/ecgost/KeyAgreementSpi;->k:Lorg/bouncycastle/crypto/agreement/ECVKOAgreement;

    return-void
.end method

.method static e(Ljava/security/PublicKey;)Lorg/bouncycastle/crypto/params/AsymmetricKeyParameter;
    .locals 1
    ...
    invoke-virtual {p0}, Lorg/bouncycastle/jcajce/provider/asymmetric/ecgost/BCECGOST3410PublicKey;->c()Lorg/bouncycastle/crypto/params/ECPublicKeyParameters;
...
.method private g(Ljava/security/Key;Ljava/security/spec/AlgorithmParameterSpec;)V
    ...
    iput-object v0, p0, Lorg/bouncycastle/jcajce/provider/asymmetric/ecgost/KeyAgreementSpi;->j:Lorg/bouncycastle/crypto/params/ECDomainParameters;
    ...
    iget-object p0, p0, Lorg/bouncycastle/jcajce/provider/asymmetric/ecgost/KeyAgreementSpi;->k:Lorg/bouncycastle/crypto/agreement/ECVKOAgreement;
    ...
    invoke-virtual {p0, v0}, Lorg/bouncycastle/crypto/agreement/ECVKOAgreement;->d(Lorg/bouncycastle/crypto/CipherParameters;)V
    ...
    iget-object p0, p0, Lorg/bouncycastle/jcajce/provider/asymmetric/ecgost/KeyAgreementSpi;->i:Ljava/lang/String;
    ...
    invoke-static {p0}, Lorg/bouncycastle/jcajce/provider/asymmetric/ecgost/KeyAgreementSpi;->f(Ljava/lang/Class;)Ljava/lang/String;
...
.method protected a()[B
    ...
    iget-object p0, p0, Lorg/bouncycastle/jcajce/provider/asymmetric/ecgost/KeyAgreementSpi;->l:[B
...
.method protected engineDoPhase(Ljava/security/Key;Z)Ljava/security/Key;
    ...
    iget-object v0, p0, Lorg/bouncycastle/jcajce/provider/asymmetric/ecgost/KeyAgreementSpi;->j:Lorg/bouncycastle/crypto/params/ECDomainParameters;
    ...
    invoke-static {p1}, Lorg/bouncycastle/jcajce/provider/asymmetric/ecgost/KeyAgreementSpi;->e(Ljava/security/PublicKey;)Lorg/bouncycastle/crypto/params/AsymmetricKeyParameter;

    move-result-object p1

    :try_start_0
    iget-object p2, p0, Lorg/bouncycastle/jcajce/provider/asymmetric/ecgost/KeyAgreementSpi;->k:Lorg/bouncycastle/crypto/agreement/ECVKOAgreement;

    invoke-virtual {p2, p1}, Lorg/bouncycastle/crypto/agreement/ECVKOAgreement;->a(Lorg/bouncycastle/crypto/CipherParameters;)[B

    move-result-object p1

    iput-object p1, p0, Lorg/bouncycastle/jcajce/provider/asymmetric/ecgost/KeyAgreementSpi;->l:[B
    :try_end_0
...
.method protected engineInit(Ljava/security/Key;Ljava/security/SecureRandom;)V
    ...
    invoke-direct {p0, p1, p2}, Lorg/bouncycastle/jcajce/provider/asymmetric/ecgost/KeyAgreementSpi;->g(Ljava/security/Key;Ljava/security/spec/AlgorithmParameterSpec;)V
