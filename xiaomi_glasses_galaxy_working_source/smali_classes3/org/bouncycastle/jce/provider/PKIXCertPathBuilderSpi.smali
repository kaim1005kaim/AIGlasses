...
# virtual methods
.method protected a(Ljava/security/cert/X509Certificate;Lorg/bouncycastle/jcajce/PKIXExtendedBuilderParameters;Ljava/util/List;)Ljava/security/cert/CertPathBuilderResult;
    .locals 5
    ...
    :cond_0
    invoke-virtual {p2}, Lorg/bouncycastle/jcajce/PKIXExtendedBuilderParameters;->b()Ljava/util/Set;
    ...
    :cond_1
    invoke-virtual {p2}, Lorg/bouncycastle/jcajce/PKIXExtendedBuilderParameters;->c()I
    ...
    :try_start_1
    invoke-virtual {p2}, Lorg/bouncycastle/jcajce/PKIXExtendedBuilderParameters;->a()Lorg/bouncycastle/jcajce/PKIXExtendedParameters;
    ...
    invoke-static {p1, v3, v4}, Lorg/bouncycastle/jce/provider/CertPathValidatorUtilities;->v(Ljava/security/cert/X509Certificate;Ljava/util/Set;Ljava/lang/String;)Z
    ...
    invoke-virtual {v2}, Lorg/bouncycastle/jcajce/PKIXExtendedParameters;->m()Ljava/util/List;
    ...
    :try_start_5
    sget-object v2, Lorg/bouncycastle/asn1/x509/Extension;->i:Lorg/bouncycastle/asn1/ASN1ObjectIdentifier;
    ...
    invoke-static {v2, v3}, Lorg/bouncycastle/jce/provider/CertPathValidatorUtilities;->f([BLjava/util/Map;)Ljava/util/List;
    ...
    invoke-static {p1, v3, v0}, Lorg/bouncycastle/jce/provider/CertPathValidatorUtilities;->c(Ljava/security/cert/X509Certificate;Ljava/util/List;Ljava/util/List;)Ljava/util/Collection;
    ...
    invoke-virtual {p0, v2, p2, p3}, Lorg/bouncycastle/jce/provider/PKIXCertPathBuilderSpi;->a(Ljava/security/cert/X509Certificate;Lorg/bouncycastle/jcajce/PKIXExtendedBuilderParameters;Ljava/util/List;)Ljava/security/cert/CertPathBuilderResult;
...
.method public engineBuild(Ljava/security/cert/CertPathParameters;)Ljava/security/cert/CertPathBuilderResult;
    ...
    invoke-virtual {p1}, Lorg/bouncycastle/x509/ExtendedPKIXParameters;->d()Ljava/util/List;
    ...
    invoke-virtual {v0, v2}, Lorg/bouncycastle/jcajce/PKIXExtendedParameters$Builder;->m(Lorg/bouncycastle/jcajce/PKIXCertStore;)Lorg/bouncycastle/jcajce/PKIXExtendedParameters$Builder;
    ...
    invoke-virtual {v0}, Lorg/bouncycastle/jcajce/PKIXExtendedParameters$Builder;->p()Lorg/bouncycastle/jcajce/PKIXExtendedParameters;
    ...
    invoke-virtual {v1, v0}, Lorg/bouncycastle/jcajce/PKIXExtendedBuilderParameters$Builder;->d(Ljava/util/Set;)Lorg/bouncycastle/jcajce/PKIXExtendedBuilderParameters$Builder;

    invoke-virtual {p1}, Lorg/bouncycastle/x509/ExtendedPKIXBuilderParameters;->z()I

    move-result p1

    invoke-virtual {v1, p1}, Lorg/bouncycastle/jcajce/PKIXExtendedBuilderParameters$Builder;->f(I)Lorg/bouncycastle/jcajce/PKIXExtendedBuilderParameters$Builder;
    ...
    :goto_1
    invoke-virtual {v1}, Lorg/bouncycastle/jcajce/PKIXExtendedBuilderParameters$Builder;->e()Lorg/bouncycastle/jcajce/PKIXExtendedBuilderParameters;
    ...
    invoke-virtual {v1}, Lorg/bouncycastle/jcajce/PKIXExtendedParameters;->s()Lorg/bouncycastle/jcajce/PKIXCertStoreSelector;
    ...
    invoke-static {v1, v2}, Lorg/bouncycastle/jce/provider/CertPathValidatorUtilities;->b(Lorg/bouncycastle/jcajce/PKIXCertStoreSelector;Ljava/util/List;)Ljava/util/Collection;
    ...
    invoke-static {v1, v3}, Lorg/bouncycastle/jce/provider/CertPathValidatorUtilities;->b(Lorg/bouncycastle/jcajce/PKIXCertStoreSelector;Ljava/util/List;)Ljava/util/Collection;
    ...
    invoke-virtual {p0, v2, p1, v0}, Lorg/bouncycastle/jce/provider/PKIXCertPathBuilderSpi;->a(Ljava/security/cert/X509Certificate;Lorg/bouncycastle/jcajce/PKIXExtendedBuilderParameters;Ljava/util/List;)Ljava/security/cert/CertPathBuilderResult;
    ...
    iget-object p0, p0, Lorg/bouncycastle/jce/provider/PKIXCertPathBuilderSpi;->a:Ljava/lang/Exception;
