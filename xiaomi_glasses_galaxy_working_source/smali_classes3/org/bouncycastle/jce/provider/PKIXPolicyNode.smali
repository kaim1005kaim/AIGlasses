...
# virtual methods
.method public a(Lorg/bouncycastle/jce/provider/PKIXPolicyNode;)V
    .locals 1
    ...
    invoke-virtual {p1, p0}, Lorg/bouncycastle/jce/provider/PKIXPolicyNode;->g(Lorg/bouncycastle/jce/provider/PKIXPolicyNode;)V

    return-void
.end method

.method public b()Lorg/bouncycastle/jce/provider/PKIXPolicyNode;
    .locals 9
    ...
    iget-object p0, p0, Lorg/bouncycastle/jce/provider/PKIXPolicyNode;->a:Ljava/util/List;
    ...
    invoke-virtual {v0}, Lorg/bouncycastle/jce/provider/PKIXPolicyNode;->b()Lorg/bouncycastle/jce/provider/PKIXPolicyNode;

    move-result-object v0

    invoke-virtual {v0, v8}, Lorg/bouncycastle/jce/provider/PKIXPolicyNode;->g(Lorg/bouncycastle/jce/provider/PKIXPolicyNode;)V

    invoke-virtual {v8, v0}, Lorg/bouncycastle/jce/provider/PKIXPolicyNode;->a(Lorg/bouncycastle/jce/provider/PKIXPolicyNode;)V
...
.method public clone()Ljava/lang/Object;
    ...
    invoke-virtual {p0}, Lorg/bouncycastle/jce/provider/PKIXPolicyNode;->b()Lorg/bouncycastle/jce/provider/PKIXPolicyNode;
...
.method public d(Lorg/bouncycastle/jce/provider/PKIXPolicyNode;)V
    .locals 0
...
.method public f(Ljava/util/Set;)V
    ...
    iput-object p1, p0, Lorg/bouncycastle/jce/provider/PKIXPolicyNode;->c:Ljava/util/Set;

    return-void
.end method

.method public g(Lorg/bouncycastle/jce/provider/PKIXPolicyNode;)V
    .locals 0

    iput-object p1, p0, Lorg/bouncycastle/jce/provider/PKIXPolicyNode;->d:Ljava/security/cert/PolicyNode;
...
.method public getDepth()I
    ...
    iget p0, p0, Lorg/bouncycastle/jce/provider/PKIXPolicyNode;->b:I
...
.method public getExpectedPolicies()Ljava/util/Set;
    ...
    iget-object p0, p0, Lorg/bouncycastle/jce/provider/PKIXPolicyNode;->c:Ljava/util/Set;
...
.method public getParent()Ljava/security/cert/PolicyNode;
    ...
    iget-object p0, p0, Lorg/bouncycastle/jce/provider/PKIXPolicyNode;->d:Ljava/security/cert/PolicyNode;
...
.method public getPolicyQualifiers()Ljava/util/Set;
    ...
    iget-object p0, p0, Lorg/bouncycastle/jce/provider/PKIXPolicyNode;->e:Ljava/util/Set;
...
.method public getValidPolicy()Ljava/lang/String;
    ...
    iget-object p0, p0, Lorg/bouncycastle/jce/provider/PKIXPolicyNode;->f:Ljava/lang/String;
...
.method public h(Ljava/lang/String;)Ljava/lang/String;
    ...
    invoke-virtual {v2, v3}, Lorg/bouncycastle/jce/provider/PKIXPolicyNode;->h(Ljava/lang/String;)Ljava/lang/String;
...
.method public isCritical()Z
    ...
    iget-boolean p0, p0, Lorg/bouncycastle/jce/provider/PKIXPolicyNode;->g:Z
...
.method public toString()Ljava/lang/String;
    ...
    invoke-virtual {p0, v0}, Lorg/bouncycastle/jce/provider/PKIXPolicyNode;->h(Ljava/lang/String;)Ljava/lang/String;
