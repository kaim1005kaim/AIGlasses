...
.method private b([B)V
    ...
    invoke-static {p1}, Lorg/bouncycastle/util/encoders/Base64;->g([B)[B
...
# virtual methods
.method public a(Lorg/bouncycastle/util/io/pem/PemObject;)I
    .locals 4

    invoke-virtual {p1}, Lorg/bouncycastle/util/io/pem/PemObject;->d()Ljava/lang/String;
    ...
    iget v1, p0, Lorg/bouncycastle/util/io/pem/PemWriter;->a:I
    ...
    invoke-virtual {v2}, Lorg/bouncycastle/util/io/pem/PemHeader;->b()Ljava/lang/String;
    ...
    invoke-virtual {v2}, Lorg/bouncycastle/util/io/pem/PemHeader;->c()Ljava/lang/String;
    ...
    iget v2, p0, Lorg/bouncycastle/util/io/pem/PemWriter;->a:I
    ...
    iget p0, p0, Lorg/bouncycastle/util/io/pem/PemWriter;->a:I
...
.method public c(Lorg/bouncycastle/util/io/pem/PemObjectGenerator;)V
    ...
    invoke-direct {p0, v0}, Lorg/bouncycastle/util/io/pem/PemWriter;->f(Ljava/lang/String;)V
    ...
    invoke-virtual {v1}, Lorg/bouncycastle/util/io/pem/PemHeader;->c()Ljava/lang/String;
    ...
    invoke-direct {p0, v0}, Lorg/bouncycastle/util/io/pem/PemWriter;->b([B)V

    invoke-virtual {p1}, Lorg/bouncycastle/util/io/pem/PemObject;->d()Ljava/lang/String;

    move-result-object p1

    invoke-direct {p0, p1}, Lorg/bouncycastle/util/io/pem/PemWriter;->d(Ljava/lang/String;)V
