...
.method public constructor <init>(Ljava/security/PrivateKey;[Ljava/security/cert/X509Certificate;)V
    ...
    invoke-static {p1}, Lorg/bouncycastle/pkix/jcajce/JcaPKIXIdentity;->g(Ljava/security/PrivateKey;)Lorg/bouncycastle/asn1/pkcs/PrivateKeyInfo;

    move-result-object v0

    invoke-static {p2}, Lorg/bouncycastle/pkix/jcajce/JcaPKIXIdentity;->e([Ljava/security/cert/X509Certificate;)[Lorg/bouncycastle/cert/X509CertificateHolder;
    ...
    iput-object p1, p0, Lorg/bouncycastle/pkix/jcajce/JcaPKIXIdentity;->c:Ljava/security/PrivateKey;

    array-length p1, p2

    new-array p1, p1, [Ljava/security/cert/X509Certificate;

    iput-object p1, p0, Lorg/bouncycastle/pkix/jcajce/JcaPKIXIdentity;->d:[Ljava/security/cert/X509Certificate;
...
.method private static e([Ljava/security/cert/X509Certificate;)[Lorg/bouncycastle/cert/X509CertificateHolder;
    .locals 5
...
.method private static g(Ljava/security/PrivateKey;)Lorg/bouncycastle/asn1/pkcs/PrivateKeyInfo;
    .locals 0
...
.method public f()Ljava/security/PrivateKey;
    ...
    iget-object p0, p0, Lorg/bouncycastle/pkix/jcajce/JcaPKIXIdentity;->c:Ljava/security/PrivateKey;
...
.method public h()Ljava/security/cert/X509Certificate;
    ...
    iget-object p0, p0, Lorg/bouncycastle/pkix/jcajce/JcaPKIXIdentity;->d:[Ljava/security/cert/X509Certificate;
