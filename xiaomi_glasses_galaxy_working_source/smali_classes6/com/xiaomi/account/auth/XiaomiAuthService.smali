...
.method constructor <init>(Landroid/os/IBinder;)V
    ...
    :catch_0
    invoke-static {p1}, Lmiui/net/IXiaomiAuthService$Stub;->d(Landroid/os/IBinder;)Lmiui/net/IXiaomiAuthService;
...
.method private miuiv5(Landroid/content/Context;Lcom/xiaomi/account/IXiaomiAuthResponse;Lcom/xiaomi/account/auth/OAuthConfig;Landroid/os/Bundle;)V
    ...
    iget-object p0, p0, Lcom/xiaomi/account/auth/XiaomiAuthService;->mMiuiV5AuthService:Lmiui/net/IXiaomiAuthService;

    if-eqz p0, :cond_5

    invoke-interface {p0, v0, p4}, Lmiui/net/IXiaomiAuthService;->getMiCloudAccessToken(Landroid/accounts/Account;Landroid/os/Bundle;)Landroid/os/Bundle;
    ...
    invoke-interface {p2, p0}, Lcom/xiaomi/account/IXiaomiAuthResponse;->onResult(Landroid/os/Bundle;)V
    ...
    invoke-static {p1, p4, p2, p3}, Lcom/xiaomi/account/openauth/AuthorizeActivityBase;->asMiddleActivity(Landroid/content/Context;Landroid/content/Intent;Lcom/xiaomi/account/IXiaomiAuthResponse;Ljava/lang/Class;)Landroid/content/Intent;
    ...
    const-string p1, "getMiCloudAccessToken return null"
    ...
    const-string p1, "mMiuiV5AuthService return null"
    ...
    const-string p1, "Xiaomi Account not Login"
...
.method public getMiCloudAccessToken(Landroid/accounts/Account;Landroid/os/Bundle;)Landroid/os/Bundle;
    ...
    invoke-interface {p0, p1, p2}, Lmiui/net/IXiaomiAuthService;->getMiCloudAccessToken(Landroid/accounts/Account;Landroid/os/Bundle;)Landroid/os/Bundle;
...
.method public invalidateAccessToken(Landroid/accounts/Account;Landroid/os/Bundle;)V
    ...
    invoke-interface {p0, p1, p2}, Lmiui/net/IXiaomiAuthService;->invalidateAccessToken(Landroid/accounts/Account;Landroid/os/Bundle;)V
...
.method public oauthInResponse(Landroid/content/Context;Lcom/xiaomi/account/IXiaomiAuthResponse;Lcom/xiaomi/account/auth/OAuthConfig;)V
    ...
    :cond_0
    const-string p0, "this version of miui only support system account login"
    ...
    :cond_2
    const-string p0, "this version of miui not support fast Oauth"
    ...
    invoke-interface {p0, p2, p1, v2, v2}, Lcom/xiaomi/account/IXiaomiAuthService;->getAccessTokenInResponse(Lcom/xiaomi/account/IXiaomiAuthResponse;Landroid/os/Bundle;II)V
