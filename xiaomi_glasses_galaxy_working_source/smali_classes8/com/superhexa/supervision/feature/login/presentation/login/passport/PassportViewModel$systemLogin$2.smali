.class public final Lcom/superhexa/supervision/feature/login/presentation/login/passport/PassportViewModel$systemLogin$2;
...
.annotation system Ldalvik/annotation/EnclosingMethod;
    value = Lcom/superhexa/supervision/feature/login/presentation/login/passport/PassportViewModel;->B(Z)V
.end annotation
...
.annotation runtime Lkotlin/Metadata;
    ...
    d2 = {
        "com/superhexa/supervision/feature/login/presentation/login/passport/PassportViewModel$systemLogin$2",
        "Lcom/superhexa/supervision/feature/login/presentation/login/passport/ResultCallBack;",
        "Lcom/xiaomi/passport/servicetoken/ServiceTokenResult;",
        "data",
        "",
...
.method constructor <init>(Lcom/superhexa/supervision/feature/login/presentation/login/passport/PassportViewModel;)V
    ...
    iput-object p1, p0, Lcom/superhexa/supervision/feature/login/presentation/login/passport/PassportViewModel$systemLogin$2;->a:Lcom/superhexa/supervision/feature/login/presentation/login/passport/PassportViewModel;
...
.method public bridge synthetic a(Ljava/lang/Object;)V
    ...
    invoke-virtual {p0, p1}, Lcom/superhexa/supervision/feature/login/presentation/login/passport/PassportViewModel$systemLogin$2;->e(Lcom/xiaomi/passport/servicetoken/ServiceTokenResult;)V
...
.method public c(Ljava/lang/Throwable;)V
    ...
    sget v2, Lcom/superhexa/supervision/feature/login/R$string;->LOGIN_FAILED:I
    ...
    invoke-static {v1, p1, v0}, Lcom/superhexa/supervision/library/base/basecommon/extension/ContextExtensionsKt;->a(Landroid/content/Context;Ljava/lang/String;I)V

    iget-object p0, p0, Lcom/superhexa/supervision/feature/login/presentation/login/passport/PassportViewModel$systemLogin$2;->a:Lcom/superhexa/supervision/feature/login/presentation/login/passport/PassportViewModel;
    ...
    sget-object p1, Lcom/superhexa/supervision/feature/login/presentation/login/passport/PassportViewModel$systemLogin$2$doError$1;->a:Lcom/superhexa/supervision/feature/login/presentation/login/passport/PassportViewModel$systemLogin$2$doError$1;
...
.method public e(Lcom/xiaomi/passport/servicetoken/ServiceTokenResult;)V
    ...
    const-string v0, "LibBaseApplication.insta\u2026ng(R.string.LOGIN_FAILED)"
    ...
    iget-object v2, p1, Lcom/xiaomi/passport/servicetoken/ServiceTokenResult;->serviceToken:Ljava/lang/String;

    filled-new-array {v2}, [Ljava/lang/Object;

    move-result-object v2

    const-string v3, "serviceToken=====%s"

    invoke-virtual {v0, v3, v2}, Ltimber/log/Timber$Forest;->i(Ljava/lang/String;[Ljava/lang/Object;)V

    iget-object p0, p0, Lcom/superhexa/supervision/feature/login/presentation/login/passport/PassportViewModel$systemLogin$2;->a:Lcom/superhexa/supervision/feature/login/presentation/login/passport/PassportViewModel;

    invoke-virtual {p0, v1, p1}, Lcom/superhexa/supervision/feature/login/presentation/login/passport/PassportViewModel;->s(ZLcom/xiaomi/passport/servicetoken/ServiceTokenResult;)V
    ...
    const-string v0, "getSystemToken:data.intent!=null"
    ...
    sget-object p1, Lcom/superhexa/supervision/feature/login/presentation/login/passport/PassportViewModel$systemLogin$2$doResult$1;->a:Lcom/superhexa/supervision/feature/login/presentation/login/passport/PassportViewModel$systemLogin$2$doResult$1;
    ...
    const-string v3, "getSystemToken:errorMessage=null,data.errorCode:%s"

    filled-new-array {v2}, [Ljava/lang/Object;

    move-result-object v2

    invoke-virtual {p1, v3, v2}, Ltimber/log/Timber$Forest;->i(Ljava/lang/String;[Ljava/lang/Object;)V
    ...
    sget-object p1, Lcom/superhexa/supervision/feature/login/presentation/login/passport/PassportViewModel$systemLogin$2$doResult$2;->a:Lcom/superhexa/supervision/feature/login/presentation/login/passport/PassportViewModel$systemLogin$2$doResult$2;
    ...
    const-string v2, "getSystemToken:data==null"
    ...
    sget-object p1, Lcom/superhexa/supervision/feature/login/presentation/login/passport/PassportViewModel$systemLogin$2$doResult$3;->a:Lcom/superhexa/supervision/feature/login/presentation/login/passport/PassportViewModel$systemLogin$2$doResult$3;
