...
.method private d(Lorg/bouncycastle/cms/CMSTypedData;Lorg/bouncycastle/operator/OutputEncryptor;)Lorg/bouncycastle/cms/CMSEnvelopedData;
    .locals 5
    ...
    iget-object v0, p0, Lorg/bouncycastle/cms/CMSEnvelopedGenerator;->a:Ljava/util/List;
    ...
    :try_start_0
    invoke-interface {p2, v1}, Lorg/bouncycastle/operator/OutputEncryptor;->b(Ljava/io/OutputStream;)Ljava/io/OutputStream;

    move-result-object v2

    invoke-interface {p1, v2}, Lorg/bouncycastle/cms/CMSProcessable;->a(Ljava/io/OutputStream;)V
    ...
    invoke-interface {v4, p2}, Lorg/bouncycastle/cms/RecipientInfoGenerator;->a(Lorg/bouncycastle/operator/GenericKey;)Lorg/bouncycastle/asn1/cms/RecipientInfo;
    ...
    iget-object p1, p0, Lorg/bouncycastle/cms/CMSEnvelopedGenerator;->c:Lorg/bouncycastle/cms/CMSAttributeTableGenerator;
    ...
    invoke-interface {p1, v1}, Lorg/bouncycastle/cms/CMSAttributeTableGenerator;->a(Ljava/util/Map;)Lorg/bouncycastle/asn1/cms/AttributeTable;
    ...
    iget-object p0, p0, Lorg/bouncycastle/cms/CMSEnvelopedGenerator;->d:Lorg/bouncycastle/asn1/cms/OriginatorInfo;
    ...
    invoke-direct {v3, p0, v4, p2, v1}, Lorg/bouncycastle/asn1/cms/EnvelopedData;-><init>(Lorg/bouncycastle/asn1/cms/OriginatorInfo;Lorg/bouncycastle/asn1/ASN1Set;Lorg/bouncycastle/asn1/cms/EncryptedContentInfo;Lorg/bouncycastle/asn1/ASN1Set;)V
    ...
    new-instance p0, Lorg/bouncycastle/cms/CMSEnvelopedData;
...
# virtual methods
.method public e(Lorg/bouncycastle/cms/CMSTypedData;Lorg/bouncycastle/operator/OutputEncryptor;)Lorg/bouncycastle/cms/CMSEnvelopedData;
    .locals 0
    .annotation system Ldalvik/annotation/Throws;
        value = {
            Lorg/bouncycastle/cms/CMSException;
    ...
    invoke-direct {p0, p1, p2}, Lorg/bouncycastle/cms/CMSEnvelopedDataGenerator;->d(Lorg/bouncycastle/cms/CMSTypedData;Lorg/bouncycastle/operator/OutputEncryptor;)Lorg/bouncycastle/cms/CMSEnvelopedData;
