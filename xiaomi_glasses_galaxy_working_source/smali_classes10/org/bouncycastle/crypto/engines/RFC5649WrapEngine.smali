...
.method private e([BII)[B
    ...
    iget-object p1, p0, Lorg/bouncycastle/crypto/engines/RFC5649WrapEngine;->a:Lorg/bouncycastle/crypto/BlockCipher;

    iget-object p2, p0, Lorg/bouncycastle/crypto/engines/RFC5649WrapEngine;->b:Lorg/bouncycastle/crypto/params/KeyParameter;

    invoke-interface {p1, v5, p2}, Lorg/bouncycastle/crypto/BlockCipher;->a(ZLorg/bouncycastle/crypto/CipherParameters;)V
    ...
    :cond_0
    iget-object v7, p0, Lorg/bouncycastle/crypto/engines/RFC5649WrapEngine;->a:Lorg/bouncycastle/crypto/BlockCipher;
    ...
    :cond_2
    iput-object v3, p0, Lorg/bouncycastle/crypto/engines/RFC5649WrapEngine;->f:[B
...
.method public a(ZLorg/bouncycastle/crypto/CipherParameters;)V
    ...
    iput-object p1, p0, Lorg/bouncycastle/crypto/engines/RFC5649WrapEngine;->b:Lorg/bouncycastle/crypto/params/KeyParameter;

    iget-object p0, p0, Lorg/bouncycastle/crypto/engines/RFC5649WrapEngine;->e:[B
...
.method public b([BII)[B
    ...
    invoke-static {p3}, Lorg/bouncycastle/util/Pack;->h(I)[B
    ...
    invoke-direct {p0, v2}, Lorg/bouncycastle/crypto/engines/RFC5649WrapEngine;->d([B)[B
    ...
    invoke-interface {p1, p3, v0}, Lorg/bouncycastle/crypto/BlockCipher;->a(ZLorg/bouncycastle/crypto/CipherParameters;)V
    ...
    iget-object p0, p0, Lorg/bouncycastle/crypto/engines/RFC5649WrapEngine;->b:Lorg/bouncycastle/crypto/params/KeyParameter;
    ...
    invoke-interface {p2, p3, v0}, Lorg/bouncycastle/crypto/Wrapper;->a(ZLorg/bouncycastle/crypto/CipherParameters;)V

    array-length p0, p1

    invoke-interface {p2, p1, v5, p0}, Lorg/bouncycastle/crypto/Wrapper;->b([BII)[B
...
.method public c([BII)[B
    ...
    invoke-interface {p1, v2, p2}, Lorg/bouncycastle/crypto/BlockCipher;->a(ZLorg/bouncycastle/crypto/CipherParameters;)V
    ...
    iput-object p1, p0, Lorg/bouncycastle/crypto/engines/RFC5649WrapEngine;->f:[B

    array-length p2, p1

    invoke-static {v3, v2, p1, v2, p2}, Ljava/lang/System;->arraycopy(Ljava/lang/Object;ILjava/lang/Object;II)V

    iget-object p1, p0, Lorg/bouncycastle/crypto/engines/RFC5649WrapEngine;->f:[B
    ...
    :cond_1
    invoke-direct {p0, p1, p2, p3}, Lorg/bouncycastle/crypto/engines/RFC5649WrapEngine;->e([BII)[B
    ...
    iget-object v1, p0, Lorg/bouncycastle/crypto/engines/RFC5649WrapEngine;->f:[B
    ...
    invoke-static {p3, p0}, Lorg/bouncycastle/util/Arrays;->C([B[B)Z
    ...
    invoke-static {v1, v0}, Lorg/bouncycastle/util/Arrays;->C([B[B)Z
...
.method public getAlgorithmName()Ljava/lang/String;
    ...
    iget-object p0, p0, Lorg/bouncycastle/crypto/engines/RFC5649WrapEngine;->a:Lorg/bouncycastle/crypto/BlockCipher;
