...
.method private k([BI[B[BI)V
    ...
    iget-object v1, p0, Lorg/bouncycastle/crypto/generators/PKCS5S2ParametersGenerator;->d:Lorg/bouncycastle/crypto/Mac;
    ...
    iget-object p3, p0, Lorg/bouncycastle/crypto/generators/PKCS5S2ParametersGenerator;->e:[B

    invoke-interface {p1, p3, v0}, Lorg/bouncycastle/crypto/Mac;->doFinal([BI)I

    iget-object p1, p0, Lorg/bouncycastle/crypto/generators/PKCS5S2ParametersGenerator;->e:[B
    ...
    iget-object p3, p0, Lorg/bouncycastle/crypto/generators/PKCS5S2ParametersGenerator;->d:Lorg/bouncycastle/crypto/Mac;

    iget-object v1, p0, Lorg/bouncycastle/crypto/generators/PKCS5S2ParametersGenerator;->e:[B
...
.method private l(I)[B
    ...
    iget-object v4, p0, Lorg/bouncycastle/crypto/PBEParametersGenerator;->a:[B

    invoke-direct {v3, v4}, Lorg/bouncycastle/crypto/params/KeyParameter;-><init>([B)V

    iget-object v4, p0, Lorg/bouncycastle/crypto/generators/PKCS5S2ParametersGenerator;->d:Lorg/bouncycastle/crypto/Mac;

    invoke-interface {v4, v3}, Lorg/bouncycastle/crypto/Mac;->a(Lorg/bouncycastle/crypto/CipherParameters;)V
    ...
    :cond_0
    iget-object v4, p0, Lorg/bouncycastle/crypto/PBEParametersGenerator;->b:[B

    iget v5, p0, Lorg/bouncycastle/crypto/PBEParametersGenerator;->c:I
    ...
    invoke-direct/range {v3 .. v8}, Lorg/bouncycastle/crypto/generators/PKCS5S2ParametersGenerator;->k([BI[B[BI)V
...
.method public d(I)Lorg/bouncycastle/crypto/CipherParameters;
    ...
    invoke-virtual {p0, p1}, Lorg/bouncycastle/crypto/generators/PKCS5S2ParametersGenerator;->e(I)Lorg/bouncycastle/crypto/CipherParameters;
...
.method public e(I)Lorg/bouncycastle/crypto/CipherParameters;
    ...
    invoke-direct {p0, p1}, Lorg/bouncycastle/crypto/generators/PKCS5S2ParametersGenerator;->l(I)[B

    move-result-object p0

    const/4 v0, 0x0

    invoke-static {p0, v0, p1}, Lorg/bouncycastle/util/Arrays;->K([BII)[B

    move-result-object p0

    new-instance v1, Lorg/bouncycastle/crypto/params/KeyParameter;

    invoke-direct {v1, p0, v0, p1}, Lorg/bouncycastle/crypto/params/KeyParameter;-><init>([BII)V
...
.method public f(II)Lorg/bouncycastle/crypto/CipherParameters;
    ...
    invoke-direct {p0, v0}, Lorg/bouncycastle/crypto/generators/PKCS5S2ParametersGenerator;->l(I)[B
