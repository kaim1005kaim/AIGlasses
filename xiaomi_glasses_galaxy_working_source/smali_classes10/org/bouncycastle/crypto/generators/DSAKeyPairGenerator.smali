...
# instance fields
.field private g:Lorg/bouncycastle/crypto/params/DSAKeyGenerationParameters;
...
.method private static d(Ljava/math/BigInteger;Ljava/security/SecureRandom;)Ljava/math/BigInteger;
    ...
    :cond_0
    sget-object v1, Lorg/bouncycastle/crypto/generators/DSAKeyPairGenerator;->h:Ljava/math/BigInteger;

    invoke-virtual {p0, v1}, Ljava/math/BigInteger;->subtract(Ljava/math/BigInteger;)Ljava/math/BigInteger;

    move-result-object v2

    invoke-static {v1, v2, p1}, Lorg/bouncycastle/util/BigIntegers;->c(Ljava/math/BigInteger;Ljava/math/BigInteger;Ljava/security/SecureRandom;)Ljava/math/BigInteger;
...
.method public a()Lorg/bouncycastle/crypto/AsymmetricCipherKeyPair;
    ...
    invoke-virtual {v0}, Lorg/bouncycastle/crypto/params/DSAKeyGenerationParameters;->c()Lorg/bouncycastle/crypto/params/DSAParameters;
    ...
    iget-object p0, p0, Lorg/bouncycastle/crypto/generators/DSAKeyPairGenerator;->g:Lorg/bouncycastle/crypto/params/DSAKeyGenerationParameters;

    invoke-virtual {p0}, Lorg/bouncycastle/crypto/KeyGenerationParameters;->a()Ljava/security/SecureRandom;

    move-result-object p0

    invoke-static {v1, p0}, Lorg/bouncycastle/crypto/generators/DSAKeyPairGenerator;->d(Ljava/math/BigInteger;Ljava/security/SecureRandom;)Ljava/math/BigInteger;
    ...
    invoke-static {v1, v2, p0}, Lorg/bouncycastle/crypto/generators/DSAKeyPairGenerator;->c(Ljava/math/BigInteger;Ljava/math/BigInteger;Ljava/math/BigInteger;)Ljava/math/BigInteger;
...
.method public b(Lorg/bouncycastle/crypto/KeyGenerationParameters;)V
    ...
    iput-object p1, p0, Lorg/bouncycastle/crypto/generators/DSAKeyPairGenerator;->g:Lorg/bouncycastle/crypto/params/DSAKeyGenerationParameters;
