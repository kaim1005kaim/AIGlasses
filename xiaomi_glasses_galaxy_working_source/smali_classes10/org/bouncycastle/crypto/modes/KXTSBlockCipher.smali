...
.method public constructor <init>(Lorg/bouncycastle/crypto/BlockCipher;)V
    ...
    invoke-static {p1}, Lorg/bouncycastle/crypto/modes/KXTSBlockCipher;->k(I)J

    move-result-wide v0

    iput-wide v0, p0, Lorg/bouncycastle/crypto/modes/KXTSBlockCipher;->h:J

    ushr-int/lit8 v0, p1, 0x3

    new-array v0, v0, [J

    iput-object v0, p0, Lorg/bouncycastle/crypto/modes/KXTSBlockCipher;->i:[J

    ushr-int/lit8 p1, p1, 0x3

    new-array p1, p1, [J

    iput-object p1, p0, Lorg/bouncycastle/crypto/modes/KXTSBlockCipher;->j:[J

    const/4 p1, -0x1

    iput p1, p0, Lorg/bouncycastle/crypto/modes/KXTSBlockCipher;->k:I
...
.method private l([BI[BI)V
    ...
    iget v0, p0, Lorg/bouncycastle/crypto/modes/KXTSBlockCipher;->k:I
    ...
    iput v0, p0, Lorg/bouncycastle/crypto/modes/KXTSBlockCipher;->k:I

    iget-wide v0, p0, Lorg/bouncycastle/crypto/modes/KXTSBlockCipher;->h:J

    iget-object v2, p0, Lorg/bouncycastle/crypto/modes/KXTSBlockCipher;->j:[J

    invoke-static {v0, v1, v2}, Lorg/bouncycastle/crypto/modes/KXTSBlockCipher;->j(J[J)V

    iget v0, p0, Lorg/bouncycastle/crypto/modes/KXTSBlockCipher;->g:I

    new-array v0, v0, [B

    iget-object v1, p0, Lorg/bouncycastle/crypto/modes/KXTSBlockCipher;->j:[J

    const/4 v2, 0x0

    invoke-static {v1, v0, v2}, Lorg/bouncycastle/util/Pack;->B([J[BI)V

    iget v1, p0, Lorg/bouncycastle/crypto/modes/KXTSBlockCipher;->g:I
    ...
    :goto_0
    iget v4, p0, Lorg/bouncycastle/crypto/modes/KXTSBlockCipher;->g:I
...
.method public a([BI)I
    ...
    invoke-virtual {p0}, Lorg/bouncycastle/crypto/modes/KXTSBlockCipher;->i()V
...
.method public f(ZLorg/bouncycastle/crypto/CipherParameters;)V
    ...
    iget v2, p0, Lorg/bouncycastle/crypto/modes/KXTSBlockCipher;->g:I
    ...
    invoke-interface {p2, v2, v0}, Lorg/bouncycastle/crypto/BlockCipher;->a(ZLorg/bouncycastle/crypto/CipherParameters;)V
    ...
    iget-object p1, p0, Lorg/bouncycastle/crypto/modes/KXTSBlockCipher;->i:[J

    invoke-static {v1, v3, p1}, Lorg/bouncycastle/util/Pack;->s([BI[J)V

    iget-object p1, p0, Lorg/bouncycastle/crypto/modes/KXTSBlockCipher;->i:[J

    iget-object p2, p0, Lorg/bouncycastle/crypto/modes/KXTSBlockCipher;->j:[J

    array-length v0, p1

    invoke-static {p1, v3, p2, v3, v0}, Ljava/lang/System;->arraycopy(Ljava/lang/Object;ILjava/lang/Object;II)V

    iput v3, p0, Lorg/bouncycastle/crypto/modes/KXTSBlockCipher;->k:I
...
.method public h([BII[BI)I
    ...
    invoke-direct {p0, p1, v1, p4, v2}, Lorg/bouncycastle/crypto/modes/KXTSBlockCipher;->l([BI[BI)V
...
.method public i()V
    ...
    iget-object v0, p0, Lorg/bouncycastle/crypto/modes/KXTSBlockCipher;->i:[J
