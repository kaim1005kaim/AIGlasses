...
.method static constructor <clinit>()V
    ...
    sput-object v0, Lorg/bouncycastle/crypto/digests/LongDigest;->p:[J
...
.method protected constructor <init>(Lorg/bouncycastle/crypto/digests/LongDigest;)V
    ...
    invoke-virtual {p0, p1}, Lorg/bouncycastle/crypto/digests/LongDigest;->v(Lorg/bouncycastle/crypto/digests/LongDigest;)V

    return-void
.end method

.method private o(JJJ)J
    .locals 0
...
.method protected A(JJ)V
    ...
    iget v0, p0, Lorg/bouncycastle/crypto/digests/LongDigest;->n:I

    const/16 v1, 0xe

    if-le v0, v1, :cond_0

    invoke-virtual {p0}, Lorg/bouncycastle/crypto/digests/LongDigest;->z()V

    :cond_0
    iget-object p0, p0, Lorg/bouncycastle/crypto/digests/LongDigest;->m:[J
...
.method protected B([BI)V
    ...
    invoke-static {p1, p2}, Lorg/bouncycastle/util/Pack;->c([BI)J
...
.method protected C([B)V
    ...
    invoke-static {p1, v0}, Lorg/bouncycastle/util/Pack;->c([BI)J
    ...
    iput v0, p0, Lorg/bouncycastle/crypto/digests/LongDigest;->n:I
    ...
    invoke-static {p1, v1}, Lorg/bouncycastle/util/Pack;->c([BI)J
...
.method public update(B)V
    ...
    iget v1, p0, Lorg/bouncycastle/crypto/digests/LongDigest;->b:I
    ...
    invoke-virtual {p0, v0, p1}, Lorg/bouncycastle/crypto/digests/LongDigest;->B([BI)V

    iput p1, p0, Lorg/bouncycastle/crypto/digests/LongDigest;->b:I
...
.method public update([BII)V
    ...
    invoke-virtual {p0, p1, p2}, Lorg/bouncycastle/crypto/digests/LongDigest;->B([BI)V
...
.method protected v(Lorg/bouncycastle/crypto/digests/LongDigest;)V
    .locals 4
    ...
    iget-object v0, p1, Lorg/bouncycastle/crypto/digests/LongDigest;->m:[J

    iget-object v1, p0, Lorg/bouncycastle/crypto/digests/LongDigest;->m:[J
...
.method public w()V
    ...
    invoke-direct {p0}, Lorg/bouncycastle/crypto/digests/LongDigest;->u()V
    ...
    :cond_0
    invoke-virtual {p0, v0, v1, v2, v3}, Lorg/bouncycastle/crypto/digests/LongDigest;->A(JJ)V
...
.method protected x()I
    ...
    iget p0, p0, Lorg/bouncycastle/crypto/digests/LongDigest;->n:I
...
.method protected y([B)V
    ...
    invoke-static {v0, v1, p1, v3}, Lorg/bouncycastle/util/Pack;->v(J[BI)V

    iget-wide v0, p0, Lorg/bouncycastle/crypto/digests/LongDigest;->d:J
...
.method protected z()V
    ...
    invoke-direct/range {p0 .. p0}, Lorg/bouncycastle/crypto/digests/LongDigest;->u()V
    ...
    iget-object v1, v7, Lorg/bouncycastle/crypto/digests/LongDigest;->m:[J

    add-int/lit8 v2, v0, -0x2

    aget-wide v2, v1, v2

    invoke-direct {v7, v2, v3}, Lorg/bouncycastle/crypto/digests/LongDigest;->r(J)J

    move-result-wide v2

    iget-object v4, v7, Lorg/bouncycastle/crypto/digests/LongDigest;->m:[J
    ...
    invoke-direct {v7, v4, v5}, Lorg/bouncycastle/crypto/digests/LongDigest;->q(J)J
    ...
    iget-wide v2, v7, Lorg/bouncycastle/crypto/digests/LongDigest;->f:J

    iget-wide v4, v7, Lorg/bouncycastle/crypto/digests/LongDigest;->g:J

    iget-wide v9, v7, Lorg/bouncycastle/crypto/digests/LongDigest;->h:J

    iget-wide v11, v7, Lorg/bouncycastle/crypto/digests/LongDigest;->i:J

    iget-wide v13, v7, Lorg/bouncycastle/crypto/digests/LongDigest;->j:J

    move-wide v15, v9

    iget-wide v8, v7, Lorg/bouncycastle/crypto/digests/LongDigest;->k:J

    move-wide/from16 v17, v0

    iget-wide v0, v7, Lorg/bouncycastle/crypto/digests/LongDigest;->l:J
    ...
    invoke-direct {v7, v5, v6}, Lorg/bouncycastle/crypto/digests/LongDigest;->t(J)J
    ...
    invoke-direct/range {v0 .. v6}, Lorg/bouncycastle/crypto/digests/LongDigest;->o(JJJ)J

    move-result-wide v0

    add-long v24, v24, v0

    sget-object v29, Lorg/bouncycastle/crypto/digests/LongDigest;->p:[J

    aget-wide v0, v29, v23

    add-long v24, v24, v0

    iget-object v0, v7, Lorg/bouncycastle/crypto/digests/LongDigest;->m:[J
    ...
    invoke-direct {v7, v8, v9}, Lorg/bouncycastle/crypto/digests/LongDigest;->s(J)J
    ...
    invoke-direct/range {v0 .. v6}, Lorg/bouncycastle/crypto/digests/LongDigest;->p(JJJ)J
    ...
    invoke-direct {v7, v11, v12}, Lorg/bouncycastle/crypto/digests/LongDigest;->s(J)J
    ...
    invoke-direct {v7, v10, v11}, Lorg/bouncycastle/crypto/digests/LongDigest;->t(J)J
    ...
    invoke-direct {v7, v10, v11}, Lorg/bouncycastle/crypto/digests/LongDigest;->s(J)J
    ...
    invoke-direct {v7, v13, v14}, Lorg/bouncycastle/crypto/digests/LongDigest;->t(J)J
    ...
    invoke-direct {v7, v13, v14}, Lorg/bouncycastle/crypto/digests/LongDigest;->s(J)J
    ...
    invoke-direct {v7, v8, v9}, Lorg/bouncycastle/crypto/digests/LongDigest;->t(J)J
    ...
    iput-wide v0, v7, Lorg/bouncycastle/crypto/digests/LongDigest;->e:J

    iget-wide v0, v7, Lorg/bouncycastle/crypto/digests/LongDigest;->f:J

    add-long/2addr v0, v13

    iput-wide v0, v7, Lorg/bouncycastle/crypto/digests/LongDigest;->f:J

    iget-wide v0, v7, Lorg/bouncycastle/crypto/digests/LongDigest;->g:J

    add-long/2addr v0, v15

    iput-wide v0, v7, Lorg/bouncycastle/crypto/digests/LongDigest;->g:J

    iget-wide v0, v7, Lorg/bouncycastle/crypto/digests/LongDigest;->h:J

    add-long v0, v0, v19

    iput-wide v0, v7, Lorg/bouncycastle/crypto/digests/LongDigest;->h:J

    iget-wide v0, v7, Lorg/bouncycastle/crypto/digests/LongDigest;->i:J

    add-long v0, v0, v27

    iput-wide v0, v7, Lorg/bouncycastle/crypto/digests/LongDigest;->i:J

    iget-wide v0, v7, Lorg/bouncycastle/crypto/digests/LongDigest;->j:J

    add-long v0, v0, v21

    iput-wide v0, v7, Lorg/bouncycastle/crypto/digests/LongDigest;->j:J

    iget-wide v0, v7, Lorg/bouncycastle/crypto/digests/LongDigest;->k:J

    add-long v0, v0, v17

    iput-wide v0, v7, Lorg/bouncycastle/crypto/digests/LongDigest;->k:J

    iget-wide v0, v7, Lorg/bouncycastle/crypto/digests/LongDigest;->l:J

    add-long/2addr v0, v11

    iput-wide v0, v7, Lorg/bouncycastle/crypto/digests/LongDigest;->l:J

    const/4 v0, 0x0

    iput v0, v7, Lorg/bouncycastle/crypto/digests/LongDigest;->n:I
