.class public abstract Lcom/xiaomi/android/ble/TimeoutableValueRequest;
...
.annotation system Ldalvik/annotation/Signature;
    value = {
        ...
        "Ljava/lang/Object;",
        ">",
        "Lcom/xiaomi/android/ble/TimeoutableRequest;"
    }
.end annotation
...
.method constructor <init>(Lcom/xiaomi/android/ble/Request$Type;Landroid/bluetooth/BluetoothGattCharacteristic;)V
    ...
    .line 2
    invoke-direct {p0, p1, p2}, Lcom/xiaomi/android/ble/TimeoutableRequest;-><init>(Lcom/xiaomi/android/ble/Request$Type;Landroid/bluetooth/BluetoothGattCharacteristic;)V
...
.method constructor <init>(Lcom/xiaomi/android/ble/Request$Type;Landroid/bluetooth/BluetoothGattDescriptor;)V
    ...
    .line 3
    invoke-direct {p0, p1, p2}, Lcom/xiaomi/android/ble/TimeoutableRequest;-><init>(Lcom/xiaomi/android/ble/Request$Type;Landroid/bluetooth/BluetoothGattDescriptor;)V
...
.method public await(Ljava/lang/Class;)Ljava/lang/Object;
    ...
    .line 8
    invoke-virtual {p0, v1}, Lcom/xiaomi/android/ble/TimeoutableValueRequest;->await(Ljava/lang/Object;)Ljava/lang/Object;
...
.method public await(Ljava/lang/Class;J)Ljava/lang/Object;
    ...
    .line 13
    invoke-virtual {p0, p2, p3}, Lcom/xiaomi/android/ble/TimeoutableValueRequest;->timeout(J)Lcom/xiaomi/android/ble/TimeoutableValueRequest;
...
.method public await(Ljava/lang/Object;)Ljava/lang/Object;
    ...
    .line 3
    :try_start_0
    invoke-virtual {p0, p1}, Lcom/xiaomi/android/ble/TimeoutableValueRequest;->with(Ljava/lang/Object;)Lcom/xiaomi/android/ble/TimeoutableValueRequest;

    move-result-object v1

    invoke-virtual {v1}, Lcom/xiaomi/android/ble/TimeoutableRequest;->await()V
    :try_end_0
    .catchall {:try_start_0 .. :try_end_0} :catchall_0

    .line 4
    iput-object v0, p0, Lcom/xiaomi/android/ble/TimeoutableValueRequest;->valueCallback:Ljava/lang/Object;
...
.method public await(Ljava/lang/Object;J)Ljava/lang/Object;
    ...
    invoke-virtual {p0, p1}, Lcom/xiaomi/android/ble/TimeoutableValueRequest;->await(Ljava/lang/Object;)Ljava/lang/Object;
...
.method public bridge synthetic timeout(J)Lcom/xiaomi/android/ble/TimeoutableRequest;
    ...
    .line 1
    invoke-virtual {p0, p1, p2}, Lcom/xiaomi/android/ble/TimeoutableValueRequest;->timeout(J)Lcom/xiaomi/android/ble/TimeoutableValueRequest;
...
.method public timeout(J)Lcom/xiaomi/android/ble/TimeoutableValueRequest;
    .locals 0
    .annotation build Landroidx/annotation/NonNull;
    .end annotation
...
.method public with(Ljava/lang/Object;)Lcom/xiaomi/android/ble/TimeoutableValueRequest;
    .locals 0
    .param p1    # Ljava/lang/Object;
        .annotation build Landroidx/annotation/NonNull;
        .end annotation
    ...
    iput-object p1, p0, Lcom/xiaomi/android/ble/TimeoutableValueRequest;->valueCallback:Ljava/lang/Object;
