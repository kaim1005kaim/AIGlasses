.class public Lcom/xiaomi/ai/api/intent/domain/Website;
...
.method public constructor <init>()V
    ...
    iput-object v0, p0, Lcom/xiaomi/ai/api/intent/domain/Website;->name:Lcom/xiaomi/common/Optional;

    invoke-static {}, Lcom/xiaomi/common/Optional;->empty()Lcom/xiaomi/common/Optional;

    move-result-object v0

    iput-object v0, p0, Lcom/xiaomi/ai/api/intent/domain/Website;->text:Lcom/xiaomi/common/Optional;

    return-void
.end method

.method public static read(Lcom/fasterxml/jackson/databind/JsonNode;Lcom/xiaomi/common/Optional;)Lcom/xiaomi/ai/api/intent/domain/Website;
    .locals 3
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "(",
            ...
            "Ljava/lang/String;",
            ">;)",
            "Lcom/xiaomi/ai/api/intent/domain/Website;"
        }
    .end annotation
    ...
    new-instance p1, Lcom/xiaomi/ai/api/intent/domain/Website;

    invoke-direct {p1}, Lcom/xiaomi/ai/api/intent/domain/Website;-><init>()V
    ...
    invoke-virtual {p1, v0}, Lcom/xiaomi/ai/api/intent/domain/Website;->setName(Lcom/xiaomi/ai/api/intent/Slot;)Lcom/xiaomi/ai/api/intent/domain/Website;
    ...
    invoke-virtual {p1, p0}, Lcom/xiaomi/ai/api/intent/domain/Website;->setText(Lcom/xiaomi/ai/api/intent/Slot;)Lcom/xiaomi/ai/api/intent/domain/Website;

    :cond_1
    return-object p1
.end method

.method public static write(Lcom/xiaomi/ai/api/intent/domain/Website;)Lcom/fasterxml/jackson/databind/JsonNode;
    .locals 3
    .annotation system Ldalvik/annotation/Throws;
        value = {
            Ljava/lang/reflect/InvocationTargetException;,
    ...
    iget-object v1, p0, Lcom/xiaomi/ai/api/intent/domain/Website;->name:Lcom/xiaomi/common/Optional;
    ...
    :cond_0
    iget-object v1, p0, Lcom/xiaomi/ai/api/intent/domain/Website;->text:Lcom/xiaomi/common/Optional;
    ...
    iget-object p0, p0, Lcom/xiaomi/ai/api/intent/domain/Website;->text:Lcom/xiaomi/common/Optional;
...
.method public getName()Lcom/xiaomi/common/Optional;
    ...
    iget-object p0, p0, Lcom/xiaomi/ai/api/intent/domain/Website;->name:Lcom/xiaomi/common/Optional;
...
.method public setName(Lcom/xiaomi/ai/api/intent/Slot;)Lcom/xiaomi/ai/api/intent/domain/Website;
    .locals 0
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "(",
    ...
    iput-object p1, p0, Lcom/xiaomi/ai/api/intent/domain/Website;->name:Lcom/xiaomi/common/Optional;

    return-object p0
.end method

.method public setText(Lcom/xiaomi/ai/api/intent/Slot;)Lcom/xiaomi/ai/api/intent/domain/Website;
    .locals 0
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "(",
    ...
    iput-object p1, p0, Lcom/xiaomi/ai/api/intent/domain/Website;->text:Lcom/xiaomi/common/Optional;
