.class public Lcom/xiaomi/ai/api/intent/domain/RingTone;
...
.method public constructor <init>()V
    ...
    iput-object v0, p0, Lcom/xiaomi/ai/api/intent/domain/RingTone;->target:Lcom/xiaomi/common/Optional;
...
.method public constructor <init>(Lcom/xiaomi/ai/api/intent/EntityType;)V
    ...
    .line 5
    iput-object p1, p0, Lcom/xiaomi/ai/api/intent/domain/RingTone;->entity_type:Lcom/xiaomi/ai/api/intent/EntityType;

    return-void
.end method

.method public static read(Lcom/fasterxml/jackson/databind/JsonNode;Lcom/xiaomi/common/Optional;)Lcom/xiaomi/ai/api/intent/domain/RingTone;
    .locals 2
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "(",
            ...
            "Ljava/lang/String;",
            ">;)",
            "Lcom/xiaomi/ai/api/intent/domain/RingTone;"
        }
    .end annotation
    ...
    new-instance v0, Lcom/xiaomi/ai/api/intent/domain/RingTone;
    ...
    invoke-direct {v0, p1}, Lcom/xiaomi/ai/api/intent/domain/RingTone;-><init>(Lcom/xiaomi/ai/api/intent/EntityType;)V
    ...
    const-class p1, Lcom/xiaomi/ai/api/intent/domain/RingTone$RingType;
    ...
    invoke-virtual {v0, p0}, Lcom/xiaomi/ai/api/intent/domain/RingTone;->setTarget(Lcom/xiaomi/ai/api/intent/Slot;)Lcom/xiaomi/ai/api/intent/domain/RingTone;

    :cond_0
    return-object v0
.end method

.method public static write(Lcom/xiaomi/ai/api/intent/domain/RingTone;)Lcom/fasterxml/jackson/databind/JsonNode;
    .locals 2
    .annotation system Ldalvik/annotation/Throws;
        value = {
            Ljava/lang/reflect/InvocationTargetException;,
    ...
    iget-object v0, p0, Lcom/xiaomi/ai/api/intent/domain/RingTone;->entity_type:Lcom/xiaomi/ai/api/intent/EntityType;
    ...
    iget-object v1, p0, Lcom/xiaomi/ai/api/intent/domain/RingTone;->target:Lcom/xiaomi/common/Optional;
    ...
    iget-object p0, p0, Lcom/xiaomi/ai/api/intent/domain/RingTone;->target:Lcom/xiaomi/common/Optional;
...
.method protected __1()Lcom/xiaomi/ai/api/intent/EntityType;
    ...
    iget-object p0, p0, Lcom/xiaomi/ai/api/intent/domain/RingTone;->entity_type:Lcom/xiaomi/ai/api/intent/EntityType;
...
.method public setEntityType(Lcom/xiaomi/ai/api/intent/EntityType;)Lcom/xiaomi/ai/api/intent/domain/RingTone;
    .locals 0
    .annotation runtime Lcom/xiaomi/ai/api/common/Required;
    .end annotation
...
.method public setTarget(Lcom/xiaomi/ai/api/intent/Slot;)Lcom/xiaomi/ai/api/intent/domain/RingTone;
    .locals 0
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "(",
    ...
    iput-object p1, p0, Lcom/xiaomi/ai/api/intent/domain/RingTone;->target:Lcom/xiaomi/common/Optional;
