.class public Lcom/xiaomi/ai/api/intent/domain/IntercomMessage;
...
.method public constructor <init>()V
    ...
    iput-object v0, p0, Lcom/xiaomi/ai/api/intent/domain/IntercomMessage;->text:Lcom/xiaomi/common/Optional;

    return-void
.end method

.method public static read(Lcom/fasterxml/jackson/databind/JsonNode;Lcom/xiaomi/common/Optional;)Lcom/xiaomi/ai/api/intent/domain/IntercomMessage;
    .locals 2
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "(",
            ...
            "Ljava/lang/String;",
            ">;)",
            "Lcom/xiaomi/ai/api/intent/domain/IntercomMessage;"
        }
    .end annotation
    ...
    new-instance p1, Lcom/xiaomi/ai/api/intent/domain/IntercomMessage;

    invoke-direct {p1}, Lcom/xiaomi/ai/api/intent/domain/IntercomMessage;-><init>()V
    ...
    invoke-virtual {p1, p0}, Lcom/xiaomi/ai/api/intent/domain/IntercomMessage;->setText(Lcom/xiaomi/ai/api/intent/Slot;)Lcom/xiaomi/ai/api/intent/domain/IntercomMessage;

    :cond_0
    return-object p1
.end method

.method public static write(Lcom/xiaomi/ai/api/intent/domain/IntercomMessage;)Lcom/fasterxml/jackson/databind/JsonNode;
    .locals 2
    .annotation system Ldalvik/annotation/Throws;
        value = {
            Ljava/lang/reflect/InvocationTargetException;,
    ...
    iget-object v1, p0, Lcom/xiaomi/ai/api/intent/domain/IntercomMessage;->text:Lcom/xiaomi/common/Optional;
    ...
    iget-object p0, p0, Lcom/xiaomi/ai/api/intent/domain/IntercomMessage;->text:Lcom/xiaomi/common/Optional;
...
.method public setText(Lcom/xiaomi/ai/api/intent/Slot;)Lcom/xiaomi/ai/api/intent/domain/IntercomMessage;
    .locals 0
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "(",
    ...
    iput-object p1, p0, Lcom/xiaomi/ai/api/intent/domain/IntercomMessage;->text:Lcom/xiaomi/common/Optional;
