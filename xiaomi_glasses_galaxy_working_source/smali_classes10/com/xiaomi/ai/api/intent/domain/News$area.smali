.class public Lcom/xiaomi/ai/api/intent/domain/News$area;
...
.method public constructor <init>(Lcom/xiaomi/ai/api/intent/Slot;)V
    ...
    .line 3
    iput-object p1, p0, Lcom/xiaomi/ai/api/intent/domain/News$area;->name:Lcom/xiaomi/ai/api/intent/Slot;

    return-void
.end method

.method public static read(Lcom/fasterxml/jackson/databind/JsonNode;)Lcom/xiaomi/ai/api/intent/domain/News$area;
    .locals 2
    ...
    new-instance v0, Lcom/xiaomi/ai/api/intent/domain/News$area;

    invoke-direct {v0}, Lcom/xiaomi/ai/api/intent/domain/News$area;-><init>()V
    ...
    invoke-virtual {v0, p0}, Lcom/xiaomi/ai/api/intent/domain/News$area;->setName(Lcom/xiaomi/ai/api/intent/Slot;)Lcom/xiaomi/ai/api/intent/domain/News$area;

    return-object v0
.end method

.method public static write(Lcom/xiaomi/ai/api/intent/domain/News$area;)Lcom/fasterxml/jackson/databind/node/ObjectNode;
    .locals 2
    .annotation system Ldalvik/annotation/Throws;
        value = {
            Ljava/lang/reflect/InvocationTargetException;,
    ...
    iget-object p0, p0, Lcom/xiaomi/ai/api/intent/domain/News$area;->name:Lcom/xiaomi/ai/api/intent/Slot;
...
.method public setName(Lcom/xiaomi/ai/api/intent/Slot;)Lcom/xiaomi/ai/api/intent/domain/News$area;
    .locals 0
    .annotation runtime Lcom/xiaomi/ai/api/common/Required;
    .end annotation
