.class public Lcom/xiaomi/ai/api/intent/domain/VehicleAC;
...
.annotation system Ldalvik/annotation/MemberClasses;
    value = {
        Lcom/xiaomi/ai/api/intent/domain/VehicleAC$temperature;,
        Lcom/xiaomi/ai/api/intent/domain/VehicleAC$mode;,
        Lcom/xiaomi/ai/api/intent/domain/VehicleAC$fanLevel;,
        Lcom/xiaomi/ai/api/intent/domain/VehicleAC$cold;,
...
.method public constructor <init>()V
    ...
    iput-object v0, p0, Lcom/xiaomi/ai/api/intent/domain/VehicleAC;->position:Lcom/xiaomi/common/Optional;
...
.method public constructor <init>(Lcom/xiaomi/ai/api/intent/EntityType;)V
    ...
    .line 5
    iput-object p1, p0, Lcom/xiaomi/ai/api/intent/domain/VehicleAC;->entity_type:Lcom/xiaomi/ai/api/intent/EntityType;

    return-void
.end method

.method public static read(Lcom/fasterxml/jackson/databind/JsonNode;Lcom/xiaomi/common/Optional;)Lcom/xiaomi/ai/api/intent/domain/VehicleAC;
    .locals 2
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "(",
            ...
            "Ljava/lang/String;",
            ">;)",
            "Lcom/xiaomi/ai/api/intent/domain/VehicleAC;"
        }
    .end annotation
    ...
    new-instance v0, Lcom/xiaomi/ai/api/intent/domain/VehicleAC;

    const-string v1, "VehicleAC"
    ...
    invoke-direct {v0, p1}, Lcom/xiaomi/ai/api/intent/domain/VehicleAC;-><init>(Lcom/xiaomi/ai/api/intent/EntityType;)V
    ...
    invoke-virtual {v0, p0}, Lcom/xiaomi/ai/api/intent/domain/VehicleAC;->setPosition(Lcom/xiaomi/ai/api/intent/Slot;)Lcom/xiaomi/ai/api/intent/domain/VehicleAC;

    :cond_0
    return-object v0
.end method

.method public static write(Lcom/xiaomi/ai/api/intent/domain/VehicleAC;)Lcom/fasterxml/jackson/databind/JsonNode;
    .locals 2
    .annotation system Ldalvik/annotation/Throws;
        value = {
            Ljava/lang/reflect/InvocationTargetException;,
    ...
    iget-object v0, p0, Lcom/xiaomi/ai/api/intent/domain/VehicleAC;->entity_type:Lcom/xiaomi/ai/api/intent/EntityType;
    ...
    iget-object v1, p0, Lcom/xiaomi/ai/api/intent/domain/VehicleAC;->position:Lcom/xiaomi/common/Optional;
    ...
    iget-object p0, p0, Lcom/xiaomi/ai/api/intent/domain/VehicleAC;->position:Lcom/xiaomi/common/Optional;
...
.method protected __1()Lcom/xiaomi/ai/api/intent/EntityType;
    ...
    iget-object p0, p0, Lcom/xiaomi/ai/api/intent/domain/VehicleAC;->entity_type:Lcom/xiaomi/ai/api/intent/EntityType;
...
.method public setEntityType(Lcom/xiaomi/ai/api/intent/EntityType;)Lcom/xiaomi/ai/api/intent/domain/VehicleAC;
    .locals 0
    .annotation runtime Lcom/xiaomi/ai/api/common/Required;
    .end annotation
...
.method public setPosition(Lcom/xiaomi/ai/api/intent/Slot;)Lcom/xiaomi/ai/api/intent/domain/VehicleAC;
    .locals 0
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "(",
    ...
    iput-object p1, p0, Lcom/xiaomi/ai/api/intent/domain/VehicleAC;->position:Lcom/xiaomi/common/Optional;
