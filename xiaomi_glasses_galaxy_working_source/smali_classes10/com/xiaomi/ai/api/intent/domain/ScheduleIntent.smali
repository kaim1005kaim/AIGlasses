.class public Lcom/xiaomi/ai/api/intent/domain/ScheduleIntent;
...
.method public constructor <init>()V
    ...
    iput-object v0, p0, Lcom/xiaomi/ai/api/intent/domain/ScheduleIntent;->datetime:Lcom/xiaomi/common/Optional;

    return-void
.end method

.method public static read(Lcom/fasterxml/jackson/databind/JsonNode;Lcom/xiaomi/common/Optional;)Lcom/xiaomi/ai/api/intent/domain/ScheduleIntent;
    .locals 2
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "(",
            ...
            "Ljava/lang/String;",
            ">;)",
            "Lcom/xiaomi/ai/api/intent/domain/ScheduleIntent;"
        }
    .end annotation
    ...
    new-instance p1, Lcom/xiaomi/ai/api/intent/domain/ScheduleIntent;

    invoke-direct {p1}, Lcom/xiaomi/ai/api/intent/domain/ScheduleIntent;-><init>()V
    ...
    const-class v0, Lcom/xiaomi/ai/api/intent/slots/Miai$Datetime;
    ...
    invoke-virtual {p1, p0}, Lcom/xiaomi/ai/api/intent/domain/ScheduleIntent;->setDatetime(Lcom/xiaomi/ai/api/intent/Slot;)Lcom/xiaomi/ai/api/intent/domain/ScheduleIntent;

    :cond_0
    return-object p1
.end method

.method public static write(Lcom/xiaomi/ai/api/intent/domain/ScheduleIntent;)Lcom/fasterxml/jackson/databind/JsonNode;
    .locals 2
    .annotation system Ldalvik/annotation/Throws;
        value = {
            Ljava/lang/reflect/InvocationTargetException;,
    ...
    iget-object v1, p0, Lcom/xiaomi/ai/api/intent/domain/ScheduleIntent;->datetime:Lcom/xiaomi/common/Optional;
    ...
    iget-object p0, p0, Lcom/xiaomi/ai/api/intent/domain/ScheduleIntent;->datetime:Lcom/xiaomi/common/Optional;
...
.method public setDatetime(Lcom/xiaomi/ai/api/intent/Slot;)Lcom/xiaomi/ai/api/intent/domain/ScheduleIntent;
    .locals 0
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "(",
    ...
    iput-object p1, p0, Lcom/xiaomi/ai/api/intent/domain/ScheduleIntent;->datetime:Lcom/xiaomi/common/Optional;
