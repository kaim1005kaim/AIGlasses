.class public Lcom/xiaomi/ai/api/intent/domain/WaterHeater$mode;
...
.method public constructor <init>()V
    ...
    iput-object v0, p0, Lcom/xiaomi/ai/api/intent/domain/WaterHeater$mode;->name:Lcom/xiaomi/common/Optional;

    return-void
.end method

.method public static read(Lcom/fasterxml/jackson/databind/JsonNode;)Lcom/xiaomi/ai/api/intent/domain/WaterHeater$mode;
    .locals 3
    ...
    new-instance v0, Lcom/xiaomi/ai/api/intent/domain/WaterHeater$mode;

    invoke-direct {v0}, Lcom/xiaomi/ai/api/intent/domain/WaterHeater$mode;-><init>()V
    ...
    const-class v1, Lcom/xiaomi/ai/api/intent/domain/WaterHeater$WaterHeaterMode;
    ...
    invoke-virtual {v0, p0}, Lcom/xiaomi/ai/api/intent/domain/WaterHeater$mode;->setName(Lcom/xiaomi/ai/api/intent/Slot;)Lcom/xiaomi/ai/api/intent/domain/WaterHeater$mode;

    :cond_0
    return-object v0
.end method

.method public static write(Lcom/xiaomi/ai/api/intent/domain/WaterHeater$mode;)Lcom/fasterxml/jackson/databind/node/ObjectNode;
    .locals 2
    .annotation system Ldalvik/annotation/Throws;
        value = {
            Ljava/lang/reflect/InvocationTargetException;,
    ...
    iget-object v1, p0, Lcom/xiaomi/ai/api/intent/domain/WaterHeater$mode;->name:Lcom/xiaomi/common/Optional;
    ...
    iget-object p0, p0, Lcom/xiaomi/ai/api/intent/domain/WaterHeater$mode;->name:Lcom/xiaomi/common/Optional;
...
.method public setName(Lcom/xiaomi/ai/api/intent/Slot;)Lcom/xiaomi/ai/api/intent/domain/WaterHeater$mode;
    .locals 0
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "(",
    ...
    iput-object p1, p0, Lcom/xiaomi/ai/api/intent/domain/WaterHeater$mode;->name:Lcom/xiaomi/common/Optional;
