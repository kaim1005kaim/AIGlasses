.class public Lcom/xiaomi/ai/api/intent/domain/Message;
...
.field private user_id:Lcom/xiaomi/ai/api/intent/Slot;
...
.method public constructor <init>()V
    ...
    iput-object v0, p0, Lcom/xiaomi/ai/api/intent/domain/Message;->content:Lcom/xiaomi/common/Optional;
...
.method public constructor <init>(Lcom/xiaomi/ai/api/intent/Slot;)V
    ...
    .line 5
    iput-object p1, p0, Lcom/xiaomi/ai/api/intent/domain/Message;->user_id:Lcom/xiaomi/ai/api/intent/Slot;

    return-void
.end method

.method public static read(Lcom/fasterxml/jackson/databind/JsonNode;Lcom/xiaomi/common/Optional;)Lcom/xiaomi/ai/api/intent/domain/Message;
    .locals 3
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "(",
            ...
            "Ljava/lang/String;",
            ">;)",
            "Lcom/xiaomi/ai/api/intent/domain/Message;"
        }
    .end annotation
    ...
    new-instance p1, Lcom/xiaomi/ai/api/intent/domain/Message;

    invoke-direct {p1}, Lcom/xiaomi/ai/api/intent/domain/Message;-><init>()V
    ...
    invoke-virtual {p1, v0}, Lcom/xiaomi/ai/api/intent/domain/Message;->setUserId(Lcom/xiaomi/ai/api/intent/Slot;)Lcom/xiaomi/ai/api/intent/domain/Message;
    ...
    invoke-virtual {p1, p0}, Lcom/xiaomi/ai/api/intent/domain/Message;->setContent(Lcom/xiaomi/ai/api/intent/Slot;)Lcom/xiaomi/ai/api/intent/domain/Message;

    :cond_0
    return-object p1
.end method

.method public static write(Lcom/xiaomi/ai/api/intent/domain/Message;)Lcom/fasterxml/jackson/databind/JsonNode;
    .locals 3
    .annotation system Ldalvik/annotation/Throws;
        value = {
            Ljava/lang/reflect/InvocationTargetException;,
    ...
    iget-object v1, p0, Lcom/xiaomi/ai/api/intent/domain/Message;->user_id:Lcom/xiaomi/ai/api/intent/Slot;
    ...
    iget-object v1, p0, Lcom/xiaomi/ai/api/intent/domain/Message;->content:Lcom/xiaomi/common/Optional;
    ...
    iget-object p0, p0, Lcom/xiaomi/ai/api/intent/domain/Message;->content:Lcom/xiaomi/common/Optional;
...
.method public getUserId()Lcom/xiaomi/ai/api/intent/Slot;
    .locals 0
    .annotation runtime Lcom/xiaomi/ai/api/common/Required;
    .end annotation
    ...
    iget-object p0, p0, Lcom/xiaomi/ai/api/intent/domain/Message;->user_id:Lcom/xiaomi/ai/api/intent/Slot;

    return-object p0
.end method

.method public setContent(Lcom/xiaomi/ai/api/intent/Slot;)Lcom/xiaomi/ai/api/intent/domain/Message;
    .locals 0
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "(",
    ...
    iput-object p1, p0, Lcom/xiaomi/ai/api/intent/domain/Message;->content:Lcom/xiaomi/common/Optional;

    return-object p0
.end method

.method public setUserId(Lcom/xiaomi/ai/api/intent/Slot;)Lcom/xiaomi/ai/api/intent/domain/Message;
    .locals 0
    .annotation runtime Lcom/xiaomi/ai/api/common/Required;
    .end annotation
