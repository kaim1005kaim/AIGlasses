.class public Lcom/xiaomi/ai/api/intent/domain/PinPositionIntent;
...
.method public constructor <init>()V
    ...
    iput-object v0, p0, Lcom/xiaomi/ai/api/intent/domain/PinPositionIntent;->ordinal:Lcom/xiaomi/common/Optional;

    invoke-static {}, Lcom/xiaomi/common/Optional;->empty()Lcom/xiaomi/common/Optional;

    move-result-object v0

    iput-object v0, p0, Lcom/xiaomi/ai/api/intent/domain/PinPositionIntent;->position:Lcom/xiaomi/common/Optional;

    return-void
.end method

.method public static read(Lcom/fasterxml/jackson/databind/JsonNode;Lcom/xiaomi/common/Optional;)Lcom/xiaomi/ai/api/intent/domain/PinPositionIntent;
    .locals 2
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "(",
            ...
            "Ljava/lang/String;",
            ">;)",
            "Lcom/xiaomi/ai/api/intent/domain/PinPositionIntent;"
        }
    .end annotation
    ...
    new-instance p1, Lcom/xiaomi/ai/api/intent/domain/PinPositionIntent;

    invoke-direct {p1}, Lcom/xiaomi/ai/api/intent/domain/PinPositionIntent;-><init>()V
    ...
    invoke-virtual {p1, v0}, Lcom/xiaomi/ai/api/intent/domain/PinPositionIntent;->setOrdinal(Lcom/xiaomi/ai/api/intent/Slot;)Lcom/xiaomi/ai/api/intent/domain/PinPositionIntent;
    ...
    invoke-virtual {p1, p0}, Lcom/xiaomi/ai/api/intent/domain/PinPositionIntent;->setPosition(Lcom/xiaomi/ai/api/intent/Slot;)Lcom/xiaomi/ai/api/intent/domain/PinPositionIntent;

    :cond_1
    return-object p1
.end method

.method public static write(Lcom/xiaomi/ai/api/intent/domain/PinPositionIntent;)Lcom/fasterxml/jackson/databind/JsonNode;
    .locals 3
    .annotation system Ldalvik/annotation/Throws;
        value = {
            Ljava/lang/reflect/InvocationTargetException;,
    ...
    iget-object v1, p0, Lcom/xiaomi/ai/api/intent/domain/PinPositionIntent;->ordinal:Lcom/xiaomi/common/Optional;
    ...
    :cond_0
    iget-object v1, p0, Lcom/xiaomi/ai/api/intent/domain/PinPositionIntent;->position:Lcom/xiaomi/common/Optional;
    ...
    iget-object p0, p0, Lcom/xiaomi/ai/api/intent/domain/PinPositionIntent;->position:Lcom/xiaomi/common/Optional;
...
.method public getOrdinal()Lcom/xiaomi/common/Optional;
    ...
    iget-object p0, p0, Lcom/xiaomi/ai/api/intent/domain/PinPositionIntent;->ordinal:Lcom/xiaomi/common/Optional;
...
.method public setOrdinal(Lcom/xiaomi/ai/api/intent/Slot;)Lcom/xiaomi/ai/api/intent/domain/PinPositionIntent;
    .locals 0
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "(",
    ...
    iput-object p1, p0, Lcom/xiaomi/ai/api/intent/domain/PinPositionIntent;->ordinal:Lcom/xiaomi/common/Optional;

    return-object p0
.end method

.method public setPosition(Lcom/xiaomi/ai/api/intent/Slot;)Lcom/xiaomi/ai/api/intent/domain/PinPositionIntent;
    .locals 0
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "(",
    ...
    iput-object p1, p0, Lcom/xiaomi/ai/api/intent/domain/PinPositionIntent;->position:Lcom/xiaomi/common/Optional;
