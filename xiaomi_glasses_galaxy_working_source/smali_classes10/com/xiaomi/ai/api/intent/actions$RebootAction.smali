.class public Lcom/xiaomi/ai/api/intent/actions$RebootAction;
...
.method public constructor <init>(Lcom/xiaomi/ai/api/intent/IntentionEntity;)V
    ...
    iput-object v0, p0, Lcom/xiaomi/ai/api/intent/actions$RebootAction;->when:Lcom/xiaomi/common/Optional;

    .line 3
    iput-object p1, p0, Lcom/xiaomi/ai/api/intent/actions$RebootAction;->object:Lcom/xiaomi/ai/api/intent/IntentionEntity;
...
.method public constructor <init>(Lcom/xiaomi/ai/api/intent/IntentionEntity;Lcom/xiaomi/common/Optional;)V
    ...
    .line 7
    iput-object p2, p0, Lcom/xiaomi/ai/api/intent/actions$RebootAction;->when:Lcom/xiaomi/common/Optional;

    return-void
.end method

.method public static read(Lcom/fasterxml/jackson/databind/JsonNode;Lcom/xiaomi/ai/api/intent/action$ActionName;)Lcom/xiaomi/ai/api/intent/actions$RebootAction;
    .locals 3
    ...
    new-instance v1, Lcom/xiaomi/ai/api/intent/actions$RebootAction;
    ...
    invoke-direct {v1, v0}, Lcom/xiaomi/ai/api/intent/actions$RebootAction;-><init>(Lcom/xiaomi/ai/api/intent/IntentionEntity;)V
    ...
    invoke-virtual {v1, p0}, Lcom/xiaomi/ai/api/intent/actions$RebootAction;->setWhen(Lcom/xiaomi/ai/api/intent/IntentionEntity;)Lcom/xiaomi/ai/api/intent/actions$RebootAction;

    :cond_0
    return-object v1
.end method

.method public static write(Lcom/xiaomi/ai/api/intent/actions$RebootAction;)Lcom/fasterxml/jackson/databind/JsonNode;
    .locals 3
    .annotation system Ldalvik/annotation/Throws;
        value = {
            Ljava/lang/reflect/InvocationTargetException;,
    ...
    iget-object v1, p0, Lcom/xiaomi/ai/api/intent/actions$RebootAction;->object:Lcom/xiaomi/ai/api/intent/IntentionEntity;
    ...
    iget-object v1, p0, Lcom/xiaomi/ai/api/intent/actions$RebootAction;->when:Lcom/xiaomi/common/Optional;
    ...
    iget-object p0, p0, Lcom/xiaomi/ai/api/intent/actions$RebootAction;->when:Lcom/xiaomi/common/Optional;
...
.method public getObject()Lcom/xiaomi/ai/api/intent/IntentionEntity;
    ...
    iget-object p0, p0, Lcom/xiaomi/ai/api/intent/actions$RebootAction;->object:Lcom/xiaomi/ai/api/intent/IntentionEntity;
...
.method public setObject(Lcom/xiaomi/ai/api/intent/IntentionEntity;)Lcom/xiaomi/ai/api/intent/actions$RebootAction;
    .locals 0
    .annotation runtime Lcom/xiaomi/ai/api/common/Required;
    .end annotation
...
.method public setWhen(Lcom/xiaomi/ai/api/intent/IntentionEntity;)Lcom/xiaomi/ai/api/intent/actions$RebootAction;
    .locals 0
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "(TB;)",
    ...
    iput-object p1, p0, Lcom/xiaomi/ai/api/intent/actions$RebootAction;->when:Lcom/xiaomi/common/Optional;
