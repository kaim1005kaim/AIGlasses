.class public Lcom/xiaomi/ai/api/intent/DialogTask$select;
...
.method public constructor <init>()V
    ...
    iput-object v0, p0, Lcom/xiaomi/ai/api/intent/DialogTask$select;->ordinal:Lcom/xiaomi/common/Optional;

    invoke-static {}, Lcom/xiaomi/common/Optional;->empty()Lcom/xiaomi/common/Optional;

    move-result-object v0

    iput-object v0, p0, Lcom/xiaomi/ai/api/intent/DialogTask$select;->keyword:Lcom/xiaomi/common/Optional;

    return-void
.end method

.method public static read(Lcom/fasterxml/jackson/databind/JsonNode;)Lcom/xiaomi/ai/api/intent/DialogTask$select;
    .locals 3
    ...
    new-instance v0, Lcom/xiaomi/ai/api/intent/DialogTask$select;

    invoke-direct {v0}, Lcom/xiaomi/ai/api/intent/DialogTask$select;-><init>()V
    ...
    invoke-virtual {v0, p0}, Lcom/xiaomi/ai/api/intent/DialogTask$select;->setOrdinal(Lcom/xiaomi/common/Optional;)V

    :cond_0
    return-object v0
.end method

.method public static write(Lcom/xiaomi/ai/api/intent/DialogTask$select;)Lcom/fasterxml/jackson/databind/node/ObjectNode;
    .locals 3
    .annotation system Ldalvik/annotation/Throws;
        value = {
            Ljava/lang/reflect/InvocationTargetException;,
    ...
    invoke-virtual {p0}, Lcom/xiaomi/ai/api/intent/DialogTask$select;->getOrdinal()Lcom/xiaomi/common/Optional;
    ...
    iget-object v1, p0, Lcom/xiaomi/ai/api/intent/DialogTask$select;->ordinal:Lcom/xiaomi/common/Optional;
    ...
    :cond_0
    invoke-virtual {p0}, Lcom/xiaomi/ai/api/intent/DialogTask$select;->getKeyword()Lcom/xiaomi/common/Optional;
    ...
    iget-object p0, p0, Lcom/xiaomi/ai/api/intent/DialogTask$select;->keyword:Lcom/xiaomi/common/Optional;
...
.method public getOrdinal()Lcom/xiaomi/common/Optional;
    ...
    iget-object p0, p0, Lcom/xiaomi/ai/api/intent/DialogTask$select;->ordinal:Lcom/xiaomi/common/Optional;

    return-object p0
.end method

.method public setKeyword(Lcom/xiaomi/common/Optional;)V
    .locals 0
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "(",
    ...
    iput-object p1, p0, Lcom/xiaomi/ai/api/intent/DialogTask$select;->keyword:Lcom/xiaomi/common/Optional;

    return-void
.end method

.method public setOrdinal(Lcom/xiaomi/common/Optional;)V
    .locals 0
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "(",
    ...
    iput-object p1, p0, Lcom/xiaomi/ai/api/intent/DialogTask$select;->ordinal:Lcom/xiaomi/common/Optional;
