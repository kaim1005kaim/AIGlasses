...
.field public static final enum UNKNOWN:Lcom/xiaomi/ai/api/UIController$InteractionIntentType;
...
.method static constructor <clinit>()V
    ...
    invoke-direct {v0, v2, v3, v1}, Lcom/xiaomi/ai/api/UIController$InteractionIntentType;-><init>(Ljava/lang/String;II)V

    sput-object v0, Lcom/xiaomi/ai/api/UIController$InteractionIntentType;->UNKNOWN:Lcom/xiaomi/ai/api/UIController$InteractionIntentType;

    new-instance v1, Lcom/xiaomi/ai/api/UIController$InteractionIntentType;

    const-string v2, "MUSIC_SELECT"

    const/4 v4, 0x1

    invoke-direct {v1, v2, v4, v3}, Lcom/xiaomi/ai/api/UIController$InteractionIntentType;-><init>(Ljava/lang/String;II)V

    sput-object v1, Lcom/xiaomi/ai/api/UIController$InteractionIntentType;->MUSIC_SELECT:Lcom/xiaomi/ai/api/UIController$InteractionIntentType;

    new-instance v2, Lcom/xiaomi/ai/api/UIController$InteractionIntentType;

    const-string v3, "STATION_SELECT"

    const/4 v5, 0x2

    invoke-direct {v2, v3, v5, v4}, Lcom/xiaomi/ai/api/UIController$InteractionIntentType;-><init>(Ljava/lang/String;II)V

    sput-object v2, Lcom/xiaomi/ai/api/UIController$InteractionIntentType;->STATION_SELECT:Lcom/xiaomi/ai/api/UIController$InteractionIntentType;

    new-instance v3, Lcom/xiaomi/ai/api/UIController$InteractionIntentType;

    const-string v4, "VIDEO_SELECT"

    const/4 v6, 0x3

    invoke-direct {v3, v4, v6, v5}, Lcom/xiaomi/ai/api/UIController$InteractionIntentType;-><init>(Ljava/lang/String;II)V
    ...
    new-instance v4, Lcom/xiaomi/ai/api/UIController$InteractionIntentType;

    const-string v5, "COMMON"

    const/4 v7, 0x4

    invoke-direct {v4, v5, v7, v6}, Lcom/xiaomi/ai/api/UIController$InteractionIntentType;-><init>(Ljava/lang/String;II)V

    sput-object v4, Lcom/xiaomi/ai/api/UIController$InteractionIntentType;->COMMON:Lcom/xiaomi/ai/api/UIController$InteractionIntentType;

    filled-new-array {v0, v1, v2, v3, v4}, [Lcom/xiaomi/ai/api/UIController$InteractionIntentType;

    move-result-object v0

    sput-object v0, Lcom/xiaomi/ai/api/UIController$InteractionIntentType;->$VALUES:[Lcom/xiaomi/ai/api/UIController$InteractionIntentType;
