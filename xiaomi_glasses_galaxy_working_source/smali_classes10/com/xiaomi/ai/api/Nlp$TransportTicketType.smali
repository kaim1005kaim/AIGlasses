...
.method static constructor <clinit>()V
    ...
    const-string v2, "HIGH_SPEED_RAIL"

    const/4 v3, 0x1

    invoke-direct {v1, v2, v3, v3}, Lcom/xiaomi/ai/api/Nlp$TransportTicketType;-><init>(Ljava/lang/String;II)V

    sput-object v1, Lcom/xiaomi/ai/api/Nlp$TransportTicketType;->HIGH_SPEED_RAIL:Lcom/xiaomi/ai/api/Nlp$TransportTicketType;

    new-instance v2, Lcom/xiaomi/ai/api/Nlp$TransportTicketType;

    const-string v3, "NORMAL_TICKET"

    const/4 v4, 0x2

    invoke-direct {v2, v3, v4, v4}, Lcom/xiaomi/ai/api/Nlp$TransportTicketType;-><init>(Ljava/lang/String;II)V

    sput-object v2, Lcom/xiaomi/ai/api/Nlp$TransportTicketType;->NORMAL_TICKET:Lcom/xiaomi/ai/api/Nlp$TransportTicketType;

    filled-new-array {v0, v1, v2}, [Lcom/xiaomi/ai/api/Nlp$TransportTicketType;

    move-result-object v0

    sput-object v0, Lcom/xiaomi/ai/api/Nlp$TransportTicketType;->$VALUES:[Lcom/xiaomi/ai/api/Nlp$TransportTicketType;
