...
.field public static final enum UNKNOWN:Lcom/xiaomi/ai/api/Template$QueryType;
...
.method static constructor <clinit>()V
    ...
    invoke-direct {v0, v2, v3, v1}, Lcom/xiaomi/ai/api/Template$QueryType;-><init>(Ljava/lang/String;II)V

    sput-object v0, Lcom/xiaomi/ai/api/Template$QueryType;->UNKNOWN:Lcom/xiaomi/ai/api/Template$QueryType;

    new-instance v1, Lcom/xiaomi/ai/api/Template$QueryType;

    const-string v2, "SONG_SEARCH"

    const/4 v4, 0x1

    invoke-direct {v1, v2, v4, v3}, Lcom/xiaomi/ai/api/Template$QueryType;-><init>(Ljava/lang/String;II)V

    sput-object v1, Lcom/xiaomi/ai/api/Template$QueryType;->SONG_SEARCH:Lcom/xiaomi/ai/api/Template$QueryType;

    new-instance v2, Lcom/xiaomi/ai/api/Template$QueryType;

    const-string v3, "SONG_RECOMMENDATION"

    const/4 v5, 0x2

    invoke-direct {v2, v3, v5, v4}, Lcom/xiaomi/ai/api/Template$QueryType;-><init>(Ljava/lang/String;II)V

    sput-object v2, Lcom/xiaomi/ai/api/Template$QueryType;->SONG_RECOMMENDATION:Lcom/xiaomi/ai/api/Template$QueryType;
    ...
    invoke-direct {v3, v4, v6, v5}, Lcom/xiaomi/ai/api/Template$QueryType;-><init>(Ljava/lang/String;II)V

    sput-object v3, Lcom/xiaomi/ai/api/Template$QueryType;->TAG_SEARCH:Lcom/xiaomi/ai/api/Template$QueryType;

    new-instance v4, Lcom/xiaomi/ai/api/Template$QueryType;

    const-string v5, "ARTIST_SEARCH"

    const/4 v7, 0x4

    invoke-direct {v4, v5, v7, v6}, Lcom/xiaomi/ai/api/Template$QueryType;-><init>(Ljava/lang/String;II)V

    sput-object v4, Lcom/xiaomi/ai/api/Template$QueryType;->ARTIST_SEARCH:Lcom/xiaomi/ai/api/Template$QueryType;
    ...
    invoke-direct {v5, v6, v8, v7}, Lcom/xiaomi/ai/api/Template$QueryType;-><init>(Ljava/lang/String;II)V

    sput-object v5, Lcom/xiaomi/ai/api/Template$QueryType;->OTHER:Lcom/xiaomi/ai/api/Template$QueryType;

    filled-new-array/range {v0 .. v5}, [Lcom/xiaomi/ai/api/Template$QueryType;

    move-result-object v0

    sput-object v0, Lcom/xiaomi/ai/api/Template$QueryType;->$VALUES:[Lcom/xiaomi/ai/api/Template$QueryType;
