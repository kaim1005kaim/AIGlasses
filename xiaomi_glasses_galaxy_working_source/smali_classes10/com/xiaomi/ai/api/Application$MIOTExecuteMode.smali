...
.field public static final enum UNKNOWN:Lcom/xiaomi/ai/api/Application$MIOTExecuteMode;
...
.method static constructor <clinit>()V
    ...
    invoke-direct {v0, v2, v3, v1}, Lcom/xiaomi/ai/api/Application$MIOTExecuteMode;-><init>(Ljava/lang/String;II)V

    sput-object v0, Lcom/xiaomi/ai/api/Application$MIOTExecuteMode;->UNKNOWN:Lcom/xiaomi/ai/api/Application$MIOTExecuteMode;

    new-instance v1, Lcom/xiaomi/ai/api/Application$MIOTExecuteMode;

    const-string v2, "ONLINE_NLP_OFFLINE_EXEC"

    const/4 v4, 0x1

    invoke-direct {v1, v2, v4, v3}, Lcom/xiaomi/ai/api/Application$MIOTExecuteMode;-><init>(Ljava/lang/String;II)V

    sput-object v1, Lcom/xiaomi/ai/api/Application$MIOTExecuteMode;->ONLINE_NLP_OFFLINE_EXEC:Lcom/xiaomi/ai/api/Application$MIOTExecuteMode;

    new-instance v2, Lcom/xiaomi/ai/api/Application$MIOTExecuteMode;

    const-string v3, "ONLINE_NLP_ONLINE_EXEC"

    const/4 v5, 0x2

    invoke-direct {v2, v3, v5, v4}, Lcom/xiaomi/ai/api/Application$MIOTExecuteMode;-><init>(Ljava/lang/String;II)V

    sput-object v2, Lcom/xiaomi/ai/api/Application$MIOTExecuteMode;->ONLINE_NLP_ONLINE_EXEC:Lcom/xiaomi/ai/api/Application$MIOTExecuteMode;

    new-instance v3, Lcom/xiaomi/ai/api/Application$MIOTExecuteMode;

    const-string v4, "RACING_NLP_OFFLINE_EXEC"

    const/4 v6, 0x3

    invoke-direct {v3, v4, v6, v5}, Lcom/xiaomi/ai/api/Application$MIOTExecuteMode;-><init>(Ljava/lang/String;II)V
    ...
    new-instance v4, Lcom/xiaomi/ai/api/Application$MIOTExecuteMode;

    const-string v5, "OFFLINE_NLP_OFFLINE_EXEC"

    const/4 v7, 0x4

    invoke-direct {v4, v5, v7, v6}, Lcom/xiaomi/ai/api/Application$MIOTExecuteMode;-><init>(Ljava/lang/String;II)V

    sput-object v4, Lcom/xiaomi/ai/api/Application$MIOTExecuteMode;->OFFLINE_NLP_OFFLINE_EXEC:Lcom/xiaomi/ai/api/Application$MIOTExecuteMode;

    filled-new-array {v0, v1, v2, v3, v4}, [Lcom/xiaomi/ai/api/Application$MIOTExecuteMode;

    move-result-object v0

    sput-object v0, Lcom/xiaomi/ai/api/Application$MIOTExecuteMode;->$VALUES:[Lcom/xiaomi/ai/api/Application$MIOTExecuteMode;
