...
.field public static final enum INSERT_CURRENT:Lcom/xiaomi/ai/api/AudioPlayer$PlayBehavior;
...
.method static constructor <clinit>()V
    ...
    invoke-direct {v2, v3, v5, v4}, Lcom/xiaomi/ai/api/AudioPlayer$PlayBehavior;-><init>(Ljava/lang/String;II)V
    ...
    const-string v4, "REPLACE_PENDING"

    const/4 v6, 0x3

    invoke-direct {v3, v4, v6, v5}, Lcom/xiaomi/ai/api/AudioPlayer$PlayBehavior;-><init>(Ljava/lang/String;II)V

    sput-object v3, Lcom/xiaomi/ai/api/AudioPlayer$PlayBehavior;->REPLACE_PENDING:Lcom/xiaomi/ai/api/AudioPlayer$PlayBehavior;

    new-instance v4, Lcom/xiaomi/ai/api/AudioPlayer$PlayBehavior;

    const-string v5, "INSERT_FRONT"

    const/4 v7, 0x4

    invoke-direct {v4, v5, v7, v6}, Lcom/xiaomi/ai/api/AudioPlayer$PlayBehavior;-><init>(Ljava/lang/String;II)V

    sput-object v4, Lcom/xiaomi/ai/api/AudioPlayer$PlayBehavior;->INSERT_FRONT:Lcom/xiaomi/ai/api/AudioPlayer$PlayBehavior;

    new-instance v5, Lcom/xiaomi/ai/api/AudioPlayer$PlayBehavior;

    const-string v6, "INSERT_CURRENT"

    const/4 v8, 0x5

    invoke-direct {v5, v6, v8, v7}, Lcom/xiaomi/ai/api/AudioPlayer$PlayBehavior;-><init>(Ljava/lang/String;II)V

    sput-object v5, Lcom/xiaomi/ai/api/AudioPlayer$PlayBehavior;->INSERT_CURRENT:Lcom/xiaomi/ai/api/AudioPlayer$PlayBehavior;

    filled-new-array/range {v0 .. v5}, [Lcom/xiaomi/ai/api/AudioPlayer$PlayBehavior;

    move-result-object v0

    sput-object v0, Lcom/xiaomi/ai/api/AudioPlayer$PlayBehavior;->$VALUES:[Lcom/xiaomi/ai/api/AudioPlayer$PlayBehavior;
