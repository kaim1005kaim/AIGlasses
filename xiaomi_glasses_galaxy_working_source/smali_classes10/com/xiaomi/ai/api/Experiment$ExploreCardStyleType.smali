...
.method static constructor <clinit>()V
    ...
    const-string v2, "EXP_A"

    const/4 v3, 0x1

    invoke-direct {v1, v2, v3, v3}, Lcom/xiaomi/ai/api/Experiment$ExploreCardStyleType;-><init>(Ljava/lang/String;II)V
    ...
    new-instance v2, Lcom/xiaomi/ai/api/Experiment$ExploreCardStyleType;

    const-string v3, "EXP_B"

    const/4 v4, 0x2

    invoke-direct {v2, v3, v4, v4}, Lcom/xiaomi/ai/api/Experiment$ExploreCardStyleType;-><init>(Ljava/lang/String;II)V

    sput-object v2, Lcom/xiaomi/ai/api/Experiment$ExploreCardStyleType;->EXP_B:Lcom/xiaomi/ai/api/Experiment$ExploreCardStyleType;

    new-instance v3, Lcom/xiaomi/ai/api/Experiment$ExploreCardStyleType;

    const-string v4, "EXP_C"

    const/4 v5, 0x3

    invoke-direct {v3, v4, v5, v5}, Lcom/xiaomi/ai/api/Experiment$ExploreCardStyleType;-><init>(Ljava/lang/String;II)V

    sput-object v3, Lcom/xiaomi/ai/api/Experiment$ExploreCardStyleType;->EXP_C:Lcom/xiaomi/ai/api/Experiment$ExploreCardStyleType;

    filled-new-array {v0, v1, v2, v3}, [Lcom/xiaomi/ai/api/Experiment$ExploreCardStyleType;

    move-result-object v0

    sput-object v0, Lcom/xiaomi/ai/api/Experiment$ExploreCardStyleType;->$VALUES:[Lcom/xiaomi/ai/api/Experiment$ExploreCardStyleType;
